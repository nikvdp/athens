...
var extmap__4478__auto__ = (function (){var G__57583 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__57569);
...
(reitit.coercion.ParameterCoercion.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57591,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57601 = k57591;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57591,else__4442__auto__);
...
(reitit.coercion.ParameterCoercion.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57590){
var self__ = this;
var G__57590__$1 = this;
return (new cljs.core.RecordIter((0),G__57590__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"keywordize?","keywordize?",-234306912),new cljs.core.Keyword(null,"open?","open?",1238443125)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.coercion.ParameterCoercion.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57592,other57593){
var self__ = this;
var this57592__$1 = this;
return (((!((other57593 == null)))) && ((this57592__$1.constructor === other57593.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57592__$1.in,other57593.in)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57592__$1.style,other57593.style)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57592__$1.keywordize_QMARK_,other57593.keywordize_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57592__$1.open_QMARK_,other57593.open_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57592__$1.__extmap,other57593.__extmap)));
}));
...
(reitit.coercion.ParameterCoercion.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57590){
var self__ = this;
var this__4446__auto____$1 = this;
...
return (new reitit.coercion.ParameterCoercion(G__57590,self__.style,self__.keywordize_QMARK_,self__.open_QMARK_,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.coercion.ParameterCoercion(self__.in$,G__57590,self__.keywordize_QMARK_,self__.open_QMARK_,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.coercion.ParameterCoercion(self__.in$,self__.style,G__57590,self__.open_QMARK_,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.coercion.ParameterCoercion(self__.in$,self__.style,self__.keywordize_QMARK_,G__57590,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.coercion.ParameterCoercion(self__.in$,self__.style,self__.keywordize_QMARK_,self__.open_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57590),null));
}
}
}
}
...
(reitit.coercion.ParameterCoercion.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57590){
var self__ = this;
var this__4438__auto____$1 = this;
return (new reitit.coercion.ParameterCoercion(self__.in$,self__.style,self__.keywordize_QMARK_,self__.open_QMARK_,G__57590,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.coercion.map__GT_ParameterCoercion = (function reitit$coercion$map__GT_ParameterCoercion(G__57597){
var extmap__4478__auto__ = (function (){var G__57618 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57597,new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"keywordize?","keywordize?",-234306912),new cljs.core.Keyword(null,"open?","open?",1238443125)], 0));
if(cljs.core.record_QMARK_(G__57597)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57618);
} else {
return G__57618;
}
})();
return (new reitit.coercion.ParameterCoercion(new cljs.core.Keyword(null,"in","in",-1531184865).cljs$core$IFn$_invoke$arity$1(G__57597),new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(G__57597),new cljs.core.Keyword(null,"keywordize?","keywordize?",-234306912).cljs$core$IFn$_invoke$arity$1(G__57597),new cljs.core.Keyword(null,"open?","open?",1238443125).cljs$core$IFn$_invoke$arity$1(G__57597),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
