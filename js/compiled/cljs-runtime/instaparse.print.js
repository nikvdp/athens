...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63593 = (function (){var G__63594 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63594) : parser.call(null,G__63594));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63593) : tag_set.call(null,G__63593));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63596){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63597__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63597__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63601,hidden_QMARK_){
var map__63602 = p__63601;
var map__63602__$1 = (((((!((map__63602 == null))))?(((((map__63602.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63602.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63602):map__63602);
var p = map__63602__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63602__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63602__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63602__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63602__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63602__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__63604 = tag;
var G__63604__$1 = (((G__63604 instanceof cljs.core.Keyword))?G__63604.fqn:null);
switch (G__63604__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__63605_63629 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63606_63630 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63607_63631 = true;
var _STAR_print_fn_STAR__temp_val__63608_63632 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63607_63631);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63608_63632);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63606_63630);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63605_63629);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__63609_63633 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63610_63634 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63611_63635 = true;
var _STAR_print_fn_STAR__temp_val__63612_63636 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63611_63635);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63612_63636);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63610_63634);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63609_63633);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63604__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63613){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63614__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63614__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63616(s__63617){
return (new cljs.core.LazySeq(null,(function (){
var s__63617__$1 = s__63617;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63617__$1);
if(temp__5735__auto__){
var s__63617__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63617__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63617__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63619 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63618 = (0);
while(true){
if((i__63618 < size__4581__auto__)){
var vec__63620 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63618);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63620,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63620,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63619,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63637 = (i__63618 + (1));
i__63618 = G__63637;
continue;
} else {
var G__63638 = (i__63618 + (1));
i__63618 = G__63638;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63619),instaparse$print$Parser__GT_str_$_iter__63616(cljs.core.chunk_rest(s__63617__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63619),null);
}
} else {
var vec__63623 = cljs.core.first(s__63617__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63623,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63623,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63616(cljs.core.rest(s__63617__$2)));
} else {
var G__63639 = cljs.core.rest(s__63617__$2);
s__63617__$1 = G__63639;
continue;
}
}
} else {
