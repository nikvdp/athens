...
var G__46891 = cljs.core.cons(pdb,path);
var G__46892 = posh.lib.db.get_parent_db(pdb);
path = G__46891;
pdb = G__46892;
continue;
} else {
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__46879,poshdb){
