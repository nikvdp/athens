...
var G__46842 = cljs.core.first(poshdb);
...
var G__46882 = cljs.core.cons(pdb,path);
var G__46883 = posh.lib.db.get_parent_db(pdb);
path = G__46882;
pdb = G__46883;
continue;
} else {
...
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__46861 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46861.cljs$core$IFn$_invoke$arity$2 ? fexpr__46861.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__46861.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__46862 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46862.cljs$core$IFn$_invoke$arity$2 ? fexpr__46862.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__46862.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__46864 = db__$4;
var G__46865 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__46863 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46863.cljs$core$IFn$_invoke$arity$2 ? fexpr__46863.cljs$core$IFn$_invoke$arity$2(G__46864,G__46865) : fexpr__46863.call(null,G__46864,G__46865));
})():db__$4);
return db__$5;
}));
