...
if(cljs.core.truth_((function (){var fexpr__65352 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65352.cljs$core$IFn$_invoke$arity$1 ? fexpr__65352.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65352.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65358 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65358.cljs$core$IFn$_invoke$arity$1 ? fexpr__65358.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65358.call(null,type));
})())){
} else {
...
var G__65362 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65362)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65362)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65362)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65362)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65362)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65374){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65377 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65377) : instaparse.reduction.node_builders.call(null,G__65377));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65367){
var G__65368 = cljs.core.first(seq65367);
var seq65367__$1 = cljs.core.next(seq65367);
var G__65369 = cljs.core.first(seq65367__$1);
var seq65367__$2 = cljs.core.next(seq65367__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65368,G__65369,seq65367__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65427 = arguments.length;
var i__4790__auto___65428 = (0);
while(true){
if((i__4790__auto___65428 < len__4789__auto___65427)){
args__4795__auto__.push((arguments[i__4790__auto___65428]));

var G__65429 = (i__4790__auto___65428 + (1));
i__4790__auto___65428 = G__65429;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65381){
var map__65382 = p__65381;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65384 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65384) : instaparse.reduction.node_builders.call(null,G__65384));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65378){
var G__65379 = cljs.core.first(seq65378);
var seq65378__$1 = cljs.core.next(seq65378);
var G__65380 = cljs.core.first(seq65378__$1);
var seq65378__$2 = cljs.core.next(seq65378__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65379,G__65380,seq65378__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65386,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65386,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65392){
var vec__65393 = p__65392;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65393,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65393,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65396 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65396(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65387,other65388){
var self__ = this;
var this65387__$1 = this;
return (((!((other65388 == null)))) && ((this65387__$1.constructor === other65388.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65387__$1.grammar,other65388.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65387__$1.start_production,other65388.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65387__$1.output_format,other65388.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65387__$1.__extmap,other65388.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65385){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65397 = cljs.core.keyword_identical_QMARK_;
var expr__65398 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65400 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65401 = expr__65398;
return (pred__65397.cljs$core$IFn$_invoke$arity$2 ? pred__65397.cljs$core$IFn$_invoke$arity$2(G__65400,G__65401) : pred__65397.call(null,G__65400,G__65401));
})())){
return (new instaparse.core.Parser(G__65385,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65402 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65403 = expr__65398;
return (pred__65397.cljs$core$IFn$_invoke$arity$2 ? pred__65397.cljs$core$IFn$_invoke$arity$2(G__65402,G__65403) : pred__65397.call(null,G__65402,G__65403));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65385,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65404 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65405 = expr__65398;
return (pred__65397.cljs$core$IFn$_invoke$arity$2 ? pred__65397.cljs$core$IFn$_invoke$arity$2(G__65404,G__65405) : pred__65397.call(null,G__65404,G__65405));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65385,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65385),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65385){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65385,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65390){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65390)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65389){
var extmap__4478__auto__ = (function (){var G__65407 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65389,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65389)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65407);
} else {
return G__65407;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65389),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65389),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65389),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65498 = arguments.length;
var i__4790__auto___65499 = (0);
while(true){
if((i__4790__auto___65499 < len__4789__auto___65498)){
args__4795__auto__.push((arguments[i__4790__auto___65499]));

var G__65500 = (i__4790__auto___65499 + (1));
i__4790__auto___65499 = G__65500;
continue;
} else {
}
break;
