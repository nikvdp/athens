...
if(cljs.core.truth_((function (){var fexpr__65255 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65255.cljs$core$IFn$_invoke$arity$1 ? fexpr__65255.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65255.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65256 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65256.cljs$core$IFn$_invoke$arity$1 ? fexpr__65256.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65256.call(null,type));
})())){
} else {
...
var G__65260 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65260)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65260)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65260)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65260)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65260)].join('')));
...
var G__65354 = (i__4790__auto___65352 + (1));
i__4790__auto___65352 = G__65354;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65265){
var map__65266 = p__65265;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65270 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65270) : instaparse.reduction.node_builders.call(null,G__65270));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65262){
var G__65263 = cljs.core.first(seq65262);
var seq65262__$1 = cljs.core.next(seq65262);
var G__65264 = cljs.core.first(seq65262__$1);
var seq65262__$2 = cljs.core.next(seq65262__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65263,G__65264,seq65262__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65364 = arguments.length;
var i__4790__auto___65365 = (0);
while(true){
if((i__4790__auto___65365 < len__4789__auto___65364)){
args__4795__auto__.push((arguments[i__4790__auto___65365]));

var G__65366 = (i__4790__auto___65365 + (1));
i__4790__auto___65365 = G__65366;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65275){
var map__65276 = p__65275;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65282 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65272){
var G__65273 = cljs.core.first(seq65272);
var seq65272__$1 = cljs.core.next(seq65272);
var G__65274 = cljs.core.first(seq65272__$1);
var seq65272__$2 = cljs.core.next(seq65272__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65273,G__65274,seq65272__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65294,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65294,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65307){
var vec__65308 = p__65307;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65308,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65308,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65319 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65319(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65295,other65296){
var self__ = this;
var this65295__$1 = this;
return (((!((other65296 == null)))) && ((this65295__$1.constructor === other65296.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65295__$1.grammar,other65296.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65295__$1.start_production,other65296.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65295__$1.output_format,other65296.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65295__$1.__extmap,other65296.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65293){
var self__ = this;
...
return (new instaparse.core.Parser(G__65293,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__65293,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65293,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65293),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65293){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65293,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65300){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65300)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65299){
var extmap__4478__auto__ = (function (){var G__65338 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65299,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65299),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65299),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65299),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65468 = arguments.length;
var i__4790__auto___65469 = (0);
while(true){
if((i__4790__auto___65469 < len__4789__auto___65468)){
args__4795__auto__.push((arguments[i__4790__auto___65469]));

var G__65470 = (i__4790__auto___65469 + (1));
i__4790__auto___65469 = G__65470;
continue;
} else {
}
break;
