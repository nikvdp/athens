...
var G__56057 = cljs.spec.alpha.get_spec(x);
x = G__56057;
continue;
} else {
...
var G__56065 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56065;
continue;
} else {
