...
var G__58075_58100 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__58076_58101 = (function (db){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__58077){
var vec__58078 = p__58077;
var seq__58079 = cljs.core.seq(vec__58078);
var first__58080 = cljs.core.first(seq__58079);
var seq__58079__$1 = cljs.core.next(seq__58079);
var ___$1 = first__58080;
var route = seq__58079__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__58081,p__58082){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58083__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__58084 = p__58082;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58084,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58084,(1),null);
...
var node = (function (){var G__58088 = athens.db.dsdb;
var G__58089 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
...
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58088,G__58089,G__58090) : posh.reagent.pull.call(null,G__58088,G__58089,G__58090));
})();
...
var G__58091_58104 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__58092_58105 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__58091_58104,G__58092_58105) : re_frame.core.reg_fx.call(null,G__58091_58104,G__58092_58105));
...
var G__58094 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58094) : re_frame.core.dispatch.call(null,G__58094));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__58095 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58095) : re_frame.core.dispatch.call(null,G__58095));
});
...
var G__58098 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58098) : re_frame.core.dispatch.call(null,G__58098));
}));

(athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2 = (function (uid,e){
var shift = e.shiftKey;
if(cljs.core.truth_(shift)){
var G__58099 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
