...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__42498(s__42499){
return (new cljs.core.LazySeq(null,(function (){
var s__42499__$1 = s__42499;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42499__$1);
if(temp__5735__auto__){
var s__42499__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42499__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42499__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42501 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42500 = (0);
while(true){
if((i__42500 < size__4581__auto__)){
var vec__42504 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42500);
...
cljs.core.chunk_append(b__42501,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__42715 = (i__42500 + (1));
i__42500 = G__42715;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42501),datascript$impl$entity$js_seq_$_iter__42498(cljs.core.chunk_rest(s__42499__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42501),null);
}
} else {
var vec__42507 = cljs.core.first(s__42499__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42507,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42507,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__42498(cljs.core.rest(s__42499__$2)));
}
} else {
return null;
}
...
var G__42721 = null;
var G__42721__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__42538 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42539 = null;
var count__42540 = (0);
var i__42541 = (0);
while(true){
if((i__42541 < count__42540)){
var vec__42567 = chunk__42539.cljs$core$IIndexed$_nth$arity$2(null,i__42541);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42567,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42567,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42724 = seq__42538;
var G__42725 = chunk__42539;
var G__42726 = count__42540;
var G__42727 = (i__42541 + (1));
seq__42538 = G__42724;
chunk__42539 = G__42725;
count__42540 = G__42726;
i__42541 = G__42727;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42538);
if(temp__5735__auto__){
var seq__42538__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42538__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42538__$1);
var G__42729 = cljs.core.chunk_rest(seq__42538__$1);
var G__42730 = c__4609__auto__;
var G__42731 = cljs.core.count(c__4609__auto__);
var G__42732 = (0);
seq__42538 = G__42729;
chunk__42539 = G__42730;
count__42540 = G__42731;
i__42541 = G__42732;
continue;
} else {
var vec__42578 = cljs.core.first(seq__42538__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42578,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42578,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42736 = cljs.core.next(seq__42538__$1);
var G__42737 = null;
var G__42738 = (0);
var G__42739 = (0);
seq__42538 = G__42736;
chunk__42539 = G__42737;
count__42540 = G__42738;
i__42541 = G__42739;
continue;
}
} else {
...
var G__42721__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__42587 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42588 = null;
var count__42589 = (0);
var i__42590 = (0);
while(true){
if((i__42590 < count__42589)){
var vec__42599 = chunk__42588.cljs$core$IIndexed$_nth$arity$2(null,i__42590);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42599,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42599,(1),null);
f.call(use_as_this,v,a,this$);


var G__42748 = seq__42587;
var G__42749 = chunk__42588;
var G__42750 = count__42589;
var G__42751 = (i__42590 + (1));
seq__42587 = G__42748;
chunk__42588 = G__42749;
count__42589 = G__42750;
i__42590 = G__42751;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42587);
if(temp__5735__auto__){
var seq__42587__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42587__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42587__$1);
var G__42755 = cljs.core.chunk_rest(seq__42587__$1);
var G__42756 = c__4609__auto__;
var G__42757 = cljs.core.count(c__4609__auto__);
var G__42758 = (0);
seq__42587 = G__42755;
chunk__42588 = G__42756;
count__42589 = G__42757;
i__42590 = G__42758;
continue;
} else {
var vec__42613 = cljs.core.first(seq__42587__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42613,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42613,(1),null);
f.call(use_as_this,v,a,this$);


var G__42760 = cljs.core.next(seq__42587__$1);
var G__42761 = null;
var G__42762 = (0);
var G__42763 = (0);
seq__42587 = G__42760;
chunk__42588 = G__42761;
count__42589 = G__42762;
i__42590 = G__42763;
continue;
}
} else {
...
G__42721 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__42721__1.call(this,f);
case 2:
return G__42721__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__42721.cljs$core$IFn$_invoke$arity$1 = G__42721__1;
G__42721.cljs$core$IFn$_invoke$arity$2 = G__42721__2;
return G__42721;
})()
);
...
var G__42618 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__42618);
} else {
return G__42618;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__42641 = this$__$1;
var G__42642 = k;
var G__42643 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__42641,G__42642,G__42643) : datascript.impl.entity.lookup_entity.call(null,G__42641,G__42642,G__42643));
})());
}));
...
var self__ = this;
var self__ = this;
var G__42648 = (arguments.length - (1));
switch (G__42648) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args42525){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args42525)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__42682 = cljs.core.deref(this$.cache);
return (fexpr__42682.cljs$core$IFn$_invoke$arity$1 ? fexpr__42682.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__42682.call(null,attr));
})();
...
var temp__5735__auto___42804 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___42804)){
var datoms_42812 = temp__5735__auto___42804;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_42812)));
