...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42494_SHARP_,p2__42495_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42494_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__42495_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__42501(s__42502){
return (new cljs.core.LazySeq(null,(function (){
var s__42502__$1 = s__42502;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42502__$1);
if(temp__5735__auto__){
var s__42502__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42502__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42502__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42504 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42503 = (0);
while(true){
if((i__42503 < size__4581__auto__)){
var vec__42514 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42503);
...
cljs.core.chunk_append(b__42504,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__42722 = (i__42503 + (1));
i__42503 = G__42722;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42504),datascript$impl$entity$js_seq_$_iter__42501(cljs.core.chunk_rest(s__42502__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42504),null);
}
} else {
var vec__42521 = cljs.core.first(s__42502__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__42501(cljs.core.rest(s__42502__$2)));
}
} else {
return null;
}
...
var G__42727 = null;
var G__42727__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__42564 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42565 = null;
var count__42566 = (0);
var i__42567 = (0);
while(true){
if((i__42567 < count__42566)){
var vec__42581 = chunk__42565.cljs$core$IIndexed$_nth$arity$2(null,i__42567);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42581,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42581,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42739 = seq__42564;
var G__42740 = chunk__42565;
var G__42741 = count__42566;
var G__42742 = (i__42567 + (1));
seq__42564 = G__42739;
chunk__42565 = G__42740;
count__42566 = G__42741;
i__42567 = G__42742;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42564);
if(temp__5735__auto__){
var seq__42564__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42564__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42564__$1);
var G__42743 = cljs.core.chunk_rest(seq__42564__$1);
var G__42744 = c__4609__auto__;
var G__42745 = cljs.core.count(c__4609__auto__);
var G__42746 = (0);
seq__42564 = G__42743;
chunk__42565 = G__42744;
count__42566 = G__42745;
i__42567 = G__42746;
continue;
} else {
var vec__42588 = cljs.core.first(seq__42564__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42588,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42588,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42748 = cljs.core.next(seq__42564__$1);
var G__42749 = null;
var G__42750 = (0);
var G__42751 = (0);
seq__42564 = G__42748;
chunk__42565 = G__42749;
count__42566 = G__42750;
i__42567 = G__42751;
continue;
}
} else {
...
var G__42727__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__42600 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42601 = null;
var count__42602 = (0);
var i__42603 = (0);
while(true){
if((i__42603 < count__42602)){
var vec__42617 = chunk__42601.cljs$core$IIndexed$_nth$arity$2(null,i__42603);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42617,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42617,(1),null);
f.call(use_as_this,v,a,this$);


var G__42755 = seq__42600;
var G__42756 = chunk__42601;
var G__42757 = count__42602;
var G__42758 = (i__42603 + (1));
seq__42600 = G__42755;
chunk__42601 = G__42756;
count__42602 = G__42757;
i__42603 = G__42758;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42600);
if(temp__5735__auto__){
var seq__42600__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42600__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42600__$1);
var G__42760 = cljs.core.chunk_rest(seq__42600__$1);
var G__42761 = c__4609__auto__;
var G__42762 = cljs.core.count(c__4609__auto__);
var G__42763 = (0);
seq__42600 = G__42760;
chunk__42601 = G__42761;
count__42602 = G__42762;
i__42603 = G__42763;
continue;
} else {
var vec__42622 = cljs.core.first(seq__42600__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42622,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42622,(1),null);
f.call(use_as_this,v,a,this$);


var G__42768 = cljs.core.next(seq__42600__$1);
var G__42769 = null;
var G__42770 = (0);
var G__42771 = (0);
seq__42600 = G__42768;
chunk__42601 = G__42769;
count__42602 = G__42770;
i__42603 = G__42771;
continue;
}
} else {
...
G__42727 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__42727__1.call(this,f);
case 2:
return G__42727__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__42727.cljs$core$IFn$_invoke$arity$1 = G__42727__1;
G__42727.cljs$core$IFn$_invoke$arity$2 = G__42727__2;
return G__42727;
})()
);
...
var G__42627 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__42627);
} else {
return G__42627;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__42654 = this$__$1;
var G__42655 = k;
var G__42656 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__42654,G__42655,G__42656) : datascript.impl.entity.lookup_entity.call(null,G__42654,G__42655,G__42656));
})());
}));
...
var self__ = this;
var self__ = this;
var G__42660 = (arguments.length - (1));
switch (G__42660) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args42544){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args42544)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__42687 = cljs.core.deref(this$.cache);
return (fexpr__42687.cljs$core$IFn$_invoke$arity$1 ? fexpr__42687.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__42687.call(null,attr));
})();
...
var temp__5735__auto___42823 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___42823)){
var datoms_42824 = temp__5735__auto___42823;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_42824)));
