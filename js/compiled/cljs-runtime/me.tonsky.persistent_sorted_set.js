...
var l__40994__auto___41108 = ((r1_l - a1_l) - (0));
var n__4666__auto___41110 = l__40994__auto___41108;
...
while(true){
if((i__40995__auto___41116 < n__4666__auto___41114)){
...
while(true){
if((level > (0))){
var G__41173 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__41174 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__41173;
node = G__41174;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__41190 = (function (){var arr__41009__auto__ = node__$1.pointers;
return (arr__41009__auto__[(arr__41009__auto__.length - (1))]);
})();
var G__41191 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__41192 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__41190;
path = G__41191;
level__$1 = G__41192;
continue;
...
var G__41236 = new_left;
var G__41237 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41238 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__41239 = new_acc;
left__$1 = G__41236;
keys__$1 = G__41237;
idx__$1 = G__41238;
acc = G__41239;
...
var G__41296 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41297 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41296;
res = G__41297;
continue;
}
...
var G__41299 = (node.pointers[idx]);
var G__41300 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41301 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41299;
path = G__41300;
level = G__41301;
continue;
...
var G__41304 = (node.pointers[idx]);
var G__41305 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41306 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41304;
path = G__41305;
level = G__41306;
continue;
...
var pos_41313 = (0);
while(true){
var rest_41314 = (len - pos_41313);
if((rest_41314 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41313));
} else {
if((rest_41314 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41313,(pos_41313 + chunk_len)));

var G__41316 = (pos_41313 + chunk_len);
pos_41313 = G__41316;
continue;
} else {
var piece_len_41317 = (rest_41314 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41313,(pos_41313 + piece_len_41317)));

var G__41318 = (pos_41313 + piece_len_41317);
pos_41313 = G__41318;
continue;
...
var G__41328 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41329 = (i + (1));
var G__41330 = e;
acc = G__41328;
i = G__41329;
...
while(true){
if((i__4790__auto___41362 < len__4789__auto___41360)){
