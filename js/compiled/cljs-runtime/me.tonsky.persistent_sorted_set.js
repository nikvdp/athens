...
var G__41117 = (i__40995__auto___41115 + (1));
i__40995__auto___41115 = G__41117;
continue;
} else {
}
break;
...
var l__40994__auto___41118 = (r1_l - (0));
var n__4666__auto___41120 = l__40994__auto___41118;
...
var i__40995__auto___41126 = (0);
while(true){
if((i__40995__auto___41126 < n__4666__auto___41125)){
(r2[(i__40995__auto___41126 + (0))] = (a1[(i__40995__auto___41126 + r1_l)]));

var G__41128 = (i__40995__auto___41126 + (1));
i__40995__auto___41126 = G__41128;
continue;
} else {
}
break;
...
var G__41263 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41264 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41263;
res = G__41264;
continue;
}
...
var G__41288 = (node.pointers[idx]);
var G__41289 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41290 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41288;
path = G__41289;
level = G__41290;
continue;
...
while(true){
if((i_41295 < len)){
(arr[i_41295] = (function (){var G__41063 = (arr[i_41295]);
...
var pos_41297 = (0);
while(true){
var rest_41298 = (len - pos_41297);
if((rest_41298 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41297));
} else {
if((rest_41298 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41297,(pos_41297 + chunk_len)));

var G__41304 = (pos_41297 + chunk_len);
pos_41297 = G__41304;
continue;
} else {
var piece_len_41305 = (rest_41298 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41297,(pos_41297 + piece_len_41305)));

var G__41306 = (pos_41297 + piece_len_41305);
pos_41297 = G__41306;
continue;
...
var G__41314 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41315 = (i + (1));
var G__41316 = e;
acc = G__41314;
i = G__41315;
