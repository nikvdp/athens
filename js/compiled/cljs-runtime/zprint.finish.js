...
return cljs.core.filterv((function (p1__28645_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28645_SHARP_))));
...
var vec__28660 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28660,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28660,(1),null);
var cvec_element = vec__28660;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28665_SHARP_,p2__28664_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28664_SHARP_)){
return cljs.core.reduced(p1__28665_SHARP_);
} else {
return (p1__28665_SHARP_ + (1));
}
}),(0),lines);
});
/**
