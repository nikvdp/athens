...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68115,action,ex){
...
var state = map__68116__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68116__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
var req = this;
var map__68146 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__68146__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68146__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__68148 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68148) : callback.call(null,G__68148));
} else {
...
if(cljs.core.truth_((function (){var G__68158 = new cljs.core.Keyword(null,"ws","ws",86841443);
...
if(cljs.core.truth_((function (){var G__68160 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68161 = expr__68156;
return (pred__68155.cljs$core$IFn$_invoke$arity$2 ? pred__68155.cljs$core$IFn$_invoke$arity$2(G__68160,G__68161) : pred__68155.call(null,G__68160,G__68161));
})())){
...
var extmap__4478__auto__ = (function (){var G__68162 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68140,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68140)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68162);
} else {
return G__68162;
}
})();
...
var runtime = (function (){var G__68163 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68163);
...
var map__68164 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68164__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
