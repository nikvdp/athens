...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68371,action,ex){
var map__68372 = p__68371;
var map__68372__$1 = (((((!((map__68372 == null))))?(((((map__68372.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68372.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68372):map__68372);
var state = map__68372__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68372__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68374 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68374) : callback.call(null,G__68374));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68375,p__68376){
var map__68377 = p__68375;
...
var action = map__68378__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68378__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68381 = type;
var G__68381__$1 = (((G__68381 instanceof cljs.core.Keyword))?G__68381.fqn:null);
switch (G__68381__$1) {
case "repl/invoke":
var map__68382 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68382__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68385 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68385) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68385));
}catch (e68384){var ex = e68384;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68381__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68386){
...
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68387__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68389 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68389.cljs$core$IFn$_invoke$arity$1 ? fexpr__68389.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68389.call(null,state));
} else {
var map__68390 = cljs.core.first(actions);
var map__68390__$1 = (((((!((map__68390 == null))))?(((((map__68390.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68390.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68390):map__68390);
var action = map__68390__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68390__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__68397 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68398 = (function (res){
var req = this;
var map__68402 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__68402__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68402__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__68404 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68404) : callback.call(null,G__68404));
} else {
...
var G__68399 = "POST";
var G__68400 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68401 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68397,G__68398,G__68399,G__68400,G__68401);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68393,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__68405 = k68393;
var G__68405__$1 = (((G__68405 instanceof cljs.core.Keyword))?G__68405.fqn:null);
switch (G__68405__$1) {
case "ws":
return self__.ws;
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68392){
var self__ = this;
var G__68392__$1 = this;
return (new cljs.core.RecordIter((0),G__68392__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__68410 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68410(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68394,other68395){
var self__ = this;
var this68394__$1 = this;
return (((!((other68395 == null)))) && ((this68394__$1.constructor === other68395.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68394__$1.ws,other68395.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68394__$1.state_ref,other68395.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68394__$1.__extmap,other68395.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68392){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68411 = cljs.core.keyword_identical_QMARK_;
var expr__68412 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68414 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68415 = expr__68412;
return (pred__68411.cljs$core$IFn$_invoke$arity$2 ? pred__68411.cljs$core$IFn$_invoke$arity$2(G__68414,G__68415) : pred__68411.call(null,G__68414,G__68415));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68392,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68416 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68417 = expr__68412;
return (pred__68411.cljs$core$IFn$_invoke$arity$2 ? pred__68411.cljs$core$IFn$_invoke$arity$2(G__68416,G__68417) : pred__68411.call(null,G__68416,G__68417));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68392,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68392),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68392){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68392,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68396){
var extmap__4478__auto__ = (function (){var G__68418 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68396,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68396)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68418);
} else {
return G__68418;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68396),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68396),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68419 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68419);
...
var map__68420 = temp__5737__auto__;
var map__68420__$1 = (((((!((map__68420 == null))))?(((((map__68420.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68420.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68420):map__68420);
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68420__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
