...
var iter__4582__auto__ = (function day8$re_frame_10x$view$parts$render_registered_$_iter__33127(s__33128){
return (new cljs.core.LazySeq(null,(function (){
var s__33128__$1 = s__33128;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__33128__$1);
if(temp__5735__auto__){
var s__33128__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__33128__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__33128__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__33130 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__33129 = (0);
while(true){
if((i__33129 < size__4581__auto__)){
var vec__33140 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__33129);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33130),day8$re_frame_10x$view$parts$render_registered_$_iter__33127(cljs.core.chunk_rest(s__33128__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33130),null);
}
} else {
var vec__33149 = cljs.core.first(s__33128__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)),day8$re_frame_10x$view$parts$render_registered_$_iter__33127(cljs.core.rest(s__33128__$2)));
}
} else {
return null;
}
...
var iter__4582__auto__ = (function day8$re_frame_10x$view$parts$render_subs_$_iter__33154(s__33155){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33157),day8$re_frame_10x$view$parts$render_subs_$_iter__33154(cljs.core.chunk_rest(s__33155__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33157),null);
}
} else {
var vec__33171 = cljs.core.first(s__33155__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)),day8$re_frame_10x$view$parts$render_subs_$_iter__33154(cljs.core.rest(s__33155__$2)));
}
} else {
return null;
}
