...
var G__40585_40653 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40585_40653) : style_created_handler.call(null,G__40585_40653));

var seq__40587 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__40588 = null;
var count__40589 = (0);
var i__40590 = (0);
while(true){
if((i__40590 < count__40589)){
var sub_style = chunk__40588.cljs$core$IIndexed$_nth$arity$2(null,i__40590);
var G__40597_40654 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40598_40655 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40597_40654,G__40598_40655) : stylefy.impl.styles.create_style_BANG_.call(null,G__40597_40654,G__40598_40655));


var G__40656 = seq__40587;
var G__40657 = chunk__40588;
var G__40658 = count__40589;
var G__40659 = (i__40590 + (1));
seq__40587 = G__40656;
chunk__40588 = G__40657;
count__40589 = G__40658;
i__40590 = G__40659;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__40587);
if(temp__5735__auto__){
var seq__40587__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40587__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__40587__$1);
var G__40660 = cljs.core.chunk_rest(seq__40587__$1);
var G__40661 = c__4609__auto__;
var G__40662 = cljs.core.count(c__4609__auto__);
var G__40663 = (0);
seq__40587 = G__40660;
chunk__40588 = G__40661;
count__40589 = G__40662;
i__40590 = G__40663;
continue;
} else {
var sub_style = cljs.core.first(seq__40587__$1);
var G__40601_40664 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40602_40665 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40601_40664,G__40602_40665) : stylefy.impl.styles.create_style_BANG_.call(null,G__40601_40664,G__40602_40665));


var G__40666 = cljs.core.next(seq__40587__$1);
var G__40667 = null;
var G__40668 = (0);
var G__40669 = (0);
seq__40587 = G__40666;
chunk__40588 = G__40667;
count__40589 = G__40668;
i__40590 = G__40669;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40608_SHARP_){
return ((typeof p1__40608_SHARP_ === 'string') || ((p1__40608_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40608_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40608#] (or (string? p1__40608#) (keyword? p1__40608#) (nil? p1__40608#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___40678 = arguments.length;
var i__4790__auto___40679 = (0);
while(true){
if((i__4790__auto___40679 < len__4789__auto___40678)){
args__4795__auto__.push((arguments[i__4790__auto___40679]));

var G__40680 = (i__4790__auto___40679 + (1));
i__4790__auto___40679 = G__40680;
continue;
} else {
}
break;
...
var styles_40688__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40647_40689 = cljs.core.seq(styles_40688__$1);
var chunk__40648_40690 = null;
var count__40649_40691 = (0);
var i__40650_40692 = (0);
while(true){
if((i__40650_40692 < count__40649_40691)){
var style_40693 = chunk__40648_40690.cljs$core$IIndexed$_nth$arity$2(null,i__40650_40692);
stylefy.impl.styles.use_style_BANG_(style_40693,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40695 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40693));
if(cljs.core.truth_(temp__5735__auto___40695)){
var sub_styles_40696 = temp__5735__auto___40695;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40696,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40698 = seq__40647_40689;
var G__40699 = chunk__40648_40690;
var G__40700 = count__40649_40691;
var G__40701 = (i__40650_40692 + (1));
seq__40647_40689 = G__40698;
chunk__40648_40690 = G__40699;
count__40649_40691 = G__40700;
i__40650_40692 = G__40701;
continue;
} else {
var temp__5735__auto___40703 = cljs.core.seq(seq__40647_40689);
if(temp__5735__auto___40703){
var seq__40647_40704__$1 = temp__5735__auto___40703;
if(cljs.core.chunked_seq_QMARK_(seq__40647_40704__$1)){
var c__4609__auto___40705 = cljs.core.chunk_first(seq__40647_40704__$1);
var G__40706 = cljs.core.chunk_rest(seq__40647_40704__$1);
var G__40707 = c__4609__auto___40705;
var G__40708 = cljs.core.count(c__4609__auto___40705);
var G__40709 = (0);
seq__40647_40689 = G__40706;
chunk__40648_40690 = G__40707;
count__40649_40691 = G__40708;
i__40650_40692 = G__40709;
continue;
} else {
var style_40710 = cljs.core.first(seq__40647_40704__$1);
stylefy.impl.styles.use_style_BANG_(style_40710,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40711__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40710));
if(cljs.core.truth_(temp__5735__auto___40711__$1)){
var sub_styles_40713 = temp__5735__auto___40711__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40713,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40715 = cljs.core.next(seq__40647_40704__$1);
var G__40716 = null;
var G__40717 = (0);
var G__40718 = (0);
seq__40647_40689 = G__40715;
chunk__40648_40690 = G__40716;
count__40649_40691 = G__40717;
i__40650_40692 = G__40718;
continue;
}
} else {
}
