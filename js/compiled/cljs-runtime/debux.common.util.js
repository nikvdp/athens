...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53701_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53701_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53700_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53700_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53702_SHARP_){
return (((p1__53702_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53702_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53705,mapping){
var map__53706 = p__53705;
var map__53706__$1 = (((((!((map__53706 == null))))?(((((map__53706.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53706.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53706):map__53706);
var state = map__53706__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53706__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53706__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53706__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53703_SHARP_){
if((p1__53703_SHARP_ instanceof cljs.core.Symbol)){
...
var G__53749 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53750 = clojure.zip.next(loc);
loc = G__53750;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53713){
var vec__53714 = p__53713;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53714,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53711){
var G__53712 = cljs.core.first(seq53711);
var seq53711__$1 = cljs.core.next(seq53711);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53712,seq53711__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53719_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53719_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53723_53756 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53724_53757 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53725_53758 = true;
var _STAR_print_fn_STAR__temp_val__53726_53759 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53725_53758);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53726_53759);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53724_53757);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53723_53756);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53722_SHARP_){
return debux.common.util.prepend_bars(p1__53722_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__53729 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53729.cljs$core$IFn$_invoke$arity$1 ? fexpr__53729.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53729.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__53730 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53730.cljs$core$IFn$_invoke$arity$1 ? fexpr__53730.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53730.call(null,f));
})())){
var G__53773 = cljs.core.nnext(opts__$1);
var G__53774 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53773;
acc = G__53774;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__53775 = cljs.core.next(opts__$1);
var G__53776 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53775;
acc = G__53776;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__53731){
var vec__53732 = p__53731;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53732,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53732,(1),null);
...
var G__53739 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__53738 = (function (){var fexpr__53740 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__53740.cljs$core$IFn$_invoke$arity$1 ? fexpr__53740.cljs$core$IFn$_invoke$arity$1(form) : fexpr__53740.call(null,form));
})();
return (fexpr__53738.cljs$core$IFn$_invoke$arity$1 ? fexpr__53738.cljs$core$IFn$_invoke$arity$1(G__53739) : fexpr__53738.call(null,G__53739));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53742 = quoted_form;
var G__53743 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53742,G__53743) : debux.common.util.remove_d.call(null,G__53742,G__53743));
...
return (function() { 
var G__53777__delegate = function (arg){
...
var G__53777 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__53778__i = 0, G__53778__a = new Array(arguments.length -  0);
while (G__53778__i < G__53778__a.length) {G__53778__a[G__53778__i] = arguments[G__53778__i + 0]; ++G__53778__i;}
  arg = new cljs.core.IndexedSeq(G__53778__a,0,null);
} 
return G__53777__delegate.call(this,arg);};
G__53777.cljs$lang$maxFixedArity = 0;
G__53777.cljs$lang$applyTo = (function (arglist__53779){
var arg = cljs.core.seq(arglist__53779);
return G__53777__delegate(arg);
});
...
var G__53780 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53780;
continue;
} else {
...
var G__53781 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53781;
continue;
} else {
var G__53782 = clojure.zip.next(loc);
loc = G__53782;
continue;
