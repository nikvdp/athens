...
return [(function (){var pred__32567 = cljs.core.instance_QMARK_;
var expr__32568 = reactive_val;
if(cljs.core.truth_((pred__32567.cljs$core$IFn$_invoke$arity$2 ? pred__32567.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__32568) : pred__32567.call(null,reagent.ratom.RAtom,expr__32568)))){
return "ra";
} else {
if(cljs.core.truth_((pred__32567.cljs$core$IFn$_invoke$arity$2 ? pred__32567.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__32568) : pred__32567.call(null,reagent.ratom.RCursor,expr__32568)))){
return "rc";
} else {
if(cljs.core.truth_((pred__32567.cljs$core$IFn$_invoke$arity$2 ? pred__32567.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__32568) : pred__32567.call(null,reagent.ratom.Reaction,expr__32568)))){
return "rx";
} else {
if(cljs.core.truth_((pred__32567.cljs$core$IFn$_invoke$arity$2 ? pred__32567.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__32568) : pred__32567.call(null,reagent.ratom.Track,expr__32568)))){
return "tr";
} else {
return "other";
}
