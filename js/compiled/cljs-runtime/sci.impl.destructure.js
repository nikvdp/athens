...
var G__66087 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__66088 = n;
var G__66089 = cljs.core.nnext(bs);
var G__66090 = true;
ret = G__66087;
n = G__66088;
bs = G__66089;
seen_rest_QMARK_ = G__66090;
continue;
} else {
...
});})(G__66083,gmap,defaults,pvec,bents))
;
return fexpr__66082(G__66083);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66072_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66072_SHARP_);
}
})(),cljs.core.name(p1__66072_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66073_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66073_SHARP_);
}
})(),cljs.core.name(p1__66073_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__66074_SHARP_,p2__66075_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66074_SHARP_,p2__66075_SHARP_,(function (){var fexpr__66084 = cljs.core.val(entry);
return (fexpr__66084.cljs$core$IFn$_invoke$arity$1 ? fexpr__66084.cljs$core$IFn$_invoke$arity$1(p2__66075_SHARP_) : fexpr__66084.call(null,p2__66075_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__66085 = cljs.core.key(entry);
return (fexpr__66085.cljs$core$IFn$_invoke$arity$1 ? fexpr__66085.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__66085.call(null,bes));
})());
...
var G__66095 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__66096 = cljs.core.next(bes);
ret = G__66095;
bes = G__66096;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66076_SHARP_){
return (cljs.core.first(p1__66076_SHARP_) instanceof cljs.core.Keyword);
}),bents));
