...
var G__66062 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__66063 = n;
var G__66064 = cljs.core.nnext(bs);
var G__66065 = true;
ret = G__66062;
n = G__66063;
bs = G__66064;
seen_rest_QMARK_ = G__66065;
continue;
} else {
...
});})(G__66058,gmap,defaults,pvec,bents))
;
return fexpr__66057(G__66058);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66047_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66047_SHARP_);
}
})(),cljs.core.name(p1__66047_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66048_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66048_SHARP_);
}
})(),cljs.core.name(p1__66048_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__66049_SHARP_,p2__66050_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66049_SHARP_,p2__66050_SHARP_,(function (){var fexpr__66059 = cljs.core.val(entry);
return (fexpr__66059.cljs$core$IFn$_invoke$arity$1 ? fexpr__66059.cljs$core$IFn$_invoke$arity$1(p2__66050_SHARP_) : fexpr__66059.call(null,p2__66050_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__66060 = cljs.core.key(entry);
return (fexpr__66060.cljs$core$IFn$_invoke$arity$1 ? fexpr__66060.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__66060.call(null,bes));
})());
...
var G__66070 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__66071 = cljs.core.next(bes);
ret = G__66070;
bes = G__66071;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66051_SHARP_){
return (cljs.core.first(p1__66051_SHARP_) instanceof cljs.core.Keyword);
}),bents));
