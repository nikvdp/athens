...
var G__65865 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65866 = n;
var G__65867 = cljs.core.nnext(bs);
var G__65868 = true;
ret = G__65865;
n = G__65866;
bs = G__65867;
seen_rest_QMARK_ = G__65868;
continue;
} else {
...
});})(G__65861,gmap,defaults,pvec,bents))
;
return fexpr__65860(G__65861);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65850_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65850_SHARP_);
}
})(),cljs.core.name(p1__65850_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65851_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65851_SHARP_);
}
})(),cljs.core.name(p1__65851_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65852_SHARP_,p2__65853_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65852_SHARP_,p2__65853_SHARP_,(function (){var fexpr__65862 = cljs.core.val(entry);
return (fexpr__65862.cljs$core$IFn$_invoke$arity$1 ? fexpr__65862.cljs$core$IFn$_invoke$arity$1(p2__65853_SHARP_) : fexpr__65862.call(null,p2__65853_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65863 = cljs.core.key(entry);
return (fexpr__65863.cljs$core$IFn$_invoke$arity$1 ? fexpr__65863.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65863.call(null,bes));
})());
...
var G__65873 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65874 = cljs.core.next(bes);
ret = G__65873;
bes = G__65874;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65854_SHARP_){
return (cljs.core.first(p1__65854_SHARP_) instanceof cljs.core.Keyword);
}),bents));
