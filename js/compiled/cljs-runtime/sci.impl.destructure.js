...
var G__66078 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__66079 = n;
var G__66080 = cljs.core.nnext(bs);
var G__66081 = true;
ret = G__66078;
n = G__66079;
bs = G__66080;
seen_rest_QMARK_ = G__66081;
continue;
} else {
...
});})(G__66074,gmap,defaults,pvec,bents))
;
return fexpr__66073(G__66074);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66063_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66063_SHARP_);
}
})(),cljs.core.name(p1__66063_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__66064_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__66064_SHARP_);
}
})(),cljs.core.name(p1__66064_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__66065_SHARP_,p2__66066_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66065_SHARP_,p2__66066_SHARP_,(function (){var fexpr__66075 = cljs.core.val(entry);
return (fexpr__66075.cljs$core$IFn$_invoke$arity$1 ? fexpr__66075.cljs$core$IFn$_invoke$arity$1(p2__66066_SHARP_) : fexpr__66075.call(null,p2__66066_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__66076 = cljs.core.key(entry);
return (fexpr__66076.cljs$core$IFn$_invoke$arity$1 ? fexpr__66076.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__66076.call(null,bes));
})());
...
var G__66086 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__66087 = cljs.core.next(bes);
ret = G__66086;
bes = G__66087;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66067_SHARP_){
return (cljs.core.first(p1__66067_SHARP_) instanceof cljs.core.Keyword);
}),bents));
