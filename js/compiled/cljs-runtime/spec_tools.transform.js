...
if((x instanceof cljs.core.Keyword)){
var G__55089 = spec;
var G__55090 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55089,G__55090) : f.call(null,G__55089,G__55090));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__55091 = spec;
var G__55092 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55091,G__55092) : f.call(null,G__55091,G__55092));
} else {
return x;
...
}catch (e55094){if((e55094 instanceof Error)){
var ___$1 = e55094;
return x;
} else {
throw e55094;
...
}catch (e55095){if((e55095 instanceof Error)){
var ___$1 = e55095;
return x;
} else {
throw e55095;
...
}catch (e55096){if((e55096 instanceof Error)){
var ___$1 = e55096;
return x;
} else {
throw e55096;
...
}catch (e55097){if((e55097 instanceof Error)){
var ___$1 = e55097;
return x;
} else {
throw e55097;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__55098,x){
var map__55099 = p__55098;
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55099__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__55101,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55102__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__55104,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55105__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
