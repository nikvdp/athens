...
var prefix = (function (){var G__31952 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__31952,"\u2026/"].join('');
} else {
return G__31952;
}
})();
...
var or__4185__auto__ = (function (){var G__31970 = form.name;
if((G__31970 == null)){
return null;
} else {
return clojure.string.replace(G__31970,/(^.*\$)(.*)/,"$2");
}
})();
