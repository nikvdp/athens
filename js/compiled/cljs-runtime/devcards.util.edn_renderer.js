...
}catch (e50589){if((e50589 instanceof Error)){
var e = e50589;
return devcards.util.edn_renderer.clearfix_separator_STAR_;
} else {
throw e50589;
...
devcards.util.edn_renderer.html_keyval = (function devcards$util$edn_renderer$html_keyval(p__50591){
var vec__50593 = p__50591;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50593,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50593,(1),null);
...
var _STAR_key_counter_STAR__orig_val__50600 = devcards.util.edn_renderer._STAR_key_counter_STAR_;
var _STAR_key_counter_STAR__temp_val__50601 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1((0));
(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__temp_val__50601);
...
}finally {(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__orig_val__50600);
}});
