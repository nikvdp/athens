...
var G__20932 = cljs.core.PersistentArrayMap.EMPTY;
var G__20933 = native_stack_trace;
var G__20934 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20935 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20932,G__20933,G__20934,G__20935) : cljs.stacktrace.parse_stacktrace.call(null,G__20932,G__20933,G__20934,G__20935));
});
...
var temp__5733__auto___20971 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20971)){
var seen_errors_20972 = temp__5733__auto___20971;
if(cljs.core.truth_(seen_errors_20972.has(self))){
} else {
seen_errors_20972.add(self);

var temp__5735__auto___20973 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20973)){
var sense_20975 = temp__5735__auto___20973;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20975)].join(''));
} else {
}
}
} else {
