...
var G__20749 = cljs.core.PersistentArrayMap.EMPTY;
var G__20750 = native_stack_trace;
var G__20751 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20752 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20749,G__20750,G__20751,G__20752) : cljs.stacktrace.parse_stacktrace.call(null,G__20749,G__20750,G__20751,G__20752));
});
...
}catch (e20756){var _e = e20756;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20776 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20776)){
var seen_errors_20779 = temp__5733__auto___20776;
if(cljs.core.truth_(seen_errors_20779.has(self))){
} else {
seen_errors_20779.add(self);

var temp__5735__auto___20780 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20780)){
var sense_20781 = temp__5735__auto___20780;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20781)].join(''));
} else {
}
}
} else {
