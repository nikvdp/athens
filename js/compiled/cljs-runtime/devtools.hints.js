...
var temp__5733__auto___20856 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20856)){
var seen_errors_20857 = temp__5733__auto___20856;
if(cljs.core.truth_(seen_errors_20857.has(self))){
} else {
seen_errors_20857.add(self);

var temp__5735__auto___20859 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20859)){
var sense_20860 = temp__5735__auto___20859;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20860)].join(''));
} else {
}
}
} else {
