...
}catch (e24160){var _e__20859__auto__ = e24160;
return false;
...
var _STAR_current_state_STAR__orig_val__24175 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__24176 = (function (){var or__4185__auto__ = config;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__24176);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__24175);
}});
});
