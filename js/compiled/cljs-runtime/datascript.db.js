...
var G__42305 = db;
var G__42306 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__42305;
eid = G__42306;
continue;
} else {
...
var G__42347 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
var G__42348 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__42347;
es = G__42348;
continue;
} else {
...
var G__42349 = report;
var G__42350 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__42349;
es = G__42350;
continue;
} else {
...
,datoms))){
var G__42364 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__42365 = entities;
report = G__42364;
es = G__42365;
continue;
} else {
...
var G__42371 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__42372 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__42371;
es = G__42372;
continue;
} else {
...
if((temp__5737__auto__ == null)){
var G__42374 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.next_eid(db));
var G__42375 = es;
report = G__42374;
es = G__42375;
continue;
...
var G__42376 = report;
var G__42377 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,vid], null),entities);
report = G__42376;
es = G__42377;
continue;
}
