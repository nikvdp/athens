...
var c__41339__auto__ = (d1.e - d2.e);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41339__auto____$2)){
var c__41339__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41339__auto____$3)){
return (0);
} else {
return c__41339__auto____$3;
}
} else {
return c__41339__auto____$2;
}
} else {
return c__41339__auto____$1;
}
} else {
return c__41339__auto__;
}
});
datascript.db.cmp_datoms_aevt = (function datascript$db$cmp_datoms_aevt(d1,d2){
var c__41339__auto__ = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = (d1.e - d2.e);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41339__auto____$2)){
var c__41339__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
...
var c__41339__auto__ = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = (d1.e - d2.e);
if(((0) === c__41339__auto____$2)){
var c__41339__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41339__auto____$3)){
return (0);
...
var c__41339__auto__ = (d1.e - d2.e);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = cljs.core.compare(d1.v,d2.v);
if(((0) === c__41339__auto____$2)){
var c__41339__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41339__auto____$3)){
return (0);
...
var c__41339__auto__ = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = (d1.e - d2.e);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = cljs.core.compare(d1.v,d2.v);
...
var c__41339__auto__ = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41339__auto__)){
var c__41339__auto____$1 = cljs.core.compare(d1.v,d2.v);
if(((0) === c__41339__auto____$1)){
var c__41339__auto____$2 = (d1.e - d2.e);
if(((0) === c__41339__auto____$2)){
var c__41339__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
...
var G__41936_42203 = attr;
var G__41937_42204 = (new cljs.core.List(null,new cljs.core.Symbol(null,"-index-range","-index-range",898114142,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,attr,(new cljs.core.List(null,start,(new cljs.core.List(null,end,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__41936_42203,G__41937_42204) : datascript.db.validate_attr.call(null,G__41936_42203,G__41937_42204));
...
var G__42258 = seq__41975;
var G__42259 = chunk__41976;
var G__42260 = count__41977;
var G__42261 = (i__41978 + (1));
seq__41975 = G__42258;
chunk__41976 = G__42259;
count__41977 = G__42260;
i__41978 = G__42261;
continue;
} else {
...
var G__42263 = cljs.core.chunk_rest(seq__41975__$1);
var G__42264 = c__4609__auto__;
var G__42265 = cljs.core.count(c__4609__auto__);
var G__42266 = (0);
seq__41975 = G__42263;
chunk__41976 = G__42264;
count__41977 = G__42265;
i__41978 = G__42266;
continue;
} else {
...
var comp_QMARK__42267 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
datascript.db.validate_schema_key(a,new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null));

if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__42267;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079));
} else {
return and__4174__auto__;
...
if(cljs.core.truth_(a)){
var G__42003_42296 = a;
var G__42004_42297 = (new cljs.core.List(null,new cljs.core.Symbol(null,"resolve-datom","resolve-datom",-294110827,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,e,(new cljs.core.List(null,a,(new cljs.core.List(null,v,(new cljs.core.List(null,t,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null)),(6),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__42003_42296,G__42004_42297) : datascript.db.validate_attr.call(null,G__42003_42296,G__42004_42297));
} else {
}
