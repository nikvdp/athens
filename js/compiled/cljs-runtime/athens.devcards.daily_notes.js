...
var daily_notes = cljs.core.deref((function (){var G__65932 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"daily-notes","daily-notes",302751021)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__65932) : re_frame.core.subscribe.call(null,G__65932));
})());
...
if((delta < (1))){
var G__65933 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"next-daily-note","next-daily-note",557965411),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$1(cljs.core.count(daily_notes))], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__65933) : re_frame.core.dispatch.call(null,G__65933));
} else {
return null;
}
});
...
var note_refs = (function (){var G__65934 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"daily-notes","daily-notes",302751021)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__65934) : re_frame.core.subscribe.call(null,G__65934));
})();
if(cljs.core.empty_QMARK_(cljs.core.deref(note_refs))){
var G__65935_65949 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"next-daily-note","next-daily-note",557965411),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$0()], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__65935_65949) : re_frame.core.dispatch.call(null,G__65935_65949));
} else {
}

return (function (){
var notes = (function (){var G__65936 = athens.db.dsdb;
var G__65937 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65938 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
...
return (posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3(G__65936,G__65937,G__65938) : posh.reagent.pull_many.call(null,G__65936,G__65937,G__65938));
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#daily-notes","div#daily-notes",-1983155722),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_scroll_area_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$daily_notes$daily_notes_panel_$_iter__65939(s__65940){
return (new cljs.core.LazySeq(null,(function (){
var s__65940__$1 = s__65940;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65940__$1);
if(temp__5735__auto__){
var s__65940__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65940__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__65940__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65942 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65941 = (0);
while(true){
if((i__65941 < size__4581__auto__)){
var map__65943 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65941);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65942),athens$devcards$daily_notes$daily_notes_panel_$_iter__65939(cljs.core.chunk_rest(s__65940__$2)));
} else {
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65945__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$daily_notes$daily_notes_panel_$_iter__65939(cljs.core.rest(s__65940__$2)));
}
} else {
return null;
}
