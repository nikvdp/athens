...
var vec__65161 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65161,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65161,(1),null);
...
var vec__65164 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65164,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65164,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__65167 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65167,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65167,(1),null);
...
var G__65228 = cljs.core.next(parses__$1);
parses__$1 = G__65228;
continue;
}
...
var G__65175 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65176 = G__65175;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(2),null);
var selection = vec__65176;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65175__$1 = G__65175;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65182 = G__65175__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65182,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65182,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65182,(2),null);
var selection__$1 = vec__65182;
...
var G__65190 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65191 = G__65190;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(2),null);
var selection = vec__65191;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65190__$1 = G__65190;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65197 = G__65190__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65197,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65197,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65197,(2),null);
var selection__$1 = vec__65197;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__65205 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65206 = G__65205;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65206,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65206,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65206,(2),null);
var selection = vec__65206;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65205__$1 = G__65205;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65212 = G__65205__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65212,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65212,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65212,(2),null);
var selection__$1 = vec__65212;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65238 = cljs.core.long$(end__$1);
var G__65239 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65240 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65238;
parses__$1 = G__65239;
G__65205__$1 = G__65240;
continue;
...
return (fexpr__65217.cljs$core$IFn$_invoke$arity$1 ? fexpr__65217.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__65217.call(null,output_format));
})())){
} else {
...
var G__65218 = output_format;
var G__65218__$1 = (((G__65218 instanceof cljs.core.Keyword))?G__65218.fqn:null);
switch (G__65218__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__65226 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__65225 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__65225.cljs$core$IFn$_invoke$arity$1 ? fexpr__65225.cljs$core$IFn$_invoke$arity$1(G__65226) : fexpr__65225.call(null,G__65226));
})();
