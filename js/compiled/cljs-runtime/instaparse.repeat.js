...
var vec__65106 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65106,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65106,(1),null);
...
var vec__65109 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65109,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65109,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__65112 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65112,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65112,(1),null);
...
var G__65173 = cljs.core.next(parses__$1);
parses__$1 = G__65173;
continue;
}
...
var G__65120 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65121 = G__65120;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65121,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65121,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65121,(2),null);
var selection = vec__65121;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65120__$1 = G__65120;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65127 = G__65120__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65127,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65127,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65127,(2),null);
var selection__$1 = vec__65127;
...
var G__65175 = cljs.core.long$(end__$1);
var G__65176 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65177 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65175;
parses__$1 = G__65176;
G__65120__$1 = G__65177;
continue;
...
var G__65135 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65136 = G__65135;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65136,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65136,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65136,(2),null);
var selection = vec__65136;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65135__$1 = G__65135;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65142 = G__65135__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65142,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65142,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65142,(2),null);
var selection__$1 = vec__65142;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65179 = cljs.core.long$(end__$1);
var G__65180 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65181 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65179;
parses__$1 = G__65180;
G__65135__$1 = G__65181;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__65150 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65151 = G__65150;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65151,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65151,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65151,(2),null);
var selection = vec__65151;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65150__$1 = G__65150;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65157 = G__65150__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65157,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65157,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65157,(2),null);
var selection__$1 = vec__65157;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65183 = cljs.core.long$(end__$1);
var G__65184 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65185 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65183;
parses__$1 = G__65184;
G__65150__$1 = G__65185;
continue;
...
if(cljs.core.truth_((function (){var fexpr__65162 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65162.cljs$core$IFn$_invoke$arity$1 ? fexpr__65162.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__65162.call(null,output_format));
})())){
} else {
...
var G__65163 = output_format;
var G__65163__$1 = (((G__65163 instanceof cljs.core.Keyword))?G__65163.fqn:null);
switch (G__65163__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__65171 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__65170 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__65170.cljs$core$IFn$_invoke$arity$1 ? fexpr__65170.cljs$core$IFn$_invoke$arity$1(G__65171) : fexpr__65170.call(null,G__65171));
})();
