...
var map__25520 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25520__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25521 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25521__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__25527 = (m1 + m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__25527) : u.call(null,G__25527));
});
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25661);
}
...
var map__25537 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25537__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25538 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25538__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__25541 = (m1 - m2);
...
var G__25676__delegate = function (x,y,more){
...
var G__25676 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__25679__i < G__25679__a.length) {G__25679__a[G__25679__i] = arguments[G__25679__i + 2]; ++G__25679__i;}
  more = new cljs.core.IndexedSeq(G__25679__a,0,null);
} 
return G__25676__delegate.call(this,x,y,more);};
G__25676.cljs$lang$maxFixedArity = 2;
G__25676.cljs$lang$applyTo = (function (arglist__25680){
...
return G__25676__delegate(x,y,more);
});
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25681);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
G__25688.cljs$lang$applyTo = (function (arglist__25691){
...
G__25693 = new cljs.core.IndexedSeq(G__25694__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25693);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__25703__delegate = function (x,y,more){
...
var G__25703 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__25704__i < G__25704__a.length) {G__25704__a[G__25704__i] = arguments[G__25704__i + 2]; ++G__25704__i;}
  more = new cljs.core.IndexedSeq(G__25704__a,0,null);
} 
return G__25703__delegate.call(this,x,y,more);};
G__25703.cljs$lang$maxFixedArity = 2;
G__25703.cljs$lang$applyTo = (function (arglist__25705){
var x = cljs.core.first(arglist__25705);
arglist__25705 = cljs.core.next(arglist__25705);
var y = cljs.core.first(arglist__25705);
var more = cljs.core.rest(arglist__25705);
return G__25703__delegate(x,y,more);
});
...
G__25707 = new cljs.core.IndexedSeq(G__25708__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25707);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
