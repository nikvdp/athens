...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__66435,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__66436 = p__66435;
var map__66436__$1 = (((((!((map__66436 == null))))?(((((map__66436.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66436.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66436):map__66436);
var _m = map__66436__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66436__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66436__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66436__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66436__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__66461 = cljs.core.next(args__$1);
var G__66462 = cljs.core.next(params__$1);
var G__66463 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__66461;
params__$1 = G__66462;
ret = G__66463;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__66438 = ctx__$1;
var G__66439 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__66438,G__66439) : interpret.call(null,G__66438,G__66439));
...
var vec__66440 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66440,(0),null);
var vec__66443 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66440,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66443,(0),null);
var G__66468 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__66468;
continue;
} else {
var G__66469 = recur_val;
args = G__66469;
continue;
}
} else {
...
while (G__66474__i < G__66474__a.length) {G__66474__a[G__66474__i] = arguments[G__66474__i + 0]; ++G__66474__i;}
  args = new cljs.core.IndexedSeq(G__66474__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__66475){
...
var map__66449 = cljs.core.meta(f);
var map__66449__$1 = (((((!((map__66449 == null))))?(((((map__66449.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66449.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66449):map__66449);
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66449__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66449__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__66453){
var map__66454 = p__66453;
...
var f = map__66454__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66454__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66454__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__66476__delegate = function (args){
...
while (G__66477__i < G__66477__a.length) {G__66477__a[G__66477__i] = arguments[G__66477__i + 0]; ++G__66477__i;}
  args = new cljs.core.IndexedSeq(G__66477__a,0,null);
} 
return G__66476__delegate.call(this,args);};
G__66476.cljs$lang$maxFixedArity = 0;
G__66476.cljs$lang$applyTo = (function (arglist__66478){
var args = cljs.core.seq(arglist__66478);
return G__66476__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66451_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__66451_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__66479__delegate = function (args){
...
var G__66479 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__66480__i = 0, G__66480__a = new Array(arguments.length -  0);
while (G__66480__i < G__66480__a.length) {G__66480__a[G__66480__i] = arguments[G__66480__i + 0]; ++G__66480__i;}
  args = new cljs.core.IndexedSeq(G__66480__a,0,null);
} 
return G__66479__delegate.call(this,args);};
G__66479.cljs$lang$maxFixedArity = 0;
G__66479.cljs$lang$applyTo = (function (arglist__66481){
var args = cljs.core.seq(arglist__66481);
return G__66479__delegate(args);
});
G__66479.cljs$core$IFn$_invoke$arity$variadic = G__66479__delegate;
return G__66479;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__66452_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66452_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
