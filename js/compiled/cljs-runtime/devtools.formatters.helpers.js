...
var G__23788 = devtools.prefs.pref(v);
v = G__23788;
continue;
} else {
return v;
...
}catch (e23775){var _e__20566__auto__ = e23775;
return false;
}})();
...
}catch (e23779){var _e__20566__auto__ = e23779;
return false;
}})();
...
}catch (e23781){var _e__20566__auto__ = e23781;
return false;
}}
}
});
...
var vec__23783 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23783,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23783,(1),null);
...
return cljs.core.some((function (p1__23786_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23786_SHARP_);
}),template);
});
