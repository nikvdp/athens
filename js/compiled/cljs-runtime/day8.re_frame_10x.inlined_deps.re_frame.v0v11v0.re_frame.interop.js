...
return [(function (){var pred__27368 = cljs.core.instance_QMARK_;
var expr__27369 = reactive_val;
if(cljs.core.truth_((pred__27368.cljs$core$IFn$_invoke$arity$2 ? pred__27368.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27369) : pred__27368.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27369)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27368.cljs$core$IFn$_invoke$arity$2 ? pred__27368.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27369) : pred__27368.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27369)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27368.cljs$core$IFn$_invoke$arity$2 ? pred__27368.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27369) : pred__27368.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27369)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27368.cljs$core$IFn$_invoke$arity$2 ? pred__27368.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27369) : pred__27368.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27369)))){
return "tr";
} else {
return "other";
}
