...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58720 = goog.object.get(JSJodaLocale,"Locale");
if((G__58720 == null)){
return null;
} else {
return goog.object.get(G__58720,"US");
}
}catch (e58719){if((e58719 instanceof Error)){
var e = e58719;
return null;
} else {
throw e58719;
