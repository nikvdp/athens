...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58708 = goog.object.get(JSJodaLocale,"Locale");
if((G__58708 == null)){
return null;
} else {
return goog.object.get(G__58708,"US");
}
}catch (e58707){if((e58707 instanceof Error)){
var e = e58707;
return null;
} else {
throw e58707;
