...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58770 = goog.object.get(JSJodaLocale,"Locale");
if((G__58770 == null)){
return null;
} else {
return goog.object.get(G__58770,"US");
}
}catch (e58769){if((e58769 instanceof Error)){
var e = e58769;
return null;
} else {
throw e58769;
