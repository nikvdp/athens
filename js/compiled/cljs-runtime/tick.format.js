...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58684 = goog.object.get(JSJodaLocale,"Locale");
if((G__58684 == null)){
return null;
} else {
return goog.object.get(G__58684,"US");
}
}catch (e58683){if((e58683 instanceof Error)){
var e = e58683;
return null;
} else {
throw e58683;
