...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58705 = goog.object.get(JSJodaLocale,"Locale");
if((G__58705 == null)){
return null;
} else {
return goog.object.get(G__58705,"US");
}
