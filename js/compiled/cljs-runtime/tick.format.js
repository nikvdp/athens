...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58728 = goog.object.get(JSJodaLocale,"Locale");
if((G__58728 == null)){
return null;
} else {
return goog.object.get(G__58728,"US");
}
}catch (e58724){if((e58724 instanceof Error)){
var e = e58724;
return null;
} else {
throw e58724;
