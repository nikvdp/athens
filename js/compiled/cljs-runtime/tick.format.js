...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58761 = goog.object.get(JSJodaLocale,"Locale");
if((G__58761 == null)){
return null;
} else {
return goog.object.get(G__58761,"US");
}
}catch (e58757){if((e58757 instanceof Error)){
var e = e58757;
return null;
} else {
throw e58757;
