...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58671 = goog.object.get(JSJodaLocale,"Locale");
if((G__58671 == null)){
return null;
} else {
return goog.object.get(G__58671,"US");
}
}catch (e58670){if((e58670 instanceof Error)){
var e = e58670;
return null;
} else {
throw e58670;
