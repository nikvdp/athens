...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58711 = goog.object.get(JSJodaLocale,"Locale");
if((G__58711 == null)){
return null;
} else {
return goog.object.get(G__58711,"US");
}
