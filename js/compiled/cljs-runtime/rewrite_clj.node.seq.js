...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k30087,else__4442__auto__){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30086){
var self__ = this;
var G__30086__$1 = this;
return (new cljs.core.RecordIter((0),G__30086__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__30108 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__30108(this__4435__auto____$1);
})();
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30088,other30089){
var self__ = this;
var this30088__$1 = this;
return (((!((other30089 == null)))) && ((this30088__$1.constructor === other30089.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.tag,other30089.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.wrap_fn,other30089.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.wrap_length,other30089.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.seq_fn,other30089.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.children,other30089.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30088__$1.__extmap,other30089.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__30109 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__30109) : self__.seq_fn.call(null,G__30109));
}));
...
var self__ = this;
var this$__$1 = this;
var G__30110 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__30110) : self__.wrap_fn.call(null,G__30110));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__30086){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__30116 = cljs.core.keyword_identical_QMARK_;
var expr__30117 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__30119 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__30120 = expr__30117;
return (pred__30116.cljs$core$IFn$_invoke$arity$2 ? pred__30116.cljs$core$IFn$_invoke$arity$2(G__30119,G__30120) : pred__30116.call(null,G__30119,G__30120));
})())){
return (new rewrite_clj.node.seq.SeqNode(G__30086,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30121 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__30122 = expr__30117;
return (pred__30116.cljs$core$IFn$_invoke$arity$2 ? pred__30116.cljs$core$IFn$_invoke$arity$2(G__30121,G__30122) : pred__30116.call(null,G__30121,G__30122));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__30086,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30123 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__30124 = expr__30117;
return (pred__30116.cljs$core$IFn$_invoke$arity$2 ? pred__30116.cljs$core$IFn$_invoke$arity$2(G__30123,G__30124) : pred__30116.call(null,G__30123,G__30124));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__30086,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30125 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__30126 = expr__30117;
return (pred__30116.cljs$core$IFn$_invoke$arity$2 ? pred__30116.cljs$core$IFn$_invoke$arity$2(G__30125,G__30126) : pred__30116.call(null,G__30125,G__30126));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__30086,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30127 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__30128 = expr__30117;
return (pred__30116.cljs$core$IFn$_invoke$arity$2 ? pred__30116.cljs$core$IFn$_invoke$arity$2(G__30127,G__30128) : pred__30116.call(null,G__30127,G__30128));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__30086,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__30086),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__30086){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__30086,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__30090){
var extmap__4478__auto__ = (function (){var G__30134 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__30090,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__30090),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__30090),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__30090),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__30090),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__30090),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__30136_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__30136_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__30138_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__30138_SHARP_);
}),children);
});
