...
break;
case "\"":
var G__64754 = cljs.core.next(sq);
var G__64755 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64754;
v = G__64755;
continue;
...
break;
default:
var G__64756 = cljs.core.next(sq);
var G__64757 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64756;
v = G__64757;
continue;
...
var G__64711 = null;
var G__64712 = null;
return (read_string_STAR__64758.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__64758.cljs$core$IFn$_invoke$arity$4(G__64709,G__64710,G__64711,G__64712) : read_string_STAR__64758.call(null,G__64709,G__64710,G__64711,G__64712));
});
/**
...
break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64718 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64718) : instaparse.cfg.build_rule.call(null,G__64718));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64719 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64719) : instaparse.cfg.build_rule.call(null,G__64719));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64720 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64720) : instaparse.cfg.build_rule.call(null,G__64720));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64721 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64721) : instaparse.cfg.build_rule.call(null,G__64721));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64722 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
while(true){
var G__64728 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64728__$1)].join('')));
