...
var G__64704 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64704)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64704)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64704)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64704)].join('')));
...
var G__64750 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64751 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64750;
v = G__64751;
continue;
} else {
var G__64752 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64753 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64752;
v = G__64753;
continue;
}
...
break;
case "\"":
var G__64755 = cljs.core.next(sq);
var G__64756 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64755;
v = G__64756;
continue;
...
break;
default:
var G__64757 = cljs.core.next(sq);
var G__64758 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64757;
v = G__64758;
continue;
...
while(true){
var G__64713 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64713__$1 = (((G__64713 instanceof cljs.core.Keyword))?G__64713.fqn:null);
switch (G__64713__$1) {
case "rule":
var vec__64714 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64714,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64714,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64717 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64717) : instaparse.cfg.content.call(null,G__64717));
...
break;
case "paren":
var G__64762 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64762;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64722 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64722) : instaparse.cfg.build_rule.call(null,G__64722));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64723 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64723) : instaparse.cfg.build_rule.call(null,G__64723));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64724 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64724) : instaparse.cfg.build_rule.call(null,G__64724));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64725 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64725) : instaparse.cfg.build_rule.call(null,G__64725));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64726 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64726) : instaparse.cfg.build_rule.call(null,G__64726));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64727 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64727) : instaparse.cfg.build_rule.call(null,G__64727));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64713__$1)].join('')));
...
while(true){
var G__64729 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64764 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64764;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64729__$1)].join('')));
...
var valid_nts_64765 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64730_64766 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64731_64767 = null;
var count__64732_64768 = (0);
var i__64733_64769 = (0);
while(true){
if((i__64733_64769 < count__64732_64768)){
var nt_64770 = chunk__64731_64767.cljs$core$IIndexed$_nth$arity$2(null,i__64733_64769);
if(cljs.core.truth_((valid_nts_64765.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64765.cljs$core$IFn$_invoke$arity$1(nt_64770) : valid_nts_64765.call(null,nt_64770)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64770),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64771 = seq__64730_64766;
var G__64772 = chunk__64731_64767;
var G__64773 = count__64732_64768;
var G__64774 = (i__64733_64769 + (1));
seq__64730_64766 = G__64771;
chunk__64731_64767 = G__64772;
count__64732_64768 = G__64773;
i__64733_64769 = G__64774;
continue;
} else {
var temp__5735__auto___64775 = cljs.core.seq(seq__64730_64766);
if(temp__5735__auto___64775){
var seq__64730_64776__$1 = temp__5735__auto___64775;
if(cljs.core.chunked_seq_QMARK_(seq__64730_64776__$1)){
var c__4609__auto___64777 = cljs.core.chunk_first(seq__64730_64776__$1);
var G__64778 = cljs.core.chunk_rest(seq__64730_64776__$1);
var G__64779 = c__4609__auto___64777;
var G__64780 = cljs.core.count(c__4609__auto___64777);
var G__64781 = (0);
seq__64730_64766 = G__64778;
chunk__64731_64767 = G__64779;
count__64732_64768 = G__64780;
i__64733_64769 = G__64781;
continue;
} else {
var nt_64782 = cljs.core.first(seq__64730_64776__$1);
if(cljs.core.truth_((valid_nts_64765.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64765.cljs$core$IFn$_invoke$arity$1(nt_64782) : valid_nts_64765.call(null,nt_64782)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64782),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64783 = cljs.core.next(seq__64730_64776__$1);
var G__64784 = null;
var G__64785 = (0);
var G__64786 = (0);
seq__64730_64766 = G__64783;
chunk__64731_64767 = G__64784;
count__64732_64768 = G__64785;
i__64733_64769 = G__64786;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64734_64787 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64735_64788 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64736_64789 = true;
var _STAR_print_fn_STAR__temp_val__64737_64790 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64736_64789);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64737_64790);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64735_64788);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64734_64787);
}
...
var len__4789__auto___64791 = arguments.length;
var i__4790__auto___64792 = (0);
while(true){
if((i__4790__auto___64792 < len__4789__auto___64791)){
args__4795__auto__.push((arguments[i__4790__auto___64792]));

var G__64793 = (i__4790__auto___64792 + (1));
i__4790__auto___64792 = G__64793;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64740){
var map__64741 = p__64740;
var map__64741__$1 = (((((!((map__64741 == null))))?(((((map__64741.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64741.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64741):map__64741);
var opts = map__64741__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64743 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64744 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64744);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64745_64794 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64746_64795 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64747_64796 = true;
var _STAR_print_fn_STAR__temp_val__64748_64797 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64747_64796);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64748_64797);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64746_64795);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64745_64794);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64743);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64738){
var G__64739 = cljs.core.first(seq64738);
var seq64738__$1 = cljs.core.next(seq64738);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64739,seq64738__$1);
}));
