...
var G__64744 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64744)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64744)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64744)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64744)].join('')));
...
var G__64792 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64793 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64792;
v = G__64793;
continue;
} else {
var G__64794 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64795 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64794;
v = G__64795;
continue;
}
...
break;
case "\"":
var G__64796 = cljs.core.next(sq);
var G__64797 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64796;
v = G__64797;
continue;
...
break;
default:
var G__64798 = cljs.core.next(sq);
var G__64799 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64798;
v = G__64799;
continue;
...
while(true){
var G__64757 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64757__$1 = (((G__64757 instanceof cljs.core.Keyword))?G__64757.fqn:null);
switch (G__64757__$1) {
case "rule":
var vec__64759 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64759,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64759,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64762 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64762) : instaparse.cfg.content.call(null,G__64762));
...
break;
case "paren":
var G__64802 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64802;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64763 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64764 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__64765 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64766 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64766) : instaparse.cfg.build_rule.call(null,G__64766));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64767 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64767) : instaparse.cfg.build_rule.call(null,G__64767));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64768 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64768) : instaparse.cfg.build_rule.call(null,G__64768));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64757__$1)].join('')));
...
while(true){
var G__64769 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64804 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64804;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64769__$1)].join('')));
...
var valid_nts_64805 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64770_64806 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64771_64807 = null;
var count__64772_64808 = (0);
var i__64773_64809 = (0);
while(true){
if((i__64773_64809 < count__64772_64808)){
var nt_64810 = chunk__64771_64807.cljs$core$IIndexed$_nth$arity$2(null,i__64773_64809);
if(cljs.core.truth_((valid_nts_64805.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64805.cljs$core$IFn$_invoke$arity$1(nt_64810) : valid_nts_64805.call(null,nt_64810)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64810),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64811 = seq__64770_64806;
var G__64812 = chunk__64771_64807;
var G__64813 = count__64772_64808;
var G__64814 = (i__64773_64809 + (1));
seq__64770_64806 = G__64811;
chunk__64771_64807 = G__64812;
count__64772_64808 = G__64813;
i__64773_64809 = G__64814;
continue;
} else {
var temp__5735__auto___64815 = cljs.core.seq(seq__64770_64806);
if(temp__5735__auto___64815){
var seq__64770_64816__$1 = temp__5735__auto___64815;
if(cljs.core.chunked_seq_QMARK_(seq__64770_64816__$1)){
var c__4609__auto___64817 = cljs.core.chunk_first(seq__64770_64816__$1);
var G__64818 = cljs.core.chunk_rest(seq__64770_64816__$1);
var G__64819 = c__4609__auto___64817;
var G__64820 = cljs.core.count(c__4609__auto___64817);
var G__64821 = (0);
seq__64770_64806 = G__64818;
chunk__64771_64807 = G__64819;
count__64772_64808 = G__64820;
i__64773_64809 = G__64821;
continue;
} else {
var nt_64822 = cljs.core.first(seq__64770_64816__$1);
if(cljs.core.truth_((valid_nts_64805.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64805.cljs$core$IFn$_invoke$arity$1(nt_64822) : valid_nts_64805.call(null,nt_64822)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64822),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64823 = cljs.core.next(seq__64770_64816__$1);
var G__64824 = null;
var G__64825 = (0);
var G__64826 = (0);
seq__64770_64806 = G__64823;
chunk__64771_64807 = G__64824;
count__64772_64808 = G__64825;
i__64773_64809 = G__64826;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64774_64827 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64775_64828 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64776_64829 = true;
var _STAR_print_fn_STAR__temp_val__64777_64830 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64776_64829);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64777_64830);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64775_64828);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64774_64827);
}
...
var len__4789__auto___64831 = arguments.length;
var i__4790__auto___64832 = (0);
while(true){
if((i__4790__auto___64832 < len__4789__auto___64831)){
args__4795__auto__.push((arguments[i__4790__auto___64832]));

var G__64833 = (i__4790__auto___64832 + (1));
i__4790__auto___64832 = G__64833;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64780){
...
var opts = map__64781__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64783 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64784 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64784);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64785_64838 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64786_64839 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64787_64840 = true;
var _STAR_print_fn_STAR__temp_val__64788_64841 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64787_64840);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64788_64841);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64786_64839);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64785_64838);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64783);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64778){
var G__64779 = cljs.core.first(seq64778);
var seq64778__$1 = cljs.core.next(seq64778);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64779,seq64778__$1);
}));
