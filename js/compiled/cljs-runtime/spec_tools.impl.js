...
var vec__55037 = cljs.core.rest(expr);
var seq__55038 = cljs.core.seq(vec__55037);
var first__55039 = cljs.core.first(seq__55038);
var seq__55038__$1 = cljs.core.next(seq__55038);
var vec__55040 = first__55039;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55040,(0),null);
var form = seq__55038__$1;
...
var G__55043 = x;
var G__55043__$1 = (((G__55043 == null))?null:spec_tools.impl.polish(G__55043));
var G__55043__$2 = (((G__55043__$1 == null))?null:cljs.core.name(G__55043__$1));
if((G__55043__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55043__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55044 = x;
var G__55044__$1 = (((G__55044 == null))?null:cljs.core.name(G__55044));
if((G__55044__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55044__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55045){
var map__55046 = p__55045;
...
var data = map__55046__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55046__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55046__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55046__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55046__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55048){
...
var data = map__55049__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55049__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55049__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55051 = data;
var G__55051__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55051,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55051);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55051__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55051__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55055 = form;
var G__55055__$1 = (((G__55055 == null))?null:cljs.core.rest(G__55055));
if((G__55055__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55055__$1);
}
})();
var G__55056 = m;
var G__55056__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55056,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55052_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55052_SHARP_)));
})):G__55056);
var G__55056__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55056__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55053_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55053_SHARP_)));
})):G__55056__$1);
var G__55056__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55056__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55054_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55054_SHARP_));
})):G__55056__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55056__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55057 = (function (){var G__55058 = form;
var G__55058__$1 = (((G__55058 == null))?null:cljs.core.rest(G__55058));
if((G__55058__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55058__$1);
}
})();
var map__55057__$1 = (((((!((map__55057 == null))))?(((((map__55057.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55057.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55057):map__55057);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55057__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55057__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55057__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55057__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55060 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55060) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55061 = form;
var G__55061__$1 = (((G__55061 == null))?null:cljs.core.seq(G__55061));
var G__55061__$2 = (((G__55061__$1 == null))?null:cljs.core.first(G__55061__$1));
if((G__55061__$2 == null)){
return null;
} else {
var fexpr__55062 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55062.cljs$core$IFn$_invoke$arity$1 ? fexpr__55062.cljs$core$IFn$_invoke$arity$1(G__55061__$2) : fexpr__55062.call(null,G__55061__$2));
}
})():null));
});
/**
...
var len__4789__auto___55083 = arguments.length;
var i__4790__auto___55084 = (0);
while(true){
if((i__4790__auto___55084 < len__4789__auto___55083)){
args__4795__auto__.push((arguments[i__4790__auto___55084]));

var G__55085 = (i__4790__auto___55084 + (1));
i__4790__auto___55084 = G__55085;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55063){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55063));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55064){
var vec__55065 = p__55064;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55065,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55065,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55070){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55071__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55071__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55071__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55071__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55068_SHARP_){
return cljs.core.map_QMARK_(p1__55068_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55069_SHARP_){
return cljs.core.contains_QMARK_(p1__55069_SHARP_,x);
});
}),req_keys));
