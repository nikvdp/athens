...
var vec__55050 = cljs.core.rest(expr);
var seq__55051 = cljs.core.seq(vec__55050);
var first__55052 = cljs.core.first(seq__55051);
var seq__55051__$1 = cljs.core.next(seq__55051);
var vec__55053 = first__55052;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55053,(0),null);
var form = seq__55051__$1;
...
var G__55056 = x;
var G__55056__$1 = (((G__55056 == null))?null:spec_tools.impl.polish(G__55056));
var G__55056__$2 = (((G__55056__$1 == null))?null:cljs.core.name(G__55056__$1));
if((G__55056__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55056__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55057 = x;
var G__55057__$1 = (((G__55057 == null))?null:cljs.core.name(G__55057));
if((G__55057__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55057__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55058){
var map__55059 = p__55058;
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55061){
...
var G__55064 = data;
var G__55064__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55064,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55064);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55064__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55064__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55068 = form;
var G__55068__$1 = (((G__55068 == null))?null:cljs.core.rest(G__55068));
if((G__55068__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55068__$1);
}
})();
var G__55069 = m;
var G__55069__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55069,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55065_SHARP_){
...
var G__55069__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55069__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55066_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55066_SHARP_)));
})):G__55069__$1);
var G__55069__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55069__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55067_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55067_SHARP_));
})):G__55069__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55069__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55070 = (function (){var G__55071 = form;
var G__55071__$1 = (((G__55071 == null))?null:cljs.core.rest(G__55071));
if((G__55071__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55071__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55070__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55070__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55070__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55070__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55073 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55073) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55074 = form;
var G__55074__$1 = (((G__55074 == null))?null:cljs.core.seq(G__55074));
var G__55074__$2 = (((G__55074__$1 == null))?null:cljs.core.first(G__55074__$1));
if((G__55074__$2 == null)){
return null;
} else {
var fexpr__55075 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55075.cljs$core$IFn$_invoke$arity$1 ? fexpr__55075.cljs$core$IFn$_invoke$arity$1(G__55074__$2) : fexpr__55075.call(null,G__55074__$2));
}
})():null));
});
/**
...
var len__4789__auto___55096 = arguments.length;
var i__4790__auto___55097 = (0);
while(true){
if((i__4790__auto___55097 < len__4789__auto___55096)){
args__4795__auto__.push((arguments[i__4790__auto___55097]));

var G__55098 = (i__4790__auto___55097 + (1));
i__4790__auto___55097 = G__55098;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55076){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55076));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55077){
var vec__55078 = p__55077;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55078,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55078,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55083){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55081_SHARP_){
return cljs.core.map_QMARK_(p1__55081_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55082_SHARP_){
return cljs.core.contains_QMARK_(p1__55082_SHARP_,x);
});
}),req_keys));
