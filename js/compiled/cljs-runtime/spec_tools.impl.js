...
var vec__55028 = cljs.core.rest(expr);
...
var vec__55031 = first__55030;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55031,(0),null);
var form = seq__55029__$1;
...
var G__55034 = x;
var G__55034__$1 = (((G__55034 == null))?null:spec_tools.impl.polish(G__55034));
var G__55034__$2 = (((G__55034__$1 == null))?null:cljs.core.name(G__55034__$1));
if((G__55034__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55034__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55035 = x;
var G__55035__$1 = (((G__55035 == null))?null:cljs.core.name(G__55035));
if((G__55035__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55035__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55036){
var map__55037 = p__55036;
...
var data = map__55037__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55037__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55037__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55037__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55037__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55039){
var map__55040 = p__55039;
var map__55040__$1 = (((((!((map__55040 == null))))?(((((map__55040.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55040.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55040):map__55040);
var data = map__55040__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55040__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55040__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55042 = data;
var G__55042__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55042,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55042);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55042__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55042__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55046 = form;
var G__55046__$1 = (((G__55046 == null))?null:cljs.core.rest(G__55046));
if((G__55046__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55046__$1);
}
})();
var G__55047 = m;
var G__55047__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55047,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55043_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55043_SHARP_)));
})):G__55047);
var G__55047__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55047__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55044_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55044_SHARP_)));
})):G__55047__$1);
var G__55047__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55047__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55045_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55045_SHARP_));
})):G__55047__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55047__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55048 = (function (){var G__55049 = form;
var G__55049__$1 = (((G__55049 == null))?null:cljs.core.rest(G__55049));
if((G__55049__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55049__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55048__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55048__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55048__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55048__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55051 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55051) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55052 = form;
var G__55052__$1 = (((G__55052 == null))?null:cljs.core.seq(G__55052));
var G__55052__$2 = (((G__55052__$1 == null))?null:cljs.core.first(G__55052__$1));
if((G__55052__$2 == null)){
return null;
} else {
var fexpr__55053 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55053.cljs$core$IFn$_invoke$arity$1 ? fexpr__55053.cljs$core$IFn$_invoke$arity$1(G__55052__$2) : fexpr__55053.call(null,G__55052__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55054){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55054));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55055){
var vec__55056 = p__55055;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55056,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55056,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55061){
var map__55062 = p__55061;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55062__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55062__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55062__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55062__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55059_SHARP_){
return cljs.core.map_QMARK_(p1__55059_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55060_SHARP_){
return cljs.core.contains_QMARK_(p1__55060_SHARP_,x);
});
}),req_keys));
