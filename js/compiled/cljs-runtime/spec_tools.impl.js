...
var vec__55075 = cljs.core.rest(expr);
var seq__55076 = cljs.core.seq(vec__55075);
var first__55077 = cljs.core.first(seq__55076);
var seq__55076__$1 = cljs.core.next(seq__55076);
var vec__55078 = first__55077;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55078,(0),null);
var form = seq__55076__$1;
...
var G__55081 = x;
var G__55081__$1 = (((G__55081 == null))?null:spec_tools.impl.polish(G__55081));
var G__55081__$2 = (((G__55081__$1 == null))?null:cljs.core.name(G__55081__$1));
if((G__55081__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55081__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55082 = x;
var G__55082__$1 = (((G__55082 == null))?null:cljs.core.name(G__55082));
if((G__55082__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55082__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55083){
var map__55084 = p__55083;
var map__55084__$1 = (((((!((map__55084 == null))))?(((((map__55084.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55084.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55084):map__55084);
var data = map__55084__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55084__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55084__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55084__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55084__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55086){
...
var data = map__55087__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55087__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55087__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55089 = data;
var G__55089__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55089,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55089);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55089__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55089__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55093 = form;
var G__55093__$1 = (((G__55093 == null))?null:cljs.core.rest(G__55093));
if((G__55093__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55093__$1);
}
})();
var G__55094 = m;
var G__55094__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55094,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55090_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55090_SHARP_)));
})):G__55094);
var G__55094__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55094__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55091_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55091_SHARP_)));
})):G__55094__$1);
var G__55094__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55094__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55092_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55092_SHARP_));
})):G__55094__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55094__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55095 = (function (){var G__55096 = form;
var G__55096__$1 = (((G__55096 == null))?null:cljs.core.rest(G__55096));
if((G__55096__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55096__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55095__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55095__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55095__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55095__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55098 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55098) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55099 = form;
var G__55099__$1 = (((G__55099 == null))?null:cljs.core.seq(G__55099));
var G__55099__$2 = (((G__55099__$1 == null))?null:cljs.core.first(G__55099__$1));
if((G__55099__$2 == null)){
return null;
} else {
var fexpr__55100 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55100.cljs$core$IFn$_invoke$arity$1 ? fexpr__55100.cljs$core$IFn$_invoke$arity$1(G__55099__$2) : fexpr__55100.call(null,G__55099__$2));
}
})():null));
});
/**
...
var len__4789__auto___55119 = arguments.length;
var i__4790__auto___55120 = (0);
while(true){
if((i__4790__auto___55120 < len__4789__auto___55119)){
args__4795__auto__.push((arguments[i__4790__auto___55120]));

var G__55121 = (i__4790__auto___55120 + (1));
i__4790__auto___55120 = G__55121;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55101){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55101));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55102){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55108){
var map__55109 = p__55108;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55109__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55109__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55109__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55109__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55106_SHARP_){
return cljs.core.map_QMARK_(p1__55106_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55107_SHARP_){
return cljs.core.contains_QMARK_(p1__55107_SHARP_,x);
});
}),req_keys));
