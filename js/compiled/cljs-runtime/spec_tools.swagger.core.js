...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56259 = cljs.core.get_global_hierarchy;
return (fexpr__56259.cljs$core$IFn$_invoke$arity$0 ? fexpr__56259.cljs$core$IFn$_invoke$arity$0() : fexpr__56259.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56260){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56261__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56261__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56263,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56263,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56268 = cljs.core.get_global_hierarchy;
return (fexpr__56268.cljs$core$IFn$_invoke$arity$0 ? fexpr__56268.cljs$core$IFn$_invoke$arity$0() : fexpr__56268.call(null));
})());
...
var map__56269 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56269__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56269__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56271){
var vec__56272 = p__56271;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56272,(0),null);
var map__56275 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56272,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56277 = cljs.core.get_global_hierarchy;
return (fexpr__56277.cljs$core$IFn$_invoke$arity$0 ? fexpr__56277.cljs$core$IFn$_invoke$arity$0() : fexpr__56277.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__56278(s__56279){
...
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56282,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56282,(1),null);
cljs.core.chunk_append(b__56281,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56281),spec_tools$swagger$core$iter__56278(cljs.core.chunk_rest(s__56279__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56281),null);
}
} else {
var vec__56285 = cljs.core.first(s__56279__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56285,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56285,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56278(cljs.core.rest(s__56279__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56288){
var vec__56289 = p__56288;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56289,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56289,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56293,p){
var vec__56294 = p__56293;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56294,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56294,(1),null);
var acc__$1 = vec__56294;
