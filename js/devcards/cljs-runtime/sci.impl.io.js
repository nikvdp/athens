...
sci.impl.io.in$ = (function (){var _STAR_unrestricted_STAR__orig_val__58960 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__58961 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__58961);

try{var G__58962 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*in*","*in*",1130010229,null));
sci.impl.vars.unbind(G__58962);

return G__58962;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__58960);
}})();
sci.impl.io.out = (function (){var _STAR_unrestricted_STAR__orig_val__58963 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
...
try{var G__58965 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*out*","*out*",1277591796,null));
sci.impl.vars.unbind(G__58965);

return G__58965;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__58963);
}})();
sci.impl.io.err = (function (){var _STAR_unrestricted_STAR__orig_val__58966 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__58967 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__58967);

try{var G__58968 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*err*","*err*",2070937226,null));
sci.impl.vars.unbind(G__58968);

return G__58968;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__58966);
}})();
...
var _STAR_print_length_STAR__orig_val__58972 = cljs.core._STAR_print_length_STAR_;
var _STAR_print_length_STAR__temp_val__58973 = cljs.core.deref(sci.impl.io.print_length);
(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__temp_val__58973);

try{return cljs.core.deref(sci.impl.io.out).append(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str,objs));
}finally {(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__orig_val__58972);
}}));

(sci.impl.io.pr.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(sci.impl.io.pr.cljs$lang$applyTo = (function (seq58971){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58971));
}));
...
/** @this {Function} */
(sci.impl.io.prn.cljs$lang$applyTo = (function (seq58977){
var self__4777__auto__ = this;
...
/** @this {Function} */
(sci.impl.io.print.cljs$lang$applyTo = (function (seq58980){
var self__4777__auto__ = this;
