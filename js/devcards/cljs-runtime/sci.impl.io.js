...
sci.impl.io.in$ = (function (){var _STAR_unrestricted_STAR__orig_val__59016 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__59017 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__59017);

try{var G__59018 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*in*","*in*",1130010229,null));
sci.impl.vars.unbind(G__59018);

return G__59018;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__59016);
}})();
sci.impl.io.out = (function (){var _STAR_unrestricted_STAR__orig_val__59019 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__59020 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__59020);

try{var G__59021 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*out*","*out*",1277591796,null));
sci.impl.vars.unbind(G__59021);

return G__59021;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__59019);
}})();
sci.impl.io.err = (function (){var _STAR_unrestricted_STAR__orig_val__59022 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__59023 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__59023);

try{var G__59024 = sci.impl.vars.dynamic_var.cljs$core$IFn$_invoke$arity$1(new cljs.core.Symbol(null,"*err*","*err*",2070937226,null));
sci.impl.vars.unbind(G__59024);

return G__59024;
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__59022);
}})();
...
var _STAR_print_length_STAR__orig_val__59027 = cljs.core._STAR_print_length_STAR_;
var _STAR_print_length_STAR__temp_val__59028 = cljs.core.deref(sci.impl.io.print_length);
(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__temp_val__59028);

try{return cljs.core.deref(sci.impl.io.out).append(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str,objs));
}finally {(cljs.core._STAR_print_length_STAR_ = _STAR_print_length_STAR__orig_val__59027);
}}));

(sci.impl.io.pr.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(sci.impl.io.pr.cljs$lang$applyTo = (function (seq59026){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq59026));
}));
...
/** @this {Function} */
(sci.impl.io.prn.cljs$lang$applyTo = (function (seq59031){
var self__4777__auto__ = this;
...
var args__4795__auto__ = [];
var len__4789__auto___59054 = arguments.length;
var i__4790__auto___59055 = (0);
while(true){
if((i__4790__auto___59055 < len__4789__auto___59054)){
args__4795__auto__.push((arguments[i__4790__auto___59055]));

var G__59056 = (i__4790__auto___59055 + (1));
i__4790__auto___59055 = G__59056;
continue;
} else {
}
break;
...
var args__4795__auto__ = [];
var len__4789__auto___59058 = arguments.length;
var i__4790__auto___59059 = (0);
while(true){
if((i__4790__auto___59059 < len__4789__auto___59058)){
args__4795__auto__.push((arguments[i__4790__auto___59059]));

var G__59060 = (i__4790__auto___59059 + (1));
i__4790__auto___59059 = G__59060;
continue;
} else {
}
break;
