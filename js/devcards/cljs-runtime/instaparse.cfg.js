...
var G__57395 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57395)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57395)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57395)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57395)].join('')));
...
var G__57442 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57443 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57442;
v = G__57443;
continue;
} else {
var G__57444 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57445 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57444;
v = G__57445;
continue;
}
...
break;
case "\"":
var G__57446 = cljs.core.next(sq);
var G__57447 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57446;
v = G__57447;
continue;
...
break;
default:
var G__57448 = cljs.core.next(sq);
var G__57449 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57448;
v = G__57449;
continue;
...
break;
case "paren":
var G__57453 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57453;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57413 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57414 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57415 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57416 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57416) : instaparse.cfg.build_rule.call(null,G__57416));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__57417 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57417) : instaparse.cfg.build_rule.call(null,G__57417));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57418 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57418) : instaparse.cfg.build_rule.call(null,G__57418));
})());
...
while(true){
var G__57420 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57455 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57455;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57420__$1)].join('')));
...
var valid_nts_57456 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57421_57457 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57422_57458 = null;
var count__57423_57459 = (0);
var i__57424_57460 = (0);
while(true){
if((i__57424_57460 < count__57423_57459)){
var nt_57461 = chunk__57422_57458.cljs$core$IIndexed$_nth$arity$2(null,i__57424_57460);
if(cljs.core.truth_((valid_nts_57456.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57456.cljs$core$IFn$_invoke$arity$1(nt_57461) : valid_nts_57456.call(null,nt_57461)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57461),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57462 = seq__57421_57457;
var G__57463 = chunk__57422_57458;
var G__57464 = count__57423_57459;
var G__57465 = (i__57424_57460 + (1));
seq__57421_57457 = G__57462;
chunk__57422_57458 = G__57463;
count__57423_57459 = G__57464;
i__57424_57460 = G__57465;
continue;
} else {
var temp__5735__auto___57466 = cljs.core.seq(seq__57421_57457);
if(temp__5735__auto___57466){
var seq__57421_57467__$1 = temp__5735__auto___57466;
if(cljs.core.chunked_seq_QMARK_(seq__57421_57467__$1)){
var c__4609__auto___57468 = cljs.core.chunk_first(seq__57421_57467__$1);
var G__57469 = cljs.core.chunk_rest(seq__57421_57467__$1);
var G__57470 = c__4609__auto___57468;
var G__57471 = cljs.core.count(c__4609__auto___57468);
var G__57472 = (0);
seq__57421_57457 = G__57469;
chunk__57422_57458 = G__57470;
count__57423_57459 = G__57471;
i__57424_57460 = G__57472;
continue;
} else {
var nt_57473 = cljs.core.first(seq__57421_57467__$1);
if(cljs.core.truth_((valid_nts_57456.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57456.cljs$core$IFn$_invoke$arity$1(nt_57473) : valid_nts_57456.call(null,nt_57473)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57473),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57474 = cljs.core.next(seq__57421_57467__$1);
var G__57475 = null;
var G__57476 = (0);
var G__57477 = (0);
seq__57421_57457 = G__57474;
chunk__57422_57458 = G__57475;
count__57423_57459 = G__57476;
i__57424_57460 = G__57477;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57425_57478 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57426_57479 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57427_57480 = true;
var _STAR_print_fn_STAR__temp_val__57428_57481 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57427_57480);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57428_57481);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57426_57479);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57425_57478);
}
...
var len__4789__auto___57482 = arguments.length;
var i__4790__auto___57483 = (0);
while(true){
if((i__4790__auto___57483 < len__4789__auto___57482)){
args__4795__auto__.push((arguments[i__4790__auto___57483]));

var G__57484 = (i__4790__auto___57483 + (1));
i__4790__auto___57483 = G__57484;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57431){
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57436_57485 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57437_57486 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57438_57487 = true;
var _STAR_print_fn_STAR__temp_val__57439_57488 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57438_57487);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57439_57488);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57437_57486);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57436_57485);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57429){
