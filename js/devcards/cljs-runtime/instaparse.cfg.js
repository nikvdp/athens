...
var G__56969 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56969)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56969)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56969)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56969)].join('')));
...
var G__57015 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57016 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57015;
v = G__57016;
continue;
} else {
var G__57017 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57018 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57017;
v = G__57018;
continue;
}
...
break;
case "\"":
var G__57019 = cljs.core.next(sq);
var G__57020 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57019;
v = G__57020;
continue;
...
break;
default:
var G__57021 = cljs.core.next(sq);
var G__57022 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57021;
v = G__57022;
continue;
...
while(true){
var G__56978 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56978__$1 = (((G__56978 instanceof cljs.core.Keyword))?G__56978.fqn:null);
switch (G__56978__$1) {
case "rule":
var vec__56979 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56979,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56979,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56982 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56982) : instaparse.cfg.content.call(null,G__56982));
...
break;
case "paren":
var G__57027 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57027;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56983 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56983) : instaparse.cfg.build_rule.call(null,G__56983));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56984 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56984) : instaparse.cfg.build_rule.call(null,G__56984));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__56985 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56985) : instaparse.cfg.build_rule.call(null,G__56985));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56986 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56986) : instaparse.cfg.build_rule.call(null,G__56986));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__56987 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56992 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56978__$1)].join('')));
...
while(true){
var G__56993 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57029 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57029;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56993__$1)].join('')));
...
var valid_nts_57030 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56994_57031 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56995_57032 = null;
var count__56996_57033 = (0);
var i__56997_57034 = (0);
while(true){
if((i__56997_57034 < count__56996_57033)){
var nt_57035 = chunk__56995_57032.cljs$core$IIndexed$_nth$arity$2(null,i__56997_57034);
if(cljs.core.truth_((valid_nts_57030.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57030.cljs$core$IFn$_invoke$arity$1(nt_57035) : valid_nts_57030.call(null,nt_57035)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57035),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57036 = seq__56994_57031;
var G__57037 = chunk__56995_57032;
var G__57038 = count__56996_57033;
var G__57039 = (i__56997_57034 + (1));
seq__56994_57031 = G__57036;
chunk__56995_57032 = G__57037;
count__56996_57033 = G__57038;
i__56997_57034 = G__57039;
continue;
} else {
var temp__5735__auto___57040 = cljs.core.seq(seq__56994_57031);
if(temp__5735__auto___57040){
var seq__56994_57041__$1 = temp__5735__auto___57040;
if(cljs.core.chunked_seq_QMARK_(seq__56994_57041__$1)){
var c__4609__auto___57042 = cljs.core.chunk_first(seq__56994_57041__$1);
var G__57043 = cljs.core.chunk_rest(seq__56994_57041__$1);
var G__57044 = c__4609__auto___57042;
var G__57045 = cljs.core.count(c__4609__auto___57042);
var G__57046 = (0);
seq__56994_57031 = G__57043;
chunk__56995_57032 = G__57044;
count__56996_57033 = G__57045;
i__56997_57034 = G__57046;
continue;
} else {
var nt_57047 = cljs.core.first(seq__56994_57041__$1);
if(cljs.core.truth_((valid_nts_57030.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57030.cljs$core$IFn$_invoke$arity$1(nt_57047) : valid_nts_57030.call(null,nt_57047)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57047),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57048 = cljs.core.next(seq__56994_57041__$1);
var G__57049 = null;
var G__57050 = (0);
var G__57051 = (0);
seq__56994_57031 = G__57048;
chunk__56995_57032 = G__57049;
count__56996_57033 = G__57050;
i__56997_57034 = G__57051;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56999_57052 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57000_57053 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57001_57054 = true;
var _STAR_print_fn_STAR__temp_val__57002_57055 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57001_57054);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57002_57055);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57000_57053);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56999_57052);
}
...
var len__4789__auto___57056 = arguments.length;
var i__4790__auto___57057 = (0);
while(true){
if((i__4790__auto___57057 < len__4789__auto___57056)){
args__4795__auto__.push((arguments[i__4790__auto___57057]));

var G__57058 = (i__4790__auto___57057 + (1));
i__4790__auto___57057 = G__57058;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57005){
var map__57006 = p__57005;
var map__57006__$1 = (((((!((map__57006 == null))))?(((((map__57006.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57006.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57006):map__57006);
var opts = map__57006__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57008 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57009 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57009);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57010_57059 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57011_57060 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57012_57061 = true;
var _STAR_print_fn_STAR__temp_val__57013_57062 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57012_57061);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57013_57062);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57011_57060);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57010_57059);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57008);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57003){
var G__57004 = cljs.core.first(seq57003);
var seq57003__$1 = cljs.core.next(seq57003);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57004,seq57003__$1);
}));
