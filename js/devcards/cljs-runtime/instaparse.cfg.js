...
var G__56946 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56946)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56946)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56946)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56946)].join('')));
...
var G__56994 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56995 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56994;
v = G__56995;
continue;
} else {
var G__56996 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56997 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56996;
v = G__56997;
continue;
}
...
break;
case "\"":
var G__56998 = cljs.core.next(sq);
var G__56999 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56998;
v = G__56999;
continue;
...
break;
default:
var G__57000 = cljs.core.next(sq);
var G__57001 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57000;
v = G__57001;
continue;
...
while(true){
var G__56959 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56959__$1 = (((G__56959 instanceof cljs.core.Keyword))?G__56959.fqn:null);
switch (G__56959__$1) {
case "rule":
var vec__56960 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56960,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56960,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56963 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56963) : instaparse.cfg.content.call(null,G__56963));
...
break;
case "paren":
var G__57004 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57004;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56964 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56966 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56966) : instaparse.cfg.build_rule.call(null,G__56966));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__56967 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56967) : instaparse.cfg.build_rule.call(null,G__56967));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56968 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56968) : instaparse.cfg.build_rule.call(null,G__56968));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__56969 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56969) : instaparse.cfg.build_rule.call(null,G__56969));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56970 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56970) : instaparse.cfg.build_rule.call(null,G__56970));
})());
...
while(true){
var G__56971 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57006 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57006;
continue;
...
var valid_nts_57007 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56972_57008 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56973_57009 = null;
var count__56974_57010 = (0);
var i__56975_57011 = (0);
while(true){
if((i__56975_57011 < count__56974_57010)){
var nt_57012 = chunk__56973_57009.cljs$core$IIndexed$_nth$arity$2(null,i__56975_57011);
if(cljs.core.truth_((valid_nts_57007.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57007.cljs$core$IFn$_invoke$arity$1(nt_57012) : valid_nts_57007.call(null,nt_57012)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57012),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57013 = seq__56972_57008;
var G__57014 = chunk__56973_57009;
var G__57015 = count__56974_57010;
var G__57016 = (i__56975_57011 + (1));
seq__56972_57008 = G__57013;
chunk__56973_57009 = G__57014;
count__56974_57010 = G__57015;
i__56975_57011 = G__57016;
continue;
} else {
var temp__5735__auto___57017 = cljs.core.seq(seq__56972_57008);
if(temp__5735__auto___57017){
var seq__56972_57018__$1 = temp__5735__auto___57017;
if(cljs.core.chunked_seq_QMARK_(seq__56972_57018__$1)){
var c__4609__auto___57019 = cljs.core.chunk_first(seq__56972_57018__$1);
var G__57020 = cljs.core.chunk_rest(seq__56972_57018__$1);
var G__57021 = c__4609__auto___57019;
var G__57022 = cljs.core.count(c__4609__auto___57019);
var G__57023 = (0);
seq__56972_57008 = G__57020;
chunk__56973_57009 = G__57021;
count__56974_57010 = G__57022;
i__56975_57011 = G__57023;
continue;
} else {
var nt_57024 = cljs.core.first(seq__56972_57018__$1);
if(cljs.core.truth_((valid_nts_57007.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57007.cljs$core$IFn$_invoke$arity$1(nt_57024) : valid_nts_57007.call(null,nt_57024)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57024),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57025 = cljs.core.next(seq__56972_57018__$1);
var G__57026 = null;
var G__57027 = (0);
var G__57028 = (0);
seq__56972_57008 = G__57025;
chunk__56973_57009 = G__57026;
count__56974_57010 = G__57027;
i__56975_57011 = G__57028;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56976_57029 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56977_57030 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56978_57031 = true;
var _STAR_print_fn_STAR__temp_val__56979_57032 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56978_57031);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56979_57032);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56977_57030);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56976_57029);
}
...
var len__4789__auto___57033 = arguments.length;
var i__4790__auto___57034 = (0);
while(true){
if((i__4790__auto___57034 < len__4789__auto___57033)){
args__4795__auto__.push((arguments[i__4790__auto___57034]));

var G__57035 = (i__4790__auto___57034 + (1));
i__4790__auto___57034 = G__57035;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56982){
...
var opts = map__56983__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56985 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56986 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56986);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56987_57036 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56988_57037 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56989_57038 = true;
var _STAR_print_fn_STAR__temp_val__56990_57039 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56989_57038);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56990_57039);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56988_57037);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56987_57036);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56985);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56980){
var G__56981 = cljs.core.first(seq56980);
var seq56980__$1 = cljs.core.next(seq56980);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56981,seq56980__$1);
}));
