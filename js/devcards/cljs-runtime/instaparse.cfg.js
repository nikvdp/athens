...
var G__57369 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57369)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57369)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57369)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57369)].join('')));
...
var G__57416 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57417 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57416;
v = G__57417;
continue;
} else {
var G__57418 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57419 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57418;
v = G__57419;
continue;
}
...
break;
case "\"":
var G__57420 = cljs.core.next(sq);
var G__57421 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57420;
v = G__57421;
continue;
...
break;
default:
var G__57422 = cljs.core.next(sq);
var G__57423 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57422;
v = G__57423;
continue;
...
while(true){
var G__57378 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__57378__$1 = (((G__57378 instanceof cljs.core.Keyword))?G__57378.fqn:null);
switch (G__57378__$1) {
case "rule":
var vec__57379 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57379,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57379,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57382 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57382) : instaparse.cfg.content.call(null,G__57382));
...
break;
case "paren":
var G__57427 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57427;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57383 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57383) : instaparse.cfg.build_rule.call(null,G__57383));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57388 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57389 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57390 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57391 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57391) : instaparse.cfg.build_rule.call(null,G__57391));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57392 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57392) : instaparse.cfg.build_rule.call(null,G__57392));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57378__$1)].join('')));
...
while(true){
var G__57393 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57429 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57429;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57393__$1)].join('')));
...
var valid_nts_57430 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57395_57431 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57396_57432 = null;
var count__57397_57433 = (0);
var i__57398_57434 = (0);
while(true){
if((i__57398_57434 < count__57397_57433)){
var nt_57435 = chunk__57396_57432.cljs$core$IIndexed$_nth$arity$2(null,i__57398_57434);
if(cljs.core.truth_((valid_nts_57430.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57430.cljs$core$IFn$_invoke$arity$1(nt_57435) : valid_nts_57430.call(null,nt_57435)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57435),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57436 = seq__57395_57431;
var G__57437 = chunk__57396_57432;
var G__57438 = count__57397_57433;
var G__57439 = (i__57398_57434 + (1));
seq__57395_57431 = G__57436;
chunk__57396_57432 = G__57437;
count__57397_57433 = G__57438;
i__57398_57434 = G__57439;
continue;
} else {
var temp__5735__auto___57440 = cljs.core.seq(seq__57395_57431);
if(temp__5735__auto___57440){
var seq__57395_57441__$1 = temp__5735__auto___57440;
if(cljs.core.chunked_seq_QMARK_(seq__57395_57441__$1)){
var c__4609__auto___57442 = cljs.core.chunk_first(seq__57395_57441__$1);
var G__57443 = cljs.core.chunk_rest(seq__57395_57441__$1);
var G__57444 = c__4609__auto___57442;
var G__57445 = cljs.core.count(c__4609__auto___57442);
var G__57446 = (0);
seq__57395_57431 = G__57443;
chunk__57396_57432 = G__57444;
count__57397_57433 = G__57445;
i__57398_57434 = G__57446;
continue;
} else {
var nt_57447 = cljs.core.first(seq__57395_57441__$1);
if(cljs.core.truth_((valid_nts_57430.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57430.cljs$core$IFn$_invoke$arity$1(nt_57447) : valid_nts_57430.call(null,nt_57447)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57447),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57448 = cljs.core.next(seq__57395_57441__$1);
var G__57449 = null;
var G__57450 = (0);
var G__57451 = (0);
seq__57395_57431 = G__57448;
chunk__57396_57432 = G__57449;
count__57397_57433 = G__57450;
i__57398_57434 = G__57451;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57399_57452 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57400_57453 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57401_57454 = true;
var _STAR_print_fn_STAR__temp_val__57402_57455 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57401_57454);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57402_57455);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57400_57453);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57399_57452);
}
...
var len__4789__auto___57456 = arguments.length;
var i__4790__auto___57457 = (0);
while(true){
if((i__4790__auto___57457 < len__4789__auto___57456)){
args__4795__auto__.push((arguments[i__4790__auto___57457]));

var G__57458 = (i__4790__auto___57457 + (1));
i__4790__auto___57457 = G__57458;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57405){
...
var opts = map__57406__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57408 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57409 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57409);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57410_57459 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57411_57460 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57412_57461 = true;
var _STAR_print_fn_STAR__temp_val__57413_57462 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57412_57461);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57413_57462);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57411_57460);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57410_57459);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57408);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57403){
var G__57404 = cljs.core.first(seq57403);
var seq57403__$1 = cljs.core.next(seq57403);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57404,seq57403__$1);
}));
