...
var G__57268 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57268)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57268)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57268)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57268)].join('')));
...
var G__57315 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57316 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57315;
v = G__57316;
continue;
} else {
var G__57317 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57318 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57317;
v = G__57318;
continue;
}
...
break;
case "\"":
var G__57319 = cljs.core.next(sq);
var G__57320 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57319;
v = G__57320;
continue;
...
break;
default:
var G__57321 = cljs.core.next(sq);
var G__57322 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57321;
v = G__57322;
continue;
...
while(true){
var G__57278 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__57278__$1 = (((G__57278 instanceof cljs.core.Keyword))?G__57278.fqn:null);
switch (G__57278__$1) {
case "rule":
var vec__57279 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57279,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57279,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57282 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57282) : instaparse.cfg.content.call(null,G__57282));
...
break;
case "paren":
var G__57326 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57326;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57283 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57283) : instaparse.cfg.build_rule.call(null,G__57283));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57284 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57284) : instaparse.cfg.build_rule.call(null,G__57284));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__57285 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57285) : instaparse.cfg.build_rule.call(null,G__57285));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57286 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57286) : instaparse.cfg.build_rule.call(null,G__57286));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__57287 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57287) : instaparse.cfg.build_rule.call(null,G__57287));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57288 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57288) : instaparse.cfg.build_rule.call(null,G__57288));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57278__$1)].join('')));
...
while(true){
var G__57289 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57329 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57329;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57289__$1)].join('')));
...
var valid_nts_57330 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57294_57331 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57295_57332 = null;
var count__57296_57333 = (0);
var i__57297_57334 = (0);
while(true){
if((i__57297_57334 < count__57296_57333)){
var nt_57335 = chunk__57295_57332.cljs$core$IIndexed$_nth$arity$2(null,i__57297_57334);
if(cljs.core.truth_((valid_nts_57330.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57330.cljs$core$IFn$_invoke$arity$1(nt_57335) : valid_nts_57330.call(null,nt_57335)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57335),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57336 = seq__57294_57331;
var G__57337 = chunk__57295_57332;
var G__57338 = count__57296_57333;
var G__57339 = (i__57297_57334 + (1));
seq__57294_57331 = G__57336;
chunk__57295_57332 = G__57337;
count__57296_57333 = G__57338;
i__57297_57334 = G__57339;
continue;
} else {
var temp__5735__auto___57340 = cljs.core.seq(seq__57294_57331);
if(temp__5735__auto___57340){
var seq__57294_57341__$1 = temp__5735__auto___57340;
if(cljs.core.chunked_seq_QMARK_(seq__57294_57341__$1)){
var c__4609__auto___57342 = cljs.core.chunk_first(seq__57294_57341__$1);
var G__57343 = cljs.core.chunk_rest(seq__57294_57341__$1);
var G__57344 = c__4609__auto___57342;
var G__57345 = cljs.core.count(c__4609__auto___57342);
var G__57346 = (0);
seq__57294_57331 = G__57343;
chunk__57295_57332 = G__57344;
count__57296_57333 = G__57345;
i__57297_57334 = G__57346;
continue;
} else {
var nt_57347 = cljs.core.first(seq__57294_57341__$1);
if(cljs.core.truth_((valid_nts_57330.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57330.cljs$core$IFn$_invoke$arity$1(nt_57347) : valid_nts_57330.call(null,nt_57347)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57347),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57348 = cljs.core.next(seq__57294_57341__$1);
var G__57349 = null;
var G__57350 = (0);
var G__57351 = (0);
seq__57294_57331 = G__57348;
chunk__57295_57332 = G__57349;
count__57296_57333 = G__57350;
i__57297_57334 = G__57351;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57299_57352 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57300_57353 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57301_57354 = true;
var _STAR_print_fn_STAR__temp_val__57302_57355 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57301_57354);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57302_57355);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57300_57353);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57299_57352);
}
...
var len__4789__auto___57356 = arguments.length;
var i__4790__auto___57357 = (0);
while(true){
if((i__4790__auto___57357 < len__4789__auto___57356)){
args__4795__auto__.push((arguments[i__4790__auto___57357]));

var G__57358 = (i__4790__auto___57357 + (1));
i__4790__auto___57357 = G__57358;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57305){
...
var opts = map__57306__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57308 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57309 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57309);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57310_57359 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57311_57360 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57312_57361 = true;
var _STAR_print_fn_STAR__temp_val__57313_57362 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57312_57361);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57313_57362);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57311_57360);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57310_57359);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57308);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57303){
var G__57304 = cljs.core.first(seq57303);
var seq57303__$1 = cljs.core.next(seq57303);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57304,seq57303__$1);
}));
