...
var G__56971 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56971)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56971)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56971)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56971)].join('')));
...
var G__57018 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57019 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57018;
v = G__57019;
continue;
} else {
var G__57020 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57021 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57020;
v = G__57021;
continue;
}
...
var G__57023 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57022;
v = G__57023;
continue;
...
break;
default:
var G__57024 = cljs.core.next(sq);
var G__57025 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57024;
v = G__57025;
continue;
...
while(true){
var G__56980 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56980__$1 = (((G__56980 instanceof cljs.core.Keyword))?G__56980.fqn:null);
switch (G__56980__$1) {
case "rule":
var vec__56985 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56985,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56985,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56988 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56988) : instaparse.cfg.content.call(null,G__56988));
...
break;
case "paren":
var G__57029 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57029;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56989 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56989) : instaparse.cfg.build_rule.call(null,G__56989));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56990 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56990) : instaparse.cfg.build_rule.call(null,G__56990));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__56991 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56992 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__56993 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56993) : instaparse.cfg.build_rule.call(null,G__56993));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56994 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56994) : instaparse.cfg.build_rule.call(null,G__56994));
})());
...
while(true){
var G__56996 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__56996__$1 = (((G__56996 instanceof cljs.core.Keyword))?G__56996.fqn:null);
switch (G__56996__$1) {
case "nt":
...
case "neg":
case "rep":
var G__57031 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57031;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56996__$1)].join('')));
...
var valid_nts_57032 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56997_57033 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56998_57034 = null;
var count__56999_57035 = (0);
var i__57000_57036 = (0);
while(true){
if((i__57000_57036 < count__56999_57035)){
var nt_57037 = chunk__56998_57034.cljs$core$IIndexed$_nth$arity$2(null,i__57000_57036);
if(cljs.core.truth_((valid_nts_57032.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57032.cljs$core$IFn$_invoke$arity$1(nt_57037) : valid_nts_57032.call(null,nt_57037)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57037),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57038 = seq__56997_57033;
var G__57039 = chunk__56998_57034;
var G__57040 = count__56999_57035;
var G__57041 = (i__57000_57036 + (1));
seq__56997_57033 = G__57038;
chunk__56998_57034 = G__57039;
count__56999_57035 = G__57040;
i__57000_57036 = G__57041;
continue;
} else {
var temp__5735__auto___57042 = cljs.core.seq(seq__56997_57033);
if(temp__5735__auto___57042){
var seq__56997_57043__$1 = temp__5735__auto___57042;
if(cljs.core.chunked_seq_QMARK_(seq__56997_57043__$1)){
var c__4609__auto___57044 = cljs.core.chunk_first(seq__56997_57043__$1);
var G__57045 = cljs.core.chunk_rest(seq__56997_57043__$1);
var G__57046 = c__4609__auto___57044;
var G__57047 = cljs.core.count(c__4609__auto___57044);
var G__57048 = (0);
seq__56997_57033 = G__57045;
chunk__56998_57034 = G__57046;
count__56999_57035 = G__57047;
i__57000_57036 = G__57048;
continue;
} else {
var nt_57049 = cljs.core.first(seq__56997_57043__$1);
if(cljs.core.truth_((valid_nts_57032.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57032.cljs$core$IFn$_invoke$arity$1(nt_57049) : valid_nts_57032.call(null,nt_57049)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57049),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57050 = cljs.core.next(seq__56997_57043__$1);
var G__57051 = null;
var G__57052 = (0);
var G__57053 = (0);
seq__56997_57033 = G__57050;
chunk__56998_57034 = G__57051;
count__56999_57035 = G__57052;
i__57000_57036 = G__57053;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57001_57054 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57002_57055 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57003_57056 = true;
var _STAR_print_fn_STAR__temp_val__57004_57057 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57003_57056);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57004_57057);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57002_57055);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57001_57054);
}
...
var len__4789__auto___57058 = arguments.length;
var i__4790__auto___57059 = (0);
while(true){
if((i__4790__auto___57059 < len__4789__auto___57058)){
args__4795__auto__.push((arguments[i__4790__auto___57059]));

var G__57060 = (i__4790__auto___57059 + (1));
i__4790__auto___57059 = G__57060;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57007){
...
var opts = map__57008__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57010 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57011 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57011);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57012_57061 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57013_57062 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57014_57063 = true;
var _STAR_print_fn_STAR__temp_val__57015_57064 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57014_57063);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57015_57064);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57013_57062);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57012_57061);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57010);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57005){
var G__57006 = cljs.core.first(seq57005);
var seq57005__$1 = cljs.core.next(seq57005);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57006,seq57005__$1);
}));
