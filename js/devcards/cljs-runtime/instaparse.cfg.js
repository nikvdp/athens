...
var G__56973 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56973)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56973)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56973)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56973)].join('')));
...
var G__57021 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57022 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57021;
v = G__57022;
continue;
} else {
var G__57023 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57024 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57023;
v = G__57024;
continue;
}
...
var G__56978 = cljs.tools.reader.reader_types.string_push_back_reader.cljs$core$IFn$_invoke$arity$1(s);
var G__56979 = null;
var G__56980 = null;
var G__56981 = null;
return (read_string_STAR__57029.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__57029.cljs$core$IFn$_invoke$arity$4(G__56978,G__56979,G__56980,G__56981) : read_string_STAR__57029.call(null,G__56978,G__56979,G__56980,G__56981));
});
/**
...
while(true){
var G__56987 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56987__$1 = (((G__56987 instanceof cljs.core.Keyword))?G__56987.fqn:null);
switch (G__56987__$1) {
case "rule":
var vec__56988 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56988,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56988,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56991 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56991) : instaparse.cfg.content.call(null,G__56991));
...
break;
case "paren":
var G__57031 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57031;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56992 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56993 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
case "neg":
case "rep":
var G__57033 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57033;
continue;
...
var valid_nts_57034 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56999_57035 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57000_57036 = null;
var count__57001_57037 = (0);
var i__57002_57038 = (0);
while(true){
if((i__57002_57038 < count__57001_57037)){
var nt_57039 = chunk__57000_57036.cljs$core$IIndexed$_nth$arity$2(null,i__57002_57038);
if(cljs.core.truth_((valid_nts_57034.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57034.cljs$core$IFn$_invoke$arity$1(nt_57039) : valid_nts_57034.call(null,nt_57039)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57039),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57040 = seq__56999_57035;
var G__57041 = chunk__57000_57036;
var G__57042 = count__57001_57037;
var G__57043 = (i__57002_57038 + (1));
seq__56999_57035 = G__57040;
chunk__57000_57036 = G__57041;
count__57001_57037 = G__57042;
i__57002_57038 = G__57043;
continue;
} else {
var temp__5735__auto___57044 = cljs.core.seq(seq__56999_57035);
if(temp__5735__auto___57044){
var seq__56999_57045__$1 = temp__5735__auto___57044;
if(cljs.core.chunked_seq_QMARK_(seq__56999_57045__$1)){
var c__4609__auto___57046 = cljs.core.chunk_first(seq__56999_57045__$1);
var G__57047 = cljs.core.chunk_rest(seq__56999_57045__$1);
var G__57048 = c__4609__auto___57046;
var G__57049 = cljs.core.count(c__4609__auto___57046);
var G__57050 = (0);
seq__56999_57035 = G__57047;
chunk__57000_57036 = G__57048;
count__57001_57037 = G__57049;
i__57002_57038 = G__57050;
continue;
} else {
var nt_57051 = cljs.core.first(seq__56999_57045__$1);
if(cljs.core.truth_((valid_nts_57034.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57034.cljs$core$IFn$_invoke$arity$1(nt_57051) : valid_nts_57034.call(null,nt_57051)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57051),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57052 = cljs.core.next(seq__56999_57045__$1);
var G__57053 = null;
var G__57054 = (0);
var G__57055 = (0);
seq__56999_57035 = G__57052;
chunk__57000_57036 = G__57053;
count__57001_57037 = G__57054;
i__57002_57038 = G__57055;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57003_57056 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57004_57057 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57005_57058 = true;
var _STAR_print_fn_STAR__temp_val__57006_57059 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57005_57058);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57006_57059);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57004_57057);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57003_57056);
}
...
var len__4789__auto___57060 = arguments.length;
var i__4790__auto___57061 = (0);
while(true){
if((i__4790__auto___57061 < len__4789__auto___57060)){
args__4795__auto__.push((arguments[i__4790__auto___57061]));

var G__57062 = (i__4790__auto___57061 + (1));
i__4790__auto___57061 = G__57062;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57009){
...
var opts = map__57010__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57012 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57013 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57013);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57014_57079 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57015_57080 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57016_57081 = true;
var _STAR_print_fn_STAR__temp_val__57017_57082 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57016_57081);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57017_57082);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57015_57080);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57014_57079);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57012);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57007){
var G__57008 = cljs.core.first(seq57007);
var seq57007__$1 = cljs.core.next(seq57007);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57008,seq57007__$1);
}));
