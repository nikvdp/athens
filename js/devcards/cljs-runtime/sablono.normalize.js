...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__46015){
var vec__46016 = p__46015;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46016,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46016,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__46021_SHARP_){
return (((p1__46021_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__46021_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__46027,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__46027;
}
});
...
var len__4789__auto___46066 = arguments.length;
var i__4790__auto___46067 = (0);
while(true){
if((i__4790__auto___46067 < len__4789__auto___46066)){
args__4795__auto__.push((arguments[i__4790__auto___46067]));

var G__46068 = (i__4790__auto___46067 + (1));
i__4790__auto___46067 = G__46068;
continue;
} else {
}
break;
...
var G__46031 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46031,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__46031;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq46028){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46028));
}));
...
var vec__46039 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__46044 = cljs.core.ffirst(matches);
var fexpr__46043 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__46043.cljs$core$IFn$_invoke$arity$1 ? fexpr__46043.cljs$core$IFn$_invoke$arity$1(G__46044) : fexpr__46043.call(null,G__46044));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46039,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46039,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__46037_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__46037_SHARP_))){
return p1__46037_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__46038_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__46038_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__46059){
var vec__46060 = p__46059;
var seq__46061 = cljs.core.seq(vec__46060);
var first__46062 = cljs.core.first(seq__46061);
var seq__46061__$1 = cljs.core.next(seq__46061);
var tag = first__46062;
var content = seq__46061__$1;
...
var vec__46063 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46063,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46063,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46063,(2),null);
