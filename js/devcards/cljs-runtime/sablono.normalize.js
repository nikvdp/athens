...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__46052){
var vec__46053 = p__46052;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46053,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__46056_SHARP_){
return (((p1__46056_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__46056_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__46057,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__46057;
}
});
...
var G__46107 = (i__4790__auto___46104 + (1));
i__4790__auto___46104 = G__46107;
continue;
} else {
}
break;
...
var G__46059 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46059,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__46059;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq46058){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46058));
}));
...
var vec__46073 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__46079 = cljs.core.ffirst(matches);
var fexpr__46078 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__46078.cljs$core$IFn$_invoke$arity$1 ? fexpr__46078.cljs$core$IFn$_invoke$arity$1(G__46079) : fexpr__46078.call(null,G__46079));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46073,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46073,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__46067_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__46067_SHARP_))){
return p1__46067_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__46068_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__46068_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__46093){
var vec__46094 = p__46093;
var seq__46095 = cljs.core.seq(vec__46094);
var first__46096 = cljs.core.first(seq__46095);
var seq__46095__$1 = cljs.core.next(seq__46095);
var tag = first__46096;
var content = seq__46095__$1;
...
var vec__46100 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46100,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46100,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46100,(2),null);
