...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__45142,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__45142;
}
});
...
var len__4736__auto___45169 = arguments.length;
var i__4737__auto___45170 = (0);
while(true){
if((i__4737__auto___45170 < len__4736__auto___45169)){
args__4742__auto__.push((arguments[i__4737__auto___45170]));

var G__45171 = (i__4737__auto___45170 + (1));
i__4737__auto___45170 = G__45171;
continue;
} else {
}
break;
...
var G__45144 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45144,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__45144;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq45143){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45143));
}));
...
var vec__45147 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__45151 = cljs.core.ffirst(matches);
var fexpr__45150 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__45150.cljs$core$IFn$_invoke$arity$1 ? fexpr__45150.cljs$core$IFn$_invoke$arity$1(G__45151) : fexpr__45150.call(null,G__45151));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__45145_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__45145_SHARP_))){
return p1__45145_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__45146_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__45146_SHARP_));
