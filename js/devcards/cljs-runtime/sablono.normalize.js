...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__45171){
var vec__45172 = p__45171;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45172,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45172,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__45175_SHARP_){
return (((p1__45175_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__45175_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__45179,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__45179;
}
});
...
var G__45183 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45183,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__45183;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq45180){
...
var vec__45190 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__45194 = cljs.core.ffirst(matches);
var fexpr__45193 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__45193.cljs$core$IFn$_invoke$arity$1 ? fexpr__45193.cljs$core$IFn$_invoke$arity$1(G__45194) : fexpr__45193.call(null,G__45194));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45190,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45190,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__45187_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__45187_SHARP_))){
return p1__45187_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__45188_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__45188_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__45205){
var vec__45206 = p__45205;
var seq__45207 = cljs.core.seq(vec__45206);
var first__45208 = cljs.core.first(seq__45207);
var seq__45207__$1 = cljs.core.next(seq__45207);
var tag = first__45208;
var content = seq__45207__$1;
...
var vec__45212 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45212,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45212,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45212,(2),null);
