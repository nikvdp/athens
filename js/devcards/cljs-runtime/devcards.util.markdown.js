...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41287 = cljs.core.get_global_hierarchy;
return (fexpr__41287.cljs$core$IFn$_invoke$arity$0 ? fexpr__41287.cljs$core$IFn$_invoke$arity$0() : fexpr__41287.call(null));
})());
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__41298,line){
...
var st = map__41299__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41299__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__41301,line){
var map__41303 = p__41301;
...
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41303__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__41308,line){
...
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__41317){
var map__41318 = p__41317;
var map__41318__$1 = (((((!((map__41318 == null))))?(((((map__41318.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41318.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41318):map__41318);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41318__$1,new cljs.core.Keyword(null,"content","content",15833224));
