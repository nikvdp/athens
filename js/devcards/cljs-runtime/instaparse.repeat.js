...
var vec__57788 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57788,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57788,(1),null);
...
var vec__57791 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57791,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57791,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57794 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57794,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57794,(1),null);
...
var G__57855 = cljs.core.next(parses__$1);
parses__$1 = G__57855;
continue;
}
...
var G__57802 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57803 = G__57802;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57803,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57803,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57803,(2),null);
var selection = vec__57803;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57802__$1 = G__57802;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57809 = G__57802__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57809,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57809,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57809,(2),null);
var selection__$1 = vec__57809;
...
var G__57857 = cljs.core.long$(end__$1);
var G__57858 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57859 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57857;
parses__$1 = G__57858;
G__57802__$1 = G__57859;
continue;
...
var G__57817 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57818 = G__57817;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57818,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57818,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57818,(2),null);
var selection = vec__57818;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57817__$1 = G__57817;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57824 = G__57817__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57824,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57824,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57824,(2),null);
var selection__$1 = vec__57824;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57861 = cljs.core.long$(end__$1);
var G__57862 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57863 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57861;
parses__$1 = G__57862;
G__57817__$1 = G__57863;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57832 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57833 = G__57832;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57833,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57833,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57833,(2),null);
var selection = vec__57833;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57832__$1 = G__57832;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57839 = G__57832__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57839,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57839,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57839,(2),null);
var selection__$1 = vec__57839;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57865 = cljs.core.long$(end__$1);
var G__57866 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57867 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57865;
parses__$1 = G__57866;
G__57832__$1 = G__57867;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57844 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57844.cljs$core$IFn$_invoke$arity$1 ? fexpr__57844.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57844.call(null,output_format));
})())){
} else {
...
var G__57845 = output_format;
var G__57845__$1 = (((G__57845 instanceof cljs.core.Keyword))?G__57845.fqn:null);
switch (G__57845__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57853 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57852 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57852.cljs$core$IFn$_invoke$arity$1 ? fexpr__57852.cljs$core$IFn$_invoke$arity$1(G__57853) : fexpr__57852.call(null,G__57853));
})();
