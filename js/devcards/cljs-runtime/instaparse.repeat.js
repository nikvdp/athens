...
var vec__57344 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(0),null);
...
var vec__57347 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57347,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57347,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57350 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57350,(0),null);
...
var G__57411 = cljs.core.next(parses__$1);
parses__$1 = G__57411;
continue;
}
...
var G__57413 = cljs.core.long$(end__$1);
var G__57414 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57415 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57413;
parses__$1 = G__57414;
G__57358__$1 = G__57415;
continue;
...
var G__57373 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57374 = G__57373;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57374,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57374,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57374,(2),null);
var selection = vec__57374;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57373__$1 = G__57373;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57380 = G__57373__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(2),null);
var selection__$1 = vec__57380;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57417 = cljs.core.long$(end__$1);
var G__57418 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57419 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57417;
parses__$1 = G__57418;
G__57373__$1 = G__57419;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57388 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57389 = G__57388;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(2),null);
var selection = vec__57389;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57388__$1 = G__57388;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57395 = G__57388__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57395,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57395,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57395,(2),null);
var selection__$1 = vec__57395;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57421 = cljs.core.long$(end__$1);
var G__57422 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57423 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57421;
parses__$1 = G__57422;
G__57388__$1 = G__57423;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57400 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57400.cljs$core$IFn$_invoke$arity$1 ? fexpr__57400.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57400.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57409 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57408 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57408.cljs$core$IFn$_invoke$arity$1 ? fexpr__57408.cljs$core$IFn$_invoke$arity$1(G__57409) : fexpr__57408.call(null,G__57409));
})();
