...
var vec__57369 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57369,(0),null);
...
var vec__57372 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57372,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57372,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var G__57436 = cljs.core.next(parses__$1);
parses__$1 = G__57436;
continue;
}
...
var G__57438 = cljs.core.long$(end__$1);
var G__57439 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57440 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57438;
parses__$1 = G__57439;
G__57383__$1 = G__57440;
continue;
...
var G__57398 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57399 = G__57398;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57399,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57399,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57399,(2),null);
var selection = vec__57399;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57398__$1 = G__57398;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57405 = G__57398__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57405,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57405,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57405,(2),null);
var selection__$1 = vec__57405;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57442 = cljs.core.long$(end__$1);
var G__57443 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57444 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57442;
parses__$1 = G__57443;
G__57398__$1 = G__57444;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57413 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57414 = G__57413;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57414,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57414,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57414,(2),null);
var selection = vec__57414;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57413__$1 = G__57413;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57420 = G__57413__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57420,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57420,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57420,(2),null);
var selection__$1 = vec__57420;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57446 = cljs.core.long$(end__$1);
var G__57447 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57448 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57446;
parses__$1 = G__57447;
G__57413__$1 = G__57448;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57425 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57425.cljs$core$IFn$_invoke$arity$1 ? fexpr__57425.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57425.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57434 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57433 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
