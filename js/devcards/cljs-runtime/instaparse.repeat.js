...
var vec__57426 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57426,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57426,(1),null);
...
var vec__57429 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57429,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57429,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57432 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57432,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57432,(1),null);
...
var G__57493 = cljs.core.next(parses__$1);
parses__$1 = G__57493;
continue;
}
...
var G__57440 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57441 = G__57440;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57441,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57441,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57441,(2),null);
var selection = vec__57441;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57440__$1 = G__57440;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57447 = G__57440__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57447,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57447,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57447,(2),null);
var selection__$1 = vec__57447;
...
var G__57495 = cljs.core.long$(end__$1);
var G__57496 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57497 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57495;
parses__$1 = G__57496;
G__57440__$1 = G__57497;
continue;
...
var G__57455 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57456 = G__57455;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57456,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57456,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57456,(2),null);
var selection = vec__57456;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57455__$1 = G__57455;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57462 = G__57455__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57462,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57462,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57462,(2),null);
var selection__$1 = vec__57462;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57499 = cljs.core.long$(end__$1);
var G__57500 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57501 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57499;
parses__$1 = G__57500;
G__57455__$1 = G__57501;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57470 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57471 = G__57470;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57471,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57471,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57471,(2),null);
var selection = vec__57471;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57470__$1 = G__57470;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57477 = G__57470__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57477,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57477,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57477,(2),null);
var selection__$1 = vec__57477;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57503 = cljs.core.long$(end__$1);
var G__57504 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57505 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57503;
parses__$1 = G__57504;
G__57470__$1 = G__57505;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57482 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57482.cljs$core$IFn$_invoke$arity$1 ? fexpr__57482.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57482.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57491 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57490 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57490.cljs$core$IFn$_invoke$arity$1 ? fexpr__57490.cljs$core$IFn$_invoke$arity$1(G__57491) : fexpr__57490.call(null,G__57491));
})();
