...
var vec__57495 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57495,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57495,(1),null);
...
var vec__57498 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57498,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57498,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57501 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57501,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57501,(1),null);
...
var G__57562 = cljs.core.next(parses__$1);
parses__$1 = G__57562;
continue;
}
...
var G__57509 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57510 = G__57509;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57510,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57510,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57510,(2),null);
var selection = vec__57510;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57509__$1 = G__57509;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57516 = G__57509__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57516,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57516,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57516,(2),null);
var selection__$1 = vec__57516;
...
var G__57564 = cljs.core.long$(end__$1);
var G__57565 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57566 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57564;
parses__$1 = G__57565;
G__57509__$1 = G__57566;
continue;
...
var G__57524 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57525 = G__57524;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57525,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57525,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57525,(2),null);
var selection = vec__57525;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57524__$1 = G__57524;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57531 = G__57524__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57531,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57531,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57531,(2),null);
var selection__$1 = vec__57531;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57568 = cljs.core.long$(end__$1);
var G__57569 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57570 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57568;
parses__$1 = G__57569;
G__57524__$1 = G__57570;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57539 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57540 = G__57539;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57540,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57540,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57540,(2),null);
var selection = vec__57540;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57539__$1 = G__57539;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57546 = G__57539__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57546,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57546,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57546,(2),null);
var selection__$1 = vec__57546;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57572 = cljs.core.long$(end__$1);
var G__57573 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57574 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57572;
parses__$1 = G__57573;
G__57539__$1 = G__57574;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57551 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57551.cljs$core$IFn$_invoke$arity$1 ? fexpr__57551.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57551.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57560 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57559 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57559.cljs$core$IFn$_invoke$arity$1 ? fexpr__57559.cljs$core$IFn$_invoke$arity$1(G__57560) : fexpr__57559.call(null,G__57560));
})();
