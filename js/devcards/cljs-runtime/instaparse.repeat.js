...
var vec__57667 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57667,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57667,(1),null);
...
var vec__57670 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57670,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57670,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57673 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57673,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57673,(1),null);
...
var G__57734 = cljs.core.next(parses__$1);
parses__$1 = G__57734;
continue;
}
...
var G__57681 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57682 = G__57681;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57682,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57682,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57682,(2),null);
var selection = vec__57682;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57681__$1 = G__57681;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57688 = G__57681__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57688,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57688,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57688,(2),null);
var selection__$1 = vec__57688;
...
var G__57736 = cljs.core.long$(end__$1);
var G__57737 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57738 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57736;
parses__$1 = G__57737;
G__57681__$1 = G__57738;
continue;
...
var G__57696 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57697 = G__57696;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57697,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57697,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57697,(2),null);
var selection = vec__57697;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57696__$1 = G__57696;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57703 = G__57696__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57703,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57703,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57703,(2),null);
var selection__$1 = vec__57703;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57740 = cljs.core.long$(end__$1);
var G__57741 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57742 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57740;
parses__$1 = G__57741;
G__57696__$1 = G__57742;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57711 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57712 = G__57711;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57712,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57712,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57712,(2),null);
var selection = vec__57712;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57711__$1 = G__57711;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57718 = G__57711__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57718,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57718,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57718,(2),null);
var selection__$1 = vec__57718;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57744 = cljs.core.long$(end__$1);
var G__57745 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57746 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57744;
parses__$1 = G__57745;
G__57711__$1 = G__57746;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57723 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57723.cljs$core$IFn$_invoke$arity$1 ? fexpr__57723.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57723.call(null,output_format));
})())){
} else {
...
var G__57724 = output_format;
var G__57724__$1 = (((G__57724 instanceof cljs.core.Keyword))?G__57724.fqn:null);
switch (G__57724__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57732 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57731 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57731.cljs$core$IFn$_invoke$arity$1 ? fexpr__57731.cljs$core$IFn$_invoke$arity$1(G__57732) : fexpr__57731.call(null,G__57732));
})();
