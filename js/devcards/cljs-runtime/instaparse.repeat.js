...
var vec__57796 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57796,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57796,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57799 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57799,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57799,(1),null);
...
var G__57860 = cljs.core.next(parses__$1);
parses__$1 = G__57860;
continue;
}
...
var G__57807 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57808 = G__57807;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57808,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57808,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57808,(2),null);
var selection = vec__57808;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57807__$1 = G__57807;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57814 = G__57807__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57814,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57814,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57814,(2),null);
var selection__$1 = vec__57814;
...
var G__57822 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57823 = G__57822;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57823,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57823,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57823,(2),null);
var selection = vec__57823;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57822__$1 = G__57822;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57829 = G__57822__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57829,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57829,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57829,(2),null);
var selection__$1 = vec__57829;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57837 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57838 = G__57837;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57838,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57838,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57838,(2),null);
var selection = vec__57838;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57837__$1 = G__57837;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57844 = G__57837__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57844,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57844,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57844,(2),null);
var selection__$1 = vec__57844;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57870 = cljs.core.long$(end__$1);
var G__57871 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57872 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57870;
parses__$1 = G__57871;
G__57837__$1 = G__57872;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57849 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57849.cljs$core$IFn$_invoke$arity$1 ? fexpr__57849.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57849.call(null,output_format));
})())){
} else {
...
var G__57850 = output_format;
var G__57850__$1 = (((G__57850 instanceof cljs.core.Keyword))?G__57850.fqn:null);
switch (G__57850__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57858 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57857 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57857.cljs$core$IFn$_invoke$arity$1 ? fexpr__57857.cljs$core$IFn$_invoke$arity$1(G__57858) : fexpr__57857.call(null,G__57858));
})();
