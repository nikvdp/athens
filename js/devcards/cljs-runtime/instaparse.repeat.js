...
var vec__57442 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(1),null);
...
var vec__57445 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(0),null);
...
var vec__57448 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57448,(0),null);
...
var G__57509 = cljs.core.next(parses__$1);
parses__$1 = G__57509;
continue;
}
...
var G__57456 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57457 = G__57456;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57457,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57457,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57457,(2),null);
var selection = vec__57457;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57456__$1 = G__57456;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57463 = G__57456__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(2),null);
var selection__$1 = vec__57463;
...
var G__57511 = cljs.core.long$(end__$1);
var G__57512 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57513 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57511;
parses__$1 = G__57512;
G__57456__$1 = G__57513;
continue;
...
var G__57471 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57472 = G__57471;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57472,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57472,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57472,(2),null);
var selection = vec__57472;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57471__$1 = G__57471;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57478 = G__57471__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57478,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57478,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57478,(2),null);
var selection__$1 = vec__57478;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57515 = cljs.core.long$(end__$1);
var G__57516 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57517 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57515;
parses__$1 = G__57516;
G__57471__$1 = G__57517;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57486 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57487 = G__57486;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57487,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57487,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57487,(2),null);
var selection = vec__57487;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57486__$1 = G__57486;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57493 = G__57486__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57493,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57493,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57493,(2),null);
var selection__$1 = vec__57493;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57519 = cljs.core.long$(end__$1);
var G__57520 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57521 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57519;
parses__$1 = G__57520;
G__57486__$1 = G__57521;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57498 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57498.cljs$core$IFn$_invoke$arity$1 ? fexpr__57498.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57498.call(null,output_format));
})())){
} else {
...
var G__57499 = output_format;
var G__57499__$1 = (((G__57499 instanceof cljs.core.Keyword))?G__57499.fqn:null);
switch (G__57499__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57507 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57506 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57506.cljs$core$IFn$_invoke$arity$1 ? fexpr__57506.cljs$core$IFn$_invoke$arity$1(G__57507) : fexpr__57506.call(null,G__57507));
})();
