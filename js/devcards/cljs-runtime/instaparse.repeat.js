...
var vec__57789 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57789,(0),null);
...
var vec__57792 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57792,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57792,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57795 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57795,(0),null);
...
var G__57856 = cljs.core.next(parses__$1);
parses__$1 = G__57856;
continue;
}
...
var G__57803 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57804 = G__57803;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57804,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57804,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57804,(2),null);
var selection = vec__57804;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57803__$1 = G__57803;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57810 = G__57803__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57810,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57810,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57810,(2),null);
var selection__$1 = vec__57810;
...
var G__57858 = cljs.core.long$(end__$1);
var G__57859 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57860 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57858;
parses__$1 = G__57859;
G__57803__$1 = G__57860;
continue;
...
var G__57818 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57819 = G__57818;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57819,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57819,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57819,(2),null);
var selection = vec__57819;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57818__$1 = G__57818;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57825 = G__57818__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57825,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57825,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57825,(2),null);
var selection__$1 = vec__57825;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57862 = cljs.core.long$(end__$1);
var G__57863 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57864 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57862;
parses__$1 = G__57863;
G__57818__$1 = G__57864;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57833 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57834 = G__57833;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57834,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57834,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57834,(2),null);
var selection = vec__57834;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57840 = G__57833__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57840,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57840,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57840,(2),null);
var selection__$1 = vec__57840;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57866 = cljs.core.long$(end__$1);
var G__57867 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57868 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57866;
parses__$1 = G__57867;
G__57833__$1 = G__57868;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57845 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57845.cljs$core$IFn$_invoke$arity$1 ? fexpr__57845.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57845.call(null,output_format));
})())){
} else {
...
var G__57846 = output_format;
var G__57846__$1 = (((G__57846 instanceof cljs.core.Keyword))?G__57846.fqn:null);
switch (G__57846__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57854 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57853 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57853.cljs$core$IFn$_invoke$arity$1 ? fexpr__57853.cljs$core$IFn$_invoke$arity$1(G__57854) : fexpr__57853.call(null,G__57854));
})();
