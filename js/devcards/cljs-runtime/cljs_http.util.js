...
var vec__39579 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39579,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39579,(1),null);
...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__39588 = (new goog.Uri());
G__39588.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__39588.setDomain(server_name);

G__39588.setPort(server_port);

G__39588.setPath(uri);

G__39588.setQuery(query_string,true);
