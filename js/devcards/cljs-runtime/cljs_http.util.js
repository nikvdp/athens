...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44883,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44883,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__44886){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44887__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44887__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44887__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44887__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44887__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__44891 = (new goog.Uri());
G__44891.setScheme(cljs.core.name((function (){var or__4126__auto__ = scheme;
...
G__44891.setDomain(server_name);

G__44891.setPort(server_port);

G__44891.setPath(uri);

G__44891.setQuery(query_string,true);
