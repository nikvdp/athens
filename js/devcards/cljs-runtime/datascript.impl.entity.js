...
var G__26452 = db;
var G__26453 = e;
var G__26454 = cljs.core.volatile_BANG_(false);
var G__26455 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__26452,G__26453,G__26454,G__26455) : datascript.impl.entity.__GT_Entity.call(null,G__26452,G__26453,G__26454,G__26455));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26457_SHARP_,p2__26458_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26457_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__26458_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26459_SHARP_,p2__26460_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26459_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__26460_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__26464(s__26465){
...
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26468,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26468,(1),null);
cljs.core.chunk_append(b__26467,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__26529 = (i__26466 + (1));
i__26466 = G__26529;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26467),datascript$impl$entity$js_seq_$_iter__26464(cljs.core.chunk_rest(s__26465__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26467),null);
}
} else {
var vec__26471 = cljs.core.first(s__26465__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__26464(cljs.core.rest(s__26465__$2)));
}
} else {
return null;
}
...
var vec__26505 = cljs.core.first(seq__26491__$1);
...
var temp__5735__auto___26569 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___26569)){
var datoms_26576 = temp__5735__auto___26569;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_26576)));
