...
var vec__20412 = (cljs.core.truth_(cljs.core.re_find(/@/,st_el))?clojure.string.split.cljs$core$IFn$_invoke$arity$2(st_el,/@/):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,st_el], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20412,(0),null);
var flc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20412,(1),null);
var vec__20415 = cljs.stacktrace.parse_file_line_column(flc);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20415,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20415,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20415,(2),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = file;
if(cljs.core.truth_(and__4174__auto__)){
var and__4174__auto____$1 = function$;
if(cljs.core.truth_(and__4174__auto____$1)){
...
var vec__20427 = (cljs.core.truth_(cljs.core.re_find(/@/,st_el))?clojure.string.split.cljs$core$IFn$_invoke$arity$2(st_el,/@/):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,st_el], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(0),null);
var flc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(1),null);
var vec__20430 = cljs.stacktrace.parse_file_line_column(flc);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20430,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20430,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20430,(2),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = file;
if(cljs.core.truth_(and__4174__auto__)){
var and__4174__auto____$1 = function$;
if(cljs.core.truth_(and__4174__auto____$1)){
...
return cljs.stacktrace.firefox_st_el__GT_frame(repl_env,p1__20438_SHARP_,opts);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20437_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__20437_SHARP_.indexOf("> eval"),(-1));
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"rhino","rhino",1962118035),(function (repl_env,st,err,p__20440){
...
var opts = map__20441__$1;
var output_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20441__$1,new cljs.core.Keyword(null,"output-dir","output-dir",-290956991));
var process_frame = (function cljs$stacktrace$process_frame(frame_str){
if(((clojure.string.blank_QMARK_(frame_str)) || (((-1) === frame_str.indexOf("\tat"))))){
return null;
} else {
var vec__20453 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/:/);
var file_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20453,(0),null);
var line_fn_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20453,(1),null);
var file = clojure.string.replace(file_side,/\s+at\s+/,"");
var vec__20456 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(line_fn_side,/\s+/);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20456,(0),null);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20456,(1),null);
...
var vec__20474 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str__$1,/\s+/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20474,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20474,(1),null);
var vec__20477 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20477,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20477,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"graaljs","graaljs",1880468686),(function (repl_env,st,err,p__20483){
...
var output_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20484__$1,new cljs.core.Keyword(null,"output-dir","output-dir",-290956991));
var process_frame = (function cljs$stacktrace$process_frame(frame_str){
if(clojure.string.blank_QMARK_(frame_str)){
return null;
} else {
var vec__20497 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/\(/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20497,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20497,(1),null);
var vec__20500 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20500,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20500,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"nodejs","nodejs",321212524),(function (repl_env,st,err,p__20506){
...
var vec__20527 = ((((2) === cljs.core.count(parts)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(parts),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(cljs.core.second(parts),(1),(cljs.core.count(cljs.core.second(parts)) - (1)))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.first(parts)], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20527,(0),null);
var file_AMPERSAND_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20527,(1),null);
var vec__20530 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_AMPERSAND_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20530,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20530,(1),null);
var col_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20530,(2),null);
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"file","file",-1269645878),(cljs.core.truth_(function$)?(function (){var G__20534 = file_part;
if(cljs.core.truth_(output_dir)){
return clojure.string.replace(G__20534,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(output_dir),"/"].join(''),"");
} else {
return G__20534;
}
...
return cljs.core.last((function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(columns,cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20541_SHARP_){
...
var _STAR_print_newline_STAR__orig_val__20590_20708 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__20591_20709 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__20592_20710 = true;
var _STAR_print_fn_STAR__temp_val__20593_20711 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__20592_20710);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__20593_20711);

try{var seq__20594_20712 = cljs.core.seq(cljs.stacktrace.mapped_stacktrace.cljs$core$IFn$_invoke$arity$3(stacktrace,sms,opts));
var chunk__20595_20713 = null;
var count__20596_20714 = (0);
var i__20597_20715 = (0);
while(true){
if((i__20597_20715 < count__20596_20714)){
var map__20610_20717 = chunk__20595_20713.cljs$core$IIndexed$_nth$arity$2(null,i__20597_20715);
var map__20610_20718__$1 = (((((!((map__20610_20717 == null))))?(((((map__20610_20717.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20610_20717.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20610_20717):map__20610_20717);
var function_20719 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20610_20718__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20720 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20610_20718__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20721 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20610_20718__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20722 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20610_20718__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var G__20723 = seq__20594_20712;
var G__20724 = chunk__20595_20713;
var G__20725 = count__20596_20714;
var G__20726 = (i__20597_20715 + (1));
seq__20594_20712 = G__20723;
chunk__20595_20713 = G__20724;
count__20596_20714 = G__20725;
i__20597_20715 = G__20726;
continue;
} else {
var temp__5735__auto___20727 = cljs.core.seq(seq__20594_20712);
if(temp__5735__auto___20727){
var seq__20594_20728__$1 = temp__5735__auto___20727;
if(cljs.core.chunked_seq_QMARK_(seq__20594_20728__$1)){
var c__4609__auto___20729 = cljs.core.chunk_first(seq__20594_20728__$1);
var G__20730 = cljs.core.chunk_rest(seq__20594_20728__$1);
var G__20731 = c__4609__auto___20729;
var G__20732 = cljs.core.count(c__4609__auto___20729);
var G__20733 = (0);
seq__20594_20712 = G__20730;
chunk__20595_20713 = G__20731;
count__20596_20714 = G__20732;
i__20597_20715 = G__20733;
continue;
} else {
var map__20616_20734 = cljs.core.first(seq__20594_20728__$1);
var map__20616_20735__$1 = (((((!((map__20616_20734 == null))))?(((((map__20616_20734.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20616_20734.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20616_20734):map__20616_20734);
var function_20736 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20616_20735__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20737 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20616_20735__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20738 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20616_20735__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20739 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20616_20735__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var G__20740 = cljs.core.next(seq__20594_20728__$1);
var G__20741 = null;
var G__20742 = (0);
var G__20743 = (0);
seq__20594_20712 = G__20740;
chunk__20595_20713 = G__20741;
count__20596_20714 = G__20742;
i__20597_20715 = G__20743;
continue;
}
} else {
}
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__20591_20709);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__20590_20708);
}
