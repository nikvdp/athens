...
var vec__20367 = (cljs.core.truth_(cljs.core.re_find(/@/,st_el))?clojure.string.split.cljs$core$IFn$_invoke$arity$2(st_el,/@/):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,st_el], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20367,(0),null);
var flc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20367,(1),null);
var vec__20370 = cljs.stacktrace.parse_file_line_column(flc);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20370,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20370,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20370,(2),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = file;
if(cljs.core.truth_(and__4174__auto__)){
var and__4174__auto____$1 = function$;
if(cljs.core.truth_(and__4174__auto____$1)){
...
var vec__20393 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/:/);
var file_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20393,(0),null);
var line_fn_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20393,(1),null);
var file = clojure.string.replace(file_side,/\s+at\s+/,"");
var vec__20396 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(line_fn_side,/\s+/);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20396,(0),null);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20396,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"graaljs","graaljs",1880468686),(function (repl_env,st,err,p__20420){
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"nodejs","nodejs",321212524),(function (repl_env,st,err,p__20440){
...
var vec__20461 = ((((2) === cljs.core.count(parts)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(parts),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(cljs.core.second(parts),(1),(cljs.core.count(cljs.core.second(parts)) - (1)))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.first(parts)], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20461,(0),null);
var file_AMPERSAND_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20461,(1),null);
var vec__20464 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_AMPERSAND_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20464,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20464,(1),null);
var col_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20464,(2),null);
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"file","file",-1269645878),(cljs.core.truth_(function$)?(function (){var G__20467 = file_part;
if(cljs.core.truth_(output_dir)){
return clojure.string.replace(G__20467,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(output_dir),"/"].join(''),"");
} else {
return G__20467;
}
...
var _STAR_print_newline_STAR__orig_val__20484_20541 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__20485_20542 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__20486_20543 = true;
var _STAR_print_fn_STAR__temp_val__20487_20544 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__20486_20543);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__20487_20544);

try{var seq__20488_20545 = cljs.core.seq(cljs.stacktrace.mapped_stacktrace.cljs$core$IFn$_invoke$arity$3(stacktrace,sms,opts));
var chunk__20489_20546 = null;
var count__20490_20547 = (0);
var i__20491_20548 = (0);
while(true){
if((i__20491_20548 < count__20490_20547)){
var map__20496_20549 = chunk__20489_20546.cljs$core$IIndexed$_nth$arity$2(null,i__20491_20548);
var map__20496_20550__$1 = (((((!((map__20496_20549 == null))))?(((((map__20496_20549.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20496_20549.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20496_20549):map__20496_20549);
var function_20551 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496_20550__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20552 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496_20550__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20553 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496_20550__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20554 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496_20550__$1,new cljs.core.Keyword(null,"column","column",2078222095));
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\t",[(cljs.core.truth_(function_20551)?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(function_20551)," "].join(''):null),"(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(file_20552),(cljs.core.truth_(line_20553)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_20553)].join(''):null),(cljs.core.truth_(column_20554)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_20554)].join(''):null),")"].join('')], 0));


var G__20557 = seq__20488_20545;
var G__20558 = chunk__20489_20546;
var G__20559 = count__20490_20547;
var G__20560 = (i__20491_20548 + (1));
seq__20488_20545 = G__20557;
chunk__20489_20546 = G__20558;
count__20490_20547 = G__20559;
i__20491_20548 = G__20560;
continue;
} else {
var temp__5735__auto___20561 = cljs.core.seq(seq__20488_20545);
if(temp__5735__auto___20561){
var seq__20488_20562__$1 = temp__5735__auto___20561;
if(cljs.core.chunked_seq_QMARK_(seq__20488_20562__$1)){
var c__4609__auto___20564 = cljs.core.chunk_first(seq__20488_20562__$1);
var G__20565 = cljs.core.chunk_rest(seq__20488_20562__$1);
var G__20566 = c__4609__auto___20564;
var G__20567 = cljs.core.count(c__4609__auto___20564);
var G__20568 = (0);
seq__20488_20545 = G__20565;
chunk__20489_20546 = G__20566;
count__20490_20547 = G__20567;
i__20491_20548 = G__20568;
continue;
} else {
var map__20498_20569 = cljs.core.first(seq__20488_20562__$1);
var map__20498_20570__$1 = (((((!((map__20498_20569 == null))))?(((((map__20498_20569.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20498_20569.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20498_20569):map__20498_20569);
var function_20571 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20498_20570__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20572 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20498_20570__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20573 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20498_20570__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20574 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20498_20570__$1,new cljs.core.Keyword(null,"column","column",2078222095));
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\t",[(cljs.core.truth_(function_20571)?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(function_20571)," "].join(''):null),"(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(file_20572),(cljs.core.truth_(line_20573)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_20573)].join(''):null),(cljs.core.truth_(column_20574)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_20574)].join(''):null),")"].join('')], 0));


var G__20576 = cljs.core.next(seq__20488_20562__$1);
var G__20577 = null;
var G__20578 = (0);
var G__20579 = (0);
seq__20488_20545 = G__20576;
chunk__20489_20546 = G__20577;
count__20490_20547 = G__20578;
i__20491_20548 = G__20579;
continue;
}
} else {
}
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__20485_20542);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__20484_20541);
}
