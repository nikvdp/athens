...
var vec__47584 = cljs.core.rest(expr);
var seq__47585 = cljs.core.seq(vec__47584);
var first__47586 = cljs.core.first(seq__47585);
var seq__47585__$1 = cljs.core.next(seq__47585);
var vec__47587 = first__47586;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47587,(0),null);
var form = seq__47585__$1;
...
var G__47590 = x;
var G__47590__$1 = (((G__47590 == null))?null:spec_tools.impl.polish(G__47590));
var G__47590__$2 = (((G__47590__$1 == null))?null:cljs.core.name(G__47590__$1));
if((G__47590__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47590__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47591 = x;
var G__47591__$1 = (((G__47591 == null))?null:cljs.core.name(G__47591));
if((G__47591__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47591__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47592){
var map__47593 = p__47592;
var map__47593__$1 = (((((!((map__47593 == null))))?(((((map__47593.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47593.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47593):map__47593);
var data = map__47593__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47593__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47593__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47593__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47593__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47595){
...
var data = map__47596__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47596__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47596__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47598 = data;
var G__47598__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47598,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47598);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47598__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47598__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47602 = form;
var G__47602__$1 = (((G__47602 == null))?null:cljs.core.rest(G__47602));
if((G__47602__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47602__$1);
}
})();
var G__47603 = m;
var G__47603__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47603,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47599_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47599_SHARP_)));
})):G__47603);
var G__47603__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47603__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47600_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47600_SHARP_)));
})):G__47603__$1);
var G__47603__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47603__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47601_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47601_SHARP_));
})):G__47603__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47603__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47604 = (function (){var G__47605 = form;
var G__47605__$1 = (((G__47605 == null))?null:cljs.core.rest(G__47605));
if((G__47605__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47605__$1);
}
})();
var map__47604__$1 = (((((!((map__47604 == null))))?(((((map__47604.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47604.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47604):map__47604);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47604__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47604__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47604__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47604__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47607 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47607) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47608 = form;
var G__47608__$1 = (((G__47608 == null))?null:cljs.core.seq(G__47608));
var G__47608__$2 = (((G__47608__$1 == null))?null:cljs.core.first(G__47608__$1));
if((G__47608__$2 == null)){
return null;
} else {
var fexpr__47609 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47609.cljs$core$IFn$_invoke$arity$1 ? fexpr__47609.cljs$core$IFn$_invoke$arity$1(G__47608__$2) : fexpr__47609.call(null,G__47608__$2));
}
})():null));
});
/**
...
var len__4789__auto___47630 = arguments.length;
var i__4790__auto___47631 = (0);
while(true){
if((i__4790__auto___47631 < len__4789__auto___47630)){
args__4795__auto__.push((arguments[i__4790__auto___47631]));

var G__47632 = (i__4790__auto___47631 + (1));
i__4790__auto___47631 = G__47632;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47610){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47610));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47611){
var vec__47612 = p__47611;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47612,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47612,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47617){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47618__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47618__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47618__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47618__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47615_SHARP_){
return cljs.core.map_QMARK_(p1__47615_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47616_SHARP_){
return cljs.core.contains_QMARK_(p1__47616_SHARP_,x);
});
}),req_keys));
