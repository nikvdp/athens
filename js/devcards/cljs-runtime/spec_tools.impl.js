...
var vec__52752 = cljs.core.rest(expr);
var seq__52753 = cljs.core.seq(vec__52752);
var first__52754 = cljs.core.first(seq__52753);
var seq__52753__$1 = cljs.core.next(seq__52753);
var vec__52755 = first__52754;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52755,(0),null);
var form = seq__52753__$1;
...
var G__52758 = x;
var G__52758__$1 = (((G__52758 == null))?null:spec_tools.impl.polish(G__52758));
var G__52758__$2 = (((G__52758__$1 == null))?null:cljs.core.name(G__52758__$1));
if((G__52758__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52758__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__52759 = x;
var G__52759__$1 = (((G__52759 == null))?null:cljs.core.name(G__52759));
if((G__52759__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52759__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__52760){
var map__52761 = p__52760;
var map__52761__$1 = (((((!((map__52761 == null))))?(((((map__52761.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52761.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52761):map__52761);
var data = map__52761__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52761__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52761__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52761__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52761__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__52763){
...
var data = map__52764__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52764__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52764__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__52766 = data;
var G__52766__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52766,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__52766);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52766__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__52766__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__52770 = form;
var G__52770__$1 = (((G__52770 == null))?null:cljs.core.rest(G__52770));
if((G__52770__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__52770__$1);
}
})();
var G__52771 = m;
var G__52771__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52771,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__52767_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52767_SHARP_)));
})):G__52771);
var G__52771__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52771__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__52768_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52768_SHARP_)));
})):G__52771__$1);
var G__52771__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52771__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__52769_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__52769_SHARP_));
})):G__52771__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__52771__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__52772 = (function (){var G__52773 = form;
var G__52773__$1 = (((G__52773 == null))?null:cljs.core.rest(G__52773));
if((G__52773__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__52773__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52772__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52772__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52772__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52772__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__52775 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__52775) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__52776 = form;
var G__52776__$1 = (((G__52776 == null))?null:cljs.core.seq(G__52776));
var G__52776__$2 = (((G__52776__$1 == null))?null:cljs.core.first(G__52776__$1));
if((G__52776__$2 == null)){
return null;
} else {
var fexpr__52777 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__52777.cljs$core$IFn$_invoke$arity$1 ? fexpr__52777.cljs$core$IFn$_invoke$arity$1(G__52776__$2) : fexpr__52777.call(null,G__52776__$2));
}
})():null));
});
/**
...
var len__4789__auto___52798 = arguments.length;
var i__4790__auto___52799 = (0);
while(true){
if((i__4790__auto___52799 < len__4789__auto___52798)){
args__4795__auto__.push((arguments[i__4790__auto___52799]));

var G__52800 = (i__4790__auto___52799 + (1));
i__4790__auto___52799 = G__52800;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq52778){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq52778));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52779){
var vec__52780 = p__52779;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52780,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52780,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__52785){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52786__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52786__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52786__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52786__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__52783_SHARP_){
return cljs.core.map_QMARK_(p1__52783_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__52784_SHARP_){
return cljs.core.contains_QMARK_(p1__52784_SHARP_,x);
});
}),req_keys));
