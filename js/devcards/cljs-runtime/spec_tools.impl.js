...
var vec__47329 = cljs.core.rest(expr);
...
var vec__47332 = first__47331;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47332,(0),null);
var form = seq__47330__$1;
...
var G__47335 = x;
var G__47335__$1 = (((G__47335 == null))?null:spec_tools.impl.polish(G__47335));
var G__47335__$2 = (((G__47335__$1 == null))?null:cljs.core.name(G__47335__$1));
if((G__47335__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47335__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47336 = x;
var G__47336__$1 = (((G__47336 == null))?null:cljs.core.name(G__47336));
if((G__47336__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47336__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47337){
...
var data = map__47338__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47338__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47338__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47338__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47338__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47340){
...
var G__47343 = data;
var G__47343__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47343,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47343);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47343__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47343__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47347 = form;
var G__47347__$1 = (((G__47347 == null))?null:cljs.core.rest(G__47347));
if((G__47347__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47347__$1);
}
})();
var G__47348 = m;
var G__47348__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47348,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47344_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47344_SHARP_)));
})):G__47348);
var G__47348__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47348__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47345_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47345_SHARP_)));
})):G__47348__$1);
var G__47348__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47348__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47346_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47346_SHARP_));
})):G__47348__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47348__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47349 = (function (){var G__47350 = form;
var G__47350__$1 = (((G__47350 == null))?null:cljs.core.rest(G__47350));
if((G__47350__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47350__$1);
}
})();
var map__47349__$1 = (((((!((map__47349 == null))))?(((((map__47349.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47349.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47349):map__47349);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47349__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47349__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47349__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47349__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47352 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47352) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47353 = form;
var G__47353__$1 = (((G__47353 == null))?null:cljs.core.seq(G__47353));
var G__47353__$2 = (((G__47353__$1 == null))?null:cljs.core.first(G__47353__$1));
if((G__47353__$2 == null)){
return null;
} else {
var fexpr__47354 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47354.cljs$core$IFn$_invoke$arity$1 ? fexpr__47354.cljs$core$IFn$_invoke$arity$1(G__47353__$2) : fexpr__47354.call(null,G__47353__$2));
}
})():null));
});
/**
...
var len__4789__auto___47375 = arguments.length;
var i__4790__auto___47376 = (0);
while(true){
if((i__4790__auto___47376 < len__4789__auto___47375)){
args__4795__auto__.push((arguments[i__4790__auto___47376]));

var G__47377 = (i__4790__auto___47376 + (1));
i__4790__auto___47376 = G__47377;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47355){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47355));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47356){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47362){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47363__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47363__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47363__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47363__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47360_SHARP_){
return cljs.core.map_QMARK_(p1__47360_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47361_SHARP_){
return cljs.core.contains_QMARK_(p1__47361_SHARP_,x);
});
}),req_keys));
