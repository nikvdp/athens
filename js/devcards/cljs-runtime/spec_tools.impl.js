...
var vec__52802 = cljs.core.rest(expr);
var seq__52803 = cljs.core.seq(vec__52802);
var first__52804 = cljs.core.first(seq__52803);
var seq__52803__$1 = cljs.core.next(seq__52803);
var vec__52805 = first__52804;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52805,(0),null);
var form = seq__52803__$1;
...
var G__52808 = x;
var G__52808__$1 = (((G__52808 == null))?null:spec_tools.impl.polish(G__52808));
var G__52808__$2 = (((G__52808__$1 == null))?null:cljs.core.name(G__52808__$1));
if((G__52808__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52808__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__52809 = x;
var G__52809__$1 = (((G__52809 == null))?null:cljs.core.name(G__52809));
if((G__52809__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52809__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__52810){
var map__52811 = p__52810;
var map__52811__$1 = (((((!((map__52811 == null))))?(((((map__52811.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52811.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52811):map__52811);
var data = map__52811__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52811__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52811__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52811__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52811__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__52813){
var map__52814 = p__52813;
var map__52814__$1 = (((((!((map__52814 == null))))?(((((map__52814.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52814.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52814):map__52814);
var data = map__52814__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52814__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52814__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__52816 = data;
var G__52816__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52816,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__52816);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52816__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__52816__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__52820 = form;
var G__52820__$1 = (((G__52820 == null))?null:cljs.core.rest(G__52820));
if((G__52820__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__52820__$1);
}
})();
var G__52821 = m;
var G__52821__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52821,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__52817_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52817_SHARP_)));
})):G__52821);
var G__52821__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52821__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__52818_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52818_SHARP_)));
})):G__52821__$1);
var G__52821__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52821__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__52819_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__52819_SHARP_));
})):G__52821__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__52821__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__52822 = (function (){var G__52823 = form;
var G__52823__$1 = (((G__52823 == null))?null:cljs.core.rest(G__52823));
if((G__52823__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__52823__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52822__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52822__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52822__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52822__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__52825 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__52825) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__52826 = form;
var G__52826__$1 = (((G__52826 == null))?null:cljs.core.seq(G__52826));
var G__52826__$2 = (((G__52826__$1 == null))?null:cljs.core.first(G__52826__$1));
if((G__52826__$2 == null)){
return null;
} else {
var fexpr__52827 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__52827.cljs$core$IFn$_invoke$arity$1 ? fexpr__52827.cljs$core$IFn$_invoke$arity$1(G__52826__$2) : fexpr__52827.call(null,G__52826__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq52828){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq52828));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52829){
var vec__52830 = p__52829;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52830,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52830,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__52835){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52836__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52836__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52836__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52836__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__52833_SHARP_){
return cljs.core.map_QMARK_(p1__52833_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__52834_SHARP_){
return cljs.core.contains_QMARK_(p1__52834_SHARP_,x);
});
}),req_keys));
