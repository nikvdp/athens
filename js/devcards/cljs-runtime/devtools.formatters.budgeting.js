...
var o__20613__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20613__auto__["add"]).call(o__20613__auto__,value);
}
});
...
var o__20613__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20613__auto__["delete"]).call(o__20613__auto__,value);
}
});
...
var o__20613__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20613__auto__["has"]).call(o__20613__auto__,value);
}
});
...
var G__24105 = data;
var target__20622__auto__ = G__24105;
if(cljs.core.truth_(target__20622__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24105)].join(''),"\n","target__20622__auto__"].join('')));
}

(target__20622__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
...
var item_24138 = cljs.core.first(seq__24109_24130__$1);
(devtools.formatters.budgeting.distribute_budget_BANG_.cljs$core$IFn$_invoke$arity$2 ? devtools.formatters.budgeting.distribute_budget_BANG_.cljs$core$IFn$_invoke$arity$2(item_24138,new_depth_budget_24119) : devtools.formatters.budgeting.distribute_budget_BANG_.call(null,item_24138,new_depth_budget_24119));


var G__24140 = cljs.core.next(seq__24109_24130__$1);
var G__24141 = null;
var G__24142 = (0);
var G__24143 = (0);
