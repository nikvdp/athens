...
var len__4789__auto___42082 = arguments.length;
var i__4790__auto___42083 = (0);
while(true){
if((i__4790__auto___42083 < len__4789__auto___42082)){
args__4795__auto__.push((arguments[i__4790__auto___42083]));

var G__42084 = (i__4790__auto___42083 + (1));
i__4790__auto___42083 = G__42084;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq41947){
var G__41948 = cljs.core.first(seq41947);
var seq41947__$1 = cljs.core.next(seq41947);
var G__41949 = cljs.core.first(seq41947__$1);
var seq41947__$2 = cljs.core.next(seq41947__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41948,G__41949,seq41947__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41955__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41955__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41955__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41954_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__41954_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41984 = cljs.core.get_global_hierarchy;
return (fexpr__41984.cljs$core$IFn$_invoke$arity$0 ? fexpr__41984.cljs$core$IFn$_invoke$arity$0() : fexpr__41984.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__41987 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41987) : formatter_fn.call(null,G__41987));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__41990 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41990) : formatter_fn.call(null,G__41990));
})()], 0));
});
...
var temp__5735__auto___42085 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42085)){
var message_42086 = temp__5735__auto___42085;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42086], 0));
} else {
}
...
var temp__5735__auto___42088 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42088)){
var message_42089 = temp__5735__auto___42088;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42089], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__42026 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__42026,"/"].join('');
} else {
return G__42026;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__42039 = exception.stack;
var G__42039__$1 = (((G__42039 == null))?null:clojure.string.split_lines(G__42039));
var G__42039__$2 = (((G__42039__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__42039__$1,depth));
if((G__42039__$2 == null)){
return null;
} else {
return clojure.string.trim(G__42039__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__42041 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42041,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42041,(1),null);
var vec__42044 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42044,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42044,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42044,(2),null);
...
var m__$1 = (function (){var G__42047 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42049 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__42050 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__42050) : cljs.test.run_block.call(null,G__42050));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__42049) : obj.call(null,G__42049));
} else {
var G__42108 = (function (){var G__42051 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__42051);
} else {
return G__42051;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__42052,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__42055 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__42055) : f1.call(null,G__42055));
});
});
/**
...
var temp__5735__auto___42119 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42119)){
var t_42120 = temp__5735__auto___42119;
var G__42078_42121 = ((function (seq__42072,chunk__42073,count__42074,i__42075,t_42120,temp__5735__auto___42119,v,each_fixture_fn,G__42069,G__42069__$1,env,once_fixtures,each_fixtures,vec__42066,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42120)));
});})(seq__42072,chunk__42073,count__42074,i__42075,t_42120,temp__5735__auto___42119,v,each_fixture_fn,G__42069,G__42069__$1,env,once_fixtures,each_fixtures,vec__42066,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42078_42121) : each_fixture_fn.call(null,G__42078_42121));
} else {
}


var G__42125 = seq__42072;
var G__42126 = chunk__42073;
var G__42127 = count__42074;
var G__42128 = (i__42075 + (1));
seq__42072 = G__42125;
chunk__42073 = G__42126;
count__42074 = G__42127;
i__42075 = G__42128;
continue;
} else {
...
var G__42129 = cljs.core.chunk_rest(seq__42072__$1);
var G__42130 = c__4609__auto__;
var G__42131 = cljs.core.count(c__4609__auto__);
var G__42132 = (0);
seq__42072 = G__42129;
chunk__42073 = G__42130;
count__42074 = G__42131;
i__42075 = G__42132;
continue;
} else {
var v = cljs.core.first(seq__42072__$1);
var temp__5735__auto___42133__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42133__$1)){
var t_42134 = temp__5735__auto___42133__$1;
var G__42079_42136 = ((function (seq__42072,chunk__42073,count__42074,i__42075,t_42134,temp__5735__auto___42133__$1,v,seq__42072__$1,temp__5735__auto__,each_fixture_fn,G__42069,G__42069__$1,env,once_fixtures,each_fixtures,vec__42066,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42134)));
});})(seq__42072,chunk__42073,count__42074,i__42075,t_42134,temp__5735__auto___42133__$1,v,seq__42072__$1,temp__5735__auto__,each_fixture_fn,G__42069,G__42069__$1,env,once_fixtures,each_fixtures,vec__42066,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42079_42136) : each_fixture_fn.call(null,G__42079_42136));
} else {
}


var G__42138 = cljs.core.next(seq__42072__$1);
var G__42139 = null;
var G__42140 = (0);
var G__42141 = (0);
seq__42072 = G__42138;
chunk__42073 = G__42139;
count__42074 = G__42140;
i__42075 = G__42141;
continue;
}
} else {
...
var G__42080 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__42080) : cljs.test.report.call(null,G__42080));
})], null)));
});
/**
