...
var G__41949 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__41949,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__41949;
}
}));
...
var len__4789__auto___42097 = arguments.length;
var i__4790__auto___42098 = (0);
while(true){
if((i__4790__auto___42098 < len__4789__auto___42097)){
args__4795__auto__.push((arguments[i__4790__auto___42098]));

var G__42099 = (i__4790__auto___42098 + (1));
i__4790__auto___42098 = G__42099;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq41953){
var G__41954 = cljs.core.first(seq41953);
var seq41953__$1 = cljs.core.next(seq41953);
var G__41955 = cljs.core.first(seq41953__$1);
var seq41953__$2 = cljs.core.next(seq41953__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41954,G__41955,seq41953__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41970__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41970__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41970__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41969_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__41969_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41999 = cljs.core.get_global_hierarchy;
return (fexpr__41999.cljs$core$IFn$_invoke$arity$0 ? fexpr__41999.cljs$core$IFn$_invoke$arity$0() : fexpr__41999.call(null));
})());
...
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__42001 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__42001) : formatter_fn.call(null,G__42001));
})()], 0));
});
...
var temp__5735__auto___42100 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42100)){
var message_42101 = temp__5735__auto___42100;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42101], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__42033 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__42033,"/"].join('');
} else {
return G__42033;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__42045 = exception.stack;
var G__42045__$1 = (((G__42045 == null))?null:clojure.string.split_lines(G__42045));
var G__42045__$2 = (((G__42045__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__42045__$1,depth));
if((G__42045__$2 == null)){
return null;
} else {
return clojure.string.trim(G__42045__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__42048 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42048,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42048,(1),null);
var vec__42051 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42051,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42051,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42051,(2),null);
...
var G__42064 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__42065 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__42065) : cljs.test.run_block.call(null,G__42065));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__42064) : obj.call(null,G__42064));
} else {
var G__42121 = (function (){var G__42066 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__42066);
} else {
return G__42066;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__42067,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__42070 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__42070) : f1.call(null,G__42070));
});
});
/**
...
var vec__42071 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42071,(0),null);
var types = vec__42071;
...
var G__42075 = type;
var G__42076 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__42074 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__42074.cljs$core$IFn$_invoke$arity$2 ? fexpr__42074.cljs$core$IFn$_invoke$arity$2(G__42075,G__42076) : fexpr__42074.call(null,G__42075,G__42076));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__42080){
var vec__42081 = p__42080;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42081,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42081,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__42084 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var seq__42087 = cljs.core.seq(vars__$1);
var chunk__42088 = null;
var count__42089 = (0);
var i__42090 = (0);
while(true){
if((i__42090 < count__42089)){
var v = chunk__42088.cljs$core$IIndexed$_nth$arity$2(null,i__42090);
var temp__5735__auto___42132 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42132)){
var t_42134 = temp__5735__auto___42132;
var G__42093_42135 = ((function (seq__42087,chunk__42088,count__42089,i__42090,t_42134,temp__5735__auto___42132,v,each_fixture_fn,G__42084,G__42084__$1,env,once_fixtures,each_fixtures,vec__42081,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42134)));
});})(seq__42087,chunk__42088,count__42089,i__42090,t_42134,temp__5735__auto___42132,v,each_fixture_fn,G__42084,G__42084__$1,env,once_fixtures,each_fixtures,vec__42081,ns,vars__$1))
;
...
var G__42136 = seq__42087;
var G__42137 = chunk__42088;
var G__42138 = count__42089;
var G__42139 = (i__42090 + (1));
seq__42087 = G__42136;
...
var G__42141 = cljs.core.chunk_rest(seq__42087__$1);
var G__42142 = c__4609__auto__;
var G__42143 = cljs.core.count(c__4609__auto__);
var G__42144 = (0);
seq__42087 = G__42141;
chunk__42088 = G__42142;
count__42089 = G__42143;
i__42090 = G__42144;
continue;
} else {
var v = cljs.core.first(seq__42087__$1);
var temp__5735__auto___42146__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42146__$1)){
var t_42148 = temp__5735__auto___42146__$1;
var G__42094_42149 = ((function (seq__42087,chunk__42088,count__42089,i__42090,t_42148,temp__5735__auto___42146__$1,v,seq__42087__$1,temp__5735__auto__,each_fixture_fn,G__42084,G__42084__$1,env,once_fixtures,each_fixtures,vec__42081,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42148)));
});})(seq__42087,chunk__42088,count__42089,i__42090,t_42148,temp__5735__auto___42146__$1,v,seq__42087__$1,temp__5735__auto__,each_fixture_fn,G__42084,G__42084__$1,env,once_fixtures,each_fixtures,vec__42081,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42094_42149) : each_fixture_fn.call(null,G__42094_42149));
} else {
}


var G__42151 = cljs.core.next(seq__42087__$1);
var G__42152 = null;
var G__42153 = (0);
var G__42154 = (0);
seq__42087 = G__42151;
chunk__42088 = G__42152;
count__42089 = G__42153;
i__42090 = G__42154;
continue;
}
} else {
...
var fexpr__42085 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__42085.cljs$core$IFn$_invoke$arity$1 ? fexpr__42085.cljs$core$IFn$_invoke$arity$1(G__42086) : fexpr__42085.call(null,G__42086));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42084__$1)].join('')));
...
var G__42095 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__42095) : cljs.test.report.call(null,G__42095));
})], null)));
});
/**
