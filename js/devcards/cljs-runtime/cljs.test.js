...
var G__42024 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__42024,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__42024;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42029){
var G__42030 = cljs.core.first(seq42029);
var seq42029__$1 = cljs.core.next(seq42029);
var G__42031 = cljs.core.first(seq42029__$1);
var seq42029__$2 = cljs.core.next(seq42029__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42030,G__42031,seq42029__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42041__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42041__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42041__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42040_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__42040_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42043 = cljs.core.get_global_hierarchy;
return (fexpr__42043.cljs$core$IFn$_invoke$arity$0 ? fexpr__42043.cljs$core$IFn$_invoke$arity$0() : fexpr__42043.call(null));
})());
...
var temp__5735__auto___42115 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42115)){
var message_42116 = temp__5735__auto___42115;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42116], 0));
} else {
}
...
var temp__5735__auto___42119 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42119)){
var message_42120 = temp__5735__auto___42119;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42120], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__42049 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__42049,"/"].join('');
} else {
return G__42049;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__42051 = exception.stack;
var G__42051__$1 = (((G__42051 == null))?null:clojure.string.split_lines(G__42051));
var G__42051__$2 = (((G__42051__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__42051__$1,depth));
if((G__42051__$2 == null)){
return null;
} else {
return clojure.string.trim(G__42051__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__42052 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42052,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42052,(1),null);
var vec__42055 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42055,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42055,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42055,(2),null);
...
var m__$1 = (function (){var G__42058 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42132 = (function (){var G__42062 = cljs.core.rest(fns);
...
var G__42088_42143 = ((function (seq__42080,chunk__42081,count__42082,i__42083,t_42142,temp__5735__auto___42141,v,each_fixture_fn,G__42077,G__42077__$1,env,once_fixtures,each_fixtures,vec__42074,ns,vars__$1){
return (function (){
...
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42088_42143) : each_fixture_fn.call(null,G__42088_42143));
} else {
}
...
var G__42092_42154 = ((function (seq__42080,chunk__42081,count__42082,i__42083,t_42153,temp__5735__auto___42152__$1,v,seq__42080__$1,temp__5735__auto__,each_fixture_fn,G__42077,G__42077__$1,env,once_fixtures,each_fixtures,vec__42074,ns,vars__$1){
return (function (){
...
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42092_42154) : each_fixture_fn.call(null,G__42092_42154));
} else {
}
...
var G__42096 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__42096) : cljs.test.report.call(null,G__42096));
})], null)));
});
/**
