...
var G__41490 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__41490,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__41490;
}
}));
...
var len__4789__auto___41564 = arguments.length;
var i__4790__auto___41565 = (0);
while(true){
if((i__4790__auto___41565 < len__4789__auto___41564)){
args__4795__auto__.push((arguments[i__4790__auto___41565]));

var G__41566 = (i__4790__auto___41565 + (1));
i__4790__auto___41565 = G__41566;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq41491){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41492,G__41493,seq41491__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41495__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41495__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41495__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41494_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__41494_SHARP_));
...
var temp__5735__auto___41574 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___41574)){
var message_41576 = temp__5735__auto___41574;
...
var temp__5735__auto___41578 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___41578)){
var message_41579 = temp__5735__auto___41578;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_41579], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__41503 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__41503,"/"].join('');
} else {
return G__41503;
}
})();
...
var G__41592 = (function (){var G__41516 = cljs.core.rest(fns);
...
var vec__41522 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41522,(0),null);
var types = vec__41522;
...
var G__41526 = type;
var G__41527 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__41525 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__41525.cljs$core$IFn$_invoke$arity$2 ? fexpr__41525.cljs$core$IFn$_invoke$arity$2(G__41526,G__41527) : fexpr__41525.call(null,G__41526,G__41527));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41530){
var vec__41531 = p__41530;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41531,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41531,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__41536 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var G__41540 = (function (){
var seq__41542 = cljs.core.seq(vars__$1);
var chunk__41543 = null;
var count__41544 = (0);
var i__41545 = (0);
while(true){
if((i__41545 < count__41544)){
var v = chunk__41543.cljs$core$IIndexed$_nth$arity$2(null,i__41545);
...
var G__41552_41597 = ((function (seq__41542,chunk__41543,count__41544,i__41545,t_41596,temp__5735__auto___41595,v,each_fixture_fn,G__41536,G__41536__$1,env,once_fixtures,each_fixtures,vec__41531,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_41596)));
});})(seq__41542,chunk__41543,count__41544,i__41545,t_41596,temp__5735__auto___41595,v,each_fixture_fn,G__41536,G__41536__$1,env,once_fixtures,each_fixtures,vec__41531,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__41552_41597) : each_fixture_fn.call(null,G__41552_41597));
} else {
}


var G__41598 = seq__41542;
var G__41599 = chunk__41543;
var G__41600 = count__41544;
var G__41601 = (i__41545 + (1));
seq__41542 = G__41598;
chunk__41543 = G__41599;
count__41544 = G__41600;
i__41545 = G__41601;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__41542);
if(temp__5735__auto__){
var seq__41542__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41542__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__41542__$1);
var G__41602 = cljs.core.chunk_rest(seq__41542__$1);
var G__41603 = c__4609__auto__;
var G__41604 = cljs.core.count(c__4609__auto__);
var G__41605 = (0);
seq__41542 = G__41602;
chunk__41543 = G__41603;
count__41544 = G__41604;
i__41545 = G__41605;
continue;
} else {
var v = cljs.core.first(seq__41542__$1);
...
var G__41555_41608 = ((function (seq__41542,chunk__41543,count__41544,i__41545,t_41607,temp__5735__auto___41606__$1,v,seq__41542__$1,temp__5735__auto__,each_fixture_fn,G__41536,G__41536__$1,env,once_fixtures,each_fixtures,vec__41531,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_41607)));
});})(seq__41542,chunk__41543,count__41544,i__41545,t_41607,temp__5735__auto___41606__$1,v,seq__41542__$1,temp__5735__auto__,each_fixture_fn,G__41536,G__41536__$1,env,once_fixtures,each_fixtures,vec__41531,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__41555_41608) : each_fixture_fn.call(null,G__41555_41608));
} else {
}


var G__41609 = cljs.core.next(seq__41542__$1);
var G__41610 = null;
var G__41611 = (0);
var G__41612 = (0);
seq__41542 = G__41609;
chunk__41543 = G__41610;
count__41544 = G__41611;
i__41545 = G__41612;
continue;
}
} else {
...
var fexpr__41539 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__41539.cljs$core$IFn$_invoke$arity$1 ? fexpr__41539.cljs$core$IFn$_invoke$arity$1(G__41540) : fexpr__41539.call(null,G__41540));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41536__$1)].join('')));
...
var G__41559 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__41559) : cljs.test.report.call(null,G__41559));
})], null)));
});
/**
