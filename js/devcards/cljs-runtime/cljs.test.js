...
var G__42194 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__42194,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__42194;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42198){
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42217__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42217__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42217__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42214_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__42214_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42246 = cljs.core.get_global_hierarchy;
return (fexpr__42246.cljs$core$IFn$_invoke$arity$0 ? fexpr__42246.cljs$core$IFn$_invoke$arity$0() : fexpr__42246.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__42248 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__42248) : formatter_fn.call(null,G__42248));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__42249 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__42249) : formatter_fn.call(null,G__42249));
})()], 0));
});
...
var temp__5735__auto___42348 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___42348)){
var message_42349 = temp__5735__auto___42348;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_42349], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__42289 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__42289,"/"].join('');
} else {
return G__42289;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__42299 = exception.stack;
var G__42299__$1 = (((G__42299 == null))?null:clojure.string.split_lines(G__42299));
var G__42299__$2 = (((G__42299__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__42299__$1,depth));
if((G__42299__$2 == null)){
return null;
} else {
return clojure.string.trim(G__42299__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__42302 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42302,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42302,(1),null);
var vec__42305 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42305,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42305,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42305,(2),null);
...
var G__42371 = (function (){var G__42314 = cljs.core.rest(fns);
...
return (function (g){
var G__42318 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__42318) : f1.call(null,G__42318));
});
});
/**
...
var temp__5735__auto___42385 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42385)){
var t_42386 = temp__5735__auto___42385;
var G__42341_42387 = ((function (seq__42335,chunk__42336,count__42337,i__42338,t_42386,temp__5735__auto___42385,v,each_fixture_fn,G__42332,G__42332__$1,env,once_fixtures,each_fixtures,vec__42329,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42386)));
});})(seq__42335,chunk__42336,count__42337,i__42338,t_42386,temp__5735__auto___42385,v,each_fixture_fn,G__42332,G__42332__$1,env,once_fixtures,each_fixtures,vec__42329,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42341_42387) : each_fixture_fn.call(null,G__42341_42387));
} else {
}


var G__42389 = seq__42335;
var G__42390 = chunk__42336;
var G__42391 = count__42337;
var G__42392 = (i__42338 + (1));
seq__42335 = G__42389;
chunk__42336 = G__42390;
count__42337 = G__42391;
i__42338 = G__42392;
continue;
} else {
...
var G__42394 = cljs.core.chunk_rest(seq__42335__$1);
var G__42395 = c__4609__auto__;
var G__42396 = cljs.core.count(c__4609__auto__);
var G__42397 = (0);
seq__42335 = G__42394;
...
var temp__5735__auto___42398__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42398__$1)){
var t_42399 = temp__5735__auto___42398__$1;
var G__42342_42400 = ((function (seq__42335,chunk__42336,count__42337,i__42338,t_42399,temp__5735__auto___42398__$1,v,seq__42335__$1,temp__5735__auto__,each_fixture_fn,G__42332,G__42332__$1,env,once_fixtures,each_fixtures,vec__42329,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42399)));
});})(seq__42335,chunk__42336,count__42337,i__42338,t_42399,temp__5735__auto___42398__$1,v,seq__42335__$1,temp__5735__auto__,each_fixture_fn,G__42332,G__42332__$1,env,once_fixtures,each_fixtures,vec__42329,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42342_42400) : each_fixture_fn.call(null,G__42342_42400));
} else {
}


var G__42403 = cljs.core.next(seq__42335__$1);
var G__42404 = null;
var G__42405 = (0);
var G__42406 = (0);
seq__42335 = G__42403;
