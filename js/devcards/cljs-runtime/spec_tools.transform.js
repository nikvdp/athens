...
if((x instanceof cljs.core.Keyword)){
var G__51831 = spec;
var G__51832 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__51831,G__51832) : f.call(null,G__51831,G__51832));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__51833 = spec;
var G__51834 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__51833,G__51834) : f.call(null,G__51833,G__51834));
} else {
return x;
...
}catch (e51836){if((e51836 instanceof Error)){
var ___$1 = e51836;
return x;
} else {
throw e51836;
...
}catch (e51837){if((e51837 instanceof Error)){
var ___$1 = e51837;
return x;
} else {
throw e51837;
...
}catch (e51838){if((e51838 instanceof Error)){
var ___$1 = e51838;
return x;
} else {
throw e51838;
...
}catch (e51839){if((e51839 instanceof Error)){
var ___$1 = e51839;
return x;
} else {
throw e51839;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__51840,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51841__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__51843,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51844__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__51846,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51847__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
