...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumb.cljs$lang$applyTo = (function (seq58015){
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028 !== 'undefined')){
} else {
...
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028 = (function (meta58029){
this.meta58029 = meta58029;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58030,meta58029__$1){
var self__ = this;
var _58030__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028(meta58029__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58030){
var self__ = this;
var _58030__$1 = this;
return self__.meta58029;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58029","meta58029",174790051,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58028");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58028");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58028.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58028 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58028(meta58029){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028(meta58029));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58028(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035 = (function (meta58036){
this.meta58036 = meta58036;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58037,meta58036__$1){
var self__ = this;
var _58037__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035(meta58036__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58037){
var self__ = this;
var _58037__$1 = this;
return self__.meta58036;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.getBasis = (function (){
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58035");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58035");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58035.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58035 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58035(meta58036){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035(meta58036));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58035(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
