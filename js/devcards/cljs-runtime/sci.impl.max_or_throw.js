...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57787 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57787(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57770 = (n - (1));
var G__57771 = cljs.core.rest(s);
var G__57772 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57770,G__57771,G__57772) : sci.impl.max_or_throw.take_STAR_.call(null,G__57770,G__57771,G__57772));
})());
} else {
return null;
}
