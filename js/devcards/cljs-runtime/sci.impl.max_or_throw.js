...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57802 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57802(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57790 = (n - (1));
var G__57791 = cljs.core.rest(s);
var G__57792 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57790,G__57791,G__57792) : sci.impl.max_or_throw.take_STAR_.call(null,G__57790,G__57791,G__57792));
})());
} else {
return null;
}
