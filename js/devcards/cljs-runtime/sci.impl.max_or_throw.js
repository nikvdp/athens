...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57763 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57763(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57742 = (n - (1));
var G__57743 = cljs.core.rest(s);
var G__57744 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57742,G__57743,G__57744) : sci.impl.max_or_throw.take_STAR_.call(null,G__57742,G__57743,G__57744));
})());
} else {
return null;
}
