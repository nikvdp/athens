...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57751 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57751(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57737 = (n - (1));
var G__57738 = cljs.core.rest(s);
var G__57739 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57737,G__57738,G__57739) : sci.impl.max_or_throw.take_STAR_.call(null,G__57737,G__57738,G__57739));
})());
} else {
return null;
}
