...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57778 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57778(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57760 = (n - (1));
var G__57761 = cljs.core.rest(s);
var G__57762 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57760,G__57761,G__57762) : sci.impl.max_or_throw.take_STAR_.call(null,G__57760,G__57761,G__57762));
})());
} else {
return null;
}
