...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57741 = (n - (1));
var G__57742 = cljs.core.rest(s);
var G__57743 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57741,G__57742,G__57743) : sci.impl.max_or_throw.take_STAR_.call(null,G__57741,G__57742,G__57743));
})());
} else {
return null;
}
