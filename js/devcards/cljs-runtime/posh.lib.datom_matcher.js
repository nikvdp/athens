...
var G__28986 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__28986)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__28986)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__28986)){
return null;
} else {
...
var G__28995 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__28996 = rest_datom;
var G__28997 = cljs.core.rest(patterns);
var G__28998 = new_patterns;
var G__28999 = leftover_patterns;
entids = G__28995;
rest_datom = G__28996;
patterns = G__28997;
new_patterns = G__28998;
leftover_patterns = G__28999;
continue;
} else {
var G__29002 = entids;
...
var G__29009 = cljs.core.cons(cljs.core.first(leftover_patterns),new_patterns);
var G__29010 = cljs.core.rest(leftover_patterns);
new_patterns = G__29009;
leftover_patterns = G__29010;
continue;
}
}
break;
