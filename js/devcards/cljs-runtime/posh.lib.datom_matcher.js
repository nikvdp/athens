...
return cljs.core.some((function (p1__29231_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__29231_SHARP_);
}),datoms);
...
var G__29236 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__29236)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__29236)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__29236)){
return null;
} else {
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29235_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__29235_SHARP_);
}),datoms);
...
var G__29250 = entids;
var G__29251 = rest_datom;
var G__29252 = cljs.core.rest(patterns);
var G__29253 = new_patterns;
var G__29254 = cljs.core.cons(cljs.core.first(patterns),leftover_patterns);
entids = G__29250;
rest_datom = G__29251;
patterns = G__29252;
