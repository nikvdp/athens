...
var pred__60915 = cljs.core._EQ_;
var expr__60916 = k;
if(cljs.core.truth_((function (){var G__60918 = new cljs.core.Keyword("db","id","db/id",-1388397098);
var G__60919 = expr__60916;
return (pred__60915.cljs$core$IFn$_invoke$arity$2 ? pred__60915.cljs$core$IFn$_invoke$arity$2(G__60918,G__60919) : pred__60915.call(null,G__60918,G__60919));
})())){
var G__60920 = cljs.core.deref(athens.db.dsdb);
var G__60921 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null),new cljs.core.Keyword("block","_children","block/_children",1128070632)], null);
var G__60922 = v;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__60920,G__60921,G__60922) : datascript.core.pull.call(null,G__60920,G__60921,G__60922));
} else {
return v;
}
});
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.devtool.devtool_table_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_table_$_iter__60924(s__60925){
return (new cljs.core.LazySeq(null,(function (){
var s__60925__$1 = s__60925;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60925__$1);
if(temp__5735__auto__){
var s__60925__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60925__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60925__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60927 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60926 = (0);
while(true){
if((i__60926 < size__4581__auto__)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60926);
cljs.core.chunk_append(b__60927,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),h], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),h], null)));

var G__61030 = (i__60926 + (1));
i__60926 = G__61030;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60927),athens$devcards$devtool$data_table_$_iter__60924(cljs.core.chunk_rest(s__60925__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60927),null);
}
} else {
var h = cljs.core.first(s__60925__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),h], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),h], null)),athens$devcards$devtool$data_table_$_iter__60924(cljs.core.rest(s__60925__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_table_$_iter__60928(s__60929){
return (new cljs.core.LazySeq(null,(function (){
...
var row = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60930);
cljs.core.chunk_append(b__60931,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60930,row,c__4580__auto__,size__4581__auto__,b__60931,s__60929__$2,temp__5735__auto__,limit){
return (function (){
...
});})(i__60930,row,c__4580__auto__,size__4581__auto__,b__60931,s__60929__$2,temp__5735__auto__,limit))
], null),(function (){var iter__4582__auto__ = ((function (i__60930,row,c__4580__auto__,size__4581__auto__,b__60931,s__60929__$2,temp__5735__auto__,limit){
return (function athens$devcards$devtool$data_table_$_iter__60928_$_iter__60933(s__60934){
return (new cljs.core.LazySeq(null,((function (i__60930,row,c__4580__auto__,size__4581__auto__,b__60931,s__60929__$2,temp__5735__auto__,limit){
return (function (){
...
var c__4580__auto____$1 = cljs.core.chunk_first(s__60934__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__60936 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__60935 = (0);
while(true){
if((i__60935 < size__4581__auto____$1)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__60935);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60936),athens$devcards$devtool$data_table_$_iter__60928_$_iter__60933(cljs.core.chunk_rest(s__60934__$2)));
} else {
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$devcards$devtool$data_table_$_iter__60928_$_iter__60933(cljs.core.rest(s__60934__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60931),athens$devcards$devtool$data_table_$_iter__60928(cljs.core.chunk_rest(s__60929__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60931),null);
}
} else {
var row = cljs.core.first(s__60929__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (row,s__60929__$2,temp__5735__auto__,limit){
return (function (){
var G__60937 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(row),new cljs.core.Keyword(null,"row-value","row-value",-1067843622).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(row))], null);
return (add_nav_BANG_.cljs$core$IFn$_invoke$arity$1 ? add_nav_BANG_.cljs$core$IFn$_invoke$arity$1(G__60937) : add_nav_BANG_.call(null,G__60937));
});})(row,s__60929__$2,temp__5735__auto__,limit))
], null),(function (){var iter__4582__auto__ = ((function (row,s__60929__$2,temp__5735__auto__,limit){
return (function athens$devcards$devtool$data_table_$_iter__60928_$_iter__60938(s__60939){
return (new cljs.core.LazySeq(null,(function (){
var s__60939__$1 = s__60939;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__60939__$1);
if(temp__5735__auto____$1){
var s__60939__$2 = temp__5735__auto____$1;
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60940);
cljs.core.chunk_append(b__60941,(function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})());

var G__61033 = (i__60940 + (1));
i__60940 = G__61033;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60941),athens$devcards$devtool$data_table_$_iter__60928_$_iter__60938(cljs.core.chunk_rest(s__60939__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60941),null);
}
} else {
var i = cljs.core.first(s__60939__$2);
return cljs.core.cons((function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$devcards$devtool$data_table_$_iter__60928_$_iter__60938(cljs.core.rest(s__60939__$2)));
}
} else {
return null;
}
...
;
return iter__4582__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row], null)),athens$devcards$devtool$data_table_$_iter__60928(cljs.core.rest(s__60929__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__60942_61034 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60943_61035 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60944_61036 = true;
var _STAR_print_fn_STAR__temp_val__60945_61037 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60944_61036);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60945_61037);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60943_61035);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60942_61034);
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.devtool.data_table,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["key","value"], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60946){
var vec__60947 = p__60946;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60947,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60947,(1),null);
...
return cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$maps_viewer_$_iter__60950(s__60951){
return (new cljs.core.LazySeq(null,(function (){
...
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60952);
cljs.core.chunk_append(b__60953,cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h));

var G__61038 = (i__60952 + (1));
i__60952 = G__61038;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60953),athens$devcards$devtool$maps_viewer_$_iter__60950(cljs.core.chunk_rest(s__60951__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60953),null);
}
} else {
var h = cljs.core.first(s__60951__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h),athens$devcards$devtool$maps_viewer_$_iter__60950(cljs.core.rest(s__60951__$2)));
}
} else {
return null;
}
...
cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$tuples_viewer_$_iter__60954(s__60955){
return (new cljs.core.LazySeq(null,(function (){
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60956);
cljs.core.chunk_append(b__60957,cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i));

var G__61039 = (i__60956 + (1));
i__60956 = G__61039;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60957),athens$devcards$devtool$tuples_viewer_$_iter__60954(cljs.core.chunk_rest(s__60955__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60957),null);
}
} else {
var i = cljs.core.first(s__60955__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i),athens$devcards$devtool$tuples_viewer_$_iter__60954(cljs.core.rest(s__60955__$2)));
}
} else {
return null;
}
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__60958_SHARP_){
return athens.devcards.devtool.viewer_preference.indexOf(p1__60958_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("athens.viewer","id","athens.viewer/id",1343226473),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__60959){
...
var pred = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60960__$1,new cljs.core.Keyword("athens.viewer","pred","athens.viewer/pred",-951267918));
...
var add_nav_BANG_ = (function (p1__60962_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.update,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__60962_SHARP_], 0));
});
var navved_data = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (d,p__60963){
var vec__60964 = p__60963;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60964,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60964,(1),null);
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60969);
cljs.core.chunk_append(b__60970,(function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"2px 4px"], null),new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),((function (i__60969,nav,i,c__4580__auto__,size__4581__auto__,b__60970,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (i__60969,nav,i,c__4580__auto__,size__4581__auto__,b__60970,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (s){
...
});})(i__60969,nav,i,c__4580__auto__,size__4581__auto__,b__60970,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
);
});})(i__60969,nav,i,c__4580__auto__,size__4581__auto__,b__60970,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})());

var G__61040 = (i__60969 + (1));
i__60969 = G__61040;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60970),athens$devcards$devtool$data_browser_$_iter__60967(cljs.core.chunk_rest(s__60968__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60970),null);
}
} else {
var i = cljs.core.first(s__60968__$2);
return cljs.core.cons((function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"2px 4px"], null),new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),((function (nav,i,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (s){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$5(s,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.subvec,(0),i),new cljs.core.Keyword(null,"viewer","viewer",-783949853));
}));
});})(nav,i,s__60968__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})(),athens$devcards$devtool$data_browser_$_iter__60967(cljs.core.rest(s__60968__$2)));
}
} else {
return null;
}
...
var v = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60973);
cljs.core.chunk_append(b__60974,(function (){var click_fn = ((function (i__60973,v,c__4580__auto__,size__4581__auto__,b__60974,s__60972__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
...
});})(i__60973,v,c__4580__auto__,size__4581__auto__,b__60974,s__60972__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60974),athens$devcards$devtool$data_browser_$_iter__60971(cljs.core.chunk_rest(s__60972__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60974),null);
}
} else {
var v = cljs.core.first(s__60972__$2);
return cljs.core.cons((function (){var click_fn = ((function (v,s__60972__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"viewer","viewer",-783949853),v);
});})(v,s__60972__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),click_fn,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,viewer_name),new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name(v)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),v], null));
})(),athens$devcards$devtool$data_browser_$_iter__60971(cljs.core.rest(s__60972__$2)));
}
} else {
return null;
}
...
var vec__60978 = (function (){try{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(eval_str,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),bindings], null))], null);
}catch (e60981){if((e60981 instanceof Error)){
var e = e60981;
...
var ok_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60978,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60978,(1),null);
...
datascript.core.listen_BANG_.cljs$core$IFn$_invoke$arity$3(athens.db.dsdb,new cljs.core.Keyword("devtool","open","devtool/open",-1176270029),athens.devcards.devtool.listener);
...
athens.devcards.devtool.query_component = (function athens$devcards$devtool$query_component(p__60986){
...
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60987__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60987__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60987__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
athens.devcards.devtool.txes_component = (function athens$devcards$devtool$txes_component(p__60993){
...
var tx_reports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60994__$1,new cljs.core.Keyword(null,"tx-reports","tx-reports",1504634514));
...
var G__60996 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","toggle","devtool/toggle",-1442703685)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60996) : re_frame.core.dispatch.call(null,G__60996));
...
var G__60997 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","toggle","devtool/toggle",-1442703685)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60997) : re_frame.core.dispatch.call(null,G__60997));
...
var map__60998 = cljs.core.deref(state);
...
var active_panel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60998__$1,new cljs.core.Keyword(null,"active-panel","active-panel",-1802545994));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61005__$1)].join('')));
...
var devtool_QMARK_ = cljs.core.deref((function (){var G__61007 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","open","devtool/open",-1176270029)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61007) : re_frame.core.subscribe.call(null,G__61007));
})());
...
(athens.devcards.devtool.t_athens$devcards$devtool61008.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41691__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41709__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.db.load_real_db_button,athens.db.dsdb], null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool61020 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool61020 = (function (meta61021){
this.meta61021 = meta61021;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool61020.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61022,meta61021__$1){
var self__ = this;
var _61022__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool61020(meta61021__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool61020.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61022){
var self__ = this;
var _61022__$1 = this;
return self__.meta61021;
}));

(athens.devcards.devtool.t_athens$devcards$devtool61020.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool61020.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool61020.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61021","meta61021",-1272903411,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool61020.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool61020.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool61020");

(athens.devcards.devtool.t_athens$devcards$devtool61020.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool61020");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool61020.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool61020 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool61020(meta61021){
return (new athens.devcards.devtool.t_athens$devcards$devtool61020(meta61021));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool61020(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool61023 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool61023 = (function (meta61024){
this.meta61024 = meta61024;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool61023.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61025,meta61024__$1){
var self__ = this;
var _61025__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool61023(meta61024__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool61023.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61025){
var self__ = this;
var _61025__$1 = this;
return self__.meta61024;
}));

(athens.devcards.devtool.t_athens$devcards$devtool61023.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool61023.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool61023.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61024","meta61024",714075799,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool61023.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool61023.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool61023");

(athens.devcards.devtool.t_athens$devcards$devtool61023.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool61023");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool61023.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool61023 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool61023(meta61024){
return (new athens.devcards.devtool.t_athens$devcards$devtool61023(meta61024));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool61023(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool61026 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool61026 = (function (meta61027){
this.meta61027 = meta61027;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool61026.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61028,meta61027__$1){
var self__ = this;
var _61028__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool61026(meta61027__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool61026.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61028){
var self__ = this;
var _61028__$1 = this;
return self__.meta61027;
}));

(athens.devcards.devtool.t_athens$devcards$devtool61026.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool61026.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool61026.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61027","meta61027",2044664558,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool61026.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool61026.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool61026");

(athens.devcards.devtool.t_athens$devcards$devtool61026.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool61026");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool61026.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool61026 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool61026(meta61027){
return (new athens.devcards.devtool.t_athens$devcards$devtool61026(meta61027));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool61026(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
