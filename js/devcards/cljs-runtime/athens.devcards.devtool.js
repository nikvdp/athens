...
cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$tuples_viewer_$_iter__60689(s__60690){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__60692,cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i));

var G__60770 = (i__60691 + (1));
i__60691 = G__60770;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60692),athens$devcards$devtool$tuples_viewer_$_iter__60689(cljs.core.chunk_rest(s__60690__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60692),null);
}
} else {
var i = cljs.core.first(s__60690__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i),athens$devcards$devtool$tuples_viewer_$_iter__60689(cljs.core.rest(s__60690__$2)));
}
} else {
return null;
}
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__60709_SHARP_){
return athens.devcards.devtool.viewer_preference.indexOf(p1__60709_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("athens.viewer","id","athens.viewer/id",1343226473),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__60710){
var map__60711 = p__60710;
...
var pred = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60711__$1,new cljs.core.Keyword("athens.viewer","pred","athens.viewer/pred",-951267918));
...
var add_nav_BANG_ = (function (p1__60716_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.update,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__60716_SHARP_], 0));
});
var navved_data = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (d,p__60717){
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60723);
cljs.core.chunk_append(b__60724,(function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"2px 4px"], null),new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),((function (i__60723,nav,i,c__4580__auto__,size__4581__auto__,b__60724,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (i__60723,nav,i,c__4580__auto__,size__4581__auto__,b__60724,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (s){
...
});})(i__60723,nav,i,c__4580__auto__,size__4581__auto__,b__60724,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
);
});})(i__60723,nav,i,c__4580__auto__,size__4581__auto__,b__60724,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})());

var G__60771 = (i__60723 + (1));
i__60723 = G__60771;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60724),athens$devcards$devtool$data_browser_$_iter__60721(cljs.core.chunk_rest(s__60722__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60724),null);
}
} else {
var i = cljs.core.first(s__60722__$2);
return cljs.core.cons((function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"2px 4px"], null),new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),((function (nav,i,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (s){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$5(s,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.subvec,(0),i),new cljs.core.Keyword(null,"viewer","viewer",-783949853));
}));
});})(nav,i,s__60722__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})(),athens$devcards$devtool$data_browser_$_iter__60721(cljs.core.rest(s__60722__$2)));
}
} else {
return null;
}
...
})()),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.devtool.current_location_name_style),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(navved_data)], 0))], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.devtool.current_location_controls_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),"View as "], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_browser_$_iter__60725(s__60726){
return (new cljs.core.LazySeq(null,(function (){
var s__60726__$1 = s__60726;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60726__$1);
if(temp__5735__auto__){
var s__60726__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60726__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60726__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60728 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60727 = (0);
while(true){
if((i__60727 < size__4581__auto__)){
var v = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60727);
cljs.core.chunk_append(b__60728,(function (){var click_fn = ((function (i__60727,v,c__4580__auto__,size__4581__auto__,b__60728,s__60726__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
...
});})(i__60727,v,c__4580__auto__,size__4581__auto__,b__60728,s__60726__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60728),athens$devcards$devtool$data_browser_$_iter__60725(cljs.core.chunk_rest(s__60726__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60728),null);
}
} else {
var v = cljs.core.first(s__60726__$2);
return cljs.core.cons((function (){var click_fn = ((function (v,s__60726__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"viewer","viewer",-783949853),v);
});})(v,s__60726__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),click_fn,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,viewer_name),new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name(v)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),v], null));
})(),athens$devcards$devtool$data_browser_$_iter__60725(cljs.core.rest(s__60726__$2)));
}
} else {
return null;
}
...
athens.devcards.devtool.eval_with_sci = (function athens$devcards$devtool$eval_with_sci(p__60729){
...
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60730__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
...
var vec__60732 = (function (){try{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(eval_str,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),bindings], null))], null);
...
athens.devcards.devtool.query_component = (function athens$devcards$devtool$query_component(p__60736){
...
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60737__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60737__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60737__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
athens.devcards.devtool.txes_component = (function athens$devcards$devtool$txes_component(p__60739){
...
var tx_reports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60740__$1,new cljs.core.Keyword(null,"tx-reports","tx-reports",1504634514));
...
var map__60745 = cljs.core.deref(state);
...
var active_panel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60745__$1,new cljs.core.Keyword(null,"active-panel","active-panel",-1802545994));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60747__$1)].join('')));
...
var devtool_QMARK_ = cljs.core.deref((function (){var G__60748 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"devtool","devtool",1338288336)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60748) : re_frame.core.subscribe.call(null,G__60748));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool60752 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool60752 = (function (meta60753){
this.meta60753 = meta60753;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool60752.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60754,meta60753__$1){
var self__ = this;
var _60754__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool60752(meta60753__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool60752.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60754){
var self__ = this;
var _60754__$1 = this;
return self__.meta60753;
}));

(athens.devcards.devtool.t_athens$devcards$devtool60752.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool60752.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool60752.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60753","meta60753",39195637,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool60752.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool60752.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool60752");

(athens.devcards.devtool.t_athens$devcards$devtool60752.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool60752");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool60752.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool60752 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool60752(meta60753){
return (new athens.devcards.devtool.t_athens$devcards$devtool60752(meta60753));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool60752(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool60755 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool60755 = (function (meta60756){
this.meta60756 = meta60756;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool60755.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60757,meta60756__$1){
var self__ = this;
var _60757__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool60755(meta60756__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool60755.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60757){
var self__ = this;
var _60757__$1 = this;
return self__.meta60756;
}));

(athens.devcards.devtool.t_athens$devcards$devtool60755.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool60755.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool60755.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60756","meta60756",1392992593,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool60755.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool60755.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool60755");

(athens.devcards.devtool.t_athens$devcards$devtool60755.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool60755");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool60755.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool60755 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool60755(meta60756){
return (new athens.devcards.devtool.t_athens$devcards$devtool60755(meta60756));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool60755(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.devtool !== 'undefined') && (typeof athens.devcards.devtool.t_athens$devcards$devtool60758 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.devtool.t_athens$devcards$devtool60758 = (function (meta60759){
this.meta60759 = meta60759;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.devtool.t_athens$devcards$devtool60758.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60760,meta60759__$1){
var self__ = this;
var _60760__$1 = this;
return (new athens.devcards.devtool.t_athens$devcards$devtool60758(meta60759__$1));
}));

(athens.devcards.devtool.t_athens$devcards$devtool60758.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60760){
var self__ = this;
var _60760__$1 = this;
return self__.meta60759;
}));

(athens.devcards.devtool.t_athens$devcards$devtool60758.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.devtool.t_athens$devcards$devtool60758.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.devtool.t_athens$devcards$devtool60758.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60759","meta60759",-1180034185,null)], null);
}));

(athens.devcards.devtool.t_athens$devcards$devtool60758.cljs$lang$type = true);

(athens.devcards.devtool.t_athens$devcards$devtool60758.cljs$lang$ctorStr = "athens.devcards.devtool/t_athens$devcards$devtool60758");

(athens.devcards.devtool.t_athens$devcards$devtool60758.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.devtool/t_athens$devcards$devtool60758");
}));

/**
 * Positional factory function for athens.devcards.devtool/t_athens$devcards$devtool60758.
 */
athens.devcards.devtool.__GT_t_athens$devcards$devtool60758 = (function athens$devcards$devtool$__GT_t_athens$devcards$devtool60758(meta60759){
return (new athens.devcards.devtool.t_athens$devcards$devtool60758(meta60759));
});

}

return (new athens.devcards.devtool.t_athens$devcards$devtool60758(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
