...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58028__$1)].join('')));

}
});
athens.devcards.data_browser.coll_rows = (function athens$devcards$data_browser$coll_rows(coll){
var row = (function (p__58029){
var vec__58030 = p__58029;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58030,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58030,(1),null);
...
var G__58033 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?attr","?attr",-2066507837,null),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null)], null)], null);
var G__58034 = cljs.core.deref(athens.db.dsdb);
var G__58035 = attr;
var G__58036 = eid;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$4 ? datascript.core.q.cljs$core$IFn$_invoke$arity$4(G__58033,G__58034,G__58035,G__58036) : datascript.core.q.call(null,G__58033,G__58034,G__58035,G__58036));
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function athens$devcards$data_browser$reverse_refs_$_iter__58037(s__58038){
...
var attr = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58039);
cljs.core.chunk_append(b__58040,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.devcards.data_browser.wrap_with_db_id,athens.devcards.data_browser.reverse_refs_for_attr(attr,eid))], null));

var G__58108 = (i__58039 + (1));
i__58039 = G__58108;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58040),athens$devcards$data_browser$reverse_refs_$_iter__58037(cljs.core.chunk_rest(s__58038__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58040),null);
}
} else {
var attr = cljs.core.first(s__58038__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.devcards.data_browser.wrap_with_db_id,athens.devcards.data_browser.reverse_refs_for_attr(attr,eid))], null),athens$devcards$data_browser$reverse_refs_$_iter__58037(cljs.core.rest(s__58038__$2)));
}
} else {
return null;
}
...
athens.devcards.data_browser.reverse_rows = (function athens$devcards$data_browser$reverse_rows(p__58047){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58048__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
var row = (function (p__58050){
var vec__58051 = p__58050;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58051,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58051,(1),null);
...
var row = (function (p__58054){
var vec__58055 = p__58054;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58055,(0),null);
var values = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58055,(1),null);
...
var iter__4582__auto__ = (function athens$devcards$data_browser$maps_rows_$_iter__58058(s__58059){
return (new cljs.core.LazySeq(null,(function (){
...
var idx = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58060);
cljs.core.chunk_append(b__58061,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (i__58060,idx,c__4580__auto__,size__4581__auto__,b__58061,s__58059__$2,temp__5735__auto__,hs){
return (function athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58062(s__58063){
return (new cljs.core.LazySeq(null,((function (i__58060,idx,c__4580__auto__,size__4581__auto__,b__58061,s__58059__$2,temp__5735__auto__,hs){
return (function (){
var s__58063__$1 = s__58063;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58063__$1);
if(temp__5735__auto____$1){
var s__58063__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__58063__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__58063__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__58065 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__58064 = (0);
while(true){
if((i__58064 < size__4581__auto____$1)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__58064);
cljs.core.chunk_append(b__58065,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null));

var G__58109 = (i__58064 + (1));
i__58064 = G__58109;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58065),athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58062(cljs.core.chunk_rest(s__58063__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58065),null);
}
} else {
var h = cljs.core.first(s__58063__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null),athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58062(cljs.core.rest(s__58063__$2)));
}
} else {
return null;
}
...
});})(i__58060,idx,c__4580__auto__,size__4581__auto__,b__58061,s__58059__$2,temp__5735__auto__,hs))
,null,null));
});})(i__58060,idx,c__4580__auto__,size__4581__auto__,b__58061,s__58059__$2,temp__5735__auto__,hs))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58061),athens$devcards$data_browser$maps_rows_$_iter__58058(cljs.core.chunk_rest(s__58059__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58061),null);
}
} else {
var idx = cljs.core.first(s__58059__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (idx,s__58059__$2,temp__5735__auto__,hs){
return (function athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58066(s__58067){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58069),athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58066(cljs.core.chunk_rest(s__58067__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58069),null);
}
} else {
var h = cljs.core.first(s__58067__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null),athens$devcards$data_browser$maps_rows_$_iter__58058_$_iter__58066(cljs.core.rest(s__58067__$2)));
}
} else {
return null;
}
...
});})(idx,s__58059__$2,temp__5735__auto__,hs))
;
return iter__4582__auto__(cljs.core.rest(hs));
})()),athens$devcards$data_browser$maps_rows_$_iter__58058(cljs.core.rest(s__58059__$2)));
}
} else {
return null;
}
