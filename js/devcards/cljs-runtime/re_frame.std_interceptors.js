...
var vec__51283_51339 = clojure.data.diff(orig_db,new_db);
var only_before_51340 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51283_51339,(0),null);
var only_after_51341 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51283_51339,(1),null);
...
var new_context = ((re_frame.trace.is_trace_enabled_QMARK_())?(function (){var _STAR_current_trace_STAR__orig_val__51298 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__51299 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","handler","event/handler",-295903150),new cljs.core.Keyword(null,"operation","operation",-1267664310),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"event","event",301435442))], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__51299);

try{try{var map__51308 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51308__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__51298);
}})():(function (){var map__51314 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
