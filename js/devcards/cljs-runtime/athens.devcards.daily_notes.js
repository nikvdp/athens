...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#daily-notes","div#daily-notes",-1983155722),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_scroll_area_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$daily_notes$daily_notes_panel_$_iter__58246(s__58247){
return (new cljs.core.LazySeq(null,(function (){
var s__58247__$1 = s__58247;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58247__$1);
if(temp__5735__auto__){
var s__58247__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58247__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58247__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58249 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58248 = (0);
while(true){
if((i__58248 < size__4581__auto__)){
var map__58250 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58248);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58249),athens$devcards$daily_notes$daily_notes_panel_$_iter__58246(cljs.core.chunk_rest(s__58247__$2)));
} else {
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58252__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$daily_notes$daily_notes_panel_$_iter__58246(cljs.core.rest(s__58247__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.daily_notes !== 'undefined') && (typeof athens.devcards.daily_notes.t_athens$devcards$daily_notes58254 !== 'undefined')){
} else {
...
*/
athens.devcards.daily_notes.t_athens$devcards$daily_notes58254 = (function (meta58255){
this.meta58255 = meta58255;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58256,meta58255__$1){
var self__ = this;
var _58256__$1 = this;
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58254(meta58255__$1));
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58256){
var self__ = this;
var _58256__$1 = this;
return self__.meta58255;
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58255","meta58255",1866130138,null)], null);
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.cljs$lang$type = true);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.cljs$lang$ctorStr = "athens.devcards.daily-notes/t_athens$devcards$daily_notes58254");

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58254.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.daily-notes/t_athens$devcards$daily_notes58254");
}));

/**
 * Positional factory function for athens.devcards.daily-notes/t_athens$devcards$daily_notes58254.
 */
athens.devcards.daily_notes.__GT_t_athens$devcards$daily_notes58254 = (function athens$devcards$daily_notes$__GT_t_athens$devcards$daily_notes58254(meta58255){
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58254(meta58255));
});

}

return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58254(null));
})()
