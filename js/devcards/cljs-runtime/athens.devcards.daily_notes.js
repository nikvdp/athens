...
var daily_notes = cljs.core.deref((function (){var G__58228 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"daily-notes","daily-notes",302751021)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58228) : re_frame.core.subscribe.call(null,G__58228));
})());
...
if((delta < (1))){
var G__58229 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"next-daily-note","next-daily-note",557965411),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$1(cljs.core.count(daily_notes))], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58229) : re_frame.core.dispatch.call(null,G__58229));
} else {
return null;
}
});
...
var note_refs = (function (){var G__58230 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"daily-notes","daily-notes",302751021)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58230) : re_frame.core.subscribe.call(null,G__58230));
})();
return (function (){
if(cljs.core.empty_QMARK_(cljs.core.deref(note_refs))){
var G__58231_58251 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"next-daily-note","next-daily-note",557965411),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$0()], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58231_58251) : re_frame.core.dispatch.call(null,G__58231_58251));
} else {
}

var eids = (function (){var G__58232 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__58233 = athens.db.dsdb;
var G__58234 = cljs.core.deref(note_refs);
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$3(G__58232,G__58233,G__58234) : posh.reagent.q.call(null,G__58232,G__58233,G__58234));
})();
if(cljs.core.truth_(cljs.core.not_empty(cljs.core.deref(eids)))){
var notes = (function (){var G__58235 = athens.db.dsdb;
var G__58236 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58237 = cljs.core.deref(eids);
return (posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3(G__58235,G__58236,G__58237) : posh.reagent.pull_many.call(null,G__58235,G__58236,G__58237));
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#daily-notes","div#daily-notes",-1983155722),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_scroll_area_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$daily_notes$daily_notes_panel_$_iter__58238(s__58239){
return (new cljs.core.LazySeq(null,(function (){
var s__58239__$1 = s__58239;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58239__$1);
if(temp__5735__auto__){
var s__58239__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58239__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58239__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58241 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58240 = (0);
while(true){
if((i__58240 < size__4581__auto__)){
var map__58242 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58240);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58241),athens$devcards$daily_notes$daily_notes_panel_$_iter__58238(cljs.core.chunk_rest(s__58239__$2)));
} else {
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$daily_notes$daily_notes_panel_$_iter__58238(cljs.core.rest(s__58239__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.daily_notes !== 'undefined') && (typeof athens.devcards.daily_notes.t_athens$devcards$daily_notes58247 !== 'undefined')){
} else {
...
*/
athens.devcards.daily_notes.t_athens$devcards$daily_notes58247 = (function (meta58248){
this.meta58248 = meta58248;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58249,meta58248__$1){
var self__ = this;
var _58249__$1 = this;
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58247(meta58248__$1));
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58249){
var self__ = this;
var _58249__$1 = this;
return self__.meta58248;
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58248","meta58248",710580960,null)], null);
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.cljs$lang$type = true);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.cljs$lang$ctorStr = "athens.devcards.daily-notes/t_athens$devcards$daily_notes58247");

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58247.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.daily-notes/t_athens$devcards$daily_notes58247");
}));

/**
 * Positional factory function for athens.devcards.daily-notes/t_athens$devcards$daily_notes58247.
 */
athens.devcards.daily_notes.__GT_t_athens$devcards$daily_notes58247 = (function athens$devcards$daily_notes$__GT_t_athens$devcards$daily_notes58247(meta58248){
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58247(meta58248));
});

}

return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58247(null));
})()
