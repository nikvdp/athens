...
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61607.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
...
var G__61610 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","toggle","right-sidebar/toggle",-1089397191)], null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.right_sidebar !== 'undefined') && (typeof athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611 = (function (meta61612){
this.meta61612 = meta61612;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61613,meta61612__$1){
var self__ = this;
var _61613__$1 = this;
return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611(meta61612__$1));
}));

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61613){
var self__ = this;
var _61613__$1 = this;
return self__.meta61612;
}));

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
var this__48669__auto____$1 = this;
...
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61612","meta61612",-1246864766,null)], null);
}));

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.cljs$lang$type = true);

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.cljs$lang$ctorStr = "athens.devcards.right-sidebar/t_athens$devcards$right_sidebar61611");

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.right-sidebar/t_athens$devcards$right_sidebar61611");
}));

/**
 * Positional factory function for athens.devcards.right-sidebar/t_athens$devcards$right_sidebar61611.
 */
athens.devcards.right_sidebar.__GT_t_athens$devcards$right_sidebar61611 = (function athens$devcards$right_sidebar$__GT_t_athens$devcards$right_sidebar61611(meta61612){
return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611(meta61612));
});

}

return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar61611(null));
})()
