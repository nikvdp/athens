...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23505){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23506,G__23507,seq23505__$2);
}));
...
var map__23526 = opts;
var map__23526__$1 = (((((!((map__23526 == null))))?(((((map__23526.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23526.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23526):map__23526);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23526__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23530){var _e__20559__auto__ = e23530;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23534){var _e__20559__auto__ = e23534;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23536 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23537 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23537);

try{var map__23538 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23538__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23536);
}});
...
var temp__5733__auto___23565 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23565)){
var managed_print_level_23566 = temp__5733__auto___23565;
var _STAR_print_level_STAR__orig_val__23547_23567 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23548_23568 = managed_print_level_23566;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23548_23568);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23542_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23542_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23547_23567);
}} else {
job_fn();
}
