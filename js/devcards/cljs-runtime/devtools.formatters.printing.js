...
var G__23560 = (i__4737__auto___23557 + (1));
i__4737__auto___23557 = G__23560;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23509){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23525_SHARP_){
return (!((cljs.core.meta(p1__23525_SHARP_) == null)));
})))){
...
}catch (e23541){var _e__20749__auto__ = e23541;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23543){var _e__20749__auto__ = e23543;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23545 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23546 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23546);

try{var map__23547 = opts;
var map__23547__$1 = (((((!((map__23547 == null))))?(((((map__23547.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23547.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23547):map__23547);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23547__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23545);
}});
...
var temp__5733__auto___23592 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23592)){
var managed_print_level_23593 = temp__5733__auto___23592;
var _STAR_print_level_STAR__orig_val__23550_23594 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23551_23595 = managed_print_level_23593;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23551_23595);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23549_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23549_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23550_23594);
}} else {
job_fn();
}
