...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23521_SHARP_){
return (!((cljs.core.meta(p1__23521_SHARP_) == null)));
})))){
...
}catch (e23532){var _e__20609__auto__ = e23532;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23534){var _e__20609__auto__ = e23534;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23542 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23543 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23543);

try{var map__23544 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23544__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23542);
}});
...
var _STAR_print_level_STAR__orig_val__23550_23570 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23551_23571 = managed_print_level_23569;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23551_23571);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23547_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23547_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23550_23570);
}} else {
job_fn();
}
