...
var i__4737__auto___23546 = (0);
while(true){
if((i__4737__auto___23546 < len__4736__auto___23545)){
args__4742__auto__.push((arguments[i__4737__auto___23546]));

var G__23547 = (i__4737__auto___23546 + (1));
i__4737__auto___23546 = G__23547;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23502){
var G__23503 = cljs.core.first(seq23502);
var seq23502__$1 = cljs.core.next(seq23502);
var G__23504 = cljs.core.first(seq23502__$1);
var seq23502__$2 = cljs.core.next(seq23502__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23503,G__23504,seq23502__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23515_SHARP_){
return (!((cljs.core.meta(p1__23515_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23522__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23526){var _e__20762__auto__ = e23526;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23530){var _e__20762__auto__ = e23530;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23532 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23533 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23533);

try{var map__23535 = opts;
var map__23535__$1 = (((((!((map__23535 == null))))?(((((map__23535.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23535.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23535):map__23535);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23535__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23532);
}});
...
var temp__5733__auto___23561 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23561)){
var managed_print_level_23562 = temp__5733__auto___23561;
var _STAR_print_level_STAR__orig_val__23541_23563 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23542_23564 = managed_print_level_23562;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23542_23564);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23538_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23538_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23541_23563);
}} else {
job_fn();
}
