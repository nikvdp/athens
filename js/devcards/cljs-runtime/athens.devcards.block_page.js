...
athens.devcards.block_page.block_page_el = (function athens$devcards$block_page$block_page_el(p__58021,parents,editing_uid){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58022__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58022__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58022__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
}),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(">",(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__58024(s__58025){
return (new cljs.core.LazySeq(null,(function (){
var s__58025__$1 = s__58025;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58025__$1);
if(temp__5735__auto__){
var s__58025__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58025__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58025__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58027 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58026 = (0);
while(true){
if((i__58026 < size__4581__auto__)){
var map__58028 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58026);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58028__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58028__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
cljs.core.chunk_append(b__58027,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58026,map__58028,map__58028__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58027,s__58025__$2,temp__5735__auto__,map__58022,map__58022__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__58026,map__58028,map__58028__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58027,s__58025__$2,temp__5735__auto__,map__58022,map__58022__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58027),athens$devcards$block_page$block_page_el_$_iter__58024(cljs.core.chunk_rest(s__58025__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58027),null);
}
} else {
var map__58030 = cljs.core.first(s__58025__$2);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58030__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58030__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__58030,map__58030__$1,title,uid__$1,string__$1,s__58025__$2,temp__5735__auto__,map__58022,map__58022__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__58030,map__58030__$1,title,uid__$1,string__$1,s__58025__$2,temp__5735__auto__,map__58022,map__58022__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),athens$devcards$block_page$block_page_el_$_iter__58024(cljs.core.rest(s__58025__$2)));
}
} else {
return null;
}
...
var G__58032 = e.target.value;
var G__58033 = uid;
return (athens.devcards.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.devcards.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58032,G__58033) : athens.devcards.blocks.db_on_change.call(null,G__58032,G__58033));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),string], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__58034(s__58035){
return (new cljs.core.LazySeq(null,(function (){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58036);
cljs.core.chunk_append(b__58037,(function (){var map__58038 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58038__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58037),athens$devcards$block_page$block_page_el_$_iter__58034(cljs.core.chunk_rest(s__58035__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58037),null);
}
} else {
var child = cljs.core.first(s__58035__$2);
return cljs.core.cons((function (){var map__58040 = child;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__58034(cljs.core.rest(s__58035__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__58042 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58042) : re_frame.core.subscribe.call(null,G__58042));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.block_page !== 'undefined') && (typeof athens.devcards.block_page.t_athens$devcards$block_page58043 !== 'undefined')){
} else {
...
*/
athens.devcards.block_page.t_athens$devcards$block_page58043 = (function (meta58044){
this.meta58044 = meta58044;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.block_page.t_athens$devcards$block_page58043.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58045,meta58044__$1){
var self__ = this;
var _58045__$1 = this;
return (new athens.devcards.block_page.t_athens$devcards$block_page58043(meta58044__$1));
}));

(athens.devcards.block_page.t_athens$devcards$block_page58043.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58045){
var self__ = this;
var _58045__$1 = this;
return self__.meta58044;
}));

(athens.devcards.block_page.t_athens$devcards$block_page58043.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.block_page.t_athens$devcards$block_page58043.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.block_page.t_athens$devcards$block_page58043.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58044","meta58044",-2133702888,null)], null);
}));

(athens.devcards.block_page.t_athens$devcards$block_page58043.cljs$lang$type = true);

(athens.devcards.block_page.t_athens$devcards$block_page58043.cljs$lang$ctorStr = "athens.devcards.block-page/t_athens$devcards$block_page58043");

(athens.devcards.block_page.t_athens$devcards$block_page58043.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.block-page/t_athens$devcards$block_page58043");
}));

/**
 * Positional factory function for athens.devcards.block-page/t_athens$devcards$block_page58043.
 */
athens.devcards.block_page.__GT_t_athens$devcards$block_page58043 = (function athens$devcards$block_page$__GT_t_athens$devcards$block_page58043(meta58044){
return (new athens.devcards.block_page.t_athens$devcards$block_page58043(meta58044));
});

}

return (new athens.devcards.block_page.t_athens$devcards$block_page58043(null));
})()
