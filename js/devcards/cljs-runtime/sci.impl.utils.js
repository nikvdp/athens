...
var G__58383 = x;
var G__58383__$1 = (((G__58383 == null))?null:cljs.core.meta(G__58383));
if((G__58383__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__58383__$1);
}
});
...
var map__58390 = cljs.core.meta(iobj);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58390__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58390__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__58396 = cljs.core.meta(node);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58396__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58396__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
...
var len__4789__auto___58413 = arguments.length;
var i__4790__auto___58414 = (0);
while(true){
if((i__4790__auto___58414 < len__4789__auto___58413)){
args__4795__auto__.push((arguments[i__4790__auto___58414]));

var G__58415 = (i__4790__auto___58414 + (1));
i__4790__auto___58414 = G__58415;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq58400){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58401,G__58402,seq58400__$2);
}));
...
var G__58407 = cljs.core.namespace(sym);
switch (G__58407) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__58409 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__58409) : inner.call(null,G__58409));
})(),(function (){var G__58410 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__58410) : inner.call(null,G__58410));
})(),null));
} else {
