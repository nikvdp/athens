...
var G__57508 = x;
var G__57508__$1 = (((G__57508 == null))?null:cljs.core.meta(G__57508));
if((G__57508__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__57508__$1);
}
});
...
var map__57513 = cljs.core.meta(iobj);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57513__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57513__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__57518 = cljs.core.meta(node);
var map__57518__$1 = (((((!((map__57518 == null))))?(((((map__57518.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57518.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57518):map__57518);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__57518__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__57518__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
...
var len__4736__auto___57545 = arguments.length;
var i__4737__auto___57546 = (0);
while(true){
if((i__4737__auto___57546 < len__4736__auto___57545)){
args__4742__auto__.push((arguments[i__4737__auto___57546]));

var G__57547 = (i__4737__auto___57546 + (1));
i__4737__auto___57546 = G__57547;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq57526){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57527,G__57528,seq57526__$2);
}));
...
var G__57540 = cljs.core.namespace(sym);
switch (G__57540) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__57541 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__57541) : inner.call(null,G__57541));
})(),(function (){var G__57542 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__57542) : inner.call(null,G__57542));
})(),null));
} else {
