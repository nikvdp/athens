...
athens.views.block_page.block_page_el = (function athens$views$block_page$block_page_el(p__58498,parents,editing_uid){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58499__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58499__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58499__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
}),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(">",(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58501(s__58502){
return (new cljs.core.LazySeq(null,(function (){
var s__58502__$1 = s__58502;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58502__$1);
if(temp__5735__auto__){
var s__58502__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58502__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58502__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58504 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58503 = (0);
while(true){
if((i__58503 < size__4581__auto__)){
var map__58505 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58503);
...
cljs.core.chunk_append(b__58504,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58503,map__58505,map__58505__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58504,s__58502__$2,temp__5735__auto__,map__58499,map__58499__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__58503,map__58505,map__58505__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58504,s__58502__$2,temp__5735__auto__,map__58499,map__58499__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58504),athens$views$block_page$block_page_el_$_iter__58501(cljs.core.chunk_rest(s__58502__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58504),null);
}
} else {
var map__58507 = cljs.core.first(s__58502__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__58507,map__58507__$1,title,uid__$1,string__$1,s__58502__$2,temp__5735__auto__,map__58499,map__58499__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__58507,map__58507__$1,title,uid__$1,string__$1,s__58502__$2,temp__5735__auto__,map__58499,map__58499__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),athens$views$block_page$block_page_el_$_iter__58501(cljs.core.rest(s__58502__$2)));
}
} else {
return null;
}
...
var G__58509 = e.target.value;
var G__58510 = uid;
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58509,G__58510) : athens.views.blocks.db_on_change.call(null,G__58509,G__58510));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),string], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58511(s__58512){
return (new cljs.core.LazySeq(null,(function (){
var s__58512__$1 = s__58512;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58512__$1);
if(temp__5735__auto__){
var s__58512__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58512__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58512__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58514 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58513 = (0);
while(true){
if((i__58513 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58513);
cljs.core.chunk_append(b__58514,(function (){var map__58515 = child;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58514),athens$views$block_page$block_page_el_$_iter__58511(cljs.core.chunk_rest(s__58512__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58514),null);
}
} else {
var child = cljs.core.first(s__58512__$2);
return cljs.core.cons((function (){var map__58517 = child;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$views$block_page$block_page_el_$_iter__58511(cljs.core.rest(s__58512__$2)));
}
} else {
return null;
}
