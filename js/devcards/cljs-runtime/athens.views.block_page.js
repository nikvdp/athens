...
athens.views.block_page.block_page_el = (function athens$views$block_page$block_page_el(p__58169,parents,editing_uid){
...
}),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(">",(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58172(s__58173){
return (new cljs.core.LazySeq(null,(function (){
var s__58173__$1 = s__58173;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58173__$1);
if(temp__5735__auto__){
var s__58173__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58173__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58173__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58175 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58174 = (0);
while(true){
if((i__58174 < size__4581__auto__)){
var map__58176 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58174);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58176__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58176__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58176__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
cljs.core.chunk_append(b__58175,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58174,map__58176,map__58176__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58175,s__58173__$2,temp__5735__auto__,map__58170,map__58170__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__58174,map__58176,map__58176__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58175,s__58173__$2,temp__5735__auto__,map__58170,map__58170__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58175),athens$views$block_page$block_page_el_$_iter__58172(cljs.core.chunk_rest(s__58173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58175),null);
}
} else {
var map__58178 = cljs.core.first(s__58173__$2);
...
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58178__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__58178,map__58178__$1,title,uid__$1,string__$1,s__58173__$2,temp__5735__auto__,map__58170,map__58170__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__58178,map__58178__$1,title,uid__$1,string__$1,s__58173__$2,temp__5735__auto__,map__58170,map__58170__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),athens$views$block_page$block_page_el_$_iter__58172(cljs.core.rest(s__58173__$2)));
}
} else {
return null;
}
...
var G__58181 = uid;
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58180,G__58181) : athens.views.blocks.db_on_change.call(null,G__58180,G__58181));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),string], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58182(s__58183){
return (new cljs.core.LazySeq(null,(function (){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58184);
cljs.core.chunk_append(b__58185,(function (){var map__58186 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58186__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58185),athens$views$block_page$block_page_el_$_iter__58182(cljs.core.chunk_rest(s__58183__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58185),null);
}
} else {
var child = cljs.core.first(s__58183__$2);
return cljs.core.cons((function (){var map__58188 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58188__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$views$block_page$block_page_el_$_iter__58182(cljs.core.rest(s__58183__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__58195 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
