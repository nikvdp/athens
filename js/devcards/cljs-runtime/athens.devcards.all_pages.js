...
(athens.devcards.all_pages.t_athens$devcards$all_pages55670.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42243__auto__,devcard_opts__42244__auto__){
var self__ = this;
var this__42243__auto____$1 = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55683 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55683 = (function (meta55684){
this.meta55684 = meta55684;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55683.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55685,meta55684__$1){
var self__ = this;
var _55685__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55683(meta55684__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55685){
var self__ = this;
var _55685__$1 = this;
return self__.meta55684;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42243__auto__,devcard_opts__42244__auto__){
var self__ = this;
var this__42243__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55683.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55684","meta55684",-424549398,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55683");

(athens.devcards.all_pages.t_athens$devcards$all_pages55683.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55683");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55683.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55683 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55683(meta55684){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55683(meta55684));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55683(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55692 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55692 = (function (meta55693){
this.meta55693 = meta55693;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55692.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55694,meta55693__$1){
var self__ = this;
var _55694__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55692(meta55693__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55694){
var self__ = this;
var _55694__$1 = this;
return self__.meta55693;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42243__auto__,devcard_opts__42244__auto__){
var self__ = this;
var this__42243__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55692.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55693","meta55693",1854656430,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55692");

(athens.devcards.all_pages.t_athens$devcards$all_pages55692.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55692");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55692.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55692 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55692(meta55693){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55692(meta55693));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55692(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
