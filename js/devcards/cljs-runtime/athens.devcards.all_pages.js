...
})(),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border-radius","border-radius",419594011),"8px 0 0 8px",new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),"-16px 0 hsla(30, 11.11%, 93%, 0.1)"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__55556 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
...
var pages = (function (){var G__55563 = athens.db.dsdb;
var G__55564 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["*",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","string","block/string",-2066596447)], null),new cljs.core.Keyword(null,"limit","limit",-1355822363),(5)], null)], null);
var G__55565 = cljs.core.deref(page_eids);
return (posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3(G__55563,G__55564,G__55565) : posh.reagent.pull_many.call(null,G__55563,G__55564,G__55565));
})();
...
return (function (p1__55559_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__55559_SHARP_))].join('');
});})(i__55569,map__55572,map__55572__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__55570,s__55568__$2,temp__5735__auto__,page_eids,pages))
...
var map__55574 = cljs.core.first(s__55568__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__55574,map__55574__$1,uid,title,modified,created,children,s__55568__$2,temp__5735__auto__,page_eids,pages){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(map__55574,map__55574__$1,uid,title,modified,created,children,s__55568__$2,temp__5735__auto__,page_eids,pages))
], null)], 0)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__55574,map__55574__$1,uid,title,modified,created,children,s__55568__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__55559_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__55559_SHARP_))].join('');
});})(map__55574,map__55574__$1,uid,title,modified,created,children,s__55568__$2,temp__5735__auto__,page_eids,pages))
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55606 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55606 = (function (meta55607){
this.meta55607 = meta55607;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55606.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55608,meta55607__$1){
var self__ = this;
var _55608__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55606(meta55607__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55608){
var self__ = this;
var _55608__$1 = this;
return self__.meta55607;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55606.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55607","meta55607",1248124905,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55606");

(athens.devcards.all_pages.t_athens$devcards$all_pages55606.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55606");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55606.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55606 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55606(meta55607){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55606(meta55607));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55606(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55618 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55618 = (function (meta55619){
this.meta55619 = meta55619;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55618.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55620,meta55619__$1){
var self__ = this;
var _55620__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55618(meta55619__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55620){
var self__ = this;
var _55620__$1 = this;
return self__.meta55619;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55618.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55619","meta55619",-532632127,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55618");

(athens.devcards.all_pages.t_athens$devcards$all_pages55618.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55618");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55618.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55618 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55618(meta55619){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55618(meta55619));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55618(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
