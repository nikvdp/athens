...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55945 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55945 = (function (meta55946){
this.meta55946 = meta55946;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55945.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55947,meta55946__$1){
var self__ = this;
var _55947__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55945(meta55946__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55947){
var self__ = this;
var _55947__$1 = this;
return self__.meta55946;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
var this__42491__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55945.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55946","meta55946",-1169931878,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55945");

(athens.devcards.all_pages.t_athens$devcards$all_pages55945.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55945");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55945.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55945 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55945(meta55946){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55945(meta55946));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55945(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
