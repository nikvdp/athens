...
})(),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border-radius","border-radius",419594011),"8px 0 0 8px",new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),"-16px 0 hsla(30, 11.11%, 93%, 0.1)"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__55555 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
...
var map__55574 = cljs.core.first(s__55567__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__55574,map__55574__$1,uid,title,modified,created,children,s__55567__$2,temp__5735__auto__,page_eids,pages){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(map__55574,map__55574__$1,uid,title,modified,created,children,s__55567__$2,temp__5735__auto__,page_eids,pages))
], null)], 0)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__55574,map__55574__$1,uid,title,modified,created,children,s__55567__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__55558_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__55558_SHARP_))].join('');
});})(map__55574,map__55574__$1,uid,title,modified,created,children,s__55567__$2,temp__5735__auto__,page_eids,pages))
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55579.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55603 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55603 = (function (meta55604){
this.meta55604 = meta55604;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55603.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55605,meta55604__$1){
var self__ = this;
var _55605__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55603(meta55604__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55605){
var self__ = this;
var _55605__$1 = this;
return self__.meta55604;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55603.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55604","meta55604",-591854538,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55603");

(athens.devcards.all_pages.t_athens$devcards$all_pages55603.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55603");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55603.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55603 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55603(meta55604){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55603(meta55604));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55603(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
