...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55903 !== 'undefined')){
} else {
...
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55903 = (function (meta55904){
this.meta55904 = meta55904;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55903.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55905,meta55904__$1){
var self__ = this;
var _55905__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55903(meta55904__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55905){
var self__ = this;
var _55905__$1 = this;
return self__.meta55904;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55903.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55904","meta55904",775293979,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55903");

(athens.devcards.all_pages.t_athens$devcards$all_pages55903.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55903");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55903.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55903 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55903(meta55904){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55903(meta55904));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55903(null));
})()
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55917.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
var this__42483__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55926.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
var this__42483__auto____$1 = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55933 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55933 = (function (meta55934){
this.meta55934 = meta55934;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55933.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55935,meta55934__$1){
var self__ = this;
var _55935__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55933(meta55934__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55935){
var self__ = this;
var _55935__$1 = this;
return self__.meta55934;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
var this__42483__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55933.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55934","meta55934",56552582,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55933");

(athens.devcards.all_pages.t_athens$devcards$all_pages55933.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55933");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55933.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55933 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55933(meta55934){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55933(meta55934));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55933(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
