...
var fexpr__40837 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove);
return (fexpr__40837.cljs$core$IFn$_invoke$arity$2 ? fexpr__40837.cljs$core$IFn$_invoke$arity$2(pred,coll) : fexpr__40837.call(null,pred,coll));
});
...
var prefix = (function (p1__40838_SHARP_,p2__40839_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__40838_SHARP_,"-",p2__40839_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__40840){
var vec__40841 = p__40840;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40841,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40841,(1),null);
if(garden.util.hash_map_QMARK_(v)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__40844){
var vec__40845 = p__40844;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40845,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40845,(1),null);
...
var vec__40848 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40848,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40848,(1),null);
...
var vec__40851 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40851,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40851,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__40854 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__40855 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__40855);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__40854);
}})();
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__40856 = cljs.core.get_global_hierarchy;
return (fexpr__40856.cljs$core$IFn$_invoke$arity$0 ? fexpr__40856.cljs$core$IFn$_invoke$arity$0() : fexpr__40856.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__40857){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40858__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__40860 = value;
var map__40860__$1 = (((((!((map__40860 == null))))?(((((map__40860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40860):map__40860);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40860__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40860__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__40862 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__40862) : garden.compiler.media_expression_behavior.call(null,G__40862));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__40863){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40864__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__40866 = value;
var map__40866__$1 = (((((!((map__40866 == null))))?(((((map__40866.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40866.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40866):map__40866);
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40866__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40866__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__40871 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__40872 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__40872);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__40871);
}})();
var vec__40867 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40867,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40867,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__40873){
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40876__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40876__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__40881 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__40882 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__40882);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__40881);
}})();
var vec__40877 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40877,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40877,(1),null);
...
var G__40883_40995 = garden.compiler.expand;
var G__40884_40996 = "null";
var G__40885_40997 = (function (this$){
return null;
});
goog.object.set(G__40883_40995,G__40884_40996,G__40885_40997);
...
var G__40886_40998 = garden.compiler.expand;
var G__40887_40999 = "_";
var G__40888_41000 = (function (this$){
return (new cljs.core.List(null,this$,null,(1),null));
});
goog.object.set(G__40886_40998,G__40887_40999,G__40888_41000);
...
var ys = (function (){var iter__4582__auto__ = (function garden$compiler$iter__40893(s__40894){
return (new cljs.core.LazySeq(null,(function (){
var s__40894__$1 = s__40894;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__40894__$1);
if(temp__5735__auto__){
var s__40894__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40894__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__40894__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__40896 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__40895 = (0);
while(true){
if((i__40895 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__40895);
cljs.core.chunk_append(b__40896,((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))));

var G__41005 = (i__40895 + (1));
i__40895 = G__41005;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40896),garden$compiler$iter__40893(cljs.core.chunk_rest(s__40894__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40896),null);
}
} else {
var x = cljs.core.first(s__40894__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__40893(cljs.core.rest(s__40894__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__40897){
var vec__40898 = p__40897;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40898,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40898,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__40901_SHARP_){
return cljs.core.cons(p1__40901_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__40901_SHARP_) : f.call(null,p1__40901_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__40902){
var vec__40903 = p__40902;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40903,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40903,(1),null);
var iter__4582__auto__ = (function garden$compiler$prefixed_blocks_$_iter__40906(s__40907){
return (new cljs.core.LazySeq(null,(function (){
var s__40907__$1 = s__40907;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__40907__$1);
if(temp__5735__auto__){
var s__40907__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40907__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__40907__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__40909 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__40908 = (0);
while(true){
if((i__40908 < size__4581__auto__)){
var vendor = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__40908);
cljs.core.chunk_append(b__40909,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null));

var G__41013 = (i__40908 + (1));
i__40908 = G__41013;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40909),garden$compiler$prefixed_blocks_$_iter__40906(cljs.core.chunk_rest(s__40907__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40909),null);
}
} else {
var vendor = cljs.core.first(s__40907__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__40906(cljs.core.rest(s__40907__$2)));
}
} else {
return null;
}
...
var vec__40910 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40910,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40910,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__40913){
var vec__40914 = p__40913;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40914,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40914,(1),null);
var rule = vec__40914;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__40917){
var vec__40918 = p__40917;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40918,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40918,(1),null);
var vec__40921 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40921,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40921,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__40924){
...
var vec__40928 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40928,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40928,(1),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = v;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40931__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40931__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40933__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40933__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__40935 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40935__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40935__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40935__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__40936 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40936,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40936,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__40940 = cljs.core.get_global_hierarchy;
return (fexpr__40940.cljs$core$IFn$_invoke$arity$0 ? fexpr__40940.cljs$core$IFn$_invoke$arity$0() : fexpr__40940.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__40941){
var map__40942 = p__40941;
var map__40942__$1 = (((((!((map__40942 == null))))?(((((map__40942.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40942.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40942):map__40942);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40942__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__40944 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40944__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40944__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__40947){
var map__40948 = p__40947;
var map__40948__$1 = (((((!((map__40948 == null))))?(((((map__40948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40948.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40948):map__40948);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40948__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__40950 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40950__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40950__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40946_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40946_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__40952){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40953__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__40955 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40955__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40955__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__40957){
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40960__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40960__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var G__40965_41046 = garden.compiler.render_css;
var G__40966_41047 = "number";
var G__40967_41048 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__40965_41046,G__40966_41047,G__40967_41048);
...
var G__40968_41049 = garden.compiler.render_css;
var G__40969_41050 = "_";
var G__40970_41051 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__40968_41049,G__40969_41050,G__40970_41051);
...
var _STAR_flags_STAR__orig_val__40971 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__40972 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__40972);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__40971);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__40973,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__40976,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40977__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40977__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__40979,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40980__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var i__4790__auto___41053 = (0);
while(true){
if((i__4790__auto___41053 < len__4789__auto___41052)){
args__4795__auto__.push((arguments[i__4790__auto___41053]));

var G__41054 = (i__4790__auto___41053 + (1));
i__4790__auto___41053 = G__41054;
continue;
} else {
}
break;
...
var vec__40984 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40984,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40984,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq40982){
