...
var fexpr__34385 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove);
return (fexpr__34385.cljs$core$IFn$_invoke$arity$2 ? fexpr__34385.cljs$core$IFn$_invoke$arity$2(pred,coll) : fexpr__34385.call(null,pred,coll));
});
...
var prefix = (function (p1__34386_SHARP_,p2__34387_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__34386_SHARP_,"-",p2__34387_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__34388){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__34392){
var vec__34393 = p__34392;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34393,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34393,(1),null);
...
var vec__34396 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34396,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34396,(1),null);
...
var vec__34399 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34399,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34399,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__34402 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__34403 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__34403);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__34402);
}})();
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34404 = cljs.core.get_global_hierarchy;
return (fexpr__34404.cljs$core$IFn$_invoke$arity$0 ? fexpr__34404.cljs$core$IFn$_invoke$arity$0() : fexpr__34404.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34405){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34406__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34408 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34408__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34408__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__34410 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__34410) : garden.compiler.media_expression_behavior.call(null,G__34410));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34411){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34412__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34414 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34414__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34414__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34419 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34420 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34420);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34419);
}})();
var vec__34415 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34415,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34415,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34421){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34422__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34424 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34424__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34424__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34429 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34430 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34430);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34429);
}})();
var vec__34425 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34425,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34425,(1),null);
...
var G__34431_34543 = garden.compiler.expand;
var G__34432_34544 = "null";
var G__34433_34545 = (function (this$){
return null;
});
goog.object.set(G__34431_34543,G__34432_34544,G__34433_34545);
...
var G__34434_34548 = garden.compiler.expand;
var G__34435_34549 = "_";
var G__34436_34550 = (function (this$){
return (new cljs.core.List(null,this$,null,(1),null));
});
goog.object.set(G__34434_34548,G__34435_34549,G__34436_34550);
...
var ys = (function (){var iter__4582__auto__ = (function garden$compiler$iter__34441(s__34442){
return (new cljs.core.LazySeq(null,(function (){
var s__34442__$1 = s__34442;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34442__$1);
if(temp__5735__auto__){
var s__34442__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34442__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__34442__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34444 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34443 = (0);
while(true){
if((i__34443 < size__4581__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34444),garden$compiler$iter__34441(cljs.core.chunk_rest(s__34442__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34444),null);
}
} else {
var x = cljs.core.first(s__34442__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__34441(cljs.core.rest(s__34442__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__34445){
var vec__34446 = p__34445;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34446,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34446,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34449_SHARP_){
return cljs.core.cons(p1__34449_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__34449_SHARP_) : f.call(null,p1__34449_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__34450){
var vec__34451 = p__34450;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34451,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34451,(1),null);
var iter__4582__auto__ = (function garden$compiler$prefixed_blocks_$_iter__34454(s__34455){
return (new cljs.core.LazySeq(null,(function (){
var s__34455__$1 = s__34455;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34455__$1);
if(temp__5735__auto__){
var s__34455__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34455__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__34455__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34457 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34456 = (0);
while(true){
if((i__34456 < size__4581__auto__)){
var vendor = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__34456);
cljs.core.chunk_append(b__34457,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null));

var G__34565 = (i__34456 + (1));
i__34456 = G__34565;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34457),garden$compiler$prefixed_blocks_$_iter__34454(cljs.core.chunk_rest(s__34455__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34457),null);
}
} else {
var vendor = cljs.core.first(s__34455__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__34454(cljs.core.rest(s__34455__$2)));
}
} else {
return null;
}
...
var vec__34458 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34458,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34458,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__34461){
var vec__34462 = p__34461;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34462,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34462,(1),null);
var rule = vec__34462;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__34465){
...
var vec__34469 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34469,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34469,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__34472){
var vec__34473 = p__34472;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34473,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34473,(1),null);
var vec__34476 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34476,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34476,(1),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = v;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34479__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34479__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34481__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34481__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__34483 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34483__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34483__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34483__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__34484 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34484,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34484,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34488 = cljs.core.get_global_hierarchy;
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__34489){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34490__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34492 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34492__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34492__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34495){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34496__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34498 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34494_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34494_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34500){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34501__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34503 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34503__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34503__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34505){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34506__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34508 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34508__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34508__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var G__34510_34591 = garden.compiler.render_css;
var G__34511_34592 = "null";
var G__34512_34593 = (function (this$){
return "";
});
goog.object.set(G__34510_34591,G__34511_34592,G__34512_34593);
...
var _STAR_flags_STAR__orig_val__34519 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__34520 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__34520);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__34519);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__34521,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34522__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__34524,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34525__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34525__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__34527,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34528__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var vec__34532 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq34530){
var G__34531 = cljs.core.first(seq34530);
var seq34530__$1 = cljs.core.next(seq34530);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34531,seq34530__$1);
}));
