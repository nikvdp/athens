...
var fexpr__34652 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove);
return (fexpr__34652.cljs$core$IFn$_invoke$arity$2 ? fexpr__34652.cljs$core$IFn$_invoke$arity$2(pred,coll) : fexpr__34652.call(null,pred,coll));
});
...
var prefix = (function (p1__34653_SHARP_,p2__34654_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__34653_SHARP_,"-",p2__34654_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__34655){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__34659){
var vec__34660 = p__34659;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34660,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34660,(1),null);
...
var vec__34663 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34663,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34663,(1),null);
...
var vec__34666 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34666,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34666,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__34669 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__34670 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__34670);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__34669);
}})();
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34671 = cljs.core.get_global_hierarchy;
return (fexpr__34671.cljs$core$IFn$_invoke$arity$0 ? fexpr__34671.cljs$core$IFn$_invoke$arity$0() : fexpr__34671.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34672){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34673__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34675 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34675__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34675__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__34677 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__34677) : garden.compiler.media_expression_behavior.call(null,G__34677));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34678){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34679__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34681 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34686 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34687 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34687);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34686);
}})();
var vec__34682 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34682,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34682,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34688){
var map__34689 = p__34688;
var map__34689__$1 = (((((!((map__34689 == null))))?(((((map__34689.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34689.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34689):map__34689);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34689__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34691 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34691__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34691__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34696 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34697 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34697);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34696);
}})();
var vec__34692 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34692,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34692,(1),null);
...
var G__34698_34810 = garden.compiler.expand;
var G__34699_34811 = "null";
var G__34700_34812 = (function (this$){
return null;
});
goog.object.set(G__34698_34810,G__34699_34811,G__34700_34812);
...
var G__34701_34813 = garden.compiler.expand;
var G__34702_34814 = "_";
var G__34703_34815 = (function (this$){
return (new cljs.core.List(null,this$,null,(1),null));
});
goog.object.set(G__34701_34813,G__34702_34814,G__34703_34815);
...
var ys = (function (){var iter__4582__auto__ = (function garden$compiler$iter__34708(s__34709){
...
var c__4580__auto__ = cljs.core.chunk_first(s__34709__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34711 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34710 = (0);
while(true){
if((i__34710 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__34710);
cljs.core.chunk_append(b__34711,((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))));

var G__34820 = (i__34710 + (1));
i__34710 = G__34820;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34711),garden$compiler$iter__34708(cljs.core.chunk_rest(s__34709__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34711),null);
}
} else {
var x = cljs.core.first(s__34709__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__34708(cljs.core.rest(s__34709__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__34712){
var vec__34713 = p__34712;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34713,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34713,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34716_SHARP_){
return cljs.core.cons(p1__34716_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__34716_SHARP_) : f.call(null,p1__34716_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__34717){
var vec__34718 = p__34717;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34718,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34718,(1),null);
var iter__4582__auto__ = (function garden$compiler$prefixed_blocks_$_iter__34721(s__34722){
return (new cljs.core.LazySeq(null,(function (){
var s__34722__$1 = s__34722;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34722__$1);
if(temp__5735__auto__){
var s__34722__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34722__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__34722__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34724 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34723 = (0);
while(true){
if((i__34723 < size__4581__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34724),garden$compiler$prefixed_blocks_$_iter__34721(cljs.core.chunk_rest(s__34722__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34724),null);
}
} else {
var vendor = cljs.core.first(s__34722__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__34721(cljs.core.rest(s__34722__$2)));
}
} else {
return null;
}
...
var vec__34725 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34725,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34725,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__34728){
var vec__34729 = p__34728;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34729,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34729,(1),null);
var rule = vec__34729;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__34732){
...
var vec__34736 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34736,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34736,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__34739){
...
var vec__34743 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34743,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34743,(1),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = v;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34746__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34746__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34748__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34748__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__34750 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34750__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34750__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34750__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__34751 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34751,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34751,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34755 = cljs.core.get_global_hierarchy;
return (fexpr__34755.cljs$core$IFn$_invoke$arity$0 ? fexpr__34755.cljs$core$IFn$_invoke$arity$0() : fexpr__34755.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__34756){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34757__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34759 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34759__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34759__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34762){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34763__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34765 = value;
var map__34765__$1 = (((((!((map__34765 == null))))?(((((map__34765.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34765.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34765):map__34765);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34765__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34765__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34761_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34761_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34767){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34768__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34770 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34770__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34770__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34772){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34773__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34775 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34775__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34775__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var G__34777_34855 = garden.compiler.render_css;
var G__34778_34856 = "null";
var G__34779_34857 = (function (this$){
return "";
});
goog.object.set(G__34777_34855,G__34778_34856,G__34779_34857);
...
var G__34780_34861 = garden.compiler.render_css;
var G__34781_34862 = "number";
var G__34782_34863 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__34780_34861,G__34781_34862,G__34782_34863);
...
var G__34783_34864 = garden.compiler.render_css;
var G__34784_34865 = "_";
var G__34785_34866 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__34783_34864,G__34784_34865,G__34785_34866);
...
var _STAR_flags_STAR__orig_val__34786 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__34787 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__34787);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__34786);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__34788,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34789__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__34791,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34792__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34792__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__34794,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34795__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var vec__34799 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34799,(0),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq34797){
var G__34798 = cljs.core.first(seq34797);
var seq34797__$1 = cljs.core.next(seq34797);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34798,seq34797__$1);
}));
