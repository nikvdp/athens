...
var fexpr__34397 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove);
return (fexpr__34397.cljs$core$IFn$_invoke$arity$2 ? fexpr__34397.cljs$core$IFn$_invoke$arity$2(pred,coll) : fexpr__34397.call(null,pred,coll));
});
...
var prefix = (function (p1__34398_SHARP_,p2__34399_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__34398_SHARP_,"-",p2__34399_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__34400){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__34404){
var vec__34405 = p__34404;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34405,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34405,(1),null);
...
var vec__34408 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34408,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34408,(1),null);
...
var vec__34411 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34411,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34411,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__34414 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__34415 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__34415);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__34414);
}})();
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34416 = cljs.core.get_global_hierarchy;
return (fexpr__34416.cljs$core$IFn$_invoke$arity$0 ? fexpr__34416.cljs$core$IFn$_invoke$arity$0() : fexpr__34416.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34417){
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34420__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34420__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__34422 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__34422) : garden.compiler.media_expression_behavior.call(null,G__34422));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34423){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34424__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34426 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34426__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34426__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34431 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34432 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34432);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34431);
}})();
var vec__34427 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34427,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34427,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34433){
var map__34434 = p__34433;
var map__34434__$1 = (((((!((map__34434 == null))))?(((((map__34434.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34434.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34434):map__34434);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34434__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34436 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34436__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34436__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34441 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34442 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34442);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34441);
}})();
var vec__34437 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34437,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34437,(1),null);
...
var G__34446_34558 = garden.compiler.expand;
var G__34447_34559 = "_";
var G__34448_34560 = (function (this$){
return (new cljs.core.List(null,this$,null,(1),null));
});
goog.object.set(G__34446_34558,G__34447_34559,G__34448_34560);
...
var ys = (function (){var iter__4582__auto__ = (function garden$compiler$iter__34453(s__34454){
...
var c__4580__auto__ = cljs.core.chunk_first(s__34454__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34456 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34455 = (0);
while(true){
if((i__34455 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__34455);
cljs.core.chunk_append(b__34456,((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))));

var G__34570 = (i__34455 + (1));
i__34455 = G__34570;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34456),garden$compiler$iter__34453(cljs.core.chunk_rest(s__34454__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34456),null);
}
} else {
var x = cljs.core.first(s__34454__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__34453(cljs.core.rest(s__34454__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__34457){
var vec__34458 = p__34457;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34458,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34458,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34461_SHARP_){
return cljs.core.cons(p1__34461_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__34461_SHARP_) : f.call(null,p1__34461_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__34462){
var vec__34463 = p__34462;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34463,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34463,(1),null);
var iter__4582__auto__ = (function garden$compiler$prefixed_blocks_$_iter__34466(s__34467){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__34467__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34469 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34468 = (0);
while(true){
if((i__34468 < size__4581__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34469),garden$compiler$prefixed_blocks_$_iter__34466(cljs.core.chunk_rest(s__34467__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34469),null);
}
} else {
var vendor = cljs.core.first(s__34467__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__34466(cljs.core.rest(s__34467__$2)));
}
} else {
return null;
}
...
var vec__34470 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34470,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34470,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__34473){
var vec__34474 = p__34473;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34474,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34474,(1),null);
var rule = vec__34474;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__34477){
var vec__34478 = p__34477;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(1),null);
var vec__34481 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__34484){
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34491__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34491__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34493__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34493__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__34495 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34495__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34495__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34495__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__34496 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34496,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34496,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34500 = cljs.core.get_global_hierarchy;
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__34501){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34504__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34504__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34507){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34508__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34510 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34510__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34506_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34506_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34512){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34513__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34515 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34515__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34515__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34517){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34518__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34520 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34520__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34520__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var G__34522_34603 = garden.compiler.render_css;
var G__34523_34604 = "null";
var G__34524_34605 = (function (this$){
return "";
});
goog.object.set(G__34522_34603,G__34523_34604,G__34524_34605);
...
var _STAR_flags_STAR__orig_val__34531 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__34532 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__34532);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__34531);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__34533,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34534__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__34536,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34537__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34537__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__34539,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34540__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var vec__34544 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34544,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34544,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq34542){
