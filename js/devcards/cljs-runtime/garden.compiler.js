...
var fexpr__34404 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove);
return (fexpr__34404.cljs$core$IFn$_invoke$arity$2 ? fexpr__34404.cljs$core$IFn$_invoke$arity$2(pred,coll) : fexpr__34404.call(null,pred,coll));
});
...
var prefix = (function (p1__34405_SHARP_,p2__34406_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__34405_SHARP_,"-",p2__34406_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__34407){
var vec__34408 = p__34407;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34408,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34408,(1),null);
if(garden.util.hash_map_QMARK_(v)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__34411){
var vec__34412 = p__34411;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34412,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34412,(1),null);
...
var vec__34415 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34415,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34415,(1),null);
...
var vec__34418 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34418,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34418,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__34421 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__34422 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__34422);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__34421);
}})();
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34423 = cljs.core.get_global_hierarchy;
return (fexpr__34423.cljs$core$IFn$_invoke$arity$0 ? fexpr__34423.cljs$core$IFn$_invoke$arity$0() : fexpr__34423.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34424){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34425__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34427 = value;
var map__34427__$1 = (((((!((map__34427 == null))))?(((((map__34427.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34427.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34427):map__34427);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34427__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34427__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__34429 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__34429) : garden.compiler.media_expression_behavior.call(null,G__34429));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34430){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34431__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34433 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34433__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34433__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34438 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34439 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34439);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34438);
}})();
var vec__34434 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34434,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34434,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34440){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34441__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34443 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34443__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34443__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__34448 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__34449 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__34449);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__34448);
}})();
var vec__34444 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34444,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34444,(1),null);
...
var G__34450_34562 = garden.compiler.expand;
var G__34451_34563 = "null";
var G__34452_34564 = (function (this$){
return null;
});
goog.object.set(G__34450_34562,G__34451_34563,G__34452_34564);
...
var G__34453_34565 = garden.compiler.expand;
var G__34454_34566 = "_";
var G__34455_34567 = (function (this$){
return (new cljs.core.List(null,this$,null,(1),null));
});
goog.object.set(G__34453_34565,G__34454_34566,G__34455_34567);
...
var ys = (function (){var iter__4582__auto__ = (function garden$compiler$iter__34460(s__34461){
return (new cljs.core.LazySeq(null,(function (){
var s__34461__$1 = s__34461;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34461__$1);
if(temp__5735__auto__){
var s__34461__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34461__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__34461__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34463 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34462 = (0);
while(true){
if((i__34462 < size__4581__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34463),garden$compiler$iter__34460(cljs.core.chunk_rest(s__34461__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34463),null);
}
} else {
var x = cljs.core.first(s__34461__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__34460(cljs.core.rest(s__34461__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__34464){
var vec__34465 = p__34464;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34465,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34465,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34468_SHARP_){
return cljs.core.cons(p1__34468_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__34468_SHARP_) : f.call(null,p1__34468_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__34469){
var vec__34470 = p__34469;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34470,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34470,(1),null);
var iter__4582__auto__ = (function garden$compiler$prefixed_blocks_$_iter__34473(s__34474){
return (new cljs.core.LazySeq(null,(function (){
var s__34474__$1 = s__34474;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34474__$1);
if(temp__5735__auto__){
var s__34474__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34474__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__34474__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__34476 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__34475 = (0);
while(true){
if((i__34475 < size__4581__auto__)){
var vendor = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__34475);
cljs.core.chunk_append(b__34476,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null));

var G__34580 = (i__34475 + (1));
i__34475 = G__34580;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34476),garden$compiler$prefixed_blocks_$_iter__34473(cljs.core.chunk_rest(s__34474__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34476),null);
}
} else {
var vendor = cljs.core.first(s__34474__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__34473(cljs.core.rest(s__34474__$2)));
}
} else {
return null;
}
...
var vec__34477 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34477,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34477,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__34480){
var vec__34481 = p__34480;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(1),null);
var rule = vec__34481;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__34484){
var vec__34485 = p__34484;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34485,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34485,(1),null);
var vec__34488 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34488,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34488,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__34491){
var vec__34492 = p__34491;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34492,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34492,(1),null);
var vec__34495 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(1),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = v;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34500__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34500__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__34502 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34502__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34502__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34502__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__34503 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34503,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34503,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34507 = cljs.core.get_global_hierarchy;
return (fexpr__34507.cljs$core$IFn$_invoke$arity$0 ? fexpr__34507.cljs$core$IFn$_invoke$arity$0() : fexpr__34507.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__34508){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34509__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34511 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34511__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34511__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__34514){
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34517__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34517__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34513_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34513_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__34519){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34520__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__34524){
var map__34525 = p__34524;
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34525__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__34527 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34527__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34527__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var G__34529_34610 = garden.compiler.render_css;
var G__34530_34611 = "null";
var G__34531_34612 = (function (this$){
return "";
});
goog.object.set(G__34529_34610,G__34530_34611,G__34531_34612);
...
var G__34532_34613 = garden.compiler.render_css;
var G__34533_34614 = "number";
var G__34534_34615 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__34532_34613,G__34533_34614,G__34534_34615);
...
var G__34535_34616 = garden.compiler.render_css;
var G__34536_34617 = "_";
var G__34537_34618 = (function (this$){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$);
});
goog.object.set(G__34535_34616,G__34536_34617,G__34537_34618);
...
var _STAR_flags_STAR__orig_val__34538 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__34539 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__34539);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__34538);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__34540,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34541__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__34543,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34544__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34544__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__34546,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34547__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var G__34621 = (i__4790__auto___34620 + (1));
i__4790__auto___34620 = G__34621;
continue;
} else {
}
break;
...
var vec__34551 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34551,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34551,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq34549){
