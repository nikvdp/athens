...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50364_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50364_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50363_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50363_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50366_SHARP_){
return (((p1__50366_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50366_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50375,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50376__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50376__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50376__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50373_SHARP_){
if((p1__50373_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50373_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var _STAR_print_newline_STAR__orig_val__50389_50427 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50390_50429 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50391_50432 = true;
var _STAR_print_fn_STAR__temp_val__50392_50434 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50391_50432);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50392_50434);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50390_50429);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50389_50427);
}
...
var G__50436 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50435;
acc = G__50436;
continue;
} else {
if(typeof f === 'string'){
var G__50437 = cljs.core.next(opts__$1);
var G__50438 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50437;
acc = G__50438;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50439 = cljs.core.nnext(opts__$1);
var G__50440 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50439;
acc = G__50440;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50441 = cljs.core.next(opts__$1);
var G__50442 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50441;
acc = G__50442;
continue;
} else {
...
var G__50445 = cljs.core.next(opts__$1);
var G__50446 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50445;
acc = G__50446;
continue;
} else {
...
var G__50447 = cljs.core.nnext(opts__$1);
var G__50448 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50447;
acc = G__50448;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50449 = cljs.core.next(opts__$1);
var G__50450 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50449;
acc = G__50450;
continue;
} else {
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50407 = quoted_form;
var G__50408 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50407,G__50408) : debux.common.util.remove_d.call(null,G__50407,G__50408));
...
return (function() { 
var G__50451__delegate = function (arg){
...
while (G__50452__i < G__50452__a.length) {G__50452__a[G__50452__i] = arguments[G__50452__i + 0]; ++G__50452__i;}
  arg = new cljs.core.IndexedSeq(G__50452__a,0,null);
} 
return G__50451__delegate.call(this,arg);};
G__50451.cljs$lang$maxFixedArity = 0;
G__50451.cljs$lang$applyTo = (function (arglist__50453){
var arg = cljs.core.seq(arglist__50453);
return G__50451__delegate(arg);
});
