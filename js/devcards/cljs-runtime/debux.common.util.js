...
var G__46344 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46343;
acc = G__46344;
continue;
} else {
...
var G__46347 = cljs.core.nnext(opts__$1);
var G__46348 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46347;
acc = G__46348;
continue;
} else {
...
var G__46351 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46350;
acc = G__46351;
continue;
} else {
...
return (function() { 
var G__46360__delegate = function (arg){
...
while (G__46362__i < G__46362__a.length) {G__46362__a[G__46362__i] = arguments[G__46362__i + 0]; ++G__46362__i;}
  arg = new cljs.core.IndexedSeq(G__46362__a,0,null);
} 
return G__46360__delegate.call(this,arg);};
G__46360.cljs$lang$maxFixedArity = 0;
G__46360.cljs$lang$applyTo = (function (arglist__46363){
var arg = cljs.core.seq(arglist__46363);
return G__46360__delegate(arg);
});
...
var G__46366 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46366;
continue;
} else {
...
var G__46367 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46367;
continue;
} else {
var G__46370 = clojure.zip.next(loc);
loc = G__46370;
continue;
