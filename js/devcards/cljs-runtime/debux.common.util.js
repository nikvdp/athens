...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46027_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46027_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46026_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46026_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46028_SHARP_){
return (((p1__46028_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46028_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46031,mapping){
...
var state = map__46032__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46032__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46032__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46032__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46029_SHARP_){
if((p1__46029_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46029_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__46075 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46076 = clojure.zip.next(loc);
loc = G__46076;
continue;
}
}
...
i__4790__auto___46080 = G__46081;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46039){
var vec__46040 = p__46039;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46040,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46037){
var G__46038 = cljs.core.first(seq46037);
var seq46037__$1 = cljs.core.next(seq46037);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46038,seq46037__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46043_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46043_SHARP_)].join('');
}),lines);
});
...
var G__46087 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46086;
acc = G__46087;
continue;
} else {
if(typeof f === 'string'){
var G__46088 = cljs.core.next(opts__$1);
var G__46089 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46088;
acc = G__46089;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46090 = cljs.core.nnext(opts__$1);
var G__46091 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46090;
acc = G__46091;
continue;
} else {
...
var G__46093 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46092;
acc = G__46093;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46051 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__46051.cljs$core$IFn$_invoke$arity$1 ? fexpr__46051.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46051.call(null,f));
})())){
var G__46094 = cljs.core.next(opts__$1);
var G__46095 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46094;
acc = G__46095;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46052 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46052.cljs$core$IFn$_invoke$arity$1 ? fexpr__46052.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46052.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46053){
var vec__46054 = p__46053;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46054,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46054,(1),null);
...
var G__46059 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46058 = (function (){var fexpr__46060 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46060.cljs$core$IFn$_invoke$arity$1 ? fexpr__46060.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46060.call(null,form));
})();
return (fexpr__46058.cljs$core$IFn$_invoke$arity$1 ? fexpr__46058.cljs$core$IFn$_invoke$arity$1(G__46059) : fexpr__46058.call(null,G__46059));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46062 = quoted_form;
var G__46063 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46062,G__46063) : debux.common.util.remove_d.call(null,G__46062,G__46063));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46064 = quoted_form;
var G__46065 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46064,G__46065) : debux.common.util.remove_d.call(null,G__46064,G__46065));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__46110__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46066 = quoted_form;
var G__46067 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46066,G__46067) : debux.common.util.remove_d.call(null,G__46066,G__46067));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__46113__i < G__46113__a.length) {G__46113__a[G__46113__i] = arguments[G__46113__i + 0]; ++G__46113__i;}
  arg = new cljs.core.IndexedSeq(G__46113__a,0,null);
} 
return G__46110__delegate.call(this,arg);};
G__46110.cljs$lang$maxFixedArity = 0;
G__46110.cljs$lang$applyTo = (function (arglist__46114){
var arg = cljs.core.seq(arglist__46114);
return G__46110__delegate(arg);
});
