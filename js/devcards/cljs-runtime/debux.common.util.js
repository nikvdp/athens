...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50306_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50306_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50305_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50305_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50307_SHARP_){
return (((p1__50307_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50307_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50335,mapping){
...
var state = map__50336__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50336__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50336__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50336__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50333_SHARP_){
if((p1__50333_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50333_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50402 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50403 = clojure.zip.next(loc);
loc = G__50403;
continue;
}
}
...
var len__4736__auto___50413 = arguments.length;
var i__4737__auto___50414 = (0);
while(true){
if((i__4737__auto___50414 < len__4736__auto___50413)){
args__4742__auto__.push((arguments[i__4737__auto___50414]));

var G__50415 = (i__4737__auto___50414 + (1));
i__4737__auto___50414 = G__50415;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50351){
var vec__50352 = p__50351;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50352,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50341){
var G__50342 = cljs.core.first(seq50341);
var seq50341__$1 = cljs.core.next(seq50341);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50342,seq50341__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50359_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50359_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50361_50416 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50362_50417 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50363_50418 = true;
var _STAR_print_fn_STAR__temp_val__50364_50419 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50363_50418);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50364_50419);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50362_50417);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50361_50416);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50360_SHARP_){
return debux.common.util.prepend_bars(p1__50360_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50420 = cljs.core.next(opts__$1);
var G__50421 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50420;
acc = G__50421;
continue;
} else {
if(typeof f === 'string'){
var G__50422 = cljs.core.next(opts__$1);
var G__50423 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50422;
acc = G__50423;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50424 = cljs.core.nnext(opts__$1);
var G__50425 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50424;
acc = G__50425;
continue;
} else {
...
var G__50428 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50427;
acc = G__50428;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50369 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50369.cljs$core$IFn$_invoke$arity$1 ? fexpr__50369.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50369.call(null,f));
})())){
var G__50430 = cljs.core.next(opts__$1);
var G__50431 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50430;
acc = G__50431;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50370 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50370.cljs$core$IFn$_invoke$arity$1 ? fexpr__50370.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50370.call(null,f));
})())){
var G__50432 = cljs.core.nnext(opts__$1);
var G__50433 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50432;
acc = G__50433;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50434 = cljs.core.next(opts__$1);
var G__50435 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50434;
acc = G__50435;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50371){
var vec__50372 = p__50371;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50372,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50372,(1),null);
...
var G__50376 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50375 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50375.cljs$core$IFn$_invoke$arity$1 ? fexpr__50375.cljs$core$IFn$_invoke$arity$1(G__50376) : fexpr__50375.call(null,G__50376));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50379 = quoted_form;
var G__50380 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50379,G__50380) : debux.common.util.remove_d.call(null,G__50379,G__50380));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50382 = quoted_form;
var G__50383 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50382,G__50383) : debux.common.util.remove_d.call(null,G__50382,G__50383));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50436__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50384 = quoted_form;
var G__50385 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50384,G__50385) : debux.common.util.remove_d.call(null,G__50384,G__50385));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__50437__i < G__50437__a.length) {G__50437__a[G__50437__i] = arguments[G__50437__i + 0]; ++G__50437__i;}
  arg = new cljs.core.IndexedSeq(G__50437__a,0,null);
} 
return G__50436__delegate.call(this,arg);};
G__50436.cljs$lang$maxFixedArity = 0;
G__50436.cljs$lang$applyTo = (function (arglist__50438){
var arg = cljs.core.seq(arglist__50438);
return G__50436__delegate(arg);
});
...
var G__50439 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50439;
continue;
} else {
...
var G__50440 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50440;
continue;
} else {
var G__50441 = clojure.zip.next(loc);
loc = G__50441;
continue;
