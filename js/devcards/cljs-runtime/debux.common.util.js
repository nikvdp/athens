...
var G__46067 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46068 = clojure.zip.next(loc);
loc = G__46068;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46031){
var vec__46032 = p__46031;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46032,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46029){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46035_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46035_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46037_46074 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46038_46075 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46039_46076 = true;
var _STAR_print_fn_STAR__temp_val__46040_46077 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46039_46076);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46040_46077);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46038_46075);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46037_46074);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46036_SHARP_){
return debux.common.util.prepend_bars(p1__46036_SHARP_,indent_level);
...
var G__46079 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46078;
acc = G__46079;
continue;
} else {
...
var G__46081 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46080;
acc = G__46081;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46084 = cljs.core.nnext(opts__$1);
var G__46085 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46084;
acc = G__46085;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__46086 = cljs.core.next(opts__$1);
var G__46087 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46086;
acc = G__46087;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46043 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__46043.cljs$core$IFn$_invoke$arity$1 ? fexpr__46043.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46043.call(null,f));
})())){
var G__46091 = cljs.core.next(opts__$1);
var G__46092 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46091;
acc = G__46092;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46044 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46044.cljs$core$IFn$_invoke$arity$1 ? fexpr__46044.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46044.call(null,f));
})())){
var G__46096 = cljs.core.nnext(opts__$1);
var G__46097 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46096;
acc = G__46097;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46098 = cljs.core.next(opts__$1);
var G__46099 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46098;
acc = G__46099;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46045){
...
var G__46051 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46050 = (function (){var fexpr__46052 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46052.cljs$core$IFn$_invoke$arity$1 ? fexpr__46052.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46052.call(null,form));
})();
...
return (function() { 
var G__46106__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46058 = quoted_form;
var G__46059 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46058,G__46059) : debux.common.util.remove_d.call(null,G__46058,G__46059));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__46109__i < G__46109__a.length) {G__46109__a[G__46109__i] = arguments[G__46109__i + 0]; ++G__46109__i;}
  arg = new cljs.core.IndexedSeq(G__46109__a,0,null);
} 
return G__46106__delegate.call(this,arg);};
G__46106.cljs$lang$maxFixedArity = 0;
G__46106.cljs$lang$applyTo = (function (arglist__46110){
var arg = cljs.core.seq(arglist__46110);
return G__46106__delegate(arg);
});
...
var G__46117 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46117;
continue;
} else {
...
var G__46118 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46118;
continue;
} else {
var G__46119 = clojure.zip.next(loc);
loc = G__46119;
continue;
