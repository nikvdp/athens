...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50378_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50378_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50377_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50377_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50379_SHARP_){
return (((p1__50379_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50379_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50382,mapping){
...
var state = map__50383__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50383__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50383__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50383__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50380_SHARP_){
if((p1__50380_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50380_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50428 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50429 = clojure.zip.next(loc);
loc = G__50429;
continue;
}
}
...
var len__4736__auto___50432 = arguments.length;
var i__4737__auto___50433 = (0);
while(true){
if((i__4737__auto___50433 < len__4736__auto___50432)){
args__4742__auto__.push((arguments[i__4737__auto___50433]));

var G__50434 = (i__4737__auto___50433 + (1));
i__4737__auto___50433 = G__50434;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50388){
var vec__50389 = p__50388;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50389,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50386){
var G__50387 = cljs.core.first(seq50386);
var seq50386__$1 = cljs.core.next(seq50386);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50387,seq50386__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50400_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50400_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50402_50436 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50403_50437 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50404_50438 = true;
var _STAR_print_fn_STAR__temp_val__50405_50439 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50404_50438);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50405_50439);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50403_50437);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50402_50436);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50401_SHARP_){
return debux.common.util.prepend_bars(p1__50401_SHARP_,indent_level);
...
var G__50441 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50440;
acc = G__50441;
continue;
} else {
if(typeof f === 'string'){
var G__50442 = cljs.core.next(opts__$1);
var G__50443 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50442;
acc = G__50443;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50444 = cljs.core.nnext(opts__$1);
var G__50445 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50444;
acc = G__50445;
continue;
} else {
...
var G__50447 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50446;
acc = G__50447;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50410 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50410.cljs$core$IFn$_invoke$arity$1 ? fexpr__50410.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50410.call(null,f));
})())){
var G__50448 = cljs.core.next(opts__$1);
var G__50449 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50448;
acc = G__50449;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50411 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50411.cljs$core$IFn$_invoke$arity$1 ? fexpr__50411.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50411.call(null,f));
})())){
var G__50450 = cljs.core.nnext(opts__$1);
var G__50451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50450;
acc = G__50451;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50452 = cljs.core.next(opts__$1);
var G__50453 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50452;
acc = G__50453;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50412){
var vec__50413 = p__50412;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50413,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50413,(1),null);
...
var G__50418 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50417 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50417.cljs$core$IFn$_invoke$arity$1 ? fexpr__50417.cljs$core$IFn$_invoke$arity$1(G__50418) : fexpr__50417.call(null,G__50418));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50420 = quoted_form;
var G__50421 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50420,G__50421) : debux.common.util.remove_d.call(null,G__50420,G__50421));
...
return (function() { 
var G__50454__delegate = function (arg){
...
while (G__50455__i < G__50455__a.length) {G__50455__a[G__50455__i] = arguments[G__50455__i + 0]; ++G__50455__i;}
  arg = new cljs.core.IndexedSeq(G__50455__a,0,null);
} 
return G__50454__delegate.call(this,arg);};
G__50454.cljs$lang$maxFixedArity = 0;
G__50454.cljs$lang$applyTo = (function (arglist__50456){
var arg = cljs.core.seq(arglist__50456);
return G__50454__delegate(arg);
});
...
var G__50457 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50457;
continue;
} else {
...
var G__50458 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50458;
continue;
} else {
var G__50459 = clojure.zip.next(loc);
loc = G__50459;
continue;
