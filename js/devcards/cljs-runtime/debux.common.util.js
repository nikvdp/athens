...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50349_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50349_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50348_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50348_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50350_SHARP_){
return (((p1__50350_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50350_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50353,mapping){
...
var state = map__50354__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50354__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50354__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50354__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50351_SHARP_){
if((p1__50351_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50351_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50416 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50417 = clojure.zip.next(loc);
loc = G__50417;
continue;
}
}
...
var len__4736__auto___50420 = arguments.length;
var i__4737__auto___50421 = (0);
while(true){
if((i__4737__auto___50421 < len__4736__auto___50420)){
args__4742__auto__.push((arguments[i__4737__auto___50421]));

var G__50422 = (i__4737__auto___50421 + (1));
i__4737__auto___50421 = G__50422;
continue;
} else {
}
break;
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50379){
var G__50380 = cljs.core.first(seq50379);
var seq50379__$1 = cljs.core.next(seq50379);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50380,seq50379__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__50389_50423 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50390_50424 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50391_50425 = true;
var _STAR_print_fn_STAR__temp_val__50392_50426 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50391_50425);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50392_50426);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50390_50424);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50389_50423);
}
...
if(typeof f === 'number'){
var G__50427 = cljs.core.next(opts__$1);
var G__50428 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50427;
acc = G__50428;
continue;
} else {
if(typeof f === 'string'){
var G__50429 = cljs.core.next(opts__$1);
var G__50430 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50429;
acc = G__50430;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50431 = cljs.core.nnext(opts__$1);
var G__50432 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50431;
acc = G__50432;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50433 = cljs.core.next(opts__$1);
var G__50434 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50433;
acc = G__50434;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50395 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50395.cljs$core$IFn$_invoke$arity$1 ? fexpr__50395.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50395.call(null,f));
})())){
var G__50435 = cljs.core.next(opts__$1);
var G__50436 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50435;
acc = G__50436;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50396 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50396.cljs$core$IFn$_invoke$arity$1 ? fexpr__50396.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50396.call(null,f));
})())){
var G__50437 = cljs.core.nnext(opts__$1);
var G__50438 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50437;
acc = G__50438;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50439 = cljs.core.next(opts__$1);
var G__50440 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50439;
acc = G__50440;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50397){
...
var G__50402 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50401 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50401.cljs$core$IFn$_invoke$arity$1 ? fexpr__50401.cljs$core$IFn$_invoke$arity$1(G__50402) : fexpr__50401.call(null,G__50402));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50404 = quoted_form;
var G__50405 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50404,G__50405) : debux.common.util.remove_d.call(null,G__50404,G__50405));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50406 = quoted_form;
var G__50407 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50406,G__50407) : debux.common.util.remove_d.call(null,G__50406,G__50407));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50441__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50408 = quoted_form;
var G__50409 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50408,G__50409) : debux.common.util.remove_d.call(null,G__50408,G__50409));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__50442__i < G__50442__a.length) {G__50442__a[G__50442__i] = arguments[G__50442__i + 0]; ++G__50442__i;}
  arg = new cljs.core.IndexedSeq(G__50442__a,0,null);
} 
return G__50441__delegate.call(this,arg);};
G__50441.cljs$lang$maxFixedArity = 0;
G__50441.cljs$lang$applyTo = (function (arglist__50443){
var arg = cljs.core.seq(arglist__50443);
return G__50441__delegate(arg);
});
...
var G__50444 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50444;
continue;
} else {
...
var G__50445 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50445;
continue;
} else {
var G__50446 = clojure.zip.next(loc);
loc = G__50446;
continue;
