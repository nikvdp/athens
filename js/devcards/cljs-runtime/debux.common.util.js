...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46274_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46274_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46273_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46273_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46275_SHARP_){
return (((p1__46275_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46275_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46278,mapping){
...
var state = map__46279__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46279__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46279__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46279__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46276_SHARP_){
if((p1__46276_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46276_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__46314 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46315 = clojure.zip.next(loc);
loc = G__46315;
continue;
}
}
...
var len__4789__auto___46318 = arguments.length;
var i__4790__auto___46319 = (0);
while(true){
if((i__4790__auto___46319 < len__4789__auto___46318)){
args__4795__auto__.push((arguments[i__4790__auto___46319]));

var G__46320 = (i__4790__auto___46319 + (1));
i__4790__auto___46319 = G__46320;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46284){
var vec__46285 = p__46284;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46285,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46282){
var G__46283 = cljs.core.first(seq46282);
var seq46282__$1 = cljs.core.next(seq46282);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46283,seq46282__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46288_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46288_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46290_46321 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46291_46322 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46292_46323 = true;
var _STAR_print_fn_STAR__temp_val__46293_46324 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46292_46323);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46293_46324);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46291_46322);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46290_46321);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46289_SHARP_){
return debux.common.util.prepend_bars(p1__46289_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__46325 = cljs.core.next(opts__$1);
var G__46326 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46325;
acc = G__46326;
continue;
} else {
if(typeof f === 'string'){
var G__46327 = cljs.core.next(opts__$1);
var G__46328 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46327;
acc = G__46328;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46329 = cljs.core.nnext(opts__$1);
var G__46330 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46329;
acc = G__46330;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__46331 = cljs.core.next(opts__$1);
var G__46332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46331;
acc = G__46332;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46296 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__46296.cljs$core$IFn$_invoke$arity$1 ? fexpr__46296.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46296.call(null,f));
})())){
var G__46333 = cljs.core.next(opts__$1);
var G__46334 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46333;
acc = G__46334;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46297 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46297.cljs$core$IFn$_invoke$arity$1 ? fexpr__46297.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46297.call(null,f));
})())){
var G__46335 = cljs.core.nnext(opts__$1);
var G__46336 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46335;
acc = G__46336;
continue;
} else {
...
var G__46338 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46337;
acc = G__46338;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46298){
var vec__46299 = p__46298;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46299,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46299,(1),null);
...
var G__46304 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46303 = (function (){var fexpr__46305 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46305.cljs$core$IFn$_invoke$arity$1 ? fexpr__46305.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46305.call(null,form));
})();
return (fexpr__46303.cljs$core$IFn$_invoke$arity$1 ? fexpr__46303.cljs$core$IFn$_invoke$arity$1(G__46304) : fexpr__46303.call(null,G__46304));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46307 = quoted_form;
var G__46308 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46307,G__46308) : debux.common.util.remove_d.call(null,G__46307,G__46308));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46309 = quoted_form;
var G__46310 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46309,G__46310) : debux.common.util.remove_d.call(null,G__46309,G__46310));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__46341__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46311 = quoted_form;
var G__46312 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46311,G__46312) : debux.common.util.remove_d.call(null,G__46311,G__46312));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__46341 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__46342__i = 0, G__46342__a = new Array(arguments.length -  0);
while (G__46342__i < G__46342__a.length) {G__46342__a[G__46342__i] = arguments[G__46342__i + 0]; ++G__46342__i;}
  arg = new cljs.core.IndexedSeq(G__46342__a,0,null);
} 
return G__46341__delegate.call(this,arg);};
G__46341.cljs$lang$maxFixedArity = 0;
G__46341.cljs$lang$applyTo = (function (arglist__46343){
var arg = cljs.core.seq(arglist__46343);
return G__46341__delegate(arg);
});
...
var G__46344 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46344;
continue;
} else {
...
var G__46345 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46345;
continue;
} else {
var G__46346 = clojure.zip.next(loc);
loc = G__46346;
continue;
