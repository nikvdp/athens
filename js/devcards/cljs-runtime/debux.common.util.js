...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46034_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46034_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46033_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46033_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46035_SHARP_){
return (((p1__46035_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46035_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46038,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46039__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46039__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46039__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46036_SHARP_){
if((p1__46036_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46036_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__46082 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var len__4789__auto___46086 = arguments.length;
var i__4790__auto___46087 = (0);
while(true){
if((i__4790__auto___46087 < len__4789__auto___46086)){
args__4795__auto__.push((arguments[i__4790__auto___46087]));

var G__46088 = (i__4790__auto___46087 + (1));
i__4790__auto___46087 = G__46088;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46046){
var vec__46047 = p__46046;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46047,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46044){
var G__46045 = cljs.core.first(seq46044);
var seq46044__$1 = cljs.core.next(seq46044);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46045,seq46044__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46050_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46050_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46052_46089 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46053_46090 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46054_46091 = true;
var _STAR_print_fn_STAR__temp_val__46055_46092 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46054_46091);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46055_46092);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46053_46090);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46052_46089);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46051_SHARP_){
return debux.common.util.prepend_bars(p1__46051_SHARP_,indent_level);
...
var G__46094 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46093;
acc = G__46094;
continue;
} else {
...
var G__46107 = cljs.core.nnext(opts__$1);
var G__46108 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46107;
acc = G__46108;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46109 = cljs.core.next(opts__$1);
var G__46110 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46109;
acc = G__46110;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46060){
...
var G__46066 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46065 = (function (){var fexpr__46067 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46067.cljs$core$IFn$_invoke$arity$1 ? fexpr__46067.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46067.call(null,form));
})();
return (fexpr__46065.cljs$core$IFn$_invoke$arity$1 ? fexpr__46065.cljs$core$IFn$_invoke$arity$1(G__46066) : fexpr__46065.call(null,G__46066));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46069 = quoted_form;
var G__46070 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46069,G__46070) : debux.common.util.remove_d.call(null,G__46069,G__46070));
...
while (G__46122__i < G__46122__a.length) {G__46122__a[G__46122__i] = arguments[G__46122__i + 0]; ++G__46122__i;}
  arg = new cljs.core.IndexedSeq(G__46122__a,0,null);
} 
return G__46120__delegate.call(this,arg);};
G__46120.cljs$lang$maxFixedArity = 0;
G__46120.cljs$lang$applyTo = (function (arglist__46123){
var arg = cljs.core.seq(arglist__46123);
...
var G__46126 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46126;
continue;
} else {
...
var G__46127 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46127;
continue;
} else {
var G__46128 = clojure.zip.next(loc);
loc = G__46128;
continue;
