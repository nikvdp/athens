...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46041_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46041_SHARP_)].join('');
}),lines);
});
...
var G__46108 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46108;
continue;
} else {
