...
var G__46078 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46078;
continue;
} else {
...
var G__46081 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46081;
continue;
} else {
var G__46082 = clojure.zip.next(loc);
loc = G__46082;
continue;
