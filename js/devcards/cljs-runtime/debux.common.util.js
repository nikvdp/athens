...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50388_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50388_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50387_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50387_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50389_SHARP_){
return (((p1__50389_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50389_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50393,mapping){
...
var state = map__50394__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50394__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50394__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50394__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50391_SHARP_){
if((p1__50391_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50391_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50437 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50438 = clojure.zip.next(loc);
loc = G__50438;
continue;
}
}
...
var len__4736__auto___50442 = arguments.length;
var i__4737__auto___50443 = (0);
while(true){
if((i__4737__auto___50443 < len__4736__auto___50442)){
args__4742__auto__.push((arguments[i__4737__auto___50443]));

var G__50444 = (i__4737__auto___50443 + (1));
i__4737__auto___50443 = G__50444;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50400){
var vec__50401 = p__50400;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50401,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50398){
var G__50399 = cljs.core.first(seq50398);
var seq50398__$1 = cljs.core.next(seq50398);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50399,seq50398__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50404_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50404_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50406_50445 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50407_50446 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50408_50447 = true;
var _STAR_print_fn_STAR__temp_val__50409_50448 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50408_50447);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50409_50448);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50407_50446);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50406_50445);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50405_SHARP_){
return debux.common.util.prepend_bars(p1__50405_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50451 = cljs.core.next(opts__$1);
var G__50452 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50451;
acc = G__50452;
continue;
} else {
if(typeof f === 'string'){
var G__50453 = cljs.core.next(opts__$1);
var G__50454 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50453;
acc = G__50454;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50455 = cljs.core.nnext(opts__$1);
var G__50456 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50455;
acc = G__50456;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50457 = cljs.core.next(opts__$1);
var G__50458 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50457;
acc = G__50458;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50413 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50413.cljs$core$IFn$_invoke$arity$1 ? fexpr__50413.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50413.call(null,f));
})())){
var G__50459 = cljs.core.next(opts__$1);
var G__50460 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50459;
acc = G__50460;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50414 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50414.cljs$core$IFn$_invoke$arity$1 ? fexpr__50414.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50414.call(null,f));
})())){
var G__50461 = cljs.core.nnext(opts__$1);
var G__50462 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50461;
acc = G__50462;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50463 = cljs.core.next(opts__$1);
var G__50464 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50463;
acc = G__50464;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50415){
var vec__50416 = p__50415;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50416,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50416,(1),null);
...
var G__50420 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50419 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50419.cljs$core$IFn$_invoke$arity$1 ? fexpr__50419.cljs$core$IFn$_invoke$arity$1(G__50420) : fexpr__50419.call(null,G__50420));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50422 = quoted_form;
var G__50423 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50422,G__50423) : debux.common.util.remove_d.call(null,G__50422,G__50423));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50424 = quoted_form;
var G__50425 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50424,G__50425) : debux.common.util.remove_d.call(null,G__50424,G__50425));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50468__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50426 = quoted_form;
var G__50427 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50426,G__50427) : debux.common.util.remove_d.call(null,G__50426,G__50427));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__50468 = function (var_args){
var arg = null;
...
while (G__50475__i < G__50475__a.length) {G__50475__a[G__50475__i] = arguments[G__50475__i + 0]; ++G__50475__i;}
  arg = new cljs.core.IndexedSeq(G__50475__a,0,null);
} 
return G__50468__delegate.call(this,arg);};
G__50468.cljs$lang$maxFixedArity = 0;
G__50468.cljs$lang$applyTo = (function (arglist__50476){
var arg = cljs.core.seq(arglist__50476);
return G__50468__delegate(arg);
});
G__50468.cljs$core$IFn$_invoke$arity$variadic = G__50468__delegate;
return G__50468;
})()
;
});
...
var G__50477 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50477;
continue;
} else {
...
var G__50478 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50478;
continue;
} else {
var G__50479 = clojure.zip.next(loc);
loc = G__50479;
continue;
