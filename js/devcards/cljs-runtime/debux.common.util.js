...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51419_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51419_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51418_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51418_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51420_SHARP_){
return (((p1__51420_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51420_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51423,mapping){
...
var state = map__51424__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51424__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51424__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51424__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51421_SHARP_){
if((p1__51421_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51421_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51474 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51475 = clojure.zip.next(loc);
loc = G__51475;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51434){
var vec__51435 = p__51434;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51435,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51432){
var G__51433 = cljs.core.first(seq51432);
var seq51432__$1 = cljs.core.next(seq51432);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51433,seq51432__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51438_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51438_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51440_51482 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51441_51483 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51442_51484 = true;
var _STAR_print_fn_STAR__temp_val__51443_51485 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51442_51484);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51443_51485);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51441_51483);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51440_51482);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51439_SHARP_){
return debux.common.util.prepend_bars(p1__51439_SHARP_,indent_level);
...
var G__51487 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51486;
acc = G__51487;
continue;
} else {
...
var G__51489 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51488;
acc = G__51489;
continue;
} else {
...
var G__51491 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51490;
acc = G__51491;
continue;
} else {
...
var G__51493 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51492;
acc = G__51493;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51446 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51446.cljs$core$IFn$_invoke$arity$1 ? fexpr__51446.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51446.call(null,f));
})())){
var G__51494 = cljs.core.next(opts__$1);
var G__51495 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51494;
acc = G__51495;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51447 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51447.cljs$core$IFn$_invoke$arity$1 ? fexpr__51447.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51447.call(null,f));
})())){
var G__51496 = cljs.core.nnext(opts__$1);
var G__51497 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51496;
acc = G__51497;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51498 = cljs.core.next(opts__$1);
var G__51499 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51498;
acc = G__51499;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51448){
var vec__51449 = p__51448;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51449,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51449,(1),null);
...
var G__51454 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51453 = (function (){var fexpr__51455 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51455.cljs$core$IFn$_invoke$arity$1 ? fexpr__51455.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51455.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51457 = quoted_form;
var G__51458 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51457,G__51458) : debux.common.util.remove_d.call(null,G__51457,G__51458));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51459 = quoted_form;
var G__51460 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51459,G__51460) : debux.common.util.remove_d.call(null,G__51459,G__51460));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51500__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51461 = quoted_form;
var G__51462 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51461,G__51462) : debux.common.util.remove_d.call(null,G__51461,G__51462));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__51500 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__51501__i = 0, G__51501__a = new Array(arguments.length -  0);
while (G__51501__i < G__51501__a.length) {G__51501__a[G__51501__i] = arguments[G__51501__i + 0]; ++G__51501__i;}
  arg = new cljs.core.IndexedSeq(G__51501__a,0,null);
} 
return G__51500__delegate.call(this,arg);};
G__51500.cljs$lang$maxFixedArity = 0;
G__51500.cljs$lang$applyTo = (function (arglist__51502){
var arg = cljs.core.seq(arglist__51502);
return G__51500__delegate(arg);
});
G__51500.cljs$core$IFn$_invoke$arity$variadic = G__51500__delegate;
return G__51500;
})()
;
});
...
var G__51503 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51503;
continue;
} else {
...
var G__51505 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51505;
continue;
} else {
var G__51506 = clojure.zip.next(loc);
loc = G__51506;
continue;
