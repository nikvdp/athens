...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50389_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50389_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50388_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50388_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50390_SHARP_){
return (((p1__50390_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50390_SHARP_) == null)));
...
var G__50449 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50450 = clojure.zip.next(loc);
loc = G__50450;
continue;
}
}
...
var len__4736__auto___50453 = arguments.length;
var i__4737__auto___50454 = (0);
while(true){
if((i__4737__auto___50454 < len__4736__auto___50453)){
args__4742__auto__.push((arguments[i__4737__auto___50454]));

var G__50455 = (i__4737__auto___50454 + (1));
i__4737__auto___50454 = G__50455;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50401){
var vec__50402 = p__50401;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50402,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50399){
var G__50400 = cljs.core.first(seq50399);
var seq50399__$1 = cljs.core.next(seq50399);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50400,seq50399__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50405_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50405_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50407_50456 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50408_50457 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50409_50458 = true;
var _STAR_print_fn_STAR__temp_val__50410_50459 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50409_50458);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50410_50459);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50408_50457);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50407_50456);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50406_SHARP_){
return debux.common.util.prepend_bars(p1__50406_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50460 = cljs.core.next(opts__$1);
var G__50461 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50460;
acc = G__50461;
continue;
} else {
if(typeof f === 'string'){
var G__50462 = cljs.core.next(opts__$1);
var G__50463 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50462;
acc = G__50463;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50464 = cljs.core.nnext(opts__$1);
var G__50465 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50464;
acc = G__50465;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50466 = cljs.core.next(opts__$1);
var G__50467 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50466;
acc = G__50467;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50421 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50421.cljs$core$IFn$_invoke$arity$1 ? fexpr__50421.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50421.call(null,f));
})())){
var G__50468 = cljs.core.next(opts__$1);
var G__50469 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50468;
acc = G__50469;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50422 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50422.cljs$core$IFn$_invoke$arity$1 ? fexpr__50422.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50422.call(null,f));
})())){
var G__50470 = cljs.core.nnext(opts__$1);
var G__50471 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50470;
acc = G__50471;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50472 = cljs.core.next(opts__$1);
var G__50473 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50472;
acc = G__50473;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50423){
...
var G__50429 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50428 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50428.cljs$core$IFn$_invoke$arity$1 ? fexpr__50428.cljs$core$IFn$_invoke$arity$1(G__50429) : fexpr__50428.call(null,G__50429));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50431 = quoted_form;
var G__50432 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50431,G__50432) : debux.common.util.remove_d.call(null,G__50431,G__50432));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50433 = quoted_form;
var G__50434 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50433,G__50434) : debux.common.util.remove_d.call(null,G__50433,G__50434));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50474__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50437 = quoted_form;
var G__50438 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50437,G__50438) : debux.common.util.remove_d.call(null,G__50437,G__50438));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
