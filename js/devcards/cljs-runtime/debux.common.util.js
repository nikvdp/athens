...
var G__50429 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50430 = clojure.zip.next(loc);
loc = G__50430;
continue;
}
}
...
var len__4736__auto___50433 = arguments.length;
var i__4737__auto___50434 = (0);
while(true){
if((i__4737__auto___50434 < len__4736__auto___50433)){
args__4742__auto__.push((arguments[i__4737__auto___50434]));

var G__50435 = (i__4737__auto___50434 + (1));
i__4737__auto___50434 = G__50435;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50398){
var vec__50399 = p__50398;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50399,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50396){
var G__50397 = cljs.core.first(seq50396);
var seq50396__$1 = cljs.core.next(seq50396);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50397,seq50396__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50403_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50403_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50405_50436 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50406_50437 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50407_50438 = true;
var _STAR_print_fn_STAR__temp_val__50408_50439 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50407_50438);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50408_50439);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50406_50437);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50405_50436);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50404_SHARP_){
return debux.common.util.prepend_bars(p1__50404_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__50411 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__50412 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50412.cljs$core$IFn$_invoke$arity$1 ? fexpr__50412.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50412.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50413){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50421 = quoted_form;
var G__50422 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50421,G__50422) : debux.common.util.remove_d.call(null,G__50421,G__50422));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50423 = quoted_form;
var G__50424 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50423,G__50424) : debux.common.util.remove_d.call(null,G__50423,G__50424));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50462__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50425 = quoted_form;
var G__50426 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50425,G__50426) : debux.common.util.remove_d.call(null,G__50425,G__50426));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__50463__i < G__50463__a.length) {G__50463__a[G__50463__i] = arguments[G__50463__i + 0]; ++G__50463__i;}
  arg = new cljs.core.IndexedSeq(G__50463__a,0,null);
} 
return G__50462__delegate.call(this,arg);};
G__50462.cljs$lang$maxFixedArity = 0;
G__50462.cljs$lang$applyTo = (function (arglist__50464){
var arg = cljs.core.seq(arglist__50464);
return G__50462__delegate(arg);
});
...
var G__50465 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50465;
continue;
} else {
...
var G__50466 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50466;
continue;
} else {
var G__50467 = clojure.zip.next(loc);
loc = G__50467;
continue;
