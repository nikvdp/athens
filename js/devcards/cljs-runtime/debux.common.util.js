...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51397_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51397_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51396_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51396_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51398_SHARP_){
return (((p1__51398_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51398_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51404,mapping){
var map__51405 = p__51404;
...
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51405__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51405__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51399_SHARP_){
if((p1__51399_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51399_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4789__auto___51470 = arguments.length;
var i__4790__auto___51471 = (0);
while(true){
if((i__4790__auto___51471 < len__4789__auto___51470)){
args__4795__auto__.push((arguments[i__4790__auto___51471]));

var G__51472 = (i__4790__auto___51471 + (1));
i__4790__auto___51471 = G__51472;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51431){
var vec__51432 = p__51431;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51432,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51429){
var G__51430 = cljs.core.first(seq51429);
var seq51429__$1 = cljs.core.next(seq51429);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51430,seq51429__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51435_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51435_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51437_51473 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51438_51474 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51439_51475 = true;
var _STAR_print_fn_STAR__temp_val__51440_51476 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51439_51475);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51440_51476);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51438_51474);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51437_51473);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51436_SHARP_){
return debux.common.util.prepend_bars(p1__51436_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__51477 = cljs.core.next(opts__$1);
var G__51478 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51477;
acc = G__51478;
continue;
} else {
...
var G__51480 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51479;
acc = G__51480;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51481 = cljs.core.nnext(opts__$1);
var G__51482 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51481;
acc = G__51482;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51483 = cljs.core.next(opts__$1);
var G__51484 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51483;
acc = G__51484;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51443 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51443.cljs$core$IFn$_invoke$arity$1 ? fexpr__51443.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51443.call(null,f));
})())){
var G__51485 = cljs.core.next(opts__$1);
var G__51486 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51485;
acc = G__51486;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51444 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51444.cljs$core$IFn$_invoke$arity$1 ? fexpr__51444.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51444.call(null,f));
})())){
var G__51487 = cljs.core.nnext(opts__$1);
var G__51488 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51487;
acc = G__51488;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51489 = cljs.core.next(opts__$1);
var G__51490 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51489;
acc = G__51490;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51445){
var vec__51446 = p__51445;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51446,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51446,(1),null);
...
var G__51451 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51450 = (function (){var fexpr__51452 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51452.cljs$core$IFn$_invoke$arity$1 ? fexpr__51452.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51452.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51456 = quoted_form;
var G__51457 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51456,G__51457) : debux.common.util.remove_d.call(null,G__51456,G__51457));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51491__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51458 = quoted_form;
var G__51459 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51458,G__51459) : debux.common.util.remove_d.call(null,G__51458,G__51459));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__51500__i = 0, G__51500__a = new Array(arguments.length -  0);
while (G__51500__i < G__51500__a.length) {G__51500__a[G__51500__i] = arguments[G__51500__i + 0]; ++G__51500__i;}
  arg = new cljs.core.IndexedSeq(G__51500__a,0,null);
} 
return G__51491__delegate.call(this,arg);};
G__51491.cljs$lang$maxFixedArity = 0;
G__51491.cljs$lang$applyTo = (function (arglist__51501){
var arg = cljs.core.seq(arglist__51501);
return G__51491__delegate(arg);
});
...
var G__51502 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51502;
continue;
} else {
...
var G__51503 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51503;
continue;
} else {
