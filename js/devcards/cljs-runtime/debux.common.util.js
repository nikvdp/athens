...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50373_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50373_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50372_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50372_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50374_SHARP_){
return (((p1__50374_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50374_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50377,mapping){
...
var state = map__50378__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50378__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50378__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50378__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50375_SHARP_){
if((p1__50375_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50375_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50424 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50425 = clojure.zip.next(loc);
loc = G__50425;
continue;
}
}
...
var len__4736__auto___50430 = arguments.length;
var i__4737__auto___50431 = (0);
while(true){
if((i__4737__auto___50431 < len__4736__auto___50430)){
args__4742__auto__.push((arguments[i__4737__auto___50431]));

var G__50432 = (i__4737__auto___50431 + (1));
i__4737__auto___50431 = G__50432;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50383){
var vec__50384 = p__50383;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50384,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50381){
var G__50382 = cljs.core.first(seq50381);
var seq50381__$1 = cljs.core.next(seq50381);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50382,seq50381__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50387_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50387_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50389_50434 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50390_50435 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50391_50436 = true;
var _STAR_print_fn_STAR__temp_val__50392_50437 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50391_50436);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50392_50437);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50390_50435);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50389_50434);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50388_SHARP_){
return debux.common.util.prepend_bars(p1__50388_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50438 = cljs.core.next(opts__$1);
var G__50439 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50438;
acc = G__50439;
continue;
} else {
if(typeof f === 'string'){
var G__50440 = cljs.core.next(opts__$1);
var G__50441 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50440;
acc = G__50441;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50442 = cljs.core.nnext(opts__$1);
var G__50443 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50442;
acc = G__50443;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50444 = cljs.core.next(opts__$1);
var G__50445 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50444;
acc = G__50445;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50400 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50400.cljs$core$IFn$_invoke$arity$1 ? fexpr__50400.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50400.call(null,f));
})())){
var G__50446 = cljs.core.next(opts__$1);
var G__50447 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50446;
acc = G__50447;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50401 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50401.cljs$core$IFn$_invoke$arity$1 ? fexpr__50401.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50401.call(null,f));
})())){
var G__50448 = cljs.core.nnext(opts__$1);
var G__50449 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50448;
acc = G__50449;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50450 = cljs.core.next(opts__$1);
var G__50451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50450;
acc = G__50451;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50402){
...
var G__50407 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50406 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50406.cljs$core$IFn$_invoke$arity$1 ? fexpr__50406.cljs$core$IFn$_invoke$arity$1(G__50407) : fexpr__50406.call(null,G__50407));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50409 = quoted_form;
var G__50410 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50409,G__50410) : debux.common.util.remove_d.call(null,G__50409,G__50410));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50411 = quoted_form;
var G__50412 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50411,G__50412) : debux.common.util.remove_d.call(null,G__50411,G__50412));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50452__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50413 = quoted_form;
var G__50414 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50413,G__50414) : debux.common.util.remove_d.call(null,G__50413,G__50414));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__50452 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__50453__i = 0, G__50453__a = new Array(arguments.length -  0);
while (G__50453__i < G__50453__a.length) {G__50453__a[G__50453__i] = arguments[G__50453__i + 0]; ++G__50453__i;}
  arg = new cljs.core.IndexedSeq(G__50453__a,0,null);
} 
return G__50452__delegate.call(this,arg);};
G__50452.cljs$lang$maxFixedArity = 0;
G__50452.cljs$lang$applyTo = (function (arglist__50454){
var arg = cljs.core.seq(arglist__50454);
return G__50452__delegate(arg);
});
G__50452.cljs$core$IFn$_invoke$arity$variadic = G__50452__delegate;
return G__50452;
})()
;
});
...
var G__50455 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50455;
continue;
} else {
...
var G__50456 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50456;
continue;
} else {
var G__50457 = clojure.zip.next(loc);
loc = G__50457;
continue;
