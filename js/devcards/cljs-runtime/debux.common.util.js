...
var G__46328 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46367__i = 0, G__46367__a = new Array(arguments.length -  0);
while (G__46367__i < G__46367__a.length) {G__46367__a[G__46367__i] = arguments[G__46367__i + 0]; ++G__46367__i;}
  arg = new cljs.core.IndexedSeq(G__46367__a,0,null);
} 
...
var G__46371 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46371;
continue;
} else {
...
var G__46372 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46372;
continue;
} else {
