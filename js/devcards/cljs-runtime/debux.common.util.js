...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51412_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51412_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51411_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51411_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51413_SHARP_){
return (((p1__51413_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51413_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51416,mapping){
...
var state = map__51417__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51417__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51417__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51417__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51414_SHARP_){
if((p1__51414_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51414_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51467 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51468 = clojure.zip.next(loc);
loc = G__51468;
continue;
}
}
...
var len__4789__auto___51472 = arguments.length;
var i__4790__auto___51473 = (0);
while(true){
if((i__4790__auto___51473 < len__4789__auto___51472)){
args__4795__auto__.push((arguments[i__4790__auto___51473]));

var G__51474 = (i__4790__auto___51473 + (1));
i__4790__auto___51473 = G__51474;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51427){
var vec__51428 = p__51427;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51428,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51423){
var G__51424 = cljs.core.first(seq51423);
var seq51423__$1 = cljs.core.next(seq51423);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51424,seq51423__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51431_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51431_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51433_51475 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51434_51476 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51435_51477 = true;
var _STAR_print_fn_STAR__temp_val__51436_51478 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51435_51477);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51436_51478);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51434_51476);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51433_51475);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51432_SHARP_){
return debux.common.util.prepend_bars(p1__51432_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__51479 = cljs.core.next(opts__$1);
var G__51480 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51479;
acc = G__51480;
continue;
} else {
if(typeof f === 'string'){
var G__51481 = cljs.core.next(opts__$1);
var G__51482 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51481;
acc = G__51482;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51483 = cljs.core.nnext(opts__$1);
var G__51484 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51483;
acc = G__51484;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51485 = cljs.core.next(opts__$1);
var G__51486 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51485;
acc = G__51486;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51439 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51439.cljs$core$IFn$_invoke$arity$1 ? fexpr__51439.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51439.call(null,f));
})())){
var G__51487 = cljs.core.next(opts__$1);
var G__51488 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51487;
acc = G__51488;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51440 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51440.cljs$core$IFn$_invoke$arity$1 ? fexpr__51440.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51440.call(null,f));
})())){
var G__51489 = cljs.core.nnext(opts__$1);
var G__51490 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51489;
acc = G__51490;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51491 = cljs.core.next(opts__$1);
var G__51492 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51491;
acc = G__51492;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51441){
...
var G__51447 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51446 = (function (){var fexpr__51448 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51448.cljs$core$IFn$_invoke$arity$1 ? fexpr__51448.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51448.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51450 = quoted_form;
var G__51451 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51450,G__51451) : debux.common.util.remove_d.call(null,G__51450,G__51451));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51452 = quoted_form;
var G__51453 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51452,G__51453) : debux.common.util.remove_d.call(null,G__51452,G__51453));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51493__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51454 = quoted_form;
var G__51455 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51454,G__51455) : debux.common.util.remove_d.call(null,G__51454,G__51455));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__51493 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__51494__i = 0, G__51494__a = new Array(arguments.length -  0);
while (G__51494__i < G__51494__a.length) {G__51494__a[G__51494__i] = arguments[G__51494__i + 0]; ++G__51494__i;}
  arg = new cljs.core.IndexedSeq(G__51494__a,0,null);
} 
return G__51493__delegate.call(this,arg);};
G__51493.cljs$lang$maxFixedArity = 0;
G__51493.cljs$lang$applyTo = (function (arglist__51495){
var arg = cljs.core.seq(arglist__51495);
return G__51493__delegate(arg);
});
G__51493.cljs$core$IFn$_invoke$arity$variadic = G__51493__delegate;
return G__51493;
})()
;
});
...
var G__51496 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51496;
continue;
} else {
...
var G__51498 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51498;
continue;
} else {
var G__51499 = clojure.zip.next(loc);
loc = G__51499;
continue;
