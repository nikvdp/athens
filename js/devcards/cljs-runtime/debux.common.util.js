...
var G__46061 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46062 = clojure.zip.next(loc);
loc = G__46062;
continue;
}
}
...
var G__46083 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46082;
acc = G__46083;
continue;
} else {
...
var G__46085 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46084;
acc = G__46085;
continue;
} else {
...
var G__46087 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46086;
acc = G__46087;
continue;
} else {
...
var G__46088 = cljs.core.nnext(opts__$1);
var G__46089 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46088;
acc = G__46089;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46090 = cljs.core.next(opts__$1);
var G__46091 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46090;
acc = G__46091;
continue;
} else {
...
return (function() { 
var G__46096__delegate = function (arg){
...
var G__46096 = function (var_args){
var arg = null;
...
return G__46096__delegate.call(this,arg);};
G__46096.cljs$lang$maxFixedArity = 0;
G__46096.cljs$lang$applyTo = (function (arglist__46102){
var arg = cljs.core.seq(arglist__46102);
return G__46096__delegate(arg);
});
G__46096.cljs$core$IFn$_invoke$arity$variadic = G__46096__delegate;
return G__46096;
})()
;
});
...
var G__46106 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46106;
continue;
} else {
...
var G__46108 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46108;
continue;
} else {
var G__46109 = clojure.zip.next(loc);
loc = G__46109;
continue;
