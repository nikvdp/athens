...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46009_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46009_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46008_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46008_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46010_SHARP_){
return (((p1__46010_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46010_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46013,mapping){
var map__46014 = p__46013;
var map__46014__$1 = (((((!((map__46014 == null))))?(((((map__46014.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46014.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46014):map__46014);
var state = map__46014__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46014__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46014__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46014__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46011_SHARP_){
if((p1__46011_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46011_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__46051 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46052 = clojure.zip.next(loc);
loc = G__46052;
continue;
}
}
...
var len__4789__auto___46061 = arguments.length;
var i__4790__auto___46062 = (0);
while(true){
if((i__4790__auto___46062 < len__4789__auto___46061)){
args__4795__auto__.push((arguments[i__4790__auto___46062]));

var G__46063 = (i__4790__auto___46062 + (1));
i__4790__auto___46062 = G__46063;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46019){
var vec__46020 = p__46019;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46020,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46017){
var G__46018 = cljs.core.first(seq46017);
var seq46017__$1 = cljs.core.next(seq46017);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46018,seq46017__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46023_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46023_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46025_46064 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46026_46065 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46027_46066 = true;
var _STAR_print_fn_STAR__temp_val__46028_46067 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46027_46066);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46028_46067);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46026_46065);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46025_46064);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46024_SHARP_){
return debux.common.util.prepend_bars(p1__46024_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__46068 = cljs.core.next(opts__$1);
var G__46069 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46068;
acc = G__46069;
continue;
} else {
...
var G__46071 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46070;
acc = G__46071;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46072 = cljs.core.nnext(opts__$1);
var G__46073 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46072;
acc = G__46073;
continue;
} else {
...
var G__46075 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46074;
acc = G__46075;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46033 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__46033.cljs$core$IFn$_invoke$arity$1 ? fexpr__46033.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46033.call(null,f));
})())){
var G__46076 = cljs.core.next(opts__$1);
var G__46077 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46076;
acc = G__46077;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46034 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46034.cljs$core$IFn$_invoke$arity$1 ? fexpr__46034.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46034.call(null,f));
})())){
var G__46078 = cljs.core.nnext(opts__$1);
var G__46079 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46078;
acc = G__46079;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46080 = cljs.core.next(opts__$1);
var G__46081 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46080;
acc = G__46081;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46035){
var vec__46036 = p__46035;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46036,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46036,(1),null);
...
var G__46041 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46040 = (function (){var fexpr__46042 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46042.cljs$core$IFn$_invoke$arity$1 ? fexpr__46042.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46042.call(null,form));
})();
return (fexpr__46040.cljs$core$IFn$_invoke$arity$1 ? fexpr__46040.cljs$core$IFn$_invoke$arity$1(G__46041) : fexpr__46040.call(null,G__46041));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46046 = quoted_form;
var G__46047 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46046,G__46047) : debux.common.util.remove_d.call(null,G__46046,G__46047));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__46082__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46048 = quoted_form;
var G__46049 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46048,G__46049) : debux.common.util.remove_d.call(null,G__46048,G__46049));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__46083__i < G__46083__a.length) {G__46083__a[G__46083__i] = arguments[G__46083__i + 0]; ++G__46083__i;}
  arg = new cljs.core.IndexedSeq(G__46083__a,0,null);
} 
return G__46082__delegate.call(this,arg);};
G__46082.cljs$lang$maxFixedArity = 0;
G__46082.cljs$lang$applyTo = (function (arglist__46084){
var arg = cljs.core.seq(arglist__46084);
return G__46082__delegate(arg);
});
...
var G__46089 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46089;
continue;
} else {
...
var G__46092 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46092;
continue;
} else {
var G__46093 = clojure.zip.next(loc);
loc = G__46093;
continue;
