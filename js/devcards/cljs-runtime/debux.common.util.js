...
var G__46049 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46050 = clojure.zip.next(loc);
loc = G__46050;
continue;
}
}
...
var G__46094 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46094;
continue;
} else {
...
var G__46095 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46095;
continue;
} else {
var G__46096 = clojure.zip.next(loc);
loc = G__46096;
continue;
