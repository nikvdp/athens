...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__31271,storage_key){
var map__31272 = p__31271;
var map__31272__$1 = (((((!((map__31272 == null))))?(((((map__31272.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31272.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31272):map__31272);
var posh_tree = map__31272__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31272__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31272__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__31274 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__31277,storage_key){
...
var posh_tree = map__31278__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31278__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31278__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__31280 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__31283,storage_key){
...
var posh_tree = map__31284__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31284__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31284__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__31286 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31286,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31286,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31286,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31286,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__31289,storage_key){
...
var posh_tree = map__31290__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31290__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31290__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__31292 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31292,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31292,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31292,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31295){
var vec__31296 = p__31295;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31296,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31296,(1),null);
