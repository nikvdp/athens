...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__25829,storage_key){
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__25835,storage_key){
...
var posh_tree = map__25836__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25836__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25836__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__25838 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25838,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25838,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25838,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25838,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__25843,storage_key){
var map__25844 = p__25843;
var map__25844__$1 = (((((!((map__25844 == null))))?(((((map__25844.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25844.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25844):map__25844);
var posh_tree = map__25844__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25844__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25844__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__25846 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__25849,storage_key){
...
var posh_tree = map__25850__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25850__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25850__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__25852 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25852,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25852,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25852,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__25855){
var vec__25856 = p__25855;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25856,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25856,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__25859){
var vec__25860 = p__25859;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25860,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25860,(1),null);
...
var G__25863 = cljs.core.first(storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25863__$1)].join('')));
