...
var o__20642__auto__ = f;
return (o__20642__auto__["toString"]).call(o__20642__auto__);
} else {
return "";
}
...
try{var o__20642__auto___23752 = t;
(o__20642__auto___23752["cljs$lang$ctorPrWriter"]).call(o__20642__auto___23752,t,writer);
...
var char_code = (function (){var o__20642__auto__ = (new String(char$));
return (o__20642__auto__["charCodeAt"]).call(o__20642__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20642__auto__ = String;
return (o__20642__auto__["fromCharCode"]).call(o__20642__auto__,subscript_code);
});
/**
...
var o__20642__auto__ = String;
return (o__20642__auto__["fromCharCode"]).call(o__20642__auto__,superscript_code);
});
/**
...
var G__23772 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__23773 = cljs.core.butlast(remaining_tokens);
name_tokens = G__23772;
remaining_tokens = G__23773;
continue;
}
}
break;
...
var o__20642__auto__ = f;
return (o__20642__auto__["getBasis"]).call(o__20642__auto__);
});
/**
...
var G__23790 = (obj[cljs.core.first(path)]);
var G__23791 = cljs.core.rest(path);
obj = G__23790;
path = G__23791;
continue;
} else {
