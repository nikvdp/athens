...
athens.views.spinner.spinner_component = (function athens$views$spinner$spinner_component(p__60185){
var map__60186 = p__60185;
var map__60186__$1 = (((((!((map__60186 == null))))?(((((map__60186.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60186.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__60186):map__60186);
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60186__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60186__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
return reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.spinner.initial_spinner_component], null),goog.dom.getElement("app"));
});
