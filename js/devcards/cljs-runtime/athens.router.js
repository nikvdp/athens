...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__55911){
var vec__55912 = p__55911;
var seq__55913 = cljs.core.seq(vec__55912);
var first__55914 = cljs.core.first(seq__55913);
var seq__55913__$1 = cljs.core.next(seq__55913);
var ___$1 = first__55914;
var route = seq__55913__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__55915,p__55916){
var map__55917 = p__55915;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55917__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__55918 = p__55916;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55918,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55918,(1),null);
...
var node = (function (){var G__55922 = athens.db.dsdb;
var G__55923 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55924 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55922,G__55923,G__55924) : posh.reagent.pull.call(null,G__55922,G__55923,G__55924));
})();
...
var result__51976__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__51975__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__51976__auto__ = reitit.frontend.easy.push_state;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51976__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__51976__auto__;
})(),(function (){var opts__51975__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__51976__auto__ = route;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51976__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"route","route",1970422836,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__51976__auto__;
})());
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51976__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"apply","apply",-1334050276,null),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Symbol(null,"route","route",1970422836,null)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));
