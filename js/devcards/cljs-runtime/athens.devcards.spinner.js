...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61146){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61147__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61147__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61149 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61149 = (function (meta61150){
this.meta61150 = meta61150;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61149.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61151,meta61150__$1){
var self__ = this;
var _61151__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61149(meta61150__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61149.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61151){
var self__ = this;
var _61151__$1 = this;
return self__.meta61150;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61149.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61149.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61149.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61149.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61149.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61149");

(athens.devcards.spinner.t_athens$devcards$spinner61149.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61149");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61149.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61149 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61149(meta61150){
return (new athens.devcards.spinner.t_athens$devcards$spinner61149(meta61150));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61149(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61152 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61152 = (function (meta61153){
this.meta61153 = meta61153;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61152.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61154,meta61153__$1){
var self__ = this;
var _61154__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61152(meta61153__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61152.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61154){
var self__ = this;
var _61154__$1 = this;
return self__.meta61153;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61152.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61152.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61152.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61152.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61152.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61152");

(athens.devcards.spinner.t_athens$devcards$spinner61152.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61152");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61152.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61152 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61152(meta61153){
return (new athens.devcards.spinner.t_athens$devcards$spinner61152(meta61153));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61152(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
