...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61094){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61095__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61095__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61097 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61097 = (function (meta61098){
this.meta61098 = meta61098;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61097.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61099,meta61098__$1){
var self__ = this;
var _61099__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61097(meta61098__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61097.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61099){
var self__ = this;
var _61099__$1 = this;
return self__.meta61098;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61097.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61097.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61097.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61097.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61097.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61097");

(athens.devcards.spinner.t_athens$devcards$spinner61097.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61097");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61097.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61097 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61097(meta61098){
return (new athens.devcards.spinner.t_athens$devcards$spinner61097(meta61098));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61097(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61100 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61100 = (function (meta61101){
this.meta61101 = meta61101;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61100.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61102,meta61101__$1){
var self__ = this;
var _61102__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61100(meta61101__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61100.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61102){
var self__ = this;
var _61102__$1 = this;
return self__.meta61101;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61100.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61100.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61100.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61100.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61100.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61100");

(athens.devcards.spinner.t_athens$devcards$spinner61100.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61100");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61100.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61100 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61100(meta61101){
return (new athens.devcards.spinner.t_athens$devcards$spinner61100(meta61101));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61100(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
