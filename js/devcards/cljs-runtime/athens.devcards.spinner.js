...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61159){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61160__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61160__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61162 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61162 = (function (meta61163){
this.meta61163 = meta61163;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61162.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61164,meta61163__$1){
var self__ = this;
var _61164__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61162(meta61163__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61162.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61164){
var self__ = this;
var _61164__$1 = this;
return self__.meta61163;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61162.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61162.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61162.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61163","meta61163",-829151071,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner61162.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61162.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61162");

(athens.devcards.spinner.t_athens$devcards$spinner61162.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61162");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61162.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61162 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61162(meta61163){
return (new athens.devcards.spinner.t_athens$devcards$spinner61162(meta61163));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61162(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61165 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61165 = (function (meta61166){
this.meta61166 = meta61166;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61165.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61167,meta61166__$1){
var self__ = this;
var _61167__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61165(meta61166__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61165.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61167){
var self__ = this;
var _61167__$1 = this;
return self__.meta61166;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61165.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61165.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61165.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61166","meta61166",-993158161,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner61165.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61165.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61165");

(athens.devcards.spinner.t_athens$devcards$spinner61165.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61165");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61165.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61165 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61165(meta61166){
return (new athens.devcards.spinner.t_athens$devcards$spinner61165(meta61166));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61165(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
