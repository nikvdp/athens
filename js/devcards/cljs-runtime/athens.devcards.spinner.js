...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60956){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60957__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60957__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60959 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60959 = (function (meta60960){
this.meta60960 = meta60960;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60959.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60961,meta60960__$1){
var self__ = this;
var _60961__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60959(meta60960__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60959.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60961){
var self__ = this;
var _60961__$1 = this;
return self__.meta60960;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60959.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60959.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60959.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60960","meta60960",927034508,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60959.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60959.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60959");

(athens.devcards.spinner.t_athens$devcards$spinner60959.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60959");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60959.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60959 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60959(meta60960){
return (new athens.devcards.spinner.t_athens$devcards$spinner60959(meta60960));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60959(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60962 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60962 = (function (meta60963){
this.meta60963 = meta60963;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60962.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60964,meta60963__$1){
var self__ = this;
var _60964__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60962(meta60963__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60962.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60964){
var self__ = this;
var _60964__$1 = this;
return self__.meta60963;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60962.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60962.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60962.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60963","meta60963",67302132,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60962.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60962.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60962");

(athens.devcards.spinner.t_athens$devcards$spinner60962.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60962");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60962.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60962 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60962(meta60963){
return (new athens.devcards.spinner.t_athens$devcards$spinner60962(meta60963));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60962(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
