...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61184){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61185__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61185__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61187 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61187 = (function (meta61188){
this.meta61188 = meta61188;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61187.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61189,meta61188__$1){
var self__ = this;
var _61189__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61187(meta61188__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61187.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61189){
var self__ = this;
var _61189__$1 = this;
return self__.meta61188;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61187.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61187.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61187.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61187.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61187.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61187");

(athens.devcards.spinner.t_athens$devcards$spinner61187.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61187");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61187.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61187 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61187(meta61188){
return (new athens.devcards.spinner.t_athens$devcards$spinner61187(meta61188));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61187(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61190 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61190 = (function (meta61191){
this.meta61191 = meta61191;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61190.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61192,meta61191__$1){
var self__ = this;
var _61192__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61190(meta61191__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61190.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61192){
var self__ = this;
var _61192__$1 = this;
return self__.meta61191;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61190.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61190.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61190.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61190.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61190.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61190");

(athens.devcards.spinner.t_athens$devcards$spinner61190.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61190");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61190.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61190 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61190(meta61191){
return (new athens.devcards.spinner.t_athens$devcards$spinner61190(meta61191));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61190(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
