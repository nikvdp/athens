...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60962){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60963__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60963__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60965 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60965 = (function (meta60966){
this.meta60966 = meta60966;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60965.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60967,meta60966__$1){
var self__ = this;
var _60967__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60965(meta60966__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60965.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60967){
var self__ = this;
var _60967__$1 = this;
return self__.meta60966;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60965.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60965.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60965.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60965.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60965.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60965");

(athens.devcards.spinner.t_athens$devcards$spinner60965.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60965");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60965.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60965 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60965(meta60966){
return (new athens.devcards.spinner.t_athens$devcards$spinner60965(meta60966));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60965(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60968 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60968 = (function (meta60969){
this.meta60969 = meta60969;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60968.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60970,meta60969__$1){
var self__ = this;
var _60970__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60968(meta60969__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60968.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60970){
var self__ = this;
var _60970__$1 = this;
return self__.meta60969;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60968.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60968.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60968.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60968.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60968.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60968");

(athens.devcards.spinner.t_athens$devcards$spinner60968.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60968");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60968.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60968 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60968(meta60969){
return (new athens.devcards.spinner.t_athens$devcards$spinner60968(meta60969));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60968(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
