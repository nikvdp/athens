...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61643 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61643 = (function (meta61644){
this.meta61644 = meta61644;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61643.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61645,meta61644__$1){
var self__ = this;
var _61645__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61643(meta61644__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61643.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61645){
var self__ = this;
var _61645__$1 = this;
return self__.meta61644;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61643.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61643.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
var this__42483__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61643.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61644","meta61644",1757502319,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner61643.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61643.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61643");

(athens.devcards.spinner.t_athens$devcards$spinner61643.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61643");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61643.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61643 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61643(meta61644){
return (new athens.devcards.spinner.t_athens$devcards$spinner61643(meta61644));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61643(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
