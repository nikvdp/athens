...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61116){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61117__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61117__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61119 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61119 = (function (meta61120){
this.meta61120 = meta61120;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61119.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61121,meta61120__$1){
var self__ = this;
var _61121__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61119(meta61120__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61119.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61121){
var self__ = this;
var _61121__$1 = this;
return self__.meta61120;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61119.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61119.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61119.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61120","meta61120",-330073121,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner61119.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61119.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61119");

(athens.devcards.spinner.t_athens$devcards$spinner61119.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61119");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61119.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61119 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61119(meta61120){
return (new athens.devcards.spinner.t_athens$devcards$spinner61119(meta61120));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61119(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61122 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61122 = (function (meta61123){
this.meta61123 = meta61123;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61122.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61124,meta61123__$1){
var self__ = this;
var _61124__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61122(meta61123__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61122.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61124){
var self__ = this;
var _61124__$1 = this;
return self__.meta61123;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61122.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61122.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61122.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61122.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61122.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61122");

(athens.devcards.spinner.t_athens$devcards$spinner61122.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61122");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61122.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61122 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61122(meta61123){
return (new athens.devcards.spinner.t_athens$devcards$spinner61122(meta61123));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61122(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
