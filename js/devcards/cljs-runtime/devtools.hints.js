...
var G__20954 = cljs.core.PersistentArrayMap.EMPTY;
var G__20955 = native_stack_trace;
var G__20956 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20957 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20954,G__20955,G__20956,G__20957) : cljs.stacktrace.parse_stacktrace.call(null,G__20954,G__20955,G__20956,G__20957));
});
...
}catch (e20962){var _e = e20962;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___21003 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___21003)){
var seen_errors_21004 = temp__5733__auto___21003;
if(cljs.core.truth_(seen_errors_21004.has(self))){
} else {
seen_errors_21004.add(self);

var temp__5735__auto___21005 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___21005)){
var sense_21006 = temp__5735__auto___21005;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21006)].join(''));
} else {
}
}
} else {
