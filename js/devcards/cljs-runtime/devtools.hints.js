...
var G__20733 = cljs.core.PersistentArrayMap.EMPTY;
var G__20734 = native_stack_trace;
var G__20735 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20736 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20733,G__20734,G__20735,G__20736) : cljs.stacktrace.parse_stacktrace.call(null,G__20733,G__20734,G__20735,G__20736));
});
...
}catch (e20738){var _e = e20738;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20764 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20764)){
var seen_errors_20768 = temp__5733__auto___20764;
if(cljs.core.truth_(seen_errors_20768.has(self))){
} else {
seen_errors_20768.add(self);

var temp__5735__auto___20769 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20769)){
var sense_20770 = temp__5735__auto___20769;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20770)].join(''));
} else {
}
}
} else {
