...
var temp__5733__auto___20938 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20938)){
var seen_errors_20940 = temp__5733__auto___20938;
if(cljs.core.truth_(seen_errors_20940.has(self))){
} else {
seen_errors_20940.add(self);

var temp__5735__auto___20941 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20941)){
var sense_20942 = temp__5735__auto___20941;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20942)].join(''));
} else {
}
}
} else {
