...
}catch (e20855){var _e = e20855;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20892 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20892)){
var seen_errors_20894 = temp__5733__auto___20892;
if(cljs.core.truth_(seen_errors_20894.has(self))){
} else {
seen_errors_20894.add(self);

var temp__5735__auto___20895 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20895)){
var sense_20898 = temp__5735__auto___20895;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20898)].join(''));
} else {
}
}
} else {
