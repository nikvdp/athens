...
var G__20725 = cljs.core.PersistentArrayMap.EMPTY;
var G__20726 = native_stack_trace;
var G__20727 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20728 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20725,G__20726,G__20727,G__20728) : cljs.stacktrace.parse_stacktrace.call(null,G__20725,G__20726,G__20727,G__20728));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20733__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20733__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20733__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___20753 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20753)){
var seen_errors_20754 = temp__5733__auto___20753;
if(cljs.core.truth_(seen_errors_20754.has(self))){
} else {
seen_errors_20754.add(self);

var temp__5735__auto___20757 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20757)){
var sense_20759 = temp__5735__auto___20757;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20759)].join(''));
} else {
}
}
} else {
