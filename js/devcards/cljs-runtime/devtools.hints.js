...
}catch (e20839){var _e = e20839;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20878 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20878)){
var seen_errors_20879 = temp__5733__auto___20878;
if(cljs.core.truth_(seen_errors_20879.has(self))){
} else {
seen_errors_20879.add(self);

var temp__5735__auto___20880 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20880)){
var sense_20882 = temp__5735__auto___20880;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20882)].join(''));
} else {
}
}
} else {
