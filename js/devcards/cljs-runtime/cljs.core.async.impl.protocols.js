...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40132 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40132(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40133 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40133(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40136 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40136(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40141 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40141(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40145 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40145(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40152 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40152(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40156 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40156(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40157 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40157(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40160 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40160(b,itm);
}
});
