...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq55918){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55918));
}));
...
var len__4789__auto___55986 = arguments.length;
var i__4790__auto___55987 = (0);
while(true){
if((i__4790__auto___55987 < len__4789__auto___55986)){
args_arr__4810__auto__.push((arguments[i__4790__auto___55987]));

var G__55989 = (i__4790__auto___55987 + (1));
i__4790__auto___55987 = G__55989;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq55921){
var G__55922 = cljs.core.first(seq55921);
var seq55921__$1 = cljs.core.next(seq55921);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55922,seq55921__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___55991 = arguments.length;
var i__4790__auto___55992 = (0);
while(true){
if((i__4790__auto___55992 < len__4789__auto___55991)){
args__4795__auto__.push((arguments[i__4790__auto___55992]));

var G__55993 = (i__4790__auto___55992 + (1));
i__4790__auto___55992 = G__55993;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq55924){
var self__4777__auto__ = this;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__55927 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55927) : instaparse.combinators_source.unhide_content.call(null,G__55927));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55928 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55928) : instaparse.combinators_source.unhide_content.call(null,G__55928));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55929 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55929) : instaparse.combinators_source.unhide_content.call(null,G__55929));
})()], 0));
} else {
return parser__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__55930(s__55931){
...
var vec__55934 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55932);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55934,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55934,(1),null);
cljs.core.chunk_append(b__55933,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56046 = (i__55932 + (1));
i__55932 = G__56046;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55933),instaparse$combinators_source$unhide_all_content_$_iter__55930(cljs.core.chunk_rest(s__55931__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55933),null);
}
} else {
var vec__55937 = cljs.core.first(s__55931__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55937,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55937,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__55930(cljs.core.rest(s__55931__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__55940(s__55941){
return (new cljs.core.LazySeq(null,(function (){
var s__55941__$1 = s__55941;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55941__$1);
if(temp__5735__auto__){
var s__55941__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55941__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55941__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55943 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55942 = (0);
while(true){
if((i__55942 < size__4581__auto__)){
var vec__55944 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55942);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55944,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55944,(1),null);
cljs.core.chunk_append(b__55943,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56057 = (i__55942 + (1));
i__55942 = G__56057;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55943),instaparse$combinators_source$unhide_tags_$_iter__55940(cljs.core.chunk_rest(s__55941__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55943),null);
}
} else {
var vec__55947 = cljs.core.first(s__55941__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__55940(cljs.core.rest(s__55941__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__55950(s__55951){
return (new cljs.core.LazySeq(null,(function (){
var s__55951__$1 = s__55951;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55951__$1);
if(temp__5735__auto__){
var s__55951__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55951__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55951__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55953 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55952 = (0);
while(true){
if((i__55952 < size__4581__auto__)){
var vec__55954 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55952);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55954,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55954,(1),null);
cljs.core.chunk_append(b__55953,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56065 = (i__55952 + (1));
i__55952 = G__56065;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55953),instaparse$combinators_source$unhide_all_$_iter__55950(cljs.core.chunk_rest(s__55951__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55953),null);
}
} else {
var vec__55957 = cljs.core.first(s__55951__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55957,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55957,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__55950(cljs.core.rest(s__55951__$2)));
}
} else {
return null;
}
...
var G__55961 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55960_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__55960_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__55960_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55962 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__55963 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55962,G__55963) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55962,G__55963));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55964 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__55965 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55964,G__55965) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55964,G__55965));
})()], 0));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55961__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__55966(s__55967){
return (new cljs.core.LazySeq(null,(function (){
var s__55967__$1 = s__55967;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55967__$1);
if(temp__5735__auto__){
var s__55967__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55967__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55967__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55969 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55968 = (0);
while(true){
if((i__55968 < size__4581__auto__)){
var vec__55970 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55968);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(1),null);
cljs.core.chunk_append(b__55969,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56076 = (i__55968 + (1));
i__55968 = G__56076;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55969),instaparse$combinators_source$auto_whitespace_$_iter__55966(cljs.core.chunk_rest(s__55967__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55969),null);
}
} else {
var vec__55973 = cljs.core.first(s__55967__$2);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55973,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55973,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__55966(cljs.core.rest(s__55967__$2)));
}
} else {
return null;
}
