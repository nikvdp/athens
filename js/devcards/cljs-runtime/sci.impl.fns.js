...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59052,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59053__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59053__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59053__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59053__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59053__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59082 = cljs.core.next(args__$1);
var G__59083 = cljs.core.next(params__$1);
var G__59084 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59082;
params__$1 = G__59083;
ret = G__59084;
continue;
...
var vec__59058 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59058,(0),null);
var vec__59061 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59058,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59061,(0),null);
var G__59092 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59092;
continue;
} else {
var G__59093 = recur_val;
args = G__59093;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59095){
...
var map__59064 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59064__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59064__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59070){
...
var f = map__59071__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59071__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59071__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59107__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__59107 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59108__i = 0, G__59108__a = new Array(arguments.length -  0);
while (G__59108__i < G__59108__a.length) {G__59108__a[G__59108__i] = arguments[G__59108__i + 0]; ++G__59108__i;}
  args = new cljs.core.IndexedSeq(G__59108__a,0,null);
} 
return G__59107__delegate.call(this,args);};
G__59107.cljs$lang$maxFixedArity = 0;
G__59107.cljs$lang$applyTo = (function (arglist__59113){
var args = cljs.core.seq(arglist__59113);
return G__59107__delegate(args);
});
G__59107.cljs$core$IFn$_invoke$arity$variadic = G__59107__delegate;
return G__59107;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59068_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59068_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
while (G__59119__i < G__59119__a.length) {G__59119__a[G__59119__i] = arguments[G__59119__i + 0]; ++G__59119__i;}
  args = new cljs.core.IndexedSeq(G__59119__a,0,null);
} 
return G__59115__delegate.call(this,args);};
G__59115.cljs$lang$maxFixedArity = 0;
G__59115.cljs$lang$applyTo = (function (arglist__59120){
var args = cljs.core.seq(arglist__59120);
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59069_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59069_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
