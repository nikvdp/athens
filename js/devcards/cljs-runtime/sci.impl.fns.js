...
var _m = map__58714__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58751 = cljs.core.next(args__$1);
var G__58752 = cljs.core.next(params__$1);
var G__58753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58751;
params__$1 = G__58752;
ret = G__58753;
continue;
...
var vec__58727 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58727,(0),null);
var vec__58730 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58727,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58730,(0),null);
var G__58754 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58754;
continue;
} else {
var G__58755 = recur_val;
args = G__58755;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58759){
var args = cljs.core.seq(arglist__58759);
...
var map__58739 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58739__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58739__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58745){
var map__58746 = p__58745;
...
var f = map__58746__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58746__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58746__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58766__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58766 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58767__i = 0, G__58767__a = new Array(arguments.length -  0);
while (G__58767__i < G__58767__a.length) {G__58767__a[G__58767__i] = arguments[G__58767__i + 0]; ++G__58767__i;}
  args = new cljs.core.IndexedSeq(G__58767__a,0,null);
} 
return G__58766__delegate.call(this,args);};
G__58766.cljs$lang$maxFixedArity = 0;
G__58766.cljs$lang$applyTo = (function (arglist__58768){
var args = cljs.core.seq(arglist__58768);
return G__58766__delegate(args);
});
G__58766.cljs$core$IFn$_invoke$arity$variadic = G__58766__delegate;
return G__58766;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58742_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58742_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58770__delegate = function (args){
...
var G__58770 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58771__i = 0, G__58771__a = new Array(arguments.length -  0);
while (G__58771__i < G__58771__a.length) {G__58771__a[G__58771__i] = arguments[G__58771__i + 0]; ++G__58771__i;}
  args = new cljs.core.IndexedSeq(G__58771__a,0,null);
} 
return G__58770__delegate.call(this,args);};
G__58770.cljs$lang$maxFixedArity = 0;
G__58770.cljs$lang$applyTo = (function (arglist__58772){
var args = cljs.core.seq(arglist__58772);
return G__58770__delegate(args);
});
G__58770.cljs$core$IFn$_invoke$arity$variadic = G__58770__delegate;
return G__58770;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58743_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58743_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
