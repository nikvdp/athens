...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59012,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59013__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59013__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59013__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59013__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59013__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59050 = cljs.core.next(args__$1);
var G__59051 = cljs.core.next(params__$1);
var G__59052 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59050;
params__$1 = G__59051;
ret = G__59052;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59018 = ctx__$1;
var G__59019 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59018,G__59019) : interpret.call(null,G__59018,G__59019));
...
var vec__59020 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59020,(0),null);
var vec__59023 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59020,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59023,(0),null);
var G__59054 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59054;
continue;
} else {
var G__59055 = recur_val;
args = G__59055;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59057){
...
var map__59026 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59026__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59026__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59039){
...
var f = map__59040__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59040__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59040__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__59061__i < G__59061__a.length) {G__59061__a[G__59061__i] = arguments[G__59061__i + 0]; ++G__59061__i;}
  args = new cljs.core.IndexedSeq(G__59061__a,0,null);
} 
return G__59060__delegate.call(this,args);};
G__59060.cljs$lang$maxFixedArity = 0;
G__59060.cljs$lang$applyTo = (function (arglist__59062){
var args = cljs.core.seq(arglist__59062);
return G__59060__delegate(args);
});
G__59060.cljs$core$IFn$_invoke$arity$variadic = G__59060__delegate;
return G__59060;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59034_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59034_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59070__delegate = function (args){
...
while (G__59071__i < G__59071__a.length) {G__59071__a[G__59071__i] = arguments[G__59071__i + 0]; ++G__59071__i;}
  args = new cljs.core.IndexedSeq(G__59071__a,0,null);
} 
return G__59070__delegate.call(this,args);};
G__59070.cljs$lang$maxFixedArity = 0;
G__59070.cljs$lang$applyTo = (function (arglist__59072){
var args = cljs.core.seq(arglist__59072);
return G__59070__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59035_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59035_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
