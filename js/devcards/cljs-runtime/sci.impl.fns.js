...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58610,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58611__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58611__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58611__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58611__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58611__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58646 = cljs.core.next(args__$1);
var G__58647 = cljs.core.next(params__$1);
var G__58648 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58646;
params__$1 = G__58647;
ret = G__58648;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58613 = ctx__$1;
var G__58614 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58613,G__58614) : interpret.call(null,G__58613,G__58614));
...
var vec__58615 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58615,(0),null);
var vec__58618 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58615,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58618,(0),null);
var G__58649 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58649;
continue;
} else {
var G__58650 = recur_val;
args = G__58650;
continue;
}
} else {
...
var G__58651__i = 0, G__58651__a = new Array(arguments.length -  0);
while (G__58651__i < G__58651__a.length) {G__58651__a[G__58651__i] = arguments[G__58651__i + 0]; ++G__58651__i;}
  args = new cljs.core.IndexedSeq(G__58651__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58652){
var args = cljs.core.seq(arglist__58652);
...
var map__58630 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58630__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58640){
...
var f = map__58641__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58641__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58641__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58662__delegate = function (args){
...
while (G__58663__i < G__58663__a.length) {G__58663__a[G__58663__i] = arguments[G__58663__i + 0]; ++G__58663__i;}
  args = new cljs.core.IndexedSeq(G__58663__a,0,null);
} 
return G__58662__delegate.call(this,args);};
G__58662.cljs$lang$maxFixedArity = 0;
G__58662.cljs$lang$applyTo = (function (arglist__58664){
var args = cljs.core.seq(arglist__58664);
return G__58662__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58635_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58635_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58666__delegate = function (args){
...
var G__58666 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58667__i = 0, G__58667__a = new Array(arguments.length -  0);
while (G__58667__i < G__58667__a.length) {G__58667__a[G__58667__i] = arguments[G__58667__i + 0]; ++G__58667__i;}
  args = new cljs.core.IndexedSeq(G__58667__a,0,null);
} 
return G__58666__delegate.call(this,args);};
G__58666.cljs$lang$maxFixedArity = 0;
G__58666.cljs$lang$applyTo = (function (arglist__58668){
var args = cljs.core.seq(arglist__58668);
return G__58666__delegate(args);
});
G__58666.cljs$core$IFn$_invoke$arity$variadic = G__58666__delegate;
return G__58666;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58636_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58636_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
