...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58633,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__58635 = p__58633;
...
var _m = map__58635__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58635__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58635__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58635__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58635__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58670 = cljs.core.next(args__$1);
var G__58671 = cljs.core.next(params__$1);
var G__58672 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58670;
params__$1 = G__58671;
ret = G__58672;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58637 = ctx__$1;
var G__58638 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58637,G__58638) : interpret.call(null,G__58637,G__58638));
...
var vec__58639 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58639,(0),null);
var vec__58642 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58639,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58642,(0),null);
var G__58675 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58675;
continue;
} else {
var G__58676 = recur_val;
args = G__58676;
continue;
}
} else {
...
while (G__58677__i < G__58677__a.length) {G__58677__a[G__58677__i] = arguments[G__58677__i + 0]; ++G__58677__i;}
  args = new cljs.core.IndexedSeq(G__58677__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58678){
var args = cljs.core.seq(arglist__58678);
...
var map__58651 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58651__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58651__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58664){
...
var f = map__58665__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58665__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58665__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58688__i < G__58688__a.length) {G__58688__a[G__58688__i] = arguments[G__58688__i + 0]; ++G__58688__i;}
  args = new cljs.core.IndexedSeq(G__58688__a,0,null);
} 
return G__58687__delegate.call(this,args);};
G__58687.cljs$lang$maxFixedArity = 0;
G__58687.cljs$lang$applyTo = (function (arglist__58689){
var args = cljs.core.seq(arglist__58689);
return G__58687__delegate(args);
});
G__58687.cljs$core$IFn$_invoke$arity$variadic = G__58687__delegate;
return G__58687;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58659_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58659_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58690__delegate = function (args){
...
var G__58690 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__58692__i < G__58692__a.length) {G__58692__a[G__58692__i] = arguments[G__58692__i + 0]; ++G__58692__i;}
  args = new cljs.core.IndexedSeq(G__58692__a,0,null);
} 
return G__58690__delegate.call(this,args);};
G__58690.cljs$lang$maxFixedArity = 0;
G__58690.cljs$lang$applyTo = (function (arglist__58693){
var args = cljs.core.seq(arglist__58693);
return G__58690__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58660_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58660_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
