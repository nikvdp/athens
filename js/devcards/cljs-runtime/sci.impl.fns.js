...
var G__59070 = cljs.core.next(args__$1);
var G__59071 = cljs.core.next(params__$1);
var G__59072 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59070;
params__$1 = G__59071;
ret = G__59072;
continue;
...
var vec__59037 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59037,(0),null);
var vec__59040 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59037,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59040,(0),null);
var G__59073 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59073;
continue;
} else {
var G__59074 = recur_val;
args = G__59074;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59077){
...
var map__59045 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59045__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59050){
...
var f = map__59051__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59048_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59048_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59083__delegate = function (args){
...
while (G__59091__i < G__59091__a.length) {G__59091__a[G__59091__i] = arguments[G__59091__i + 0]; ++G__59091__i;}
  args = new cljs.core.IndexedSeq(G__59091__a,0,null);
} 
return G__59083__delegate.call(this,args);};
G__59083.cljs$lang$maxFixedArity = 0;
G__59083.cljs$lang$applyTo = (function (arglist__59092){
var args = cljs.core.seq(arglist__59092);
return G__59083__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59049_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59049_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
