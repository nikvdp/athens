...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57663,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57664__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57664__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57664__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57699 = cljs.core.next(args__$1);
var G__57700 = cljs.core.next(params__$1);
var G__57701 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57699;
params__$1 = G__57700;
ret = G__57701;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57666 = ctx__$1;
var G__57667 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57666,G__57667) : interpret.call(null,G__57666,G__57667));
...
var vec__57671 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57671,(0),null);
var vec__57674 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57671,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57674,(0),null);
var G__57704 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57704;
continue;
} else {
var G__57705 = recur_val;
args = G__57705;
continue;
}
} else {
...
var G__57706__i = 0, G__57706__a = new Array(arguments.length -  0);
while (G__57706__i < G__57706__a.length) {G__57706__a[G__57706__i] = arguments[G__57706__i + 0]; ++G__57706__i;}
  args = new cljs.core.IndexedSeq(G__57706__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57707){
var args = cljs.core.seq(arglist__57707);
...
var map__57683 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57683__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57683__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57693){
...
var f = map__57694__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57694__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57694__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57716__delegate = function (args){
...
while (G__57717__i < G__57717__a.length) {G__57717__a[G__57717__i] = arguments[G__57717__i + 0]; ++G__57717__i;}
  args = new cljs.core.IndexedSeq(G__57717__a,0,null);
} 
return G__57716__delegate.call(this,args);};
G__57716.cljs$lang$maxFixedArity = 0;
G__57716.cljs$lang$applyTo = (function (arglist__57718){
var args = cljs.core.seq(arglist__57718);
return G__57716__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57691_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57691_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57719__delegate = function (args){
...
var G__57719 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57720__i = 0, G__57720__a = new Array(arguments.length -  0);
while (G__57720__i < G__57720__a.length) {G__57720__a[G__57720__i] = arguments[G__57720__i + 0]; ++G__57720__i;}
  args = new cljs.core.IndexedSeq(G__57720__a,0,null);
} 
return G__57719__delegate.call(this,args);};
G__57719.cljs$lang$maxFixedArity = 0;
G__57719.cljs$lang$applyTo = (function (arglist__57721){
var args = cljs.core.seq(arglist__57721);
return G__57719__delegate(args);
});
G__57719.cljs$core$IFn$_invoke$arity$variadic = G__57719__delegate;
return G__57719;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57692_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57692_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
