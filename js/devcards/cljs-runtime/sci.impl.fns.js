...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58331,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58332__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58332__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58332__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58332__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58332__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58376 = cljs.core.next(args__$1);
var G__58377 = cljs.core.next(params__$1);
var G__58378 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58376;
params__$1 = G__58377;
ret = G__58378;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58335 = ctx__$1;
var G__58336 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58335,G__58336) : interpret.call(null,G__58335,G__58336));
...
var vec__58337 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58337,(0),null);
var vec__58340 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58337,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58340,(0),null);
var G__58380 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58380;
continue;
} else {
var G__58384 = recur_val;
args = G__58384;
continue;
}
} else {
...
var G__58385__i = 0, G__58385__a = new Array(arguments.length -  0);
while (G__58385__i < G__58385__a.length) {G__58385__a[G__58385__i] = arguments[G__58385__i + 0]; ++G__58385__i;}
  args = new cljs.core.IndexedSeq(G__58385__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58386){
...
var map__58347 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58347__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58347__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58354){
...
var f = map__58355__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58355__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58355__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58399__i < G__58399__a.length) {G__58399__a[G__58399__i] = arguments[G__58399__i + 0]; ++G__58399__i;}
  args = new cljs.core.IndexedSeq(G__58399__a,0,null);
} 
return G__58396__delegate.call(this,args);};
G__58396.cljs$lang$maxFixedArity = 0;
G__58396.cljs$lang$applyTo = (function (arglist__58400){
var args = cljs.core.seq(arglist__58400);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58352_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58352_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58401__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__58403__i = 0, G__58403__a = new Array(arguments.length -  0);
while (G__58403__i < G__58403__a.length) {G__58403__a[G__58403__i] = arguments[G__58403__i + 0]; ++G__58403__i;}
  args = new cljs.core.IndexedSeq(G__58403__a,0,null);
} 
return G__58401__delegate.call(this,args);};
G__58401.cljs$lang$maxFixedArity = 0;
G__58401.cljs$lang$applyTo = (function (arglist__58404){
var args = cljs.core.seq(arglist__58404);
return G__58401__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58353_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58353_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
