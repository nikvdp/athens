...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59039,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__59041 = p__59039;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59045 = ctx__$1;
var G__59046 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59045,G__59046) : interpret.call(null,G__59045,G__59046));
...
var vec__59048 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59048,(0),null);
var vec__59051 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59048,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59051,(0),null);
var G__59083 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59083;
continue;
} else {
var G__59084 = recur_val;
args = G__59084;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59086){
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59062){
...
var f = map__59063__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59057_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59057_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59094__delegate = function (args){
...
var G__59094 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59100__i = 0, G__59100__a = new Array(arguments.length -  0);
while (G__59100__i < G__59100__a.length) {G__59100__a[G__59100__i] = arguments[G__59100__i + 0]; ++G__59100__i;}
  args = new cljs.core.IndexedSeq(G__59100__a,0,null);
} 
return G__59094__delegate.call(this,args);};
G__59094.cljs$lang$maxFixedArity = 0;
G__59094.cljs$lang$applyTo = (function (arglist__59101){
var args = cljs.core.seq(arglist__59101);
return G__59094__delegate(args);
});
G__59094.cljs$core$IFn$_invoke$arity$variadic = G__59094__delegate;
return G__59094;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59059_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59059_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
