...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57683,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__57684 = p__57683;
...
var _m = map__57684__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57684__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57684__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57684__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57684__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57728 = cljs.core.next(args__$1);
var G__57729 = cljs.core.next(params__$1);
var G__57730 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57728;
params__$1 = G__57729;
ret = G__57730;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57687 = ctx__$1;
var G__57688 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57687,G__57688) : interpret.call(null,G__57687,G__57688));
...
var vec__57689 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57689,(0),null);
var vec__57692 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57689,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57692,(0),null);
var G__57732 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57732;
continue;
} else {
var G__57733 = recur_val;
args = G__57733;
continue;
}
} else {
...
var G__57737__i = 0, G__57737__a = new Array(arguments.length -  0);
while (G__57737__i < G__57737__a.length) {G__57737__a[G__57737__i] = arguments[G__57737__i + 0]; ++G__57737__i;}
  args = new cljs.core.IndexedSeq(G__57737__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57738){
var args = cljs.core.seq(arglist__57738);
...
var map__57699 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57699__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57699__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57706){
...
var f = map__57707__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57707__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57707__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57742__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__57742 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57743__i = 0, G__57743__a = new Array(arguments.length -  0);
while (G__57743__i < G__57743__a.length) {G__57743__a[G__57743__i] = arguments[G__57743__i + 0]; ++G__57743__i;}
  args = new cljs.core.IndexedSeq(G__57743__a,0,null);
} 
return G__57742__delegate.call(this,args);};
G__57742.cljs$lang$maxFixedArity = 0;
G__57742.cljs$lang$applyTo = (function (arglist__57745){
var args = cljs.core.seq(arglist__57745);
return G__57742__delegate(args);
});
G__57742.cljs$core$IFn$_invoke$arity$variadic = G__57742__delegate;
return G__57742;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57704_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57704_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57751__delegate = function (args){
...
while (G__57752__i < G__57752__a.length) {G__57752__a[G__57752__i] = arguments[G__57752__i + 0]; ++G__57752__i;}
  args = new cljs.core.IndexedSeq(G__57752__a,0,null);
} 
return G__57751__delegate.call(this,args);};
G__57751.cljs$lang$maxFixedArity = 0;
G__57751.cljs$lang$applyTo = (function (arglist__57753){
var args = cljs.core.seq(arglist__57753);
return G__57751__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57705_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57705_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
