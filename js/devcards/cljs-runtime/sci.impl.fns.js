...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58541,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58542__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58582 = cljs.core.next(args__$1);
var G__58583 = cljs.core.next(params__$1);
var G__58584 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58582;
params__$1 = G__58583;
ret = G__58584;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58546 = ctx__$1;
var G__58547 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58546,G__58547) : interpret.call(null,G__58546,G__58547));
...
var vec__58549 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58549,(0),null);
var vec__58552 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58549,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58552,(0),null);
var G__58585 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58585;
continue;
} else {
var G__58586 = recur_val;
args = G__58586;
continue;
}
} else {
...
var G__58587__i = 0, G__58587__a = new Array(arguments.length -  0);
while (G__58587__i < G__58587__a.length) {G__58587__a[G__58587__i] = arguments[G__58587__i + 0]; ++G__58587__i;}
  args = new cljs.core.IndexedSeq(G__58587__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58588){
var args = cljs.core.seq(arglist__58588);
...
var map__58557 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58557__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58557__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58562){
...
var f = map__58563__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58563__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58563__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58593__i < G__58593__a.length) {G__58593__a[G__58593__i] = arguments[G__58593__i + 0]; ++G__58593__i;}
  args = new cljs.core.IndexedSeq(G__58593__a,0,null);
} 
return G__58590__delegate.call(this,args);};
G__58590.cljs$lang$maxFixedArity = 0;
G__58590.cljs$lang$applyTo = (function (arglist__58594){
var args = cljs.core.seq(arglist__58594);
return G__58590__delegate(args);
});
G__58590.cljs$core$IFn$_invoke$arity$variadic = G__58590__delegate;
return G__58590;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58560_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58560_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58595__delegate = function (args){
...
while (G__58596__i < G__58596__a.length) {G__58596__a[G__58596__i] = arguments[G__58596__i + 0]; ++G__58596__i;}
  args = new cljs.core.IndexedSeq(G__58596__a,0,null);
} 
return G__58595__delegate.call(this,args);};
G__58595.cljs$lang$maxFixedArity = 0;
G__58595.cljs$lang$applyTo = (function (arglist__58597){
var args = cljs.core.seq(arglist__58597);
return G__58595__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58561_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58561_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
