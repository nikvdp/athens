...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58615,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58616__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58616__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58616__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58655 = cljs.core.next(args__$1);
var G__58656 = cljs.core.next(params__$1);
var G__58657 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58655;
params__$1 = G__58656;
ret = G__58657;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58621 = ctx__$1;
var G__58622 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58621,G__58622) : interpret.call(null,G__58621,G__58622));
...
var vec__58623 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58623,(0),null);
var vec__58626 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58623,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58626,(0),null);
var G__58659 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58659;
continue;
} else {
var G__58660 = recur_val;
args = G__58660;
continue;
}
} else {
...
var map__58631 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58631__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58631__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58636){
var map__58638 = p__58636;
...
var f = map__58638__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58638__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58638__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58665__delegate = function (args){
...
while (G__58666__i < G__58666__a.length) {G__58666__a[G__58666__i] = arguments[G__58666__i + 0]; ++G__58666__i;}
  args = new cljs.core.IndexedSeq(G__58666__a,0,null);
} 
return G__58665__delegate.call(this,args);};
G__58665.cljs$lang$maxFixedArity = 0;
G__58665.cljs$lang$applyTo = (function (arglist__58667){
var args = cljs.core.seq(arglist__58667);
return G__58665__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58633_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58633_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58670__delegate = function (args){
...
var G__58670 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__58676__i < G__58676__a.length) {G__58676__a[G__58676__i] = arguments[G__58676__i + 0]; ++G__58676__i;}
  args = new cljs.core.IndexedSeq(G__58676__a,0,null);
} 
return G__58670__delegate.call(this,args);};
G__58670.cljs$lang$maxFixedArity = 0;
G__58670.cljs$lang$applyTo = (function (arglist__58677){
var args = cljs.core.seq(arglist__58677);
return G__58670__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58634_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58634_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
