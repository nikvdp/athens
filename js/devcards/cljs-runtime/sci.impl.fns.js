...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57653,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__57654__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57654__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57654__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57654__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57654__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57691 = cljs.core.next(args__$1);
var G__57692 = cljs.core.next(params__$1);
var G__57693 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57691;
params__$1 = G__57692;
ret = G__57693;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57658 = ctx__$1;
var G__57659 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57658,G__57659) : interpret.call(null,G__57658,G__57659));
...
var vec__57660 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57660,(0),null);
var vec__57663 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57660,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57663,(0),null);
var G__57696 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57696;
continue;
} else {
var G__57697 = recur_val;
args = G__57697;
continue;
}
} else {
...
var G__57698__i = 0, G__57698__a = new Array(arguments.length -  0);
while (G__57698__i < G__57698__a.length) {G__57698__a[G__57698__i] = arguments[G__57698__i + 0]; ++G__57698__i;}
  args = new cljs.core.IndexedSeq(G__57698__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57699){
var args = cljs.core.seq(arglist__57699);
...
var map__57669 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57669__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57669__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57682){
...
var f = map__57683__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57683__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57683__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57708__delegate = function (args){
...
while (G__57709__i < G__57709__a.length) {G__57709__a[G__57709__i] = arguments[G__57709__i + 0]; ++G__57709__i;}
  args = new cljs.core.IndexedSeq(G__57709__a,0,null);
} 
return G__57708__delegate.call(this,args);};
G__57708.cljs$lang$maxFixedArity = 0;
G__57708.cljs$lang$applyTo = (function (arglist__57710){
var args = cljs.core.seq(arglist__57710);
return G__57708__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57677_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57677_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57711__delegate = function (args){
...
var G__57711 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57713__i = 0, G__57713__a = new Array(arguments.length -  0);
while (G__57713__i < G__57713__a.length) {G__57713__a[G__57713__i] = arguments[G__57713__i + 0]; ++G__57713__i;}
  args = new cljs.core.IndexedSeq(G__57713__a,0,null);
} 
return G__57711__delegate.call(this,args);};
G__57711.cljs$lang$maxFixedArity = 0;
G__57711.cljs$lang$applyTo = (function (arglist__57714){
var args = cljs.core.seq(arglist__57714);
return G__57711__delegate(args);
});
G__57711.cljs$core$IFn$_invoke$arity$variadic = G__57711__delegate;
return G__57711;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57681_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57681_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
