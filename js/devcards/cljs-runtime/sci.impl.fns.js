...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59017,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__59019 = p__59017;
...
var _m = map__59019__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59019__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59019__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59019__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59019__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59061 = cljs.core.next(args__$1);
var G__59062 = cljs.core.next(params__$1);
var G__59063 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59061;
params__$1 = G__59062;
ret = G__59063;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59025 = ctx__$1;
var G__59026 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59025,G__59026) : interpret.call(null,G__59025,G__59026));
...
var vec__59028 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59028,(0),null);
var vec__59031 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59028,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59031,(0),null);
var G__59066 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59066;
continue;
} else {
var G__59067 = recur_val;
args = G__59067;
continue;
}
} else {
...
while (G__59068__i < G__59068__a.length) {G__59068__a[G__59068__i] = arguments[G__59068__i + 0]; ++G__59068__i;}
  args = new cljs.core.IndexedSeq(G__59068__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59069){
var args = cljs.core.seq(arglist__59069);
...
var map__59036 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59036__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59036__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59043){
...
var f = map__59044__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59044__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59044__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59071__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__59071 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59072__i = 0, G__59072__a = new Array(arguments.length -  0);
while (G__59072__i < G__59072__a.length) {G__59072__a[G__59072__i] = arguments[G__59072__i + 0]; ++G__59072__i;}
  args = new cljs.core.IndexedSeq(G__59072__a,0,null);
} 
return G__59071__delegate.call(this,args);};
G__59071.cljs$lang$maxFixedArity = 0;
G__59071.cljs$lang$applyTo = (function (arglist__59073){
var args = cljs.core.seq(arglist__59073);
return G__59071__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59040_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59040_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59074__delegate = function (args){
...
var G__59074 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59077__i = 0, G__59077__a = new Array(arguments.length -  0);
while (G__59077__i < G__59077__a.length) {G__59077__a[G__59077__i] = arguments[G__59077__i + 0]; ++G__59077__i;}
  args = new cljs.core.IndexedSeq(G__59077__a,0,null);
} 
return G__59074__delegate.call(this,args);};
G__59074.cljs$lang$maxFixedArity = 0;
G__59074.cljs$lang$applyTo = (function (arglist__59078){
var args = cljs.core.seq(arglist__59078);
return G__59074__delegate(args);
});
G__59074.cljs$core$IFn$_invoke$arity$variadic = G__59074__delegate;
return G__59074;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59042_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59042_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
