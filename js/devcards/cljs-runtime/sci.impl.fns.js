...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59007,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__59008 = p__59007;
var map__59008__$1 = (((((!((map__59008 == null))))?(((((map__59008.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59008.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__59008):map__59008);
var _m = map__59008__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59008__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59008__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59008__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59008__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59048 = cljs.core.next(args__$1);
var G__59049 = cljs.core.next(params__$1);
var G__59050 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59048;
params__$1 = G__59049;
ret = G__59050;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59013 = ctx__$1;
var G__59014 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59013,G__59014) : interpret.call(null,G__59013,G__59014));
...
var vec__59016 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59016,(0),null);
var vec__59019 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59016,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59019,(0),null);
var G__59053 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59053;
continue;
} else {
var G__59054 = recur_val;
args = G__59054;
continue;
}
} else {
...
while (G__59055__i < G__59055__a.length) {G__59055__a[G__59055__i] = arguments[G__59055__i + 0]; ++G__59055__i;}
  args = new cljs.core.IndexedSeq(G__59055__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59056){
var args = cljs.core.seq(arglist__59056);
...
var map__59023 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59023__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59023__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59030){
...
var f = map__59031__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59031__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59031__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var args = null;
if (arguments.length > 0) {
var G__59059__i = 0, G__59059__a = new Array(arguments.length -  0);
while (G__59059__i < G__59059__a.length) {G__59059__a[G__59059__i] = arguments[G__59059__i + 0]; ++G__59059__i;}
  args = new cljs.core.IndexedSeq(G__59059__a,0,null);
} 
return G__59058__delegate.call(this,args);};
G__59058.cljs$lang$maxFixedArity = 0;
G__59058.cljs$lang$applyTo = (function (arglist__59060){
var args = cljs.core.seq(arglist__59060);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59028_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59028_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59063__delegate = function (args){
...
while (G__59064__i < G__59064__a.length) {G__59064__a[G__59064__i] = arguments[G__59064__i + 0]; ++G__59064__i;}
  args = new cljs.core.IndexedSeq(G__59064__a,0,null);
} 
return G__59063__delegate.call(this,args);};
G__59063.cljs$lang$maxFixedArity = 0;
G__59063.cljs$lang$applyTo = (function (arglist__59065){
var args = cljs.core.seq(arglist__59065);
return G__59063__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59029_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59029_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
