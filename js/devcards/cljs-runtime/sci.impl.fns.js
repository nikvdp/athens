...
var G__59079 = cljs.core.next(args__$1);
var G__59080 = cljs.core.next(params__$1);
var G__59081 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59079;
params__$1 = G__59080;
ret = G__59081;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59056 = ctx__$1;
var G__59057 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59056,G__59057) : interpret.call(null,G__59056,G__59057));
...
var vec__59061 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59061,(0),null);
var vec__59064 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59061,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59064,(0),null);
var G__59089 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59089;
continue;
} else {
var G__59090 = recur_val;
args = G__59090;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59093){
...
var map__59067 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59067__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59067__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59073){
...
var f = map__59074__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59074__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59074__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
G__59095.cljs$lang$applyTo = (function (arglist__59097){
var args = cljs.core.seq(arglist__59097);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59071_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59071_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59099__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__59103__i = 0, G__59103__a = new Array(arguments.length -  0);
while (G__59103__i < G__59103__a.length) {G__59103__a[G__59103__i] = arguments[G__59103__i + 0]; ++G__59103__i;}
  args = new cljs.core.IndexedSeq(G__59103__a,0,null);
} 
return G__59099__delegate.call(this,args);};
G__59099.cljs$lang$maxFixedArity = 0;
G__59099.cljs$lang$applyTo = (function (arglist__59104){
var args = cljs.core.seq(arglist__59104);
return G__59099__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59072_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59072_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
