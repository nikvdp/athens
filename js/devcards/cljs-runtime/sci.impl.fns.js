...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59029,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59030__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59030__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59030__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59030__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59030__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59035 = ctx__$1;
var G__59036 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59035,G__59036) : interpret.call(null,G__59035,G__59036));
...
var G__59074 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59074;
continue;
} else {
var G__59075 = recur_val;
args = G__59075;
continue;
}
} else {
...
var map__59046 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
return (function() { 
var G__59085__delegate = function (args){
...
return G__59085__delegate.call(this,args);};
G__59085.cljs$lang$maxFixedArity = 0;
G__59085.cljs$lang$applyTo = (function (arglist__59093){
var args = cljs.core.seq(arglist__59093);
return G__59085__delegate(args);
});
