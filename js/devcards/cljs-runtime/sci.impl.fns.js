...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59028,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59029__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59029__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59029__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59029__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59029__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59066 = cljs.core.next(args__$1);
var G__59067 = cljs.core.next(params__$1);
var G__59068 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59066;
params__$1 = G__59067;
ret = G__59068;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59034 = ctx__$1;
var G__59035 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59034,G__59035) : interpret.call(null,G__59034,G__59035));
...
var vec__59036 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59036,(0),null);
var vec__59039 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59036,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59039,(0),null);
var G__59071 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59071;
continue;
} else {
var G__59072 = recur_val;
args = G__59072;
continue;
}
} else {
...
while (G__59073__i < G__59073__a.length) {G__59073__a[G__59073__i] = arguments[G__59073__i + 0]; ++G__59073__i;}
  args = new cljs.core.IndexedSeq(G__59073__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59074){
var args = cljs.core.seq(arglist__59074);
...
var map__59044 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59044__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59044__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59048){
...
var f = map__59049__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59049__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59049__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
return G__59076__delegate.call(this,args);};
G__59076.cljs$lang$maxFixedArity = 0;
G__59076.cljs$lang$applyTo = (function (arglist__59078){
var args = cljs.core.seq(arglist__59078);
return G__59076__delegate(args);
});
G__59076.cljs$core$IFn$_invoke$arity$variadic = G__59076__delegate;
return G__59076;
})()
;
...
return (function() { 
var G__59079__delegate = function (args){
...
return G__59079__delegate.call(this,args);};
G__59079.cljs$lang$maxFixedArity = 0;
G__59079.cljs$lang$applyTo = (function (arglist__59083){
var args = cljs.core.seq(arglist__59083);
return G__59079__delegate(args);
});
