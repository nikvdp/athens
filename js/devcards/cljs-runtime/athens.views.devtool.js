...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.devtool.devtool_table_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = (function athens$views$devtool$data_table_$_iter__60912(s__60913){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60915),athens$views$devtool$data_table_$_iter__60912(cljs.core.chunk_rest(s__60913__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60915),null);
}
} else {
var h = cljs.core.first(s__60913__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),h], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),h], null)),athens$views$devtool$data_table_$_iter__60912(cljs.core.rest(s__60913__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$views$devtool$data_table_$_iter__60916(s__60917){
return (new cljs.core.LazySeq(null,(function (){
...
return (function athens$views$devtool$data_table_$_iter__60916_$_iter__60921(s__60922){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60924),athens$views$devtool$data_table_$_iter__60916_$_iter__60921(cljs.core.chunk_rest(s__60922__$2)));
} else {
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$views$devtool$data_table_$_iter__60916_$_iter__60921(cljs.core.rest(s__60922__$2)));
}
} else {
return null;
}
...
return (function athens$views$devtool$data_table_$_iter__60916_$_iter__60926(s__60927){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60929),athens$views$devtool$data_table_$_iter__60916_$_iter__60926(cljs.core.chunk_rest(s__60927__$2)));
} else {
...
return cljs.core.cons((function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$views$devtool$data_table_$_iter__60916_$_iter__60926(cljs.core.rest(s__60927__$2)));
}
} else {
return null;
}
...
;
return iter__4582__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row], null)),athens$views$devtool$data_table_$_iter__60916(cljs.core.rest(s__60917__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__60930_60986 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60931_60987 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60932_60988 = true;
var _STAR_print_fn_STAR__temp_val__60933_60989 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60932_60988);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60933_60989);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60931_60987);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60930_60986);
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.devtool.data_table,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["key","value"], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60934){
...
return cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$views$devtool$maps_viewer_$_iter__60938(s__60939){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60941),athens$views$devtool$maps_viewer_$_iter__60938(cljs.core.chunk_rest(s__60939__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60941),null);
}
} else {
var h = cljs.core.first(s__60939__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h),athens$views$devtool$maps_viewer_$_iter__60938(cljs.core.rest(s__60939__$2)));
}
} else {
return null;
}
...
cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$views$devtool$tuples_viewer_$_iter__60942(s__60943){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60945),athens$views$devtool$tuples_viewer_$_iter__60942(cljs.core.chunk_rest(s__60943__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60945),null);
}
} else {
var i = cljs.core.first(s__60943__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i),athens$views$devtool$tuples_viewer_$_iter__60942(cljs.core.rest(s__60943__$2)));
}
} else {
return null;
}
...
return athens.views.devtool.viewer_preference.indexOf(p1__60946_SHARP_);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60958),athens$views$devtool$data_browser_$_iter__60955(cljs.core.chunk_rest(s__60956__$2)));
} else {
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"0.125rem 0.25rem"], null),new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),((function (nav,i,s__60956__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
...
})(),athens$views$devtool$data_browser_$_iter__60955(cljs.core.rest(s__60956__$2)));
}
} else {
return null;
}
...
athens.views.devtool.eval_with_sci = (function athens$views$devtool$eval_with_sci(p__60963){
...
var state = map__60964__$1;
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
...
var vec__60966 = (function (){try{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(eval_str,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),bindings], null))], null);
}catch (e60969){if((e60969 instanceof Error)){
var e = e60969;
...
var ok_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60966,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60966,(1),null);
...
athens.views.devtool.query_component = (function athens$views$devtool$query_component(p__60970){
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60971__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60971__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
athens.views.devtool.txes_component = (function athens$views$devtool$txes_component(p__60973){
...
var tx_reports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60974__$1,new cljs.core.Keyword(null,"tx-reports","tx-reports",1504634514));
...
var G__60976 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","toggle","devtool/toggle",-1442703685)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60976) : re_frame.core.dispatch.call(null,G__60976));
...
var G__60977 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","toggle","devtool/toggle",-1442703685)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60977) : re_frame.core.dispatch.call(null,G__60977));
...
var map__60978 = cljs.core.deref(state);
...
var active_panel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60978__$1,new cljs.core.Keyword(null,"active-panel","active-panel",-1802545994));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60980__$1)].join('')));
...
var devtool_QMARK_ = cljs.core.deref((function (){var G__60981 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("devtool","open","devtool/open",-1176270029)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60981) : re_frame.core.subscribe.call(null,G__60981));
})());
