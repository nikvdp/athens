 ...
 */
garden.color.map__GT_CSSColor = (function garden$color$map__GT_CSSColor(G__38856){
var extmap__4419__auto__ = (function (){var G__38880 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38856,new cljs.core.Keyword(null,"red","red",-969428204),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"green","green",-945526839),new cljs.core.Keyword(null,"blue","blue",-622100620),new cljs.core.Keyword(null,"hue","hue",-508078848),new cljs.core.Keyword(null,"saturation","saturation",-14247929),new cljs.core.Keyword(null,"lightness","lightness",-2040901930),new cljs.core.Keyword(null,"alpha","alpha",-1574982441)], 0));
if(cljs.core.record_QMARK_(G__38856)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38880);
} else {
return G__38880;
}
})();
return (new garden.color.CSSColor(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"green","green",-945526839).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"blue","blue",-622100620).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"hue","hue",-508078848).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"saturation","saturation",-14247929).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"lightness","lightness",-2040901930).cljs$core$IFn$_invoke$arity$1(G__38856),new cljs.core.Keyword(null,"alpha","alpha",-1574982441).cljs$core$IFn$_invoke$arity$1(G__38856),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var vs = vec__38888;
if(cljs.core.every_QMARK_((function (p1__38883_SHARP_){
return garden.util.between_QMARK_(p1__38883_SHARP_,(0),(255));
}),vs)){
...
var vec__38931 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38931,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38931,(1),null);
var hex__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((3),cljs.core.count(hex)))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__38925_SHARP_){
return (new cljs.core.List(null,p1__38925_SHARP_,(new cljs.core.List(null,p1__38925_SHARP_,null,(1),null)),(2),null));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([hex], 0))):hex);
return garden.color.rgb.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38926_SHARP_){
return garden.util.string__GT_int.cljs$core$IFn$_invoke$arity$variadic(p1__38926_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(16)], 0));
 ...
 */
garden.color.rgb__GT_hex = (function garden$color$rgb__GT_hex(p__38941){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38942__$1,new cljs.core.Keyword(null,"red","red",-969428204));
var g = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38942__$1,new cljs.core.Keyword(null,"green","green",-945526839));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38942__$1,new cljs.core.Keyword(null,"blue","blue",-622100620));
 ...
 */
garden.color.rgb__GT_hsl = (function garden$color$rgb__GT_hsl(p__38960){
var map__38963 = p__38960;
var map__38963__$1 = (((((!((map__38963 == null))))?(((((map__38963.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38963.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38963):map__38963);
var color = map__38963__$1;
var red = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38963__$1,new cljs.core.Keyword(null,"red","red",-969428204));
var green = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38963__$1,new cljs.core.Keyword(null,"green","green",-945526839));
var blue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38963__$1,new cljs.core.Keyword(null,"blue","blue",-622100620));
if(garden.color.hsl_QMARK_(color)){
return color;
} else {
var vec__38967 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38959_SHARP_){
return (p1__38959_SHARP_ / (255));
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [red,green,blue], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38967,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38967,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38967,(2),null);
...
var d = (mx - mn);
var h = (function (){var pred__38975 = cljs.core._EQ_;
var expr__38976 = mx;
if(cljs.core.truth_((pred__38975.cljs$core$IFn$_invoke$arity$2 ? pred__38975.cljs$core$IFn$_invoke$arity$2(mn,expr__38976) : pred__38975.call(null,mn,expr__38976)))){
return (0);
} else {
if(cljs.core.truth_((pred__38975.cljs$core$IFn$_invoke$arity$2 ? pred__38975.cljs$core$IFn$_invoke$arity$2(r,expr__38976) : pred__38975.call(null,r,expr__38976)))){
return ((60) * ((g - b) / d));
} else {
if(cljs.core.truth_((pred__38975.cljs$core$IFn$_invoke$arity$2 ? pred__38975.cljs$core$IFn$_invoke$arity$2(g,expr__38976) : pred__38975.call(null,g,expr__38976)))){
return (((60) * ((b - r) / d)) + (120));
} else {
if(cljs.core.truth_((pred__38975.cljs$core$IFn$_invoke$arity$2 ? pred__38975.cljs$core$IFn$_invoke$arity$2(b,expr__38976) : pred__38975.call(null,b,expr__38976)))){
return (((60) * ((r - g) / d)) + (240));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__38976)].join('')));
}
}
}
}
 ...
 */
garden.color.hsl__GT_rgb = (function garden$color$hsl__GT_rgb(p__38984){
var map__38986 = p__38984;
var map__38986__$1 = (((((!((map__38986 == null))))?(((((map__38986.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38986.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38986):map__38986);
var color = map__38986__$1;
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38986__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38986__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38986__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
var m1 = (((2) * l) - m2);
var vec__38990 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38982_SHARP_){
return ((0.5 + (p1__38982_SHARP_ * (255))) | (0));
...
var G__39197__delegate = function (a,b,more){
...
var G__39197 = function (a,b,var_args){
var more = null;
if (arguments.length > 2) {
var G__39198__i = 0, G__39198__a = new Array(arguments.length -  2);
while (G__39198__i < G__39198__a.length) {G__39198__a[G__39198__i] = arguments[G__39198__i + 2]; ++G__39198__i;}
  more = new cljs.core.IndexedSeq(G__39198__a,0,null);
} 
return G__39197__delegate.call(this,a,b,more);};
G__39197.cljs$lang$maxFixedArity = 2;
G__39197.cljs$lang$applyTo = (function (arglist__39200){
var a = cljs.core.first(arglist__39200);
arglist__39200 = cljs.core.next(arglist__39200);
var b = cljs.core.first(arglist__39200);
var more = cljs.core.rest(arglist__39200);
return G__39197__delegate(a,b,more);
});
...
var G__39201 = null;
if (arguments.length > 2) {
var G__39202__i = 0, G__39202__a = new Array(arguments.length -  2);
while (G__39202__i < G__39202__a.length) {G__39202__a[G__39202__i] = arguments[G__39202__i + 2]; ++G__39202__i;}
G__39201 = new cljs.core.IndexedSeq(G__39202__a,0,null);
}
return garden$color$make_color_operation_$_color_op__3.cljs$core$IFn$_invoke$arity$variadic(a,b, G__39201);
}
...
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__39017) : garden.color.as_color.call(null,G__39017));
});
/**
...
var len__4736__auto___39204 = arguments.length;
var i__4737__auto___39205 = (0);
while(true){
if((i__4737__auto___39205 < len__4736__auto___39204)){
args_arr__4757__auto__.push((arguments[i__4737__auto___39205]));

var G__39206 = (i__4737__auto___39205 + (1));
i__4737__auto___39205 = G__39206;
continue;
} else {
}
break;
...
var G__39024 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(garden.util.average,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c1,c2], 0));
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__39024) : garden.color.as_color.call(null,G__39024));
}));
...
var len__4736__auto___39207 = arguments.length;
var i__4737__auto___39208 = (0);
while(true){
if((i__4737__auto___39208 < len__4736__auto___39207)){
args__4742__auto__.push((arguments[i__4737__auto___39208]));

var G__39209 = (i__4737__auto___39208 + (1));
i__4737__auto___39208 = G__39209;
continue;
} else {
}
break;
...
var vec__39101 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39100_SHARP_){
return (p1__39100_SHARP_ / (100));
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((100) - weight),weight], null));
var weight_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39101,(0),null);
var weight_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39101,(1),null);
var vec__39104 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(garden.color.hex__GT_long,garden.color.as_hex),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [color_1,color_2], null));
var long_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39104,(0),null);
var long_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39104,(1),null);
