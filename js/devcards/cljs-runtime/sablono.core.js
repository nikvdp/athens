...
var iter__4582__auto__ = (function sablono$core$update_arglists_$_iter__41797(s__41798){
return (new cljs.core.LazySeq(null,(function (){
var s__41798__$1 = s__41798;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__41798__$1);
if(temp__5735__auto__){
var s__41798__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41798__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__41798__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__41800 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__41799 = (0);
while(true){
if((i__41799 < size__4581__auto__)){
var args = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__41799);
cljs.core.chunk_append(b__41800,cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)));

var G__41982 = (i__41799 + (1));
i__41799 = G__41982;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41800),sablono$core$update_arglists_$_iter__41797(cljs.core.chunk_rest(s__41798__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41800),null);
}
} else {
var args = cljs.core.first(s__41798__$2);
return cljs.core.cons(cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)),sablono$core$update_arglists_$_iter__41797(cljs.core.rest(s__41798__$2)));
}
} else {
return null;
}
...
var iter__4582__auto__ = (function sablono$core$iter__41806(s__41807){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__41807__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__41809 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__41808 = (0);
while(true){
if((i__41808 < size__4581__auto__)){
var style = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__41808);
cljs.core.chunk_append(b__41809,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41809),sablono$core$iter__41806(cljs.core.chunk_rest(s__41807__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41809),null);
}
} else {
var style = cljs.core.first(s__41807__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null),sablono$core$iter__41806(cljs.core.rest(s__41807__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(sablono.core.include_css.cljs$lang$applyTo = (function (seq41804){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq41804));
}));
...
var G__41827 = goog.dom.getDocument().body;
var G__41828 = (function (){var G__41831 = "script";
var G__41832 = ({"src": src});
return goog.dom.createDom(G__41831,G__41832);
})();
return goog.dom.appendChild(G__41827,G__41828);
});
/**
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41839,seq41838__$1);
}));
 ...
 */
sablono.core.mail_to41844 = (function sablono$core$mail_to41844(var_args){
var args__4795__auto__ = [];
...
var argseq__4796__auto__ = ((((1) < args__4795__auto__.length))?(new cljs.core.IndexedSeq(args__4795__auto__.slice((1)),(0),null)):null);
return sablono.core.mail_to41844.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});

(sablono.core.mail_to41844.cljs$core$IFn$_invoke$arity$variadic = (function (e_mail,p__41851){
var vec__41853 = p__41851;
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(0),null);
...
(sablono.core.mail_to41844.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(sablono.core.mail_to41844.cljs$lang$applyTo = (function (seq41847){
var G__41848 = cljs.core.first(seq41847);
var seq41847__$1 = cljs.core.next(seq41847);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41848,seq41847__$1);
}));


sablono.core.mail_to = sablono.core.wrap_attrs(sablono.core.mail_to41844);
/**
 * Wrap a collection in an unordered list.
 */
sablono.core.unordered_list41860 = (function sablono$core$unordered_list41860(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__4582__auto__ = (function sablono$core$unordered_list41860_$_iter__41861(s__41862){
return (new cljs.core.LazySeq(null,(function (){
var s__41862__$1 = s__41862;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__41862__$1);
if(temp__5735__auto__){
var s__41862__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41862__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__41862__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__41864 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__41863 = (0);
while(true){
if((i__41863 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__41863);
cljs.core.chunk_append(b__41864,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null));

var G__41993 = (i__41863 + (1));
i__41863 = G__41993;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41864),sablono$core$unordered_list41860_$_iter__41861(cljs.core.chunk_rest(s__41862__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41864),null);
}
} else {
var x = cljs.core.first(s__41862__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$unordered_list41860_$_iter__41861(cljs.core.rest(s__41862__$2)));
}
} else {
return null;
}
...
sablono.core.unordered_list = sablono.core.wrap_attrs(sablono.core.unordered_list41860);
/**
 * Wrap a collection in an ordered list.
 */
sablono.core.ordered_list41866 = (function sablono$core$ordered_list41866(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol","ol",932524051),(function (){var iter__4582__auto__ = (function sablono$core$ordered_list41866_$_iter__41868(s__41869){
return (new cljs.core.LazySeq(null,(function (){
var s__41869__$1 = s__41869;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__41869__$1);
if(temp__5735__auto__){
var s__41869__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41869__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__41869__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__41871 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__41870 = (0);
while(true){
if((i__41870 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__41870);
cljs.core.chunk_append(b__41871,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null));

var G__41996 = (i__41870 + (1));
i__41870 = G__41996;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41871),sablono$core$ordered_list41866_$_iter__41868(cljs.core.chunk_rest(s__41869__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41871),null);
}
} else {
var x = cljs.core.first(s__41869__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$ordered_list41866_$_iter__41868(cljs.core.rest(s__41869__$2)));
}
} else {
return null;
}
...
sablono.core.ordered_list = sablono.core.wrap_attrs(sablono.core.ordered_list41866);
/**
 * Create an image element.
 */
sablono.core.image41878 = (function sablono$core$image41878(var_args){
var G__41880 = arguments.length;
switch (G__41880) {
case 1:
return sablono.core.image41878.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.image41878.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.image41878.cljs$core$IFn$_invoke$arity$1 = (function (src){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"src","src",-1651076051),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([src], 0))], null)], null);
}));

(sablono.core.image41878.cljs$core$IFn$_invoke$arity$2 = (function (src,alt){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([src], 0)),new cljs.core.Keyword(null,"alt","alt",-3214426),alt], null)], null);
}));

(sablono.core.image41878.cljs$lang$maxFixedArity = 2);


sablono.core.image = sablono.core.wrap_attrs(sablono.core.image41878);
