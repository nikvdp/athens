...
var G__41844 = cljs.core.first(seq41842);
var seq41842__$1 = cljs.core.next(seq41842);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41844,seq41842__$1);
}));
...
(sablono.core.mail_to41853.cljs$core$IFn$_invoke$arity$variadic = (function (e_mail,p__41856){
 ...
 */
sablono.core.unordered_list41862 = (function sablono$core$unordered_list41862(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__4582__auto__ = (function sablono$core$unordered_list41862_$_iter__41867(s__41868){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41870),sablono$core$unordered_list41862_$_iter__41867(cljs.core.chunk_rest(s__41868__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41870),null);
}
} else {
var x = cljs.core.first(s__41868__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$unordered_list41862_$_iter__41867(cljs.core.rest(s__41868__$2)));
}
} else {
return null;
}
...
sablono.core.unordered_list = sablono.core.wrap_attrs(sablono.core.unordered_list41862);
/**
 * Wrap a collection in an ordered list.
 */
sablono.core.ordered_list41873 = (function sablono$core$ordered_list41873(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol","ol",932524051),(function (){var iter__4582__auto__ = (function sablono$core$ordered_list41873_$_iter__41878(s__41879){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41881),sablono$core$ordered_list41873_$_iter__41878(cljs.core.chunk_rest(s__41879__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41881),null);
}
} else {
var x = cljs.core.first(s__41879__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$ordered_list41873_$_iter__41878(cljs.core.rest(s__41879__$2)));
}
} else {
return null;
}
