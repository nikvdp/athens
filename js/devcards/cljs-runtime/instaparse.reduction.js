...
var G__56231 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__56234(s__56235){
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56238,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56238,(1),null);
cljs.core.chunk_append(b__56237,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__56247 = (i__56236 + (1));
i__56236 = G__56247;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56237),instaparse$reduction$iter__56234(cljs.core.chunk_rest(s__56235__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56237),null);
}
} else {
var vec__56241 = cljs.core.first(s__56235__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56241,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56241,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__56234(cljs.core.rest(s__56235__$2)));
}
} else {
return null;
}
