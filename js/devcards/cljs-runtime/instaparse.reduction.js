...
var G__55935 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__55938(s__55939){
return (new cljs.core.LazySeq(null,(function (){
var s__55939__$1 = s__55939;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55939__$1);
if(temp__5735__auto__){
var s__55939__$2 = temp__5735__auto__;
...
var vec__55942 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55940);
...
cljs.core.chunk_append(b__55941,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__55950 = (i__55940 + (1));
i__55940 = G__55950;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55941),instaparse$reduction$iter__55938(cljs.core.chunk_rest(s__55939__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55941),null);
}
} else {
var vec__55945 = cljs.core.first(s__55939__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55945,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55945,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__55938(cljs.core.rest(s__55939__$2)));
}
} else {
return null;
}
