...
var G__55059 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__55059__$1 = (((G__55059 instanceof cljs.core.Keyword))?G__55059.fqn:null);
switch (G__55059__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__55062(s__55063){
...
var vec__55066 = cljs.core._nth(c__4527__auto__,i__55064);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55066,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55066,(1),null);
cljs.core.chunk_append(b__55065,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__55074 = (i__55064 + (1));
i__55064 = G__55074;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55065),instaparse$reduction$iter__55062(cljs.core.chunk_rest(s__55063__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55065),null);
}
} else {
var vec__55069 = cljs.core.first(s__55063__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55069,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55069,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__55062(cljs.core.rest(s__55063__$2)));
}
} else {
return null;
}
