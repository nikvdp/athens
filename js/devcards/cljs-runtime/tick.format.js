...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50861 = goog.object.get(JSJodaLocale,"Locale");
if((G__50861 == null)){
return null;
} else {
return goog.object.get(G__50861,"US");
}
}catch (e50860){if((e50860 instanceof Error)){
var e = e50860;
return null;
} else {
throw e50860;
