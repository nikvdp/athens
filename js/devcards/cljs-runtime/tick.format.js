...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__34511 = goog.object.get(JSJodaLocale,"Locale");
if((G__34511 == null)){
return null;
} else {
return goog.object.get(G__34511,"US");
}
}catch (e34508){if((e34508 instanceof Error)){
var e = e34508;
return null;
} else {
throw e34508;
