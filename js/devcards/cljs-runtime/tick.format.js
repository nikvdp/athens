...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__34495 = goog.object.get(JSJodaLocale,"Locale");
if((G__34495 == null)){
return null;
} else {
return goog.object.get(G__34495,"US");
}
}catch (e34494){if((e34494 instanceof Error)){
var e = e34494;
return null;
} else {
throw e34494;
