...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50883 = goog.object.get(JSJodaLocale,"Locale");
if((G__50883 == null)){
return null;
} else {
return goog.object.get(G__50883,"US");
}
}catch (e50882){if((e50882 instanceof Error)){
var e = e50882;
return null;
} else {
throw e50882;
