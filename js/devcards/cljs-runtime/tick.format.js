...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50884 = goog.object.get(JSJodaLocale,"Locale");
if((G__50884 == null)){
return null;
} else {
return goog.object.get(G__50884,"US");
}
}catch (e50883){if((e50883 instanceof Error)){
var e = e50883;
return null;
} else {
throw e50883;
