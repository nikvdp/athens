...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51163 = goog.object.get(JSJodaLocale,"Locale");
if((G__51163 == null)){
return null;
} else {
return goog.object.get(G__51163,"US");
}
}catch (e51160){if((e51160 instanceof Error)){
var e = e51160;
return null;
} else {
throw e51160;
