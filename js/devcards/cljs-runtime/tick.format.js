...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50912 = goog.object.get(JSJodaLocale,"Locale");
if((G__50912 == null)){
return null;
} else {
return goog.object.get(G__50912,"US");
}
}catch (e50909){if((e50909 instanceof Error)){
var e = e50909;
return null;
} else {
throw e50909;
