...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50863 = goog.object.get(JSJodaLocale,"Locale");
if((G__50863 == null)){
return null;
} else {
return goog.object.get(G__50863,"US");
}
}catch (e50862){if((e50862 instanceof Error)){
var e = e50862;
return null;
} else {
throw e50862;
