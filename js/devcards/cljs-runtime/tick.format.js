...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__26175 = goog.object.get(JSJodaLocale,"Locale");
if((G__26175 == null)){
return null;
} else {
return goog.object.get(G__26175,"US");
}
}catch (e26174){if((e26174 instanceof Error)){
var e = e26174;
return null;
} else {
throw e26174;
