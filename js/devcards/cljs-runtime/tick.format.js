...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51154 = goog.object.get(JSJodaLocale,"Locale");
if((G__51154 == null)){
return null;
} else {
return goog.object.get(G__51154,"US");
}
}catch (e51151){if((e51151 instanceof Error)){
var e = e51151;
return null;
} else {
throw e51151;
