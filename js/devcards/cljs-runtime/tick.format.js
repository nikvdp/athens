...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__34559 = goog.object.get(JSJodaLocale,"Locale");
if((G__34559 == null)){
return null;
} else {
return goog.object.get(G__34559,"US");
}
}catch (e34557){if((e34557 instanceof Error)){
var e = e34557;
return null;
} else {
throw e34557;
