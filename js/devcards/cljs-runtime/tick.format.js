...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50865 = goog.object.get(JSJodaLocale,"Locale");
if((G__50865 == null)){
return null;
} else {
return goog.object.get(G__50865,"US");
}
}catch (e50863){if((e50863 instanceof Error)){
var e = e50863;
return null;
} else {
throw e50863;
