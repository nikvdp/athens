...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50877 = goog.object.get(JSJodaLocale,"Locale");
if((G__50877 == null)){
return null;
} else {
return goog.object.get(G__50877,"US");
}
}catch (e50874){if((e50874 instanceof Error)){
var e = e50874;
return null;
} else {
throw e50874;
