...
while(true){
if((!((coll__$1 == null)))){
var G__56258 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56259 = cljs.core.next(coll__$1);
unmixed_hash = G__56258;
coll__$1 = G__56259;
continue;
} else {
return unmixed_hash;
...
var G__56260 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56261 = cljs.core.next(v);
acc = G__56260;
v = G__56261;
continue;
} else {
var G__56262 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56263 = cljs.core.next(v);
acc = G__56262;
v = G__56263;
continue;
}
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56217){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56217)));
}));
