...
var G__56265 = n__$1;
var G__56266 = y;
var G__56267 = cljs.core.imul(z,z);
n = G__56265;
y = G__56266;
z = G__56267;
continue;
...
var G__56268 = n__$1;
var G__56269 = cljs.core.imul(z,y);
var G__56270 = cljs.core.imul(z,z);
n = G__56268;
y = G__56269;
z = G__56270;
continue;
...
var G__56271 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56272 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56271;
index__$1 = G__56272;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56209 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56209) : instaparse.auto_flatten_seq.true_count.call(null,G__56209));
})() - (1)))){
...
var G__56273 = v;
var G__56274 = cljs.core.pop(index);
v = G__56273;
index = G__56274;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56294 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56295 = cljs.core.next(coll__$1);
unmixed_hash = G__56294;
coll__$1 = G__56295;
continue;
} else {
return unmixed_hash;
...
var G__56300 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56301 = cljs.core.next(v);
acc = G__56300;
v = G__56301;
continue;
} else {
var G__56302 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56303 = cljs.core.next(v);
acc = G__56302;
v = G__56303;
continue;
}
...
var self__ = this;
var self__ = this;
var G__56264 = (arguments.length - (1));
switch (G__56264) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56260){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56260)));
}));
