...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54986 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54986(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54987 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54987(self);
}
});
...
var G__54988 = n__$1;
var G__54989 = y;
var G__54990 = cljs.core.imul(z,z);
n = G__54988;
y = G__54989;
z = G__54990;
continue;
...
var G__54991 = n__$1;
var G__54992 = cljs.core.imul(z,y);
var G__54993 = cljs.core.imul(z,z);
n = G__54991;
y = G__54992;
z = G__54993;
continue;
...
var G__54994 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__54995 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__54994;
index__$1 = G__54995;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__54932 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__54932) : instaparse.auto_flatten_seq.true_count.call(null,G__54932));
})() - (1)))){
...
var G__54996 = v;
var G__54997 = cljs.core.pop(index);
v = G__54996;
index = G__54997;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55007 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55008 = cljs.core.next(coll__$1);
unmixed_hash = G__55007;
coll__$1 = G__55008;
continue;
} else {
return unmixed_hash;
...
var G__55013 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55014 = cljs.core.next(v);
acc = G__55013;
v = G__55014;
continue;
} else {
var G__55015 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55016 = cljs.core.next(v);
acc = G__55015;
v = G__55016;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55017 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55017(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.call = (function (unused__10641__auto__){
var self__ = this;
var self__ = this;
var G__54985 = (arguments.length - (1));
switch (G__54985) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54971){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54971)));
}));
