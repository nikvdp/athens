...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54974 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54974(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54975 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54975(self);
}
});
...
while(true){
if((!((coll__$1 == null)))){
var G__54995 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__54996 = cljs.core.next(coll__$1);
unmixed_hash = G__54995;
coll__$1 = G__54996;
continue;
} else {
return unmixed_hash;
...
var G__55001 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55002 = cljs.core.next(v);
acc = G__55001;
v = G__55002;
continue;
} else {
var G__55003 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55004 = cljs.core.next(v);
acc = G__55003;
v = G__55004;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55005 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55005(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54970 = (arguments.length - (1));
switch (G__54970) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54958){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54958)));
}));
