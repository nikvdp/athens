...
while(true){
if((!((coll__$1 == null)))){
var G__55000 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55001 = cljs.core.next(coll__$1);
unmixed_hash = G__55000;
coll__$1 = G__55001;
continue;
} else {
return unmixed_hash;
...
var G__55005 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55006 = cljs.core.next(v);
acc = G__55005;
v = G__55006;
continue;
} else {
var G__55007 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55008 = cljs.core.next(v);
acc = G__55007;
v = G__55008;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55013 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55013(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54982 = (arguments.length - (1));
switch (G__54982) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54964){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54964)));
}));
