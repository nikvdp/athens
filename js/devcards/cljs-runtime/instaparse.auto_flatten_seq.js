...
var G__56276 = n__$1;
var G__56277 = y;
var G__56278 = cljs.core.imul(z,z);
n = G__56276;
y = G__56277;
z = G__56278;
continue;
...
var G__56279 = n__$1;
var G__56280 = cljs.core.imul(z,y);
var G__56281 = cljs.core.imul(z,z);
n = G__56279;
y = G__56280;
z = G__56281;
continue;
...
var G__56282 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56283 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56282;
index__$1 = G__56283;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56218 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56218) : instaparse.auto_flatten_seq.true_count.call(null,G__56218));
})() - (1)))){
...
var G__56288 = v;
var G__56289 = cljs.core.pop(index);
v = G__56288;
index = G__56289;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56327 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56328 = cljs.core.next(coll__$1);
unmixed_hash = G__56327;
coll__$1 = G__56328;
continue;
} else {
return unmixed_hash;
...
var G__56337 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56338 = cljs.core.next(v);
acc = G__56337;
v = G__56338;
continue;
} else {
var G__56339 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56340 = cljs.core.next(v);
acc = G__56339;
v = G__56340;
continue;
}
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56267){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56267)));
}));
