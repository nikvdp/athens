...
var G__56247 = n__$1;
var G__56248 = y;
var G__56249 = cljs.core.imul(z,z);
n = G__56247;
y = G__56248;
z = G__56249;
continue;
...
var G__56250 = n__$1;
var G__56251 = cljs.core.imul(z,y);
var G__56252 = cljs.core.imul(z,z);
n = G__56250;
y = G__56251;
z = G__56252;
continue;
...
var G__56253 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56254 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56253;
index__$1 = G__56254;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56191 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56191) : instaparse.auto_flatten_seq.true_count.call(null,G__56191));
})() - (1)))){
...
var G__56255 = v;
var G__56256 = cljs.core.pop(index);
v = G__56255;
index = G__56256;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56259 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56260 = cljs.core.next(coll__$1);
unmixed_hash = G__56259;
coll__$1 = G__56260;
continue;
} else {
return unmixed_hash;
...
var G__56264 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56265 = cljs.core.next(v);
acc = G__56264;
v = G__56265;
continue;
} else {
var G__56266 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56267 = cljs.core.next(v);
acc = G__56266;
v = G__56267;
continue;
}
...
var self__ = this;
var self__ = this;
var G__56239 = (arguments.length - (1));
switch (G__56239) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56225){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56225)));
}));
