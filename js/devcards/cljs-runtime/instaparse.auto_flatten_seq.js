...
var G__56177 = n__$1;
var G__56178 = cljs.core.imul(z,y);
var G__56179 = cljs.core.imul(z,z);
n = G__56177;
y = G__56178;
z = G__56179;
continue;
...
var G__56180 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56181 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56180;
index__$1 = G__56181;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56131 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56131) : instaparse.auto_flatten_seq.true_count.call(null,G__56131));
})() - (1)))){
...
var G__56182 = v;
var G__56183 = cljs.core.pop(index);
v = G__56182;
index = G__56183;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56188 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56189 = cljs.core.next(coll__$1);
unmixed_hash = G__56188;
coll__$1 = G__56189;
continue;
} else {
return unmixed_hash;
...
var G__56190 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56191 = cljs.core.next(v);
acc = G__56190;
v = G__56191;
continue;
} else {
var G__56192 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56193 = cljs.core.next(v);
acc = G__56192;
v = G__56193;
continue;
}
...
var self__ = this;
var self__ = this;
var G__56168 = (arguments.length - (1));
switch (G__56168) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56165){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56165)));
}));
