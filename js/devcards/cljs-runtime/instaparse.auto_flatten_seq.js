...
var G__55856 = n__$1;
var G__55857 = y;
var G__55858 = cljs.core.imul(z,z);
n = G__55856;
y = G__55857;
z = G__55858;
continue;
...
var G__55859 = n__$1;
var G__55860 = cljs.core.imul(z,y);
...
var G__55866 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__55867 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__55866;
index__$1 = G__55867;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__55803 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__55803) : instaparse.auto_flatten_seq.true_count.call(null,G__55803));
})() - (1)))){
...
var G__55868 = v;
var G__55869 = cljs.core.pop(index);
v = G__55868;
index = G__55869;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55915 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55916 = cljs.core.next(coll__$1);
unmixed_hash = G__55915;
coll__$1 = G__55916;
continue;
} else {
return unmixed_hash;
...
var G__55917 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55918 = cljs.core.next(v);
acc = G__55917;
v = G__55918;
continue;
} else {
var G__55919 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55920 = cljs.core.next(v);
acc = G__55919;
v = G__55920;
continue;
}
...
var self__ = this;
var self__ = this;
var G__55848 = (arguments.length - (1));
switch (G__55848) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args55847){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args55847)));
}));
