...
})(),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),["0 0 0 0.125rem ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(athens.style.color.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"body-text-color","body-text-color",-349110936)))].join(''),new cljs.core.Keyword(null,"opacity","opacity",397153780),new cljs.core.Keyword(null,"opacity-med","opacity-med",1700530190).cljs$core$IFn$_invoke$arity$1(athens.style.OPACITIES)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&.closed-with-children","&.closed-with-children",-466895087),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58418 = (garden.selectors.before.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.before.cljs$core$IFn$_invoke$arity$0() : garden.selectors.before.call(null));
...
athens.views.blocks.block_content_style = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"position","position",-2011731912),"relative",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"visible",new cljs.core.Keyword(null,"flex-grow","flex-grow",1865160747),"1",new cljs.core.Keyword(null,"word-break","word-break",-407281356),"break-word",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"none"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&:hover","&:hover",-852658855),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58419 = (function (){var G__58420 = new cljs.core.Keyword(null,".is-editing",".is-editing",-747838493);
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__58420) : garden.selectors.not.call(null,G__58420));
})();
...
var G__58421 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function() { 
var G__58518__delegate = function (title){
...
var now_58519 = athens.util.now_ts();
var uid_58520 = athens.util.gen_block_uid();
(db_fn.cljs$core$IFn$_invoke$arity$3 ? db_fn.cljs$core$IFn$_invoke$arity$3(inner_title,now_58519,uid_58520) : db_fn.call(null,inner_title,now_58519,uid_58520));
} else {
}

return ["[[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(inner_title),"]]"].join('');
};
var G__58518 = function (var_args){
var title = null;
...
while (G__58522__i < G__58522__a.length) {G__58522__a[G__58522__i] = arguments[G__58522__i + 0]; ++G__58522__i;}
  title = new cljs.core.IndexedSeq(G__58522__a,0,null);
} 
return G__58518__delegate.call(this,title);};
G__58518.cljs$lang$maxFixedArity = 0;
G__58518.cljs$lang$applyTo = (function (arglist__58523){
var title = cljs.core.seq(arglist__58523);
return G__58518__delegate(title);
});
G__58518.cljs$core$IFn$_invoke$arity$variadic = G__58518__delegate;
return G__58518;
})()
...
var now_58524 = athens.util.now_ts();
var uid_58525 = athens.util.gen_block_uid();
(db_fn.cljs$core$IFn$_invoke$arity$3 ? db_fn.cljs$core$IFn$_invoke$arity$3(title,now_58524,uid_58525) : db_fn.call(null,title,now_58524,uid_58525));
} else {
}

return ["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(title)].join('');
})], null);
var G__58422 = athens.parser.parse_to_ast(source_str);
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58421,G__58422) : instaparse.core.transform.call(null,G__58421,G__58422));
});
athens.views.blocks.on_change = (function athens$views$blocks$on_change(oldvalue,value,uid){
var G__58423_58526 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),value,new cljs.core.Keyword("edit","time","edit/time",1384867476),athens.util.now_ts()], null)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58423_58526) : re_frame.core.dispatch.call(null,G__58423_58526));
...
var G__58424 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("node","title","node/title",628940777),inner_title,new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476),now_time,new cljs.core.Keyword("create","time","create/time",-1563077754),now_time], null)], null)], null);
...
if((!((uid__$1 == null)))){
var G__58425 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("page","delete","page/delete",-1774686917),uid__$1], null);
...
var G__58426 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),id,new cljs.core.Keyword("block","open","block/open",-1875254829),cljs.core.not(open)], null)], null)], null);
...
athens.views.blocks.toggle_el = (function athens$views$blocks$toggle_el(p__58427){
var map__58428 = p__58427;
var map__58428__$1 = (((((!((map__58428 == null))))?(((((map__58428.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58428.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58428):map__58428);
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58428__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58428__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58428__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
...
athens.views.blocks.tooltip_el = (function athens$views$blocks$tooltip_el(p__58430,state){
...
var dbid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
var map__58433 = cljs.core.deref(state);
...
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58433__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58433__$1,new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058));
...
var vec__58441 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58439);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58441,(0),null);
var map__58444 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58441,(1),null);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58444__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58444__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58444__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
cljs.core.chunk_append(b__58440,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58439,vec__58441,i,map__58444,map__58444__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58440,s__58438__$2,temp__5735__auto__,map__58435,map__58435__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(i__58439,vec__58441,i,map__58444,map__58444__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58440,s__58438__$2,temp__5735__auto__,map__58435,map__58435__$1,query,results,index,type))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58440),athens$views$blocks$inline_search_el_$_iter__58437(cljs.core.chunk_rest(s__58438__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58440),null);
}
} else {
var vec__58446 = cljs.core.first(s__58438__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58446,(0),null);
var map__58449 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58446,(1),null);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58449__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58449__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58449__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58446,i,map__58449,map__58449__$1,title,string,uid,s__58438__$2,temp__5735__auto__,map__58435,map__58435__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(vec__58446,i,map__58449,map__58449__$1,title,string,uid,s__58438__$2,temp__5735__auto__,map__58435,map__58435__$1,query,results,index,type))
,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index,i),new cljs.core.Keyword(null,"id","id",-1388402092),["result-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null),(function (){var or__4185__auto__ = title;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["inline-search-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(uid)].join('')], null)),athens$views$blocks$inline_search_el_$_iter__58437(cljs.core.rest(s__58438__$2)));
}
} else {
return null;
}
...
var map__58451 = cljs.core.deref(state);
...
var vec__58457 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58455);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58457,(0),null);
var vec__58460 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58457,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58460,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58460,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58460,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58460,(3),null);
cljs.core.chunk_append(b__58456,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58455,vec__58457,i,vec__58460,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58456,s__58454__$2,temp__5735__auto__,map__58451,map__58451__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(i__58455,vec__58457,i,vec__58460,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58456,s__58454__$2,temp__5735__auto__,map__58451,map__58451__$1,index))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58456),athens$views$blocks$slash_menu_el_$_iter__58453(cljs.core.chunk_rest(s__58454__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58456),null);
}
} else {
var vec__58463 = cljs.core.first(s__58454__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58463,(0),null);
var vec__58466 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58463,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58466,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58466,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58466,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58466,(3),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58463,i,vec__58466,icon,text,_expansion,kbd,s__58454__$2,temp__5735__auto__,map__58451,map__58451__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(vec__58463,i,vec__58466,icon,text,_expansion,kbd,s__58454__$2,temp__5735__auto__,map__58451,map__58451__$1,index))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.core.adapt_react_class(icon)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),text], null),(cljs.core.truth_(kbd)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kbd","kbd",316156875),kbd], null):null)], null)], null),athens$views$blocks$slash_menu_el_$_iter__58453(cljs.core.rest(s__58454__$2)));
}
} else {
return null;
}
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58470__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58470__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
if(e.shiftKey === false){
var G__58472 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040),uid], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58472) : re_frame.core.dispatch.call(null,G__58472));
} else {
return null;
}
...
var source_uid = cljs.core.deref((function (){var G__58476 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58476) : re_frame.core.subscribe.call(null,G__58476));
})());
...
var vec__58473 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (i,el){
...
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58473,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58473,(1),null);
var selected_blocks = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(blocks,start,(end + (1)));
var selected_uids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58469_SHARP_){
return p1__58469_SHARP_.dataset.uid;
}),selected_blocks);
var G__58477 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","add-items","selected/add-items",142460854),selected_uids], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58477) : re_frame.core.dispatch.call(null,G__58477));
} else {
...
return (function (p__58478,state){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
...
var atom_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58481__$1,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204));
...
var G__58483 = new cljs.core.Keyword(null,"old-string","old-string",-469973663).cljs$core$IFn$_invoke$arity$1(old);
var G__58484 = atom_string;
var G__58485 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block);
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$3 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$3(G__58483,G__58484,G__58485) : athens.views.blocks.db_on_change.call(null,G__58483,G__58484,G__58485));
} else {
return null;
}
}));
...
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58486__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
...
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58486__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
...
var map__58487 = cljs.core.deref(state);
...
var state_edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword("search","type","search/type",-1745335484));
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var drag_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"drag-target","drag-target",2017061919));
var is_editing = cljs.core.deref((function (){var G__58490 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","is-editing","editing/is-editing",-1509220484),uid], null);
...
var is_selected = cljs.core.deref((function (){var G__58491 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","is-selected","selected/is-selected",689082595),uid], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58491) : re_frame.core.subscribe.call(null,G__58491));
})());
if((state_edit_time < edit_time)){
var new_state_58531 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("edit","time","edit/time",1384867476),edit_time,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204),string,new cljs.core.Keyword(null,"old-string","old-string",-469973663),string], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,new_state_58531);
} else {
}
...
var G__58492_58532 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"drop-bullet","drop-bullet",1177869489),source_uid,uid,drag_target], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58492_58532) : re_frame.core.dispatch.call(null,G__58492_58532));
...
})())?(function (){var iter__4582__auto__ = (function athens$views$blocks$block_el_$_iter__58493(s__58494){
return (new cljs.core.LazySeq(null,(function (){
var s__58494__$1 = s__58494;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58494__$1);
if(temp__5735__auto__){
var s__58494__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58494__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58494__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58496 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58495 = (0);
while(true){
if((i__58495 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58495);
cljs.core.chunk_append(b__58496,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null));

var G__58533 = (i__58495 + (1));
i__58495 = G__58533;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58496),athens$views$blocks$block_el_$_iter__58493(cljs.core.chunk_rest(s__58494__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58496),null);
}
} else {
var child = cljs.core.first(s__58494__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null),athens$views$blocks$block_el_$_iter__58493(cljs.core.rest(s__58494__$2)));
}
} else {
return null;
}
