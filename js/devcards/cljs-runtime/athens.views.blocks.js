...
})(),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),["0 0 0 2px ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(athens.style.color.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"body-text-color","body-text-color",-349110936)))].join(''),new cljs.core.Keyword(null,"opacity","opacity",397153780),new cljs.core.Keyword(null,"opacity-med","opacity-med",1700530190).cljs$core$IFn$_invoke$arity$1(athens.style.OPACITIES)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&.closed","&.closed",693427658),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58028 = (garden.selectors.before.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.before.cljs$core$IFn$_invoke$arity$0() : garden.selectors.before.call(null));
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__58028) : garden.selectors._AMPERSAND_.call(null,G__58028));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"content","content",15833224),"none"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&.closed","&.closed",693427658),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58029 = (garden.selectors.before.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.before.cljs$core$IFn$_invoke$arity$0() : garden.selectors.before.call(null));
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__58029) : garden.selectors._AMPERSAND_.call(null,G__58029));
...
var G__58030 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),value], null)], null)], null);
...
var G__58031 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),id,new cljs.core.Keyword("block","open","block/open",-1875254829),cljs.core.not(open)], null)], null)], null);
...
var G__58032 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"up","up",-269712113),uid], null);
...
var G__58033 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left","left",-399115937),uid], null);
...
var G__58034 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"down","down",1565245570),uid], null);
...
var G__58035 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"right","right",-452581833),uid], null);
...
var G__58036 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unindent","unindent",-1291301718),uid], null);
...
var G__58037 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"indent","indent",-148200125),uid], null);
...
var G__58038 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"enter","enter",1792452624),uid,string,start,state], null);
...
var G__58039 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"backspace","backspace",-696007848),uid,string], null);
...
setTimeout((function (){
var G__58040 = target;
var G__58041 = (start - (1));
return goog.dom.selection.setCursorPosition(G__58040,G__58041);
}),(10));
...
setTimeout((function (){
var G__58042_58091 = target;
var G__58043_58092 = (start + (1));
goog.dom.selection.setStart(G__58042_58091,G__58043_58092);

var G__58044 = target;
var G__58045 = (end + (1));
return goog.dom.selection.setEnd(G__58044,G__58045);
}),(10));
...
var dbid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58048__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58048__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58048__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58048__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
var editing_uid = cljs.core.deref((function (){var G__58051 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58051) : re_frame.core.subscribe.call(null,G__58051));
})());
var tooltip_uid = cljs.core.deref((function (){var G__58052 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("tooltip","uid","tooltip/uid",1421925099)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58052) : re_frame.core.subscribe.call(null,G__58052));
})());
var map__58049 = cljs.core.deref((function (){var G__58053 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"drag-bullet","drag-bullet",441161411)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58053) : re_frame.core.subscribe.call(null,G__58053));
})());
...
var dragging_uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58049__$1,new cljs.core.Keyword(null,"uid","uid",-1447769400));
var closest_uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58049__$1,new cljs.core.Keyword("closest","uid","closest/uid",-582260451));
var closest_kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58049__$1,new cljs.core.Keyword("closest","kind","closest/kind",429209294));
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58049__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58049__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
...
var G__58055 = new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state));
var G__58056 = uid;
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58055,G__58056) : athens.views.blocks.db_on_change.call(null,G__58055,G__58056));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58060),athens$views$blocks$block_el_$_iter__58057(cljs.core.chunk_rest(s__58058__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58060),null);
}
} else {
var child = cljs.core.first(s__58058__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"32px"], null),new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null),athens$views$blocks$block_el_$_iter__58057(cljs.core.rest(s__58058__$2)));
}
} else {
return null;
}
...
})():null),(cljs.core.truth_(new cljs.core.Keyword(null,"slash?","slash?",810223916).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.dropdown.slash_menu_component], null):null),(cljs.core.truth_(new cljs.core.Keyword("search","page","search/page",1822499573).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))?(function (){var query = new cljs.core.Keyword("search","query","search/query",1830322034).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state));
var results = (((!(clojure.string.blank_QMARK_(query))))?athens.db.search_in_node_title(query):null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.dropdown.dropdown,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"content","content",15833224),((cljs.core.not(query))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Start Typing!"], null):(function (){var iter__4582__auto__ = (function athens$views$blocks$block_el_$_iter__58061(s__58062){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__58064,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58063,map__58065,map__58065__$1,title,uid__$1,c__4580__auto__,size__4581__auto__,b__58064,s__58062__$2,temp__5735__auto__,query,results,map__58048,map__58048__$1,dbid,uid,string,open,order,children,open_QMARK_,closed_QMARK_,editing_uid,tooltip_uid,map__58049,map__58049__$1,dragging_uid,closest_uid,closest_kind,x,y,state){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__58063,map__58065,map__58065__$1,title,uid__$1,c__4580__auto__,size__4581__auto__,b__58064,s__58062__$2,temp__5735__auto__,query,results,map__58048,map__58048__$1,dbid,uid,string,open,order,children,open_QMARK_,closed_QMARK_,editing_uid,tooltip_uid,map__58049,map__58049__$1,dragging_uid,closest_uid,closest_kind,x,y,state))
], null),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1], null)));

var G__58096 = (i__58063 + (1));
i__58063 = G__58096;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58064),athens$views$blocks$block_el_$_iter__58061(cljs.core.chunk_rest(s__58062__$2)));
} else {
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58067__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__58067,map__58067__$1,title,uid__$1,s__58062__$2,temp__5735__auto__,query,results,map__58048,map__58048__$1,dbid,uid,string,open,order,children,open_QMARK_,closed_QMARK_,editing_uid,tooltip_uid,map__58049,map__58049__$1,dragging_uid,closest_uid,closest_kind,x,y,state){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__58067,map__58067__$1,title,uid__$1,s__58062__$2,temp__5735__auto__,query,results,map__58048,map__58048__$1,dbid,uid,string,open,order,children,open_QMARK_,closed_QMARK_,editing_uid,tooltip_uid,map__58049,map__58049__$1,dragging_uid,closest_uid,closest_kind,x,y,state))
], null),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1], null)),athens$views$blocks$block_el_$_iter__58061(cljs.core.rest(s__58062__$2)));
}
} else {
return null;
}
