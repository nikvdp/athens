...
athens.views.blocks.block_content_style = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"position","position",-2011731912),"relative",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"visible",new cljs.core.Keyword(null,"z-index","z-index",1892827090),(2),new cljs.core.Keyword(null,"flex-grow","flex-grow",1865160747),"1",new cljs.core.Keyword(null,"word-break","word-break",-407281356),"break-word",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"none"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&:hover","&:hover",-852658855),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58301 = (function (){var G__58302 = new cljs.core.Keyword(null,".is-editing",".is-editing",-747838493);
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__58302) : garden.selectors.not.call(null,G__58302));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__58301) : garden.selectors._AMPERSAND_.call(null,G__58301));
...
var G__58303 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function() { 
var G__58390__delegate = function (title){
...
var now_58391 = athens.util.now_ts();
var uid_58392 = athens.util.gen_block_uid();
(db_fn.cljs$core$IFn$_invoke$arity$3 ? db_fn.cljs$core$IFn$_invoke$arity$3(inner_title,now_58391,uid_58392) : db_fn.call(null,inner_title,now_58391,uid_58392));
} else {
}

return ["[[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(inner_title),"]]"].join('');
};
var G__58390 = function (var_args){
var title = null;
...
while (G__58393__i < G__58393__a.length) {G__58393__a[G__58393__i] = arguments[G__58393__i + 0]; ++G__58393__i;}
  title = new cljs.core.IndexedSeq(G__58393__a,0,null);
} 
return G__58390__delegate.call(this,title);};
G__58390.cljs$lang$maxFixedArity = 0;
G__58390.cljs$lang$applyTo = (function (arglist__58394){
var title = cljs.core.seq(arglist__58394);
return G__58390__delegate(title);
});
G__58390.cljs$core$IFn$_invoke$arity$variadic = G__58390__delegate;
return G__58390;
})()
,new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function() { 
var G__58395__delegate = function (title){
var inner_title = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,title);
if(cljs.core.truth_(((typeof inner_title === 'string')?(link_fn.cljs$core$IFn$_invoke$arity$1 ? link_fn.cljs$core$IFn$_invoke$arity$1(inner_title) : link_fn.call(null,inner_title)):false))){
var now_58396 = athens.util.now_ts();
var uid_58397 = athens.util.gen_block_uid();
(db_fn.cljs$core$IFn$_invoke$arity$3 ? db_fn.cljs$core$IFn$_invoke$arity$3(inner_title,now_58396,uid_58397) : db_fn.call(null,inner_title,now_58396,uid_58397));
} else {
}

return ["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(inner_title)].join('');
};
var G__58395 = function (var_args){
var title = null;
if (arguments.length > 0) {
var G__58398__i = 0, G__58398__a = new Array(arguments.length -  0);
while (G__58398__i < G__58398__a.length) {G__58398__a[G__58398__i] = arguments[G__58398__i + 0]; ++G__58398__i;}
  title = new cljs.core.IndexedSeq(G__58398__a,0,null);
} 
return G__58395__delegate.call(this,title);};
G__58395.cljs$lang$maxFixedArity = 0;
G__58395.cljs$lang$applyTo = (function (arglist__58399){
var title = cljs.core.seq(arglist__58399);
return G__58395__delegate(title);
});
G__58395.cljs$core$IFn$_invoke$arity$variadic = G__58395__delegate;
return G__58395;
})()
], null);
var G__58304 = athens.parser.parse_to_ast(source_str);
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58303,G__58304) : instaparse.core.transform.call(null,G__58303,G__58304));
});
...
athens.views.blocks.toggle_el = (function athens$views$blocks$toggle_el(p__58305){
...
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58306__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58306__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58306__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
...
athens.views.blocks.tooltip_el = (function athens$views$blocks$tooltip_el(p__58308,state){
var map__58309 = p__58308;
...
var dbid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58309__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58309__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58309__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58309__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
var map__58311 = cljs.core.deref(state);
...
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58311__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58311__$1,new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058));
...
var map__58313 = cljs.core.deref(state);
...
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58313__$1,new cljs.core.Keyword("search","query","search/query",1830322034));
var results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58313__$1,new cljs.core.Keyword("search","results","search/results",107824727));
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58313__$1,new cljs.core.Keyword("search","index","search/index",1990835117));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58313__$1,new cljs.core.Keyword("search","type","search/type",-1745335484));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.dropdown.dropdown_style),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"top","top",-1856271961),"100%",new cljs.core.Keyword(null,"max-height","max-height",-612563804),"20rem",new cljs.core.Keyword(null,"left","left",-399115937),"1.75em"], null)], null)], 0)),((clojure.string.blank_QMARK_(query))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),["Search for a ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(type))].join('')], null):cljs.core.doall.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.dropdown.menu_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"dropdown-menu"], null)),(function (){var iter__4582__auto__ = (function athens$views$blocks$inline_search_el_$_iter__58315(s__58316){
return (new cljs.core.LazySeq(null,(function (){
var s__58316__$1 = s__58316;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58316__$1);
if(temp__5735__auto__){
var s__58316__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58316__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58316__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58318 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58317 = (0);
while(true){
if((i__58317 < size__4581__auto__)){
var vec__58319 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58317);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58319,(0),null);
var map__58322 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58319,(1),null);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58322__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58322__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58322__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
cljs.core.chunk_append(b__58318,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58317,vec__58319,i,map__58322,map__58322__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58318,s__58316__$2,temp__5735__auto__,map__58313,map__58313__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(i__58317,vec__58319,i,map__58322,map__58322__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58318,s__58316__$2,temp__5735__auto__,map__58313,map__58313__$1,query,results,index,type))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58318),athens$views$blocks$inline_search_el_$_iter__58315(cljs.core.chunk_rest(s__58316__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58318),null);
}
} else {
var vec__58324 = cljs.core.first(s__58316__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58324,(0),null);
var map__58327 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58324,(1),null);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58327__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58327__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58324,i,map__58327,map__58327__$1,title,string,uid,s__58316__$2,temp__5735__auto__,map__58313,map__58313__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(vec__58324,i,map__58327,map__58327__$1,title,string,uid,s__58316__$2,temp__5735__auto__,map__58313,map__58313__$1,query,results,index,type))
,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index,i),new cljs.core.Keyword(null,"id","id",-1388402092),["result-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null),(function (){var or__4185__auto__ = title;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["inline-search-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(uid)].join('')], null)),athens$views$blocks$inline_search_el_$_iter__58315(cljs.core.rest(s__58316__$2)));
}
} else {
return null;
}
...
var map__58329 = cljs.core.deref(state);
...
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58329__$1,new cljs.core.Keyword("search","index","search/index",1990835117));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.dropdown.dropdown_style),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"top","top",-1856271961),"100%",new cljs.core.Keyword(null,"left","left",-399115937),"-0.125em"], null)], null)], 0)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#slash-menu-container","div#slash-menu-container",2006893928),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.dropdown.menu_style),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),"8em"], null)], null)], 0)),(function (){var iter__4582__auto__ = (function athens$views$blocks$slash_menu_el_$_iter__58331(s__58332){
return (new cljs.core.LazySeq(null,(function (){
var s__58332__$1 = s__58332;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58332__$1);
if(temp__5735__auto__){
var s__58332__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58332__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58332__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58334 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58333 = (0);
while(true){
if((i__58333 < size__4581__auto__)){
var vec__58335 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58333);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58335,(0),null);
var vec__58338 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58335,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58338,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58338,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58338,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58338,(3),null);
cljs.core.chunk_append(b__58334,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58333,vec__58335,i,vec__58338,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58334,s__58332__$2,temp__5735__auto__,map__58329,map__58329__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(i__58333,vec__58335,i,vec__58338,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58334,s__58332__$2,temp__5735__auto__,map__58329,map__58329__$1,index))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58334),athens$views$blocks$slash_menu_el_$_iter__58331(cljs.core.chunk_rest(s__58332__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58334),null);
}
} else {
var vec__58341 = cljs.core.first(s__58332__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58341,(0),null);
var vec__58344 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58341,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58344,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58344,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58344,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58344,(3),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58341,i,vec__58344,icon,text,_expansion,kbd,s__58332__$2,temp__5735__auto__,map__58329,map__58329__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(vec__58341,i,vec__58344,icon,text,_expansion,kbd,s__58332__$2,temp__5735__auto__,map__58329,map__58329__$1,index))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.core.adapt_react_class(icon)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),text], null),(cljs.core.truth_(kbd)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kbd","kbd",316156875),kbd], null):null)], null)], null),athens$views$blocks$slash_menu_el_$_iter__58331(cljs.core.rest(s__58332__$2)));
}
} else {
return null;
}
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58348__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
var vec__58350 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (i,el){
...
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58350,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58350,(1),null);
var selected_blocks = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(blocks,start,(end + (1)));
var selected_uids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58347_SHARP_){
return p1__58347_SHARP_.dataset.uid;
}),selected_blocks);
...
return (function (p__58353,state){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58354__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58354__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58354__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
...
var atom_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58356__$1,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204));
...
var G__58358 = new cljs.core.Keyword(null,"old-string","old-string",-469973663).cljs$core$IFn$_invoke$arity$1(old);
var G__58359 = atom_string;
var G__58360 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block);
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$3 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$3(G__58358,G__58359,G__58360) : athens.views.blocks.db_on_change.call(null,G__58358,G__58359,G__58360));
} else {
return null;
}
}));
...
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58361__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58361__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58361__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58361__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58361__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var map__58362 = cljs.core.deref(state);
...
var state_edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58362__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58362__$1,new cljs.core.Keyword("search","type","search/type",-1745335484));
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58362__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var drag_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58362__$1,new cljs.core.Keyword(null,"drag-target","drag-target",2017061919));
...
var new_state_58404 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("edit","time","edit/time",1384867476),edit_time,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204),string,new cljs.core.Keyword(null,"old-string","old-string",-469973663),string], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,new_state_58404);
} else {
}
...
})())?(function (){var iter__4582__auto__ = (function athens$views$blocks$block_el_$_iter__58365(s__58366){
return (new cljs.core.LazySeq(null,(function (){
var s__58366__$1 = s__58366;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58366__$1);
if(temp__5735__auto__){
var s__58366__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58366__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58366__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58368 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58367 = (0);
while(true){
if((i__58367 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58367);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58368),athens$views$blocks$block_el_$_iter__58365(cljs.core.chunk_rest(s__58366__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58368),null);
}
} else {
var child = cljs.core.first(s__58366__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null),athens$views$blocks$block_el_$_iter__58365(cljs.core.rest(s__58366__$2)));
}
} else {
return null;
}
