...
athens.views.blocks.block_content_style = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"position","position",-2011731912),"relative",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"visible",new cljs.core.Keyword(null,"flex-grow","flex-grow",1865160747),"1",new cljs.core.Keyword(null,"word-break","word-break",-407281356),"break-word",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"none"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"&:hover","&:hover",-852658855),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58414 = (function (){var G__58415 = new cljs.core.Keyword(null,".is-editing",".is-editing",-747838493);
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__58415) : garden.selectors.not.call(null,G__58415));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__58414) : garden.selectors._AMPERSAND_.call(null,G__58414));
...
var G__58416_58512 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),value,new cljs.core.Keyword("edit","time","edit/time",1384867476),athens.util.now_ts()], null)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58416_58512) : re_frame.core.dispatch.call(null,G__58416_58512));

var G__58417 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function() { 
...
if(((typeof inner_title === 'string') && ((athens.db.search_exact_node_title(inner_title) == null)))){
var now_58514 = athens.util.now_ts();
var uid_58515__$1 = athens.util.gen_block_uid();
var G__58419_58516 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("node","title","node/title",628940777),inner_title,new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid_58515__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476),now_58514,new cljs.core.Keyword("create","time","create/time",-1563077754),now_58514], null)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58419_58516) : re_frame.core.dispatch.call(null,G__58419_58516));
} else {
}
...
var G__58418 = athens.parser.parse_to_ast(value);
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58417,G__58418) : instaparse.core.transform.call(null,G__58417,G__58418));
});
...
var G__58420 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),id,new cljs.core.Keyword("block","open","block/open",-1875254829),cljs.core.not(open)], null)], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58420) : re_frame.core.dispatch.call(null,G__58420));
});
athens.views.blocks.toggle_el = (function athens$views$blocks$toggle_el(p__58421){
...
athens.views.blocks.tooltip_el = (function athens$views$blocks$tooltip_el(p__58424,state){
...
var dbid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58425__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58425__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58425__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58425__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
var map__58427 = cljs.core.deref(state);
...
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58427__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58427__$1,new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058));
...
var map__58429 = cljs.core.deref(state);
...
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58429__$1,new cljs.core.Keyword("search","query","search/query",1830322034));
var results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58429__$1,new cljs.core.Keyword("search","results","search/results",107824727));
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58429__$1,new cljs.core.Keyword("search","index","search/index",1990835117));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58429__$1,new cljs.core.Keyword("search","type","search/type",-1745335484));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.dropdown.dropdown_style),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"top","top",-1856271961),"100%",new cljs.core.Keyword(null,"max-height","max-height",-612563804),"20rem",new cljs.core.Keyword(null,"left","left",-399115937),"1.75em"], null)], null)], 0)),((clojure.string.blank_QMARK_(query))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),["Search for a ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(type))].join('')], null):cljs.core.doall.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.dropdown.menu_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"dropdown-menu"], null)),(function (){var iter__4582__auto__ = (function athens$views$blocks$inline_search_el_$_iter__58431(s__58432){
return (new cljs.core.LazySeq(null,(function (){
var s__58432__$1 = s__58432;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58432__$1);
if(temp__5735__auto__){
var s__58432__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58432__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58432__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58434 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58433 = (0);
while(true){
if((i__58433 < size__4581__auto__)){
var vec__58435 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58433);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58435,(0),null);
var map__58438 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58435,(1),null);
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58438__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58438__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
cljs.core.chunk_append(b__58434,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58433,vec__58435,i,map__58438,map__58438__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58434,s__58432__$2,temp__5735__auto__,map__58429,map__58429__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(i__58433,vec__58435,i,map__58438,map__58438__$1,title,string,uid,c__4580__auto__,size__4581__auto__,b__58434,s__58432__$2,temp__5735__auto__,map__58429,map__58429__$1,query,results,index,type))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58434),athens$views$blocks$inline_search_el_$_iter__58431(cljs.core.chunk_rest(s__58432__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58434),null);
}
} else {
var vec__58440 = cljs.core.first(s__58432__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58440,i,map__58443,map__58443__$1,title,string,uid,s__58432__$2,temp__5735__auto__,map__58429,map__58429__$1,query,results,index,type){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
});})(vec__58440,i,map__58443,map__58443__$1,title,string,uid,s__58432__$2,temp__5735__auto__,map__58429,map__58429__$1,query,results,index,type))
,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index,i),new cljs.core.Keyword(null,"id","id",-1388402092),["result-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null),(function (){var or__4185__auto__ = title;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["inline-search-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(uid)].join('')], null)),athens$views$blocks$inline_search_el_$_iter__58431(cljs.core.rest(s__58432__$2)));
}
} else {
return null;
}
...
var map__58445 = cljs.core.deref(state);
...
var vec__58451 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58449);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58451,(0),null);
var vec__58454 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58451,(1),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58454,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58454,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58454,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58454,(3),null);
cljs.core.chunk_append(b__58450,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58449,vec__58451,i,vec__58454,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58450,s__58448__$2,temp__5735__auto__,map__58445,map__58445__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(i__58449,vec__58451,i,vec__58454,icon,text,_expansion,kbd,c__4580__auto__,size__4581__auto__,b__58450,s__58448__$2,temp__5735__auto__,map__58445,map__58445__$1,index))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58450),athens$views$blocks$slash_menu_el_$_iter__58447(cljs.core.chunk_rest(s__58448__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58450),null);
}
} else {
var vec__58457 = cljs.core.first(s__58448__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58457,i,vec__58460,icon,text,_expansion,kbd,s__58448__$2,temp__5735__auto__,map__58445,map__58445__$1,index){
return (function (){
return athens.keybindings.select_slash_cmd(i,state);
});})(vec__58457,i,vec__58460,icon,text,_expansion,kbd,s__58448__$2,temp__5735__auto__,map__58445,map__58445__$1,index))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.core.adapt_react_class(icon)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),text], null),(cljs.core.truth_(kbd)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kbd","kbd",316156875),kbd], null):null)], null)], null),athens$views$blocks$slash_menu_el_$_iter__58447(cljs.core.rest(s__58448__$2)));
}
} else {
return null;
}
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58464__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58464__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
if(e.shiftKey === false){
var G__58466 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040),uid], null);
...
var source_uid = cljs.core.deref((function (){var G__58470 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58470) : re_frame.core.subscribe.call(null,G__58470));
})());
...
var vec__58467 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (i,el){
...
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58467,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58467,(1),null);
var selected_blocks = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(blocks,start,(end + (1)));
var selected_uids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58463_SHARP_){
return p1__58463_SHARP_.dataset.uid;
}),selected_blocks);
var G__58471 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","add-items","selected/add-items",142460854),selected_uids], null);
...
return (function (p__58472,state){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58473__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58473__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58473__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
...
var atom_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58475__$1,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204));
...
var G__58477 = atom_string;
var G__58478 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block);
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58477,G__58478) : athens.views.blocks.db_on_change.call(null,G__58477,G__58478));
} else {
return null;
}
}));
...
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58479__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
...
var map__58480 = cljs.core.deref(state);
...
var state_edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58480__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58480__$1,new cljs.core.Keyword("search","type","search/type",-1745335484));
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58480__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var drag_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58480__$1,new cljs.core.Keyword(null,"drag-target","drag-target",2017061919));
var is_editing = cljs.core.deref((function (){var G__58483 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","is-editing","editing/is-editing",-1509220484),uid], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58483) : re_frame.core.subscribe.call(null,G__58483));
})());
var is_selected = cljs.core.deref((function (){var G__58484 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","is-selected","selected/is-selected",689082595),uid], null);
...
var new_state_58523 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("edit","time","edit/time",1384867476),edit_time,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204),string], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,new_state_58523);
} else {
}
...
var G__58485_58524 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"drop-bullet","drop-bullet",1177869489),source_uid,uid,drag_target], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58485_58524) : re_frame.core.dispatch.call(null,G__58485_58524));
...
})())?(function (){var iter__4582__auto__ = (function athens$views$blocks$block_el_$_iter__58486(s__58487){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__58487__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58489 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58488 = (0);
while(true){
if((i__58488 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58488);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58489),athens$views$blocks$block_el_$_iter__58486(cljs.core.chunk_rest(s__58487__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58489),null);
}
} else {
var child = cljs.core.first(s__58487__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null),athens$views$blocks$block_el_$_iter__58486(cljs.core.rest(s__58487__$2)));
}
} else {
return null;
}
