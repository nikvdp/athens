...
var G__30949 = cljs.core.cons(pdb,path);
var G__30950 = posh.lib.db.get_parent_db(pdb);
path = G__30949;
pdb = G__30950;
continue;
} else {
...
var G__30953 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__30953;
continue;
}
break;
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__30931,poshdb){
var map__30937 = p__30931;
var map__30937__$1 = (((((!((map__30937 == null))))?(((((map__30937.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30937.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30937):map__30937);
var posh_tree = map__30937__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30937__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30937__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__30940 = (function (){var G__30942 = posh_tree;
var G__30943 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30942,G__30943) : posh.lib.db.poshdb__GT_db.call(null,G__30942,G__30943));
})();
var G__30941 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__30939 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30939.cljs$core$IFn$_invoke$arity$2 ? fexpr__30939.cljs$core$IFn$_invoke$arity$2(G__30940,G__30941) : fexpr__30939.call(null,G__30940,G__30941));
}
});
