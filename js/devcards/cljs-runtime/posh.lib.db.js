...
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30666 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30666.cljs$core$IFn$_invoke$arity$2 ? fexpr__30666.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30666.call(null,db__$1,since));
})():db__$1);
...
var G__30680 = (function (){var G__30682 = posh_tree;
var G__30683 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30682,G__30683) : posh.lib.db.poshdb__GT_db.call(null,G__30682,G__30683));
})();
var G__30681 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__30679 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30679.cljs$core$IFn$_invoke$arity$2 ? fexpr__30679.cljs$core$IFn$_invoke$arity$2(G__30680,G__30681) : fexpr__30679.call(null,G__30680,G__30681));
}
});
