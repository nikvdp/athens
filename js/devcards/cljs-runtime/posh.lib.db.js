...
var G__30903 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30903__$1)].join('')));
...
var G__30950 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__30950;
continue;
}
break;
