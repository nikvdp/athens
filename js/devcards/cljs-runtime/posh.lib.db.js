...
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30668 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30668.cljs$core$IFn$_invoke$arity$2 ? fexpr__30668.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30668.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__30670 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30670.cljs$core$IFn$_invoke$arity$2 ? fexpr__30670.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__30670.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__30671 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30671.cljs$core$IFn$_invoke$arity$2 ? fexpr__30671.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__30671.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__30675 = db__$4;
var G__30676 = (((filter instanceof cljs.core.Symbol))?null:filter);
