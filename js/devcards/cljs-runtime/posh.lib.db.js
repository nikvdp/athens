...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30912__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30912__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30912__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30912__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__30916 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30916.cljs$core$IFn$_invoke$arity$1 ? fexpr__30916.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__30916.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30918 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30918.cljs$core$IFn$_invoke$arity$2 ? fexpr__30918.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30918.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__30920 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30920.cljs$core$IFn$_invoke$arity$2 ? fexpr__30920.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__30920.call(null,db__$2,as_of));
})():db__$2);
...
var fexpr__30923 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30923.cljs$core$IFn$_invoke$arity$2 ? fexpr__30923.cljs$core$IFn$_invoke$arity$2(G__30924,G__30925) : fexpr__30923.call(null,G__30924,G__30925));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__30926,poshdb){
...
var posh_tree = map__30927__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30927__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30927__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
