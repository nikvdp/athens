...
var G__30936 = cljs.core.cons(pdb,path);
var G__30937 = posh.lib.db.get_parent_db(pdb);
path = G__30936;
pdb = G__30937;
continue;
} else {
...
var G__30940 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__30940;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30910__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30910__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30910__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30910__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__30913 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30913.cljs$core$IFn$_invoke$arity$1 ? fexpr__30913.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__30913.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30915 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30915.cljs$core$IFn$_invoke$arity$2 ? fexpr__30915.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30915.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__30916 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30916.cljs$core$IFn$_invoke$arity$2 ? fexpr__30916.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__30916.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__30917 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30917.cljs$core$IFn$_invoke$arity$2 ? fexpr__30917.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__30917.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__30919 = db__$4;
var G__30920 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__30918 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30918.cljs$core$IFn$_invoke$arity$2 ? fexpr__30918.cljs$core$IFn$_invoke$arity$2(G__30919,G__30920) : fexpr__30918.call(null,G__30919,G__30920));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__30921,poshdb){
...
var posh_tree = map__30922__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30922__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30922__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__30928 = (function (){var G__30930 = posh_tree;
var G__30931 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30930,G__30931) : posh.lib.db.poshdb__GT_db.call(null,G__30930,G__30931));
})();
var G__30929 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__30927 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30927.cljs$core$IFn$_invoke$arity$2 ? fexpr__30927.cljs$core$IFn$_invoke$arity$2(G__30928,G__30929) : fexpr__30927.call(null,G__30928,G__30929));
}
});
