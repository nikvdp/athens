...
var G__25754 = cljs.core.first(poshdb);
var G__25754__$1 = (((G__25754 instanceof cljs.core.Keyword))?G__25754.fqn:null);
switch (G__25754__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25754__$1)].join('')));
...
var G__25794 = cljs.core.cons(pdb,path);
var G__25795 = posh.lib.db.get_parent_db(pdb);
path = G__25794;
pdb = G__25795;
continue;
} else {
...
var G__25796 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__25796;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25769__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25769__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25769__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25769__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__25771 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25771.cljs$core$IFn$_invoke$arity$1 ? fexpr__25771.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__25771.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__25772 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25772.cljs$core$IFn$_invoke$arity$2 ? fexpr__25772.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__25772.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__25773 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25773.cljs$core$IFn$_invoke$arity$2 ? fexpr__25773.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__25773.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__25774 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25774.cljs$core$IFn$_invoke$arity$2 ? fexpr__25774.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__25774.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__25776 = db__$4;
var G__25777 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__25775 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25775.cljs$core$IFn$_invoke$arity$2 ? fexpr__25775.cljs$core$IFn$_invoke$arity$2(G__25776,G__25777) : fexpr__25775.call(null,G__25776,G__25777));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__25780,poshdb){
...
var posh_tree = map__25781__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25781__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25781__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__25784 = (function (){var G__25786 = posh_tree;
var G__25787 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__25786,G__25787) : posh.lib.db.poshdb__GT_db.call(null,G__25786,G__25787));
})();
var G__25785 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__25783 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25783.cljs$core$IFn$_invoke$arity$2 ? fexpr__25783.cljs$core$IFn$_invoke$arity$2(G__25784,G__25785) : fexpr__25783.call(null,G__25784,G__25785));
}
});
