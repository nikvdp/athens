...
var G__30686 = cljs.core.cons(pdb,path);
var G__30687 = posh.lib.db.get_parent_db(pdb);
path = G__30686;
pdb = G__30687;
continue;
} else {
...
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30661 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30661.cljs$core$IFn$_invoke$arity$2 ? fexpr__30661.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30661.call(null,db__$1,since));
})():db__$1);
...
var G__30676 = (function (){var G__30678 = posh_tree;
var G__30679 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30678,G__30679) : posh.lib.db.poshdb__GT_db.call(null,G__30678,G__30679));
})();
var G__30677 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
