...
var re_frame$router$IEventQueue$push$dyn_51091 = (function (this$,event){
...
return re_frame$router$IEventQueue$push$dyn_51091(this$,event);
}
});
...
var re_frame$router$IEventQueue$remove_post_event_callback$dyn_51096 = (function (this$,f){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$remove_post_event_callback$dyn_51096(this$,f);
}
});

var re_frame$router$IEventQueue$purge$dyn_51101 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$purge$dyn_51101(this$);
}
});

var re_frame$router$IEventQueue$_fsm_trigger$dyn_51116 = (function (this$,trigger,arg){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_fsm_trigger$dyn_51116(this$,trigger,arg);
}
});

var re_frame$router$IEventQueue$_add_event$dyn_51124 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_add_event$dyn_51124(this$,event);
}
});

var re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_51125 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_51125(this$);
}
});

var re_frame$router$IEventQueue$_run_next_tick$dyn_51128 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_next_tick$dyn_51128(this$);
}
});

var re_frame$router$IEventQueue$_run_queue$dyn_51130 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_queue$dyn_51130(this$);
}
});

var re_frame$router$IEventQueue$_exception$dyn_51132 = (function (this$,ex){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_exception$dyn_51132(this$,ex);
}
});

var re_frame$router$IEventQueue$_pause$dyn_51134 = (function (this$,later_fn){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_pause$dyn_51134(this$,later_fn);
}
});

var re_frame$router$IEventQueue$_resume$dyn_51136 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_resume$dyn_51136(this$);
}
});

var re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_51138 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_51138(this$,event);
}
});
...
return (re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1 ? re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1(G__51050) : re_frame.interop.next_tick.call(null,G__51050));
}));
...
var _STAR_current_trace_STAR__orig_val__51051 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__51052 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("re-frame.router","fsm-trigger","re-frame.router/fsm-trigger",1379787274)], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__51052);

try{try{var vec__51056 = (function (){var G__51059 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51059)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"exception","exception",-335277064)], null),G__51059)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"finish-run","finish-run",753148477)], null),G__51059)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"pause","pause",-2095325672)], null),G__51059)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"resume","resume",-118572261)], null),G__51059)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027)], null),G__51059)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_run_queue$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51059)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51059)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51059)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
...
var end__50195__auto___51154 = re_frame.interop.now();
var duration__50196__auto___51155 = (end__50195__auto___51154 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__50196__auto___51155,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__50195__auto___51154);
} else {
}
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__51051);
}} else {
...
var self__ = this;
var ___$1 = this;
var seq__51073 = cljs.core.seq(cljs.core.vals(self__.post_event_callback_fns));
var chunk__51074 = null;
var count__51075 = (0);
var i__51076 = (0);
while(true){
if((i__51076 < count__51075)){
var callback = chunk__51074.cljs$core$IIndexed$_nth$arity$2(null,i__51076);
...
var G__51163 = seq__51073;
var G__51164 = chunk__51074;
var G__51165 = count__51075;
var G__51166 = (i__51076 + (1));
seq__51073 = G__51163;
chunk__51074 = G__51164;
count__51075 = G__51165;
i__51076 = G__51166;
continue;
} else {
...
var G__51170 = cljs.core.chunk_rest(seq__51073__$1);
var G__51171 = c__4556__auto__;
var G__51172 = cljs.core.count(c__4556__auto__);
var G__51173 = (0);
seq__51073 = G__51170;
chunk__51074 = G__51171;
count__51075 = G__51172;
i__51076 = G__51173;
continue;
} else {
var callback = cljs.core.first(seq__51073__$1);
(callback.cljs$core$IFn$_invoke$arity$2 ? callback.cljs$core$IFn$_invoke$arity$2(event_v,self__.queue) : callback.call(null,event_v,self__.queue));


var G__51174 = cljs.core.next(seq__51073__$1);
var G__51175 = null;
var G__51176 = (0);
var G__51177 = (0);
seq__51073 = G__51174;
chunk__51074 = G__51175;
count__51075 = G__51176;
i__51076 = G__51177;
continue;
}
} else {
