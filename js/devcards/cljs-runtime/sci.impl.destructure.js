...
var G__58442 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58443 = n;
var G__58444 = cljs.core.nnext(bs);
var G__58445 = true;
ret = G__58442;
n = G__58443;
bs = G__58444;
seen_rest_QMARK_ = G__58445;
continue;
} else {
...
var G__58447 = (n + (1));
var G__58448 = cljs.core.next(bs);
var G__58449 = seen_rest_QMARK_;
ret = G__58446;
n = G__58447;
bs = G__58448;
seen_rest_QMARK_ = G__58449;
continue;
}
...
});})(G__58436,gmap,defaults,pvec,bents))
;
return fexpr__58435(G__58436);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58418_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58418_SHARP_);
}
})(),cljs.core.name(p1__58418_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58419_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58419_SHARP_);
}
})(),cljs.core.name(p1__58419_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58420_SHARP_,p2__58421_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58420_SHARP_,p2__58421_SHARP_,(function (){var fexpr__58439 = cljs.core.val(entry);
return (fexpr__58439.cljs$core$IFn$_invoke$arity$1 ? fexpr__58439.cljs$core$IFn$_invoke$arity$1(p2__58421_SHARP_) : fexpr__58439.call(null,p2__58421_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58440 = cljs.core.key(entry);
return (fexpr__58440.cljs$core$IFn$_invoke$arity$1 ? fexpr__58440.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58440.call(null,bes));
})());
...
var G__58450 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58451 = cljs.core.next(bes);
ret = G__58450;
bes = G__58451;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58422_SHARP_){
return (cljs.core.first(p1__58422_SHARP_) instanceof cljs.core.Keyword);
}),bents));
