...
var G__58949 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58950 = n;
var G__58951 = cljs.core.nnext(bs);
var G__58952 = true;
ret = G__58949;
n = G__58950;
bs = G__58951;
seen_rest_QMARK_ = G__58952;
continue;
} else {
...
});})(G__58945,gmap,defaults,pvec,bents))
;
return fexpr__58944(G__58945);
})();
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58927_SHARP_,p2__58928_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58927_SHARP_,p2__58928_SHARP_,(function (){var fexpr__58946 = cljs.core.val(entry);
return (fexpr__58946.cljs$core$IFn$_invoke$arity$1 ? fexpr__58946.cljs$core$IFn$_invoke$arity$1(p2__58928_SHARP_) : fexpr__58946.call(null,p2__58928_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58947 = cljs.core.key(entry);
return (fexpr__58947.cljs$core$IFn$_invoke$arity$1 ? fexpr__58947.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58947.call(null,bes));
})());
...
var G__58957 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58958 = cljs.core.next(bes);
ret = G__58957;
bes = G__58958;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58929_SHARP_){
return (cljs.core.first(p1__58929_SHARP_) instanceof cljs.core.Keyword);
}),bents));
