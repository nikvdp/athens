...
var G__58962 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58963 = n;
var G__58964 = cljs.core.nnext(bs);
var G__58965 = true;
ret = G__58962;
n = G__58963;
bs = G__58964;
seen_rest_QMARK_ = G__58965;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58938_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58938_SHARP_);
}
})(),cljs.core.name(p1__58938_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58939_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58939_SHARP_);
}
})(),cljs.core.name(p1__58939_SHARP_));
}));
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58940_SHARP_,p2__58941_SHARP_,(function (){var fexpr__58954 = cljs.core.val(entry);
return (fexpr__58954.cljs$core$IFn$_invoke$arity$1 ? fexpr__58954.cljs$core$IFn$_invoke$arity$1(p2__58941_SHARP_) : fexpr__58954.call(null,p2__58941_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58957 = cljs.core.key(entry);
return (fexpr__58957.cljs$core$IFn$_invoke$arity$1 ? fexpr__58957.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58957.call(null,bes));
})());
...
var G__58970 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58971 = cljs.core.next(bes);
ret = G__58970;
bes = G__58971;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58942_SHARP_){
return (cljs.core.first(p1__58942_SHARP_) instanceof cljs.core.Keyword);
}),bents));
