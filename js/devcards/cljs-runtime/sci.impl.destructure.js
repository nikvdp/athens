...
var G__58940 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58941 = n;
var G__58942 = cljs.core.nnext(bs);
var G__58943 = true;
ret = G__58940;
n = G__58941;
bs = G__58942;
seen_rest_QMARK_ = G__58943;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58917_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58917_SHARP_);
}
})(),cljs.core.name(p1__58917_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58918_SHARP_,p2__58919_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58918_SHARP_,p2__58919_SHARP_,(function (){var fexpr__58937 = cljs.core.val(entry);
return (fexpr__58937.cljs$core$IFn$_invoke$arity$1 ? fexpr__58937.cljs$core$IFn$_invoke$arity$1(p2__58919_SHARP_) : fexpr__58937.call(null,p2__58919_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58938 = cljs.core.key(entry);
return (fexpr__58938.cljs$core$IFn$_invoke$arity$1 ? fexpr__58938.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58938.call(null,bes));
})());
...
var G__58948 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58949 = cljs.core.next(bes);
ret = G__58948;
bes = G__58949;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58920_SHARP_){
return (cljs.core.first(p1__58920_SHARP_) instanceof cljs.core.Keyword);
}),bents));
