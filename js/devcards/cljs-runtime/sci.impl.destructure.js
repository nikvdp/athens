...
var G__58674 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58675 = n;
var G__58676 = cljs.core.nnext(bs);
var G__58677 = true;
ret = G__58674;
n = G__58675;
bs = G__58676;
seen_rest_QMARK_ = G__58677;
continue;
} else {
...
var G__58679 = (n + (1));
var G__58680 = cljs.core.next(bs);
var G__58681 = seen_rest_QMARK_;
ret = G__58678;
n = G__58679;
bs = G__58680;
seen_rest_QMARK_ = G__58681;
continue;
}
...
});})(G__58667,gmap,defaults,pvec,bents))
;
return fexpr__58666(G__58667);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58650_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58650_SHARP_);
}
})(),cljs.core.name(p1__58650_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58651_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58651_SHARP_);
}
})(),cljs.core.name(p1__58651_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58652_SHARP_,p2__58653_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58652_SHARP_,p2__58653_SHARP_,(function (){var fexpr__58671 = cljs.core.val(entry);
return (fexpr__58671.cljs$core$IFn$_invoke$arity$1 ? fexpr__58671.cljs$core$IFn$_invoke$arity$1(p2__58653_SHARP_) : fexpr__58671.call(null,p2__58653_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58672 = cljs.core.key(entry);
return (fexpr__58672.cljs$core$IFn$_invoke$arity$1 ? fexpr__58672.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58672.call(null,bes));
})());
...
var G__58682 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58683 = cljs.core.next(bes);
ret = G__58682;
bes = G__58683;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58654_SHARP_){
return (cljs.core.first(p1__58654_SHARP_) instanceof cljs.core.Keyword);
}),bents));
