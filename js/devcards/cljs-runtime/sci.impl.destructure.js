...
var G__58541 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58542 = n;
var G__58543 = cljs.core.nnext(bs);
var G__58544 = true;
ret = G__58541;
n = G__58542;
bs = G__58543;
seen_rest_QMARK_ = G__58544;
continue;
} else {
...
});})(G__58528,gmap,defaults,pvec,bents))
;
return fexpr__58527(G__58528);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58517_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58517_SHARP_);
}
})(),cljs.core.name(p1__58517_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58518_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58518_SHARP_);
}
})(),cljs.core.name(p1__58518_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58519_SHARP_,p2__58520_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58519_SHARP_,p2__58520_SHARP_,(function (){var fexpr__58535 = cljs.core.val(entry);
return (fexpr__58535.cljs$core$IFn$_invoke$arity$1 ? fexpr__58535.cljs$core$IFn$_invoke$arity$1(p2__58520_SHARP_) : fexpr__58535.call(null,p2__58520_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58536 = cljs.core.key(entry);
return (fexpr__58536.cljs$core$IFn$_invoke$arity$1 ? fexpr__58536.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58536.call(null,bes));
})());
...
var G__58549 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58550 = cljs.core.next(bes);
ret = G__58549;
bes = G__58550;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58521_SHARP_){
return (cljs.core.first(p1__58521_SHARP_) instanceof cljs.core.Keyword);
}),bents));
