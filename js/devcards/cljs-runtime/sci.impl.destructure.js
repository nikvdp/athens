...
var G__58577 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58578 = n;
var G__58579 = cljs.core.nnext(bs);
var G__58580 = true;
ret = G__58577;
n = G__58578;
bs = G__58579;
seen_rest_QMARK_ = G__58580;
continue;
} else {
...
var G__58583 = (n + (1));
var G__58584 = cljs.core.next(bs);
var G__58585 = seen_rest_QMARK_;
ret = G__58582;
n = G__58583;
bs = G__58584;
seen_rest_QMARK_ = G__58585;
continue;
}
...
});})(G__58567,gmap,defaults,pvec,bents))
;
return fexpr__58566(G__58567);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58556_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58556_SHARP_);
}
})(),cljs.core.name(p1__58556_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58558_SHARP_,p2__58559_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58558_SHARP_,p2__58559_SHARP_,(function (){var fexpr__58568 = cljs.core.val(entry);
return (fexpr__58568.cljs$core$IFn$_invoke$arity$1 ? fexpr__58568.cljs$core$IFn$_invoke$arity$1(p2__58559_SHARP_) : fexpr__58568.call(null,p2__58559_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58569 = cljs.core.key(entry);
return (fexpr__58569.cljs$core$IFn$_invoke$arity$1 ? fexpr__58569.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58569.call(null,bes));
})());
...
var G__58588 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58589 = cljs.core.next(bes);
ret = G__58588;
bes = G__58589;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58560_SHARP_){
return (cljs.core.first(p1__58560_SHARP_) instanceof cljs.core.Keyword);
}),bents));
