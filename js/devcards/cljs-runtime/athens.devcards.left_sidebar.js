...
var open_QMARK_ = (function (){var G__60811 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
...
var G__60812 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60812) : re_frame.core.dispatch.call(null,G__60812));
...
var G__60813 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60813) : re_frame.core.dispatch.call(null,G__60813));
...
var G__60814 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60814) : re_frame.core.dispatch.call(null,G__60814));
...
var vec__60819 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60817);
...
cljs.core.chunk_append(b__60818,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60817,vec__60819,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60818,s__60816__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__60817,vec__60819,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60818,s__60816__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60833 = (i__60817 + (1));
i__60817 = G__60833;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60818),athens$devcards$left_sidebar$left_sidebar_$_iter__60815(cljs.core.chunk_rest(s__60816__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60818),null);
}
} else {
var vec__60822 = cljs.core.first(s__60816__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60822,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60822,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60822,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60822,_order,title,uid,s__60816__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__60822,_order,title,uid,s__60816__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60815(cljs.core.rest(s__60816__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825 = (function (meta60826){
this.meta60826 = meta60826;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60827,meta60826__$1){
var self__ = this;
var _60827__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825(meta60826__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60827){
var self__ = this;
var _60827__$1 = this;
return self__.meta60826;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__60829 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60828,G__60829) : posh.reagent.transact_BANG_.call(null,G__60828,G__60829));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60825");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60825");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60825.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60825 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60825(meta60826){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825(meta60826));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60825(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830 = (function (meta60831){
this.meta60831 = meta60831;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60832,meta60831__$1){
var self__ = this;
var _60832__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830(meta60831__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60832){
var self__ = this;
var _60832__$1 = this;
return self__.meta60831;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60830");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60830");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60830.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60830 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60830(meta60831){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830(meta60831));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60830(null));
})()
