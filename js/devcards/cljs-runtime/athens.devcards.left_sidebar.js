...
var open_QMARK_ = (function (){var G__60808 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60808) : re_frame.core.subscribe.call(null,G__60808));
})();
...
var G__60809 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60809) : re_frame.core.dispatch.call(null,G__60809));
...
var G__60810 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60810) : re_frame.core.dispatch.call(null,G__60810));
...
var G__60811 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60811) : re_frame.core.dispatch.call(null,G__60811));
...
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60816,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60816,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60816,(2),null);
cljs.core.chunk_append(b__60815,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60814,vec__60816,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60815,s__60813__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__60814,vec__60816,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60815,s__60813__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60830 = (i__60814 + (1));
i__60814 = G__60830;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60815),athens$devcards$left_sidebar$left_sidebar_$_iter__60812(cljs.core.chunk_rest(s__60813__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60815),null);
}
} else {
var vec__60819 = cljs.core.first(s__60813__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60819,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60819,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60819,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60819,_order,title,uid,s__60813__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__60819,_order,title,uid,s__60813__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60812(cljs.core.rest(s__60813__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822 = (function (meta60823){
this.meta60823 = meta60823;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60824,meta60823__$1){
var self__ = this;
var _60824__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822(meta60823__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60824){
var self__ = this;
var _60824__$1 = this;
return self__.meta60823;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__60825 = athens.db.dsdb;
var G__60826 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60825,G__60826) : posh.reagent.transact_BANG_.call(null,G__60825,G__60826));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60822");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60822");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60822.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60822 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60822(meta60823){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822(meta60823));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60822(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827 = (function (meta60828){
this.meta60828 = meta60828;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60829,meta60828__$1){
var self__ = this;
var _60829__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827(meta60828__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60829){
var self__ = this;
var _60829__$1 = this;
return self__.meta60828;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60827");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60827");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60827.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60827 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60827(meta60828){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827(meta60828));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60827(null));
})()
