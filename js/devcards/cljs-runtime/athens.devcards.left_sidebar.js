...
var open_QMARK_ = (function (){var G__60833 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60833) : re_frame.core.subscribe.call(null,G__60833));
})();
...
var G__60834 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
var G__60835 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60835) : re_frame.core.dispatch.call(null,G__60835));
...
var G__60836 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60836) : re_frame.core.dispatch.call(null,G__60836));
...
var vec__60841 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60839);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60841,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60841,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60841,(2),null);
cljs.core.chunk_append(b__60840,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60839,vec__60841,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60840,s__60838__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__60839,vec__60841,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60840,s__60838__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60855 = (i__60839 + (1));
i__60839 = G__60855;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60840),athens$devcards$left_sidebar$left_sidebar_$_iter__60837(cljs.core.chunk_rest(s__60838__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60840),null);
}
} else {
var vec__60844 = cljs.core.first(s__60838__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60844,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60844,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60844,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60844,_order,title,uid,s__60838__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__60844,_order,title,uid,s__60838__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60837(cljs.core.rest(s__60838__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847 = (function (meta60848){
this.meta60848 = meta60848;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60849,meta60848__$1){
var self__ = this;
var _60849__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847(meta60848__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60849){
var self__ = this;
var _60849__$1 = this;
return self__.meta60848;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60850,G__60851) : posh.reagent.transact_BANG_.call(null,G__60850,G__60851));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60847");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60847");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60847.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60847 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60847(meta60848){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847(meta60848));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60847(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852 = (function (meta60853){
this.meta60853 = meta60853;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60854,meta60853__$1){
var self__ = this;
var _60854__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852(meta60853__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60854){
var self__ = this;
var _60854__$1 = this;
return self__.meta60853;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60852");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60852");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60852.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60852 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60852(meta60853){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852(meta60853));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60852(null));
})()
