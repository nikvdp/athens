...
var open_QMARK_ = (function (){var G__61074 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","open","left-sidebar/open",-686633270)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61074) : re_frame.core.subscribe.call(null,G__61074));
})();
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61075 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61076 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61075,G__61076) : posh.reagent.q.call(null,G__61075,G__61076));
})())));
...
var G__61077 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61077) : re_frame.core.dispatch.call(null,G__61077));
...
var G__61078 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("athena","toggle","athena/toggle",2028366801)], null);
...
var G__61079 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61083),athens$devcards$left_sidebar$left_sidebar_$_iter__61080(cljs.core.chunk_rest(s__61081__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61083),null);
}
} else {
var vec__61087 = cljs.core.first(s__61081__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61087,_order,title,uid,s__61081__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61087,_order,title,uid,s__61081__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61080(cljs.core.rest(s__61081__$2)));
}
} else {
return null;
}
...
var G__61090 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61090) : re_frame.core.dispatch.call(null,G__61090));
})], null)], null)], null)], null);
}
});
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091 = (function (meta61092){
this.meta61092 = meta61092;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61093,meta61092__$1){
var self__ = this;
var _61093__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091(meta61092__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61093){
var self__ = this;
var _61093__$1 = this;
return self__.meta61092;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61091");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61091");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61091.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61091 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61091(meta61092){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091(meta61092));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61091(null));
})()
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61096.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
