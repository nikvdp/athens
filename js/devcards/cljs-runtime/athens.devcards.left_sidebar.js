...
var open_QMARK_ = (function (){var G__61024 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
...
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61025 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61026 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61025,G__61026) : posh.reagent.q.call(null,G__61025,G__61026));
})())));
...
var G__61027 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61027) : re_frame.core.dispatch.call(null,G__61027));
...
var G__61028 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61028) : re_frame.core.dispatch.call(null,G__61028));
...
var G__61029 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61033),athens$devcards$left_sidebar$left_sidebar_$_iter__61030(cljs.core.chunk_rest(s__61031__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61033),null);
}
} else {
var vec__61037 = cljs.core.first(s__61031__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61037,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61037,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61037,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61037,_order,title,uid,s__61031__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61037,_order,title,uid,s__61031__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61030(cljs.core.rest(s__61031__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040 = (function (meta61041){
this.meta61041 = meta61041;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61042,meta61041__$1){
var self__ = this;
var _61042__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040(meta61041__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61042){
var self__ = this;
var _61042__$1 = this;
return self__.meta61041;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61043,G__61044) : posh.reagent.transact_BANG_.call(null,G__61043,G__61044));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61041","meta61041",-1489909572,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61040");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61040");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61040.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61040 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61040(meta61041){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040(meta61041));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61040(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045 = (function (meta61046){
this.meta61046 = meta61046;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61047,meta61046__$1){
var self__ = this;
var _61047__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045(meta61046__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61047){
var self__ = this;
var _61047__$1 = this;
return self__.meta61046;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61045");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61045");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61045.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61045 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61045(meta61046){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045(meta61046));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61045(null));
})()
