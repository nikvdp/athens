...
var map__61216 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61216__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var G__61218 = k;
var G__61218__$1 = (((G__61218 instanceof cljs.core.Keyword))?G__61218.fqn:null);
switch (G__61218__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__61219_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__61219_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__61220 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61220__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61222 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61222,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61222,(1),null);
...
var map__61227 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61227__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__61228 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__61228__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61228__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61228__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61228__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61225_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61225_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61226_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61226_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61231(s__61232){
return (new cljs.core.LazySeq(null,(function (){
var s__61232__$1 = s__61232;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61232__$1);
if(temp__5735__auto__){
var s__61232__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61232__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61232__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61234 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61233 = (0);
while(true){
if((i__61233 < size__4581__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61234),athens$devcards$sci_boxes$box_component_$_iter__61231(cljs.core.chunk_rest(s__61232__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61234),null);
}
} else {
var id__$1 = cljs.core.first(s__61232__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61231(cljs.core.rest(s__61232__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235 = (function (meta61236){
this.meta61236 = meta61236;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61237,meta61236__$1){
var self__ = this;
var _61237__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235(meta61236__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61237){
var self__ = this;
var _61237__$1 = this;
return self__.meta61236;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61236","meta61236",1783582382,null)], null);
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61235");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61235");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61235.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61235 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61235(meta61236){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235(meta61236));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61235(null));
})()
