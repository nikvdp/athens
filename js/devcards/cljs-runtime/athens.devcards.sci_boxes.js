...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__61588(s__61589){
return (new cljs.core.LazySeq(null,(function (){
var s__61589__$1 = s__61589;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61589__$1);
if(temp__5735__auto__){
var s__61589__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61589__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61589__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61591 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61590 = (0);
while(true){
if((i__61590 < size__4581__auto__)){
var vec__61592 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61590);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61592,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61592,(1),null);
cljs.core.chunk_append(b__61591,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__61642 = (i__61590 + (1));
i__61590 = G__61642;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61591),athens$devcards$sci_boxes$iter__61588(cljs.core.chunk_rest(s__61589__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61591),null);
}
} else {
var vec__61595 = cljs.core.first(s__61589__$2);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61595,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61595,(1),null);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)),athens$devcards$sci_boxes$iter__61588(cljs.core.rest(s__61589__$2)));
}
} else {
return null;
}
...
return cljs.core.some((function (p__61598){
var vec__61599 = p__61598;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61599,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61599,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__61602){
...
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__61605,parent){
...
var box = map__61606__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61606__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
}catch (e61608){if((e61608 instanceof Error)){
var e = e61608;
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__61609_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__61609_SHARP_) : visited.call(null,p1__61609_SHARP_)))){
return p1__61609_SHARP_;
} else {
return null;
}
}),children);
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__61610_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__61610_SHARP_) : visited.call(null,p1__61610_SHARP_)))){
return p1__61610_SHARP_;
} else {
return null;
}
}),siblings);
...
var G__61643 = boxes_SINGLEQUOTE_;
var G__61644 = visited_SINGLEQUOTE_;
var G__61645 = id_SINGLEQUOTE_;
boxes__$1 = G__61643;
visited = G__61644;
id = G__61645;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61611,idx,id){
var map__61612 = p__61611;
var map__61612__$1 = (((((!((map__61612 == null))))?(((((map__61612.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61612.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61612):map__61612);
var box = map__61612__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61612__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61614,id){
...
var state = map__61615__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61615__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61615__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61617,id){
...
var state = map__61618__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61618__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__61620 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61620__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61624__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61626 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61626,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61626,(1),null);
...
var map__61631 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61631__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__61632 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__61632__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61632__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61632__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61632__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61629_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61629_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61630_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61630_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61635(s__61636){
return (new cljs.core.LazySeq(null,(function (){
var s__61636__$1 = s__61636;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61636__$1);
if(temp__5735__auto__){
var s__61636__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61636__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61636__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61638 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61637 = (0);
while(true){
if((i__61637 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61637);
cljs.core.chunk_append(b__61638,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61647 = (i__61637 + (1));
i__61637 = G__61647;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61638),athens$devcards$sci_boxes$box_component_$_iter__61635(cljs.core.chunk_rest(s__61636__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61638),null);
}
} else {
var id__$1 = cljs.core.first(s__61636__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61635(cljs.core.rest(s__61636__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639 = (function (meta61640){
this.meta61640 = meta61640;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61641,meta61640__$1){
var self__ = this;
var _61641__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639(meta61640__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61641){
var self__ = this;
var _61641__$1 = this;
return self__.meta61640;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61640","meta61640",1449354053,null)], null);
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61639");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61639");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61639.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61639 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61639(meta61640){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639(meta61640));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61639(null));
})()
