...
if((i < len)){
var k = (ks[i]);
var G__31886 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__31887 = (i + (1));
m = G__31886;
i = G__31887;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__31792 = p.children;
return module$node_modules$react$index.Children.toArray(G__31792);
})());
} else {
var v = temp__5737__auto__;
...
var G__31802 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__31802) : reagent.impl.component.as_element.call(null,G__31802));
};
...
while (G__31905__i < G__31905__a.length) {G__31905__a[G__31905__i] = arguments[G__31905__i + 0]; ++G__31905__i;}
  args = new cljs.core.IndexedSeq(G__31905__a,0,null);
} 
return G__31902__delegate.call(this,args);};
G__31902.cljs$lang$maxFixedArity = 0;
G__31902.cljs$lang$applyTo = (function (arglist__31907){
...
var _STAR_current_component_STAR__orig_val__31803 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__31804 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__31804);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__31803);
}});
...
var c = this;
var G__31816_31914 = goog.object.get(c,"cljsRatom");
if((G__31816_31914 == null)){
} else {
reagent.ratom.dispose_BANG_(G__31816_31914);
}
...
var renders_31915 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_31916 = cljs.core.first(cljs.core.vals(renders_31915));
...
if((cljs.core.count(renders_31915) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_31915))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_31916)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_31916], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__31817 = o;
var G__31818_31917 = G__31817;
var G__31819_31918 = cljs.core.name(k);
var G__31820_31919 = v;
goog.object.set(G__31818_31917,G__31819_31918,G__31820_31919);
...
var G__31821_31920 = cmp.prototype;
var G__31822_31921 = module$node_modules$react$index.Component.prototype;
var G__31823_31922 = methods$;
goog.object.extend(G__31821_31920,G__31822_31921,G__31823_31922);
...
var name = (function (){var G__31824 = fiber;
var G__31824__$1 = (((G__31824 == null))?null:G__31824.type);
if((G__31824__$1 == null)){
return null;
} else {
return G__31824__$1.displayName;
}
})();
var parent = (function (){var G__31825 = fiber;
if((G__31825 == null)){
return null;
} else {
return G__31825.return;
}
})();
var path = (function (){var G__31826 = parent;
var G__31826__$1 = (((G__31826 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__31826) : reagent.impl.component.fiber_component_path.call(null,G__31826)));
if((G__31826__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31826__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__31828 = c;
if((G__31828 == null)){
return null;
} else {
return goog.object.get(G__31828,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__31829._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__31831 = c;
if((G__31831 == null)){
return null;
} else {
return goog.object.get(G__31831,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__31837 = c;
if((G__31837 == null)){
return null;
} else {
return G__31837._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__31840 = instance;
if((G__31840 == null)){
return null;
} else {
return goog.object.get(G__31840,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__31847 = instance;
if((G__31847 == null)){
return null;
} else {
return G__31847._currentElement;
}
}
})();
var name = (function (){var G__31853 = elem;
var G__31853__$1 = (((G__31853 == null))?null:G__31853.type);
if((G__31853__$1 == null)){
return null;
} else {
return G__31853__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__31860 = elem;
if((G__31860 == null)){
return null;
} else {
return goog.object.get(G__31860,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__31861._owner;
}
}
})();
var path = (function (){var G__31862 = owner;
var G__31862__$1 = (((G__31862 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__31862) : reagent.impl.component.component_path.call(null,G__31862)));
if((G__31862__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31862__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__31871 = c;
var G__31871__$1 = (((G__31871 == null))?null:G__31871.constructor);
if((G__31871__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__31871__$1);
}
}
})();
