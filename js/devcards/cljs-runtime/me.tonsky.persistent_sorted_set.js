...
var pos_25080 = (0);
while(true){
var rest_25081 = (len - pos_25080);
if((rest_25081 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25080));
} else {
if((rest_25081 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25080,(pos_25080 + chunk_len)));

var G__25087 = (pos_25080 + chunk_len);
pos_25080 = G__25087;
continue;
} else {
var piece_len_25088 = (rest_25081 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25080,(pos_25080 + piece_len_25088)));

var G__25091 = (pos_25080 + piece_len_25088);
pos_25080 = G__25091;
continue;
