...
var G__24896 = (i__24796__auto___24894 + (1));
i__24796__auto___24894 = G__24896;
continue;
} else {
}
break;
...
var pos_25050 = (0);
while(true){
var rest_25051 = (len - pos_25050);
if((rest_25051 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25050));
} else {
if((rest_25051 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25050,(pos_25050 + chunk_len)));

var G__25053 = (pos_25050 + chunk_len);
pos_25050 = G__25053;
continue;
} else {
var piece_len_25054 = (rest_25051 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25050,(pos_25050 + piece_len_25054)));

var G__25055 = (pos_25050 + piece_len_25054);
pos_25050 = G__25055;
continue;
...
var G__25065 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__25066 = (i + (1));
var G__25067 = e;
acc = G__25065;
i = G__25066;
...
break;
default:
var G__25110 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25111 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25110;
shift = G__25111;
continue;
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___25124 = arguments.length;
var i__4790__auto___25126 = (0);
while(true){
if((i__4790__auto___25126 < len__4789__auto___25124)){
args_arr__4810__auto__.push((arguments[i__4790__auto___25126]));

var G__25127 = (i__4790__auto___25126 + (1));
i__4790__auto___25126 = G__25127;
continue;
} else {
}
break;
