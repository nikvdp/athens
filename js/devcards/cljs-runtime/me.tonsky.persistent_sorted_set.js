...
var n__4666__auto___24917 = l__24795__auto___24915;
...
var n__4666__auto___24923 = l__24795__auto___24921;
...
var G__25032 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__25033 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__25032;
res = G__25033;
continue;
}
...
var G__25040 = (node.pointers[idx]);
var G__25041 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__25042 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__25040;
path = G__25041;
level = G__25042;
continue;
...
var pos_25052 = (0);
while(true){
var rest_25053 = (len - pos_25052);
if((rest_25053 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25052));
} else {
if((rest_25053 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25052,(pos_25052 + chunk_len)));

var G__25055 = (pos_25052 + chunk_len);
pos_25052 = G__25055;
continue;
} else {
var piece_len_25057 = (rest_25053 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25052,(pos_25052 + piece_len_25057)));

var G__25060 = (pos_25052 + piece_len_25057);
pos_25052 = G__25060;
continue;
...
break;
default:
var G__25112 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25113 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25112;
shift = G__25113;
continue;
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___25127 = arguments.length;
var i__4790__auto___25128 = (0);
while(true){
if((i__4790__auto___25128 < len__4789__auto___25127)){
args_arr__4810__auto__.push((arguments[i__4790__auto___25128]));

var G__25130 = (i__4790__auto___25128 + (1));
i__4790__auto___25128 = G__25130;
continue;
} else {
}
break;
