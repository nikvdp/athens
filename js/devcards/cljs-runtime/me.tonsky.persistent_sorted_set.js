...
var G__24907 = (i__24796__auto___24904 + (1));
i__24796__auto___24904 = G__24907;
continue;
} else {
}
break;
...
var l__24795__auto___24913 = (a2_l - (r1_l - a1_l));
var n__4666__auto___24915 = l__24795__auto___24913;
...
var n__4666__auto___24920 = l__24795__auto___24918;
...
while(true){
if((level > (0))){
var G__24954 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__24955 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24954;
node = G__24955;
continue;
} else {
...
var G__24974 = (left__$1 + (1));
var G__24975 = keys__$1;
var G__24976 = (idx__$1 + (1));
var G__24977 = new_acc;
left__$1 = G__24974;
keys__$1 = G__24975;
idx__$1 = G__24976;
acc = G__24977;
...
var G__24980 = new_left;
var G__24981 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__24982 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__24983 = new_acc;
left__$1 = G__24980;
keys__$1 = G__24981;
idx__$1 = G__24982;
acc = G__24983;
...
var G__25017 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__25018 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__25017;
res = G__25018;
continue;
}
...
var G__25029 = (node.pointers[idx]);
var G__25030 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__25031 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__25029;
path = G__25030;
level = G__25031;
continue;
...
while(true){
if((i_25037 < len)){
(arr[i_25037] = (function (){var G__24864 = (arr[i_25037]);
...
var pos_25042 = (0);
while(true){
var rest_25043 = (len - pos_25042);
if((rest_25043 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25042));
} else {
if((rest_25043 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25042,(pos_25042 + chunk_len)));

var G__25046 = (pos_25042 + chunk_len);
pos_25042 = G__25046;
continue;
} else {
var piece_len_25047 = (rest_25043 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25042,(pos_25042 + piece_len_25047)));

var G__25048 = (pos_25042 + piece_len_25047);
pos_25042 = G__25048;
continue;
...
var len__4789__auto___25094 = arguments.length;
var i__4790__auto___25095 = (0);
while(true){
if((i__4790__auto___25095 < len__4789__auto___25094)){
args_arr__4810__auto__.push((arguments[i__4790__auto___25095]));

var G__25099 = (i__4790__auto___25095 + (1));
i__4790__auto___25095 = G__25099;
continue;
} else {
}
break;
