...
while(true){
if((level > (0))){
var G__24974 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__24975 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24974;
node = G__24975;
continue;
} else {
...
var G__25041 = new_left;
var G__25042 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25043 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
...
break;
default:
var G__25149 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25150 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25149;
shift = G__25150;
continue;
