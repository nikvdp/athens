...
var _STAR_print_newline_STAR__orig_val__60435_60494 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60436_60495 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60437_60496 = true;
var _STAR_print_fn_STAR__temp_val__60438_60497 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60437_60496);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60438_60497);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(obj);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60436_60495);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60435_60494);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
}));
shadow.cljs.devtools.client.env.repl_error = (function shadow$cljs$devtools$client$env$repl_error(e){
var G__60439 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","invoke-error","repl/invoke-error",839951858),new cljs.core.Keyword(null,"error","error",-978969032),e.message], null);
if(cljs.core.truth_(e.hasOwnProperty("stack"))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60439,new cljs.core.Keyword(null,"stack","stack",-793405930),e.stack);
} else {
return G__60439;
}
});
...
var G__60442_60498 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","out","repl/out",-905715102),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60442_60498) : msg_fn.call(null,G__60442_60498));
...
var G__60499__i = 0, G__60499__a = new Array(arguments.length -  0);
while (G__60499__i < G__60499__a.length) {G__60499__a[G__60499__i] = arguments[G__60499__i + 0]; ++G__60499__i;}
  args = new cljs.core.IndexedSeq(G__60499__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_fn.cljs$lang$applyTo = (function (arglist__60500){
var args = cljs.core.seq(arglist__60500);
...
var G__60443_60501 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","err","repl/err",-2086562244),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60443_60501) : msg_fn.call(null,G__60443_60501));
...
var args = null;
if (arguments.length > 0) {
var G__60502__i = 0, G__60502__a = new Array(arguments.length -  0);
while (G__60502__i < G__60502__a.length) {G__60502__a[G__60502__i] = arguments[G__60502__i + 0]; ++G__60502__i;}
  args = new cljs.core.IndexedSeq(G__60502__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_err_fn.cljs$lang$applyTo = (function (arglist__60503){
var args = cljs.core.seq(arglist__60503);
...
var _STAR_default_data_reader_fn_STAR__orig_val__60444 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
var _STAR_default_data_reader_fn_STAR__temp_val__60445 = (function (tag,value){
...
(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__temp_val__60445);

try{try{var msg_60504 = cljs.tools.reader.read_string.cljs$core$IFn$_invoke$arity$1(text);
shadow.cljs.devtools.client.env.repl_queue_arr.push((function (){
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(msg_60504,shadow.cljs.devtools.client.env.done_BANG_) : handler.call(null,msg_60504,shadow.cljs.devtools.client.env.done_BANG_));
}));
...
throw e;
}}finally {(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__orig_val__60444);
}});
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__60447,p__60448){
...
var log_missing_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60449__$1,new cljs.core.Keyword(null,"log-missing-fn","log-missing-fn",732676765));
var log_call_async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60449__$1,new cljs.core.Keyword(null,"log-call-async","log-call-async",183826192));
var log_call = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60449__$1,new cljs.core.Keyword(null,"log-call","log-call",412404391));
...
var fn_sym = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60450__$1,new cljs.core.Keyword(null,"fn-sym","fn-sym",1423988510));
var fn_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60450__$1,new cljs.core.Keyword(null,"fn-str","fn-str",-1348506402));
var async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60450__$1,new cljs.core.Keyword(null,"async","async",1050769601));
...
}catch (e60453){var ex = e60453;
console.warn("error when calling lifecycle function",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_sym),ex);

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
}});
});
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(failure_fn,p__60454){
...
var task = first__60457;
var remaining_tasks = seq__60456__$1;
if(cljs.core.truth_(task)){
try{var G__60459 = (function (){
return (shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2 ? shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2(failure_fn,remaining_tasks) : shadow.cljs.devtools.client.env.do_js_reload_STAR_.call(null,failure_fn,remaining_tasks));
});
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__60459) : task.call(null,G__60459));
...
(shadow.cljs.devtools.client.env.do_js_reload.cljs$core$IFn$_invoke$arity$4 = (function (p__60464,load_code_fn,complete_fn,failure_fn){
...
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60465__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60460_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60460_SHARP_);
}),new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),(function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__60461_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60461_SHARP_);
...
shadow.cljs.devtools.client.env.before_load_src = (function shadow$cljs$devtools$client$env$before_load_src(p__60467){
...
var src = map__60468__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60468__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60468__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cljs","cljs",1492417629),type)){
var seq__60470 = cljs.core.seq(goog.global.SHADOW_NS_RESET);
var chunk__60471 = null;
var count__60472 = (0);
var i__60473 = (0);
while(true){
if((i__60473 < count__60472)){
var x = chunk__60471.cljs$core$IIndexed$_nth$arity$2(null,i__60473);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60506 = seq__60470;
var G__60507 = chunk__60471;
var G__60508 = count__60472;
var G__60509 = (i__60473 + (1));
seq__60470 = G__60506;
chunk__60471 = G__60507;
count__60472 = G__60508;
i__60473 = G__60509;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60470);
if(temp__5735__auto__){
var seq__60470__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60470__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60470__$1);
var G__60510 = cljs.core.chunk_rest(seq__60470__$1);
var G__60511 = c__4609__auto__;
var G__60512 = cljs.core.count(c__4609__auto__);
var G__60513 = (0);
seq__60470 = G__60510;
chunk__60471 = G__60511;
count__60472 = G__60512;
i__60473 = G__60513;
continue;
} else {
var x = cljs.core.first(seq__60470__$1);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60514 = cljs.core.next(seq__60470__$1);
var G__60515 = null;
var G__60516 = (0);
var G__60517 = (0);
seq__60470 = G__60514;
chunk__60471 = G__60515;
count__60472 = G__60516;
i__60473 = G__60517;
continue;
}
} else {
...
var seq__60474 = cljs.core.seq(cljs.core.deref(shadow.cljs.devtools.client.env.custom_msg_subscribers_ref));
var chunk__60475 = null;
var count__60476 = (0);
var i__60477 = (0);
while(true){
if((i__60477 < count__60476)){
var vec__60486 = chunk__60475.cljs$core$IIndexed$_nth$arity$2(null,i__60477);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60486,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60486,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60489){var e_60518 = e60489;
console.warn("failed to handle custom msg",id,msg);
}

var G__60519 = seq__60474;
var G__60520 = chunk__60475;
var G__60521 = count__60476;
var G__60522 = (i__60477 + (1));
seq__60474 = G__60519;
chunk__60475 = G__60520;
count__60476 = G__60521;
i__60477 = G__60522;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60474);
if(temp__5735__auto__){
var seq__60474__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60474__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60474__$1);
var G__60523 = cljs.core.chunk_rest(seq__60474__$1);
var G__60524 = c__4609__auto__;
var G__60525 = cljs.core.count(c__4609__auto__);
var G__60526 = (0);
seq__60474 = G__60523;
chunk__60475 = G__60524;
count__60476 = G__60525;
i__60477 = G__60526;
continue;
} else {
var vec__60490 = cljs.core.first(seq__60474__$1);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60490,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60490,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60493){var e_60527 = e60493;
console.warn("failed to handle custom msg",id,msg);
}

var G__60528 = cljs.core.next(seq__60474__$1);
var G__60529 = null;
var G__60530 = (0);
var G__60531 = (0);
seq__60474 = G__60528;
chunk__60475 = G__60529;
count__60476 = G__60530;
i__60477 = G__60531;
continue;
}
} else {
