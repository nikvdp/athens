...
var pattern_28609 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28609,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var rec = (function (){var G__28584 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28584,attr,eid);
} else {
return G__28584;
}
})();
...
var G__28656 = db;
var G__28657 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28656;
p__28590 = G__28657;
continue;
}
...
case "expand":
var G__28659 = db;
var G__28660 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28659;
frames = G__28660;
continue;
...
case "expand-rev":
var G__28661 = db;
var G__28662 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28661;
frames = G__28662;
continue;
...
case "pattern":
var G__28663 = db;
var G__28664 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28663;
frames = G__28664;
continue;
...
case "recursion":
var G__28665 = db;
var G__28666 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28665;
frames = G__28666;
continue;
...
var G__28667 = db;
var G__28668 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28599 = cljs.core.first(remaining);
