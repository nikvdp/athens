...
var vec__26402 = p__26400;
var seq__26403 = cljs.core.seq(vec__26402);
var first__26404 = cljs.core.first(seq__26403);
var seq__26403__$1 = cljs.core.next(seq__26403);
var frame = first__26404;
var frames = seq__26403__$1;
...
var results = (function (){var G__26408 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__26408,kvps);
} else {
return G__26408;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26409__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26409__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_26508 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_26508,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__26412){
...
var parent = first__26415;
var frames = seq__26414__$1;
...
var found = cljs.core.not_empty((function (){var G__26416 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26416);
} else {
return G__26416;
}
})());
...
var as_value = (function (){var G__26417 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__26411_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__26411_SHARP_]);
}),G__26417);
} else {
return G__26417;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__26418 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__26418);
} else {
return G__26418;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__26419 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26419,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__26419;
}
})());
...
var vec__26420 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26420,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26420,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__26423){
var vec__26424 = p__26423;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26424,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26424,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__26427){
var vec__26428 = p__26427;
var seq__26429 = cljs.core.seq(vec__26428);
var first__26430 = cljs.core.first(seq__26429);
var seq__26429__$1 = cljs.core.next(seq__26429);
var frame = first__26430;
var frames = seq__26429__$1;
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26449__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26449__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__26453){
while(true){
...
var frame = first__26456;
var frames = seq__26455__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__26516 = db;
var G__26517 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26516;
p__26453 = G__26517;
continue;
}
...
while(true){
var G__26461 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__26461__$1 = (((G__26461 instanceof cljs.core.Keyword))?G__26461.fqn:null);
switch (G__26461__$1) {
case "expand":
var G__26519 = db;
var G__26520 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26519;
frames = G__26520;
continue;
...
case "expand-rev":
var G__26521 = db;
var G__26522 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26521;
frames = G__26522;
continue;
...
case "pattern":
var G__26523 = db;
var G__26524 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26523;
frames = G__26524;
continue;
...
case "recursion":
var G__26525 = db;
var G__26526 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26525;
frames = G__26526;
continue;
...
break;
case "done":
var vec__26465 = frames;
var seq__26466 = cljs.core.seq(vec__26465);
var first__26467 = cljs.core.first(seq__26466);
var seq__26466__$1 = cljs.core.next(seq__26466);
var f = first__26467;
var remaining = seq__26466__$1;
var result = (function (){var G__26468 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26468);
} else {
return G__26468;
}
})();
...
var G__26528 = db;
var G__26529 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26472 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26472,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__26472;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26461__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__26473_SHARP_){
return datascript.db.entid_strict(db,p1__26473_SHARP_);
})),eids);
