...
var pattern_28258 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28258,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__28159){
var vec__28160 = p__28159;
var seq__28161 = cljs.core.seq(vec__28160);
var first__28162 = cljs.core.first(seq__28161);
var seq__28161__$1 = cljs.core.next(seq__28161);
var parent = first__28162;
var frames = seq__28161__$1;
...
var found = cljs.core.not_empty((function (){var G__28166 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__28166);
} else {
return G__28166;
}
})());
...
var as_value = (function (){var G__28167 = datom_val;
if(ref_QMARK_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__28168 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__28168);
} else {
return G__28168;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__28169 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28169,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__28169;
}
})());
...
var vec__28170 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28170,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28170,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__28173){
var vec__28174 = p__28173;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28174,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28174,(1),null);
...
var G__28263 = db;
var G__28264 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28263;
p__28193 = G__28264;
continue;
}
...
while(true){
var G__28207 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__28207__$1 = (((G__28207 instanceof cljs.core.Keyword))?G__28207.fqn:null);
switch (G__28207__$1) {
case "expand":
var G__28266 = db;
var G__28267 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28266;
frames = G__28267;
continue;
...
case "expand-rev":
var G__28268 = db;
var G__28269 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28268;
frames = G__28269;
continue;
...
case "pattern":
var G__28270 = db;
var G__28271 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28270;
frames = G__28271;
continue;
...
case "recursion":
var G__28272 = db;
var G__28273 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28272;
frames = G__28273;
continue;
...
var f = first__28210;
var remaining = seq__28209__$1;
var result = (function (){var G__28211 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__28211);
} else {
return G__28211;
}
})();
...
var G__28274 = db;
var G__28275 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28212 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28212,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__28212;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__28213_SHARP_){
return datascript.db.entid_strict(db,p1__28213_SHARP_);
})),eids);
