...
var pattern_28648 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28648,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var G__28664 = db;
var G__28665 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28664;
p__28590 = G__28665;
continue;
}
...
case "expand":
var G__28668 = db;
var G__28669 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28668;
frames = G__28669;
continue;
...
case "expand-rev":
var G__28670 = db;
var G__28671 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28670;
frames = G__28671;
continue;
...
case "pattern":
var G__28676 = db;
var G__28677 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28676;
frames = G__28677;
continue;
...
case "recursion":
var G__28678 = db;
var G__28683 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28678;
frames = G__28683;
continue;
...
var G__28692 = db;
var G__28693 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28599 = cljs.core.first(remaining);
