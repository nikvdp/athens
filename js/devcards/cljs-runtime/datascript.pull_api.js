...
var pattern_28212 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28212,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var map__28185 = frame;
var map__28185__$1 = (((((!((map__28185 == null))))?(((((map__28185.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28185.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28185):map__28185);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28185__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28185__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__28187 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28187,attr,eid);
} else {
return G__28187;
}
})();
...
var G__28252 = db;
var G__28253 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28252;
p__28193 = G__28253;
continue;
}
...
case "expand":
var G__28255 = db;
var G__28256 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28255;
frames = G__28256;
continue;
...
case "expand-rev":
var G__28260 = db;
var G__28261 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28260;
frames = G__28261;
continue;
...
case "pattern":
var G__28262 = db;
var G__28263 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28262;
frames = G__28263;
continue;
...
case "recursion":
var G__28264 = db;
var G__28265 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28264;
frames = G__28265;
continue;
...
var G__28269 = db;
var G__28270 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28202 = cljs.core.first(remaining);
