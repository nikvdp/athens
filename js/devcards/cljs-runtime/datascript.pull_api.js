...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26435__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__26437 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__26437,attr,eid);
} else {
return G__26437;
}
})();
...
var G__26499 = db;
var G__26500 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26499;
p__26443 = G__26500;
continue;
}
...
case "expand":
var G__26505 = db;
var G__26506 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26505;
frames = G__26506;
continue;
...
case "expand-rev":
var G__26507 = db;
var G__26508 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26507;
frames = G__26508;
continue;
...
case "pattern":
var G__26509 = db;
var G__26510 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26509;
frames = G__26510;
continue;
...
case "recursion":
var G__26514 = db;
var G__26515 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26514;
frames = G__26515;
continue;
...
var G__26519 = db;
var G__26520 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26452 = cljs.core.first(remaining);
