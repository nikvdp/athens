...
var pattern_28615 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28615,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__28571){
...
var frame = first__28574;
var frames = seq__28573__$1;
...
var G__28659 = db;
var G__28660 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28659;
p__28590 = G__28660;
continue;
}
...
case "expand":
var G__28663 = db;
var G__28664 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28663;
frames = G__28664;
continue;
...
case "expand-rev":
var G__28665 = db;
var G__28666 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28665;
frames = G__28666;
continue;
...
case "pattern":
var G__28667 = db;
var G__28668 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28667;
frames = G__28668;
continue;
...
case "recursion":
var G__28669 = db;
var G__28670 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28669;
frames = G__28670;
continue;
...
var G__28671 = db;
var G__28672 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28599 = cljs.core.first(remaining);
