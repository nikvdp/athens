...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26210__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26210__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__26212 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__26212__$1 = (((G__26212 == null))?null:cljs.core.persistent_BANG_(G__26212));
if((G__26212__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__26212__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__26213){
...
var frame = first__26216;
var frames = seq__26215__$1;
...
var results = (function (){var G__26217 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__26217,kvps);
} else {
return G__26217;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26218__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26218__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__26222){
...
var parent = first__26225;
var frames = seq__26224__$1;
...
var found = cljs.core.not_empty((function (){var G__26226 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26226);
} else {
return G__26226;
}
})());
...
var as_value = (function (){var G__26227 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__26221_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__26221_SHARP_]);
}),G__26227);
} else {
return G__26227;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__26228 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__26228);
} else {
return G__26228;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__26229 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26229,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__26229;
}
})());
...
var vec__26230 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26230,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26230,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__26233){
var vec__26234 = p__26233;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26234,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26234,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__26237){
var vec__26238 = p__26237;
var seq__26239 = cljs.core.seq(vec__26238);
var first__26240 = cljs.core.first(seq__26239);
var seq__26239__$1 = cljs.core.next(seq__26239);
var frame = first__26240;
var frames = seq__26239__$1;
