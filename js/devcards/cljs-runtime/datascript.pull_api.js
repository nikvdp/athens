...
var pattern_28204 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28204,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__28169){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__28173){
...
var frame = first__28176;
var frames = seq__28175__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__28177){
...
var vec__28181 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28181,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28181,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28184__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28184__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__28186 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28186,attr,eid);
} else {
return G__28186;
}
})();
...
var map__28187 = frame;
var map__28187__$1 = (((((!((map__28187 == null))))?(((((map__28187.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28187.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28187):map__28187);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28187__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28187__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__28189){
while(true){
...
var frame = first__28192;
var frames = seq__28191__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__28222 = db;
var G__28223 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28222;
p__28189 = G__28223;
continue;
}
...
while(true){
var G__28194 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__28194__$1 = (((G__28194 instanceof cljs.core.Keyword))?G__28194.fqn:null);
switch (G__28194__$1) {
case "expand":
var G__28228 = db;
var G__28229 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28228;
frames = G__28229;
continue;
...
case "expand-rev":
var G__28230 = db;
var G__28231 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28230;
frames = G__28231;
continue;
...
case "pattern":
var G__28232 = db;
var G__28233 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28232;
frames = G__28233;
continue;
...
case "recursion":
var G__28234 = db;
var G__28235 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28234;
frames = G__28235;
continue;
...
break;
case "done":
var vec__28195 = frames;
var seq__28196 = cljs.core.seq(vec__28195);
var first__28197 = cljs.core.first(seq__28196);
var seq__28196__$1 = cljs.core.next(seq__28196);
var f = first__28197;
var remaining = seq__28196__$1;
var result = (function (){var G__28198 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__28198);
} else {
return G__28198;
}
})();
...
var G__28236 = db;
var G__28237 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28202 = cljs.core.first(remaining);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28194__$1)].join('')));
