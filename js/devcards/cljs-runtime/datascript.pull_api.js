...
var pattern_26485 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_26485,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var found = cljs.core.not_empty((function (){var G__26413 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26413);
} else {
return G__26413;
}
})());
...
var G__26513 = db;
var G__26514 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26513;
p__26443 = G__26514;
continue;
}
...
case "expand":
var G__26516 = db;
var G__26517 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26516;
frames = G__26517;
continue;
...
case "pattern":
var G__26521 = db;
var G__26522 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26521;
frames = G__26522;
continue;
...
case "recursion":
var G__26524 = db;
var G__26525 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26524;
frames = G__26525;
continue;
...
var G__26526 = db;
var G__26527 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26452 = cljs.core.first(remaining);
