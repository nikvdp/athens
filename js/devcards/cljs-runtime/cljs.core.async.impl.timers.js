...
var i_40822 = (0);
while(true){
if((i_40822 < arr.length)){
(arr[i_40822] = null);

var G__40823 = (i_40822 + (1));
i_40822 = G__40823;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40857 = (update[i]).forward;
(x__$2.forward[i] = (links_40857[i]));
...
var i_40863 = (0);
while(true){
if((i_40863 <= self__.level)){
var links_40864 = (update[i_40863]).forward;
if((x__$1 === (((i_40863 < links_40864.length))?(links_40864[i_40863]):null))){
(links_40864[i_40863] = (x__$1.forward[i_40863]));

var G__40865 = (i_40863 + (1));
i_40863 = G__40865;
continue;
} else {
var G__40870 = (i_40863 + (1));
i_40863 = G__40870;
continue;
}
} else {
