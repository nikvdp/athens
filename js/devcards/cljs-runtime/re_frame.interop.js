...
return [(function (){var pred__45718 = cljs.core.instance_QMARK_;
var expr__45719 = reactive_val;
if(cljs.core.truth_((pred__45718.cljs$core$IFn$_invoke$arity$2 ? pred__45718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45719) : pred__45718.call(null,reagent.ratom.RAtom,expr__45719)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45718.cljs$core$IFn$_invoke$arity$2 ? pred__45718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45719) : pred__45718.call(null,reagent.ratom.RCursor,expr__45719)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45718.cljs$core$IFn$_invoke$arity$2 ? pred__45718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45719) : pred__45718.call(null,reagent.ratom.Reaction,expr__45719)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45718.cljs$core$IFn$_invoke$arity$2 ? pred__45718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45719) : pred__45718.call(null,reagent.ratom.Track,expr__45719)))){
return "tr";
} else {
return "other";
}
