...
return [(function (){var pred__49693 = cljs.core.instance_QMARK_;
var expr__49694 = reactive_val;
if(cljs.core.truth_((pred__49693.cljs$core$IFn$_invoke$arity$2 ? pred__49693.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__49694) : pred__49693.call(null,reagent.ratom.RAtom,expr__49694)))){
return "ra";
} else {
if(cljs.core.truth_((pred__49693.cljs$core$IFn$_invoke$arity$2 ? pred__49693.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__49694) : pred__49693.call(null,reagent.ratom.RCursor,expr__49694)))){
return "rc";
} else {
if(cljs.core.truth_((pred__49693.cljs$core$IFn$_invoke$arity$2 ? pred__49693.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__49694) : pred__49693.call(null,reagent.ratom.Reaction,expr__49694)))){
return "rx";
} else {
if(cljs.core.truth_((pred__49693.cljs$core$IFn$_invoke$arity$2 ? pred__49693.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__49694) : pred__49693.call(null,reagent.ratom.Track,expr__49694)))){
return "tr";
} else {
return "other";
}
