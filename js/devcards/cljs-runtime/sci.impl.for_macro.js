...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__58547){
var vec__58548 = p__58547;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58548,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58548,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58548,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__58551){
var vec__58552 = p__58551;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58552,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58552,(1),null);
...
var err = (function() { 
var G__58582__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__58582 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__58583__i = 0, G__58583__a = new Array(arguments.length -  0);
while (G__58583__i < G__58583__a.length) {G__58583__a[G__58583__i] = arguments[G__58583__i + 0]; ++G__58583__i;}
  msg = new cljs.core.IndexedSeq(G__58583__a,0,null);
} 
return G__58582__delegate.call(this,msg);};
G__58582.cljs$lang$maxFixedArity = 0;
G__58582.cljs$lang$applyTo = (function (arglist__58584){
var msg = cljs.core.seq(arglist__58584);
return G__58582__delegate(msg);
});
G__58582.cljs$core$IFn$_invoke$arity$variadic = G__58582__delegate;
return G__58582;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__58555){
...
var seq__58560 = cljs.core.seq(vec__58559);
var first__58561 = cljs.core.first(seq__58560);
var seq__58560__$1 = cljs.core.next(seq__58560);
var bind = first__58561;
var first__58561__$1 = cljs.core.first(seq__58560__$1);
var seq__58560__$2 = cljs.core.next(seq__58560__$1);
var expr = first__58561__$1;
var mod_pairs = seq__58560__$2;
var vec__58562 = seq__58557__$1;
var vec__58565 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58562,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58565,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58565,(1),null);
var next_groups = vec__58562;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__58568){
...
var vec__58572 = first__58571;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58572,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58572,(1),null);
var pair = vec__58572;
var etc = seq__58570__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58542__auto__","iterys__58542__auto__",-123605319,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58543__auto__","fs__58543__auto__",-644177372,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58542__auto__","iterys__58542__auto__",-123605319,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58543__auto__","fs__58543__auto__",-644177372,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58543__auto__","fs__58543__auto__",-644177372,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__58575){
...
var vec__58579 = first__58578;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58579,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58579,(1),null);
var pair = vec__58579;
var etc = seq__58577__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
