...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__58943){
var vec__58944 = p__58943;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58944,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58944,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58944,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__58947){
...
var err = (function() { 
var G__58978__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__58978 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__58979__i = 0, G__58979__a = new Array(arguments.length -  0);
while (G__58979__i < G__58979__a.length) {G__58979__a[G__58979__i] = arguments[G__58979__i + 0]; ++G__58979__i;}
  msg = new cljs.core.IndexedSeq(G__58979__a,0,null);
} 
return G__58978__delegate.call(this,msg);};
G__58978.cljs$lang$maxFixedArity = 0;
G__58978.cljs$lang$applyTo = (function (arglist__58980){
var msg = cljs.core.seq(arglist__58980);
return G__58978__delegate(msg);
});
G__58978.cljs$core$IFn$_invoke$arity$variadic = G__58978__delegate;
return G__58978;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__58951){
var vec__58952 = p__58951;
...
var vec__58955 = first__58954;
var seq__58956 = cljs.core.seq(vec__58955);
var first__58957 = cljs.core.first(seq__58956);
var seq__58956__$1 = cljs.core.next(seq__58956);
var bind = first__58957;
var first__58957__$1 = cljs.core.first(seq__58956__$1);
var seq__58956__$2 = cljs.core.next(seq__58956__$1);
var expr = first__58957__$1;
var mod_pairs = seq__58956__$2;
var vec__58958 = seq__58953__$1;
var vec__58961 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58958,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58961,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58961,(1),null);
var next_groups = vec__58958;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__58964){
var vec__58965 = p__58964;
var seq__58966 = cljs.core.seq(vec__58965);
var first__58967 = cljs.core.first(seq__58966);
var seq__58966__$1 = cljs.core.next(seq__58966);
var vec__58968 = first__58967;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58934__auto__","iterys__58934__auto__",970393742,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58935__auto__","fs__58935__auto__",-1086275509,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58934__auto__","iterys__58934__auto__",970393742,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58935__auto__","fs__58935__auto__",-1086275509,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58935__auto__","fs__58935__auto__",-1086275509,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__58971){
