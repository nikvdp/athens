...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__58976){
var vec__58977 = p__58976;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58977,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58977,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58977,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__58980){
var vec__58981 = p__58980;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58981,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58981,(1),null);
...
var err = (function() { 
var G__59011__delegate = function (msg){
...
while (G__59012__i < G__59012__a.length) {G__59012__a[G__59012__i] = arguments[G__59012__i + 0]; ++G__59012__i;}
  msg = new cljs.core.IndexedSeq(G__59012__a,0,null);
} 
return G__59011__delegate.call(this,msg);};
G__59011.cljs$lang$maxFixedArity = 0;
G__59011.cljs$lang$applyTo = (function (arglist__59013){
var msg = cljs.core.seq(arglist__59013);
return G__59011__delegate(msg);
});
G__59011.cljs$core$IFn$_invoke$arity$variadic = G__59011__delegate;
return G__59011;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__58984){
...
var bind = first__58990;
var first__58990__$1 = cljs.core.first(seq__58989__$1);
var seq__58989__$2 = cljs.core.next(seq__58989__$1);
var expr = first__58990__$1;
var mod_pairs = seq__58989__$2;
var vec__58991 = seq__58986__$1;
var vec__58994 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58991,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58994,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58994,(1),null);
var next_groups = vec__58991;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__58997){
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58971__auto__","iterys__58971__auto__",-751477193,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58972__auto__","fs__58972__auto__",-776792482,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58971__auto__","iterys__58971__auto__",-751477193,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58972__auto__","fs__58972__auto__",-776792482,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58972__auto__","fs__58972__auto__",-776792482,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__59004){
var vec__59005 = p__59004;
var seq__59006 = cljs.core.seq(vec__59005);
var first__59007 = cljs.core.first(seq__59006);
var seq__59006__$1 = cljs.core.next(seq__59006);
var vec__59008 = first__59007;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59008,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59008,(1),null);
var pair = vec__59008;
var etc = seq__59006__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
