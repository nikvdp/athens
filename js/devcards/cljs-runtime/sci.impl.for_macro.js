...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__58960){
var vec__58961 = p__58960;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58961,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58961,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58961,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__58964){
var vec__58965 = p__58964;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58965,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58965,(1),null);
...
var err = (function() { 
var G__58995__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__58995 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__58996__i = 0, G__58996__a = new Array(arguments.length -  0);
while (G__58996__i < G__58996__a.length) {G__58996__a[G__58996__i] = arguments[G__58996__i + 0]; ++G__58996__i;}
  msg = new cljs.core.IndexedSeq(G__58996__a,0,null);
} 
return G__58995__delegate.call(this,msg);};
G__58995.cljs$lang$maxFixedArity = 0;
G__58995.cljs$lang$applyTo = (function (arglist__58997){
var msg = cljs.core.seq(arglist__58997);
return G__58995__delegate(msg);
});
G__58995.cljs$core$IFn$_invoke$arity$variadic = G__58995__delegate;
return G__58995;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__58968){
...
var bind = first__58974;
var first__58974__$1 = cljs.core.first(seq__58973__$1);
var seq__58973__$2 = cljs.core.next(seq__58973__$1);
var expr = first__58974__$1;
var mod_pairs = seq__58973__$2;
var vec__58975 = seq__58970__$1;
var vec__58978 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58975,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58978,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58978,(1),null);
var next_groups = vec__58975;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__58981){
...
var vec__58985 = first__58984;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58985,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58985,(1),null);
var pair = vec__58985;
var etc = seq__58983__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58955__auto__","iterys__58955__auto__",-1859788939,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58956__auto__","fs__58956__auto__",1671582843,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58955__auto__","iterys__58955__auto__",-1859788939,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58956__auto__","fs__58956__auto__",1671582843,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58956__auto__","fs__58956__auto__",1671582843,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__58988){
var vec__58989 = p__58988;
var seq__58990 = cljs.core.seq(vec__58989);
var first__58991 = cljs.core.first(seq__58990);
var seq__58990__$1 = cljs.core.next(seq__58990);
var vec__58992 = first__58991;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58992,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58992,(1),null);
var pair = vec__58992;
var etc = seq__58990__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
