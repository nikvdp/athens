...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56195 = (function (){var G__56196 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56196) : parser.call(null,G__56196));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56195) : tag_set.call(null,G__56195));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__56198){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56199__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56199__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56205,hidden_QMARK_){
var map__56206 = p__56205;
var map__56206__$1 = (((((!((map__56206 == null))))?(((((map__56206.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56206.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56206):map__56206);
var p = map__56206__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56206__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56206__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56206__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56206__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56206__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__56209_56234 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56210_56235 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56211_56236 = true;
var _STAR_print_fn_STAR__temp_val__56212_56237 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56211_56236);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56212_56237);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56210_56235);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56209_56234);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56213_56238 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56214_56239 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56215_56240 = true;
var _STAR_print_fn_STAR__temp_val__56216_56241 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56215_56240);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56216_56241);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56214_56239);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56213_56238);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56208__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56217){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56218__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56218__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56220(s__56221){
return (new cljs.core.LazySeq(null,(function (){
var s__56221__$1 = s__56221;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56221__$1);
if(temp__5735__auto__){
var s__56221__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56221__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56221__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56223 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56222 = (0);
while(true){
if((i__56222 < size__4581__auto__)){
var vec__56224 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56222);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56224,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56224,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__56223,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56243 = (i__56222 + (1));
i__56222 = G__56243;
continue;
} else {
var G__56244 = (i__56222 + (1));
i__56222 = G__56244;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56223),instaparse$print$Parser__GT_str_$_iter__56220(cljs.core.chunk_rest(s__56221__$2)));
} else {
...
var G__56245 = cljs.core.rest(s__56221__$2);
s__56221__$1 = G__56245;
continue;
}
}
} else {
