...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56221 = (function (){var G__56222 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56222) : parser.call(null,G__56222));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56221) : tag_set.call(null,G__56221));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__56224){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56225__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56225__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56229,hidden_QMARK_){
...
var p = map__56230__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56230__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56230__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56230__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56230__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56230__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__56232 = tag;
var G__56232__$1 = (((G__56232 instanceof cljs.core.Keyword))?G__56232.fqn:null);
switch (G__56232__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__56234_56269 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56235_56270 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56236_56271 = true;
var _STAR_print_fn_STAR__temp_val__56237_56272 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56236_56271);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56237_56272);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56235_56270);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56234_56269);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56238_56273 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56239_56274 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56240_56275 = true;
var _STAR_print_fn_STAR__temp_val__56241_56276 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56240_56275);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56241_56276);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56239_56274);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56238_56273);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56232__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56242){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56243__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56243__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56245(s__56246){
...
var c__4580__auto__ = cljs.core.chunk_first(s__56246__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56248 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56247 = (0);
while(true){
if((i__56247 < size__4581__auto__)){
var vec__56249 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56247);
...
cljs.core.chunk_append(b__56248,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56277 = (i__56247 + (1));
i__56247 = G__56277;
continue;
} else {
var G__56278 = (i__56247 + (1));
i__56247 = G__56278;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56248),instaparse$print$Parser__GT_str_$_iter__56245(cljs.core.chunk_rest(s__56246__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56248),null);
}
} else {
var vec__56252 = cljs.core.first(s__56246__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56252,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56252,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56245(cljs.core.rest(s__56246__$2)));
} else {
var G__56279 = cljs.core.rest(s__56246__$2);
s__56246__$1 = G__56279;
continue;
}
}
} else {
