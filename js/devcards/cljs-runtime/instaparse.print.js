...
var _STAR_print_newline_STAR__orig_val__56209_56235 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56210_56236 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56211_56237 = true;
var _STAR_print_fn_STAR__temp_val__56212_56238 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56211_56237);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56212_56238);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56210_56236);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56209_56235);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56213_56239 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56214_56240 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56215_56241 = true;
var _STAR_print_fn_STAR__temp_val__56216_56242 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56215_56241);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56216_56242);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56214_56240);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56213_56239);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56218){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56219__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56219__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56221(s__56222){
...
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56225,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56225,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__56224,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56243 = (i__56223 + (1));
i__56223 = G__56243;
continue;
} else {
var G__56244 = (i__56223 + (1));
i__56223 = G__56244;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56224),instaparse$print$Parser__GT_str_$_iter__56221(cljs.core.chunk_rest(s__56222__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56224),null);
}
} else {
var vec__56228 = cljs.core.first(s__56222__$2);
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56221(cljs.core.rest(s__56222__$2)));
} else {
var G__56245 = cljs.core.rest(s__56222__$2);
s__56222__$1 = G__56245;
continue;
}
}
} else {
