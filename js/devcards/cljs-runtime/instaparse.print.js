...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__55949 = (function (){var G__55950 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__55950) : parser.call(null,G__55950));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__55949) : tag_set.call(null,G__55949));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__55952){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55953__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55953__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__55957,hidden_QMARK_){
var map__55958 = p__55957;
var map__55958__$1 = (((((!((map__55958 == null))))?(((((map__55958.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55958.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55958):map__55958);
var p = map__55958__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55958__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55958__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55958__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55958__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55958__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__55961_55992 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55962_55993 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55963_55994 = true;
var _STAR_print_fn_STAR__temp_val__55964_55995 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55963_55994);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55964_55995);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55962_55993);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55961_55992);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__55965_55996 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55966_55997 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55967_55998 = true;
var _STAR_print_fn_STAR__temp_val__55968_55999 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55967_55998);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55968_55999);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55966_55997);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55965_55996);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55960__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__55969){
var map__55970 = p__55969;
var map__55970__$1 = (((((!((map__55970 == null))))?(((((map__55970.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55970.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55970):map__55970);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55970__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55970__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__55972(s__55973){
...
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55976,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55976,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__55975,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56007 = (i__55974 + (1));
i__55974 = G__56007;
continue;
} else {
var G__56011 = (i__55974 + (1));
i__55974 = G__56011;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55975),instaparse$print$Parser__GT_str_$_iter__55972(cljs.core.chunk_rest(s__55973__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55975),null);
}
} else {
var vec__55979 = cljs.core.first(s__55973__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55979,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55979,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__55972(cljs.core.rest(s__55973__$2)));
} else {
var G__56012 = cljs.core.rest(s__55973__$2);
s__55973__$1 = G__56012;
continue;
}
}
} else {
