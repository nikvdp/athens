...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56220 = (function (){var G__56221 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56221) : parser.call(null,G__56221));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56220) : tag_set.call(null,G__56220));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__56223){
var map__56224 = p__56223;
var map__56224__$1 = (((((!((map__56224 == null))))?(((((map__56224.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56224.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56224):map__56224);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56224__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56224__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56228,hidden_QMARK_){
...
var p = map__56229__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56229__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56229__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56229__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56229__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56229__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__56232_56258 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56233_56259 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56234_56260 = true;
var _STAR_print_fn_STAR__temp_val__56235_56261 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56234_56260);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56235_56261);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56233_56259);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56232_56258);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56236_56262 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56237_56263 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56238_56264 = true;
var _STAR_print_fn_STAR__temp_val__56239_56265 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56238_56264);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56239_56265);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56237_56263);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56236_56262);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56231__$1)].join('')));
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56243(s__56244){
return (new cljs.core.LazySeq(null,(function (){
var s__56244__$1 = s__56244;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56244__$1);
if(temp__5735__auto__){
var s__56244__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56244__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56244__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56246 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56245 = (0);
while(true){
if((i__56245 < size__4581__auto__)){
var vec__56247 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56245);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56247,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56247,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__56246,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56267 = (i__56245 + (1));
i__56245 = G__56267;
continue;
} else {
var G__56268 = (i__56245 + (1));
i__56245 = G__56268;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56246),instaparse$print$Parser__GT_str_$_iter__56243(cljs.core.chunk_rest(s__56244__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56246),null);
}
} else {
var vec__56250 = cljs.core.first(s__56244__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56250,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56250,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56243(cljs.core.rest(s__56244__$2)));
} else {
var G__56269 = cljs.core.rest(s__56244__$2);
s__56244__$1 = G__56269;
continue;
}
}
} else {
