...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56205 = (function (){var G__56206 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56206) : parser.call(null,G__56206));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56205) : tag_set.call(null,G__56205));
})():false))){
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56214,hidden_QMARK_){
...
var p = map__56215__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56215__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56215__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56215__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56215__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56215__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__56217 = tag;
var G__56217__$1 = (((G__56217 instanceof cljs.core.Keyword))?G__56217.fqn:null);
switch (G__56217__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__56218_56254 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56219_56255 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56220_56256 = true;
var _STAR_print_fn_STAR__temp_val__56221_56257 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56220_56256);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56221_56257);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56219_56255);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56218_56254);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56222_56258 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56223_56259 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56224_56260 = true;
var _STAR_print_fn_STAR__temp_val__56225_56261 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56224_56260);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56225_56261);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56223_56259);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56222_56258);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56217__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56227){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56228__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56228__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56230(s__56231){
return (new cljs.core.LazySeq(null,(function (){
var s__56231__$1 = s__56231;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56231__$1);
if(temp__5735__auto__){
var s__56231__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56231__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56231__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56233 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56232 = (0);
while(true){
if((i__56232 < size__4581__auto__)){
var vec__56234 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56232);
...
cljs.core.chunk_append(b__56233,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56262 = (i__56232 + (1));
i__56232 = G__56262;
continue;
} else {
var G__56263 = (i__56232 + (1));
i__56232 = G__56263;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56233),instaparse$print$Parser__GT_str_$_iter__56230(cljs.core.chunk_rest(s__56231__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56233),null);
}
} else {
var vec__56237 = cljs.core.first(s__56231__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56237,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56237,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56230(cljs.core.rest(s__56231__$2)));
} else {
var G__56264 = cljs.core.rest(s__56231__$2);
s__56231__$1 = G__56264;
continue;
}
}
} else {
