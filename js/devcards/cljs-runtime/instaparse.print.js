...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56241 = (function (){var G__56242 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56242) : parser.call(null,G__56242));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56241) : tag_set.call(null,G__56241));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__56244){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56245__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56245__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56249,hidden_QMARK_){
...
var p = map__56250__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56250__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56250__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56250__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56250__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56250__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__56253_56280 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56254_56281 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56255_56282 = true;
var _STAR_print_fn_STAR__temp_val__56256_56283 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56255_56282);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56256_56283);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56254_56281);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56253_56280);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56257_56288 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56258_56289 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56259_56290 = true;
var _STAR_print_fn_STAR__temp_val__56260_56291 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56259_56290);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56260_56291);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56258_56289);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56257_56288);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56261){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56262__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56262__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56264(s__56265){
return (new cljs.core.LazySeq(null,(function (){
var s__56265__$1 = s__56265;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56265__$1);
if(temp__5735__auto__){
var s__56265__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56265__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56265__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56267 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56266 = (0);
while(true){
if((i__56266 < size__4581__auto__)){
var vec__56268 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56266);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56268,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56268,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__56267,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56302 = (i__56266 + (1));
i__56266 = G__56302;
continue;
} else {
var G__56303 = (i__56266 + (1));
i__56266 = G__56303;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56267),instaparse$print$Parser__GT_str_$_iter__56264(cljs.core.chunk_rest(s__56265__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56267),null);
}
} else {
var vec__56271 = cljs.core.first(s__56265__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56271,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56271,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56264(cljs.core.rest(s__56265__$2)));
} else {
var G__56308 = cljs.core.rest(s__56265__$2);
s__56265__$1 = G__56308;
continue;
}
}
} else {
