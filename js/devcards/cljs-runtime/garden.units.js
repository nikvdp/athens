 ...
 */
garden.units.convert = (function garden$units$convert(p__40353,right){
var map__40354 = p__40353;
var map__40354__$1 = (((((!((map__40354 == null))))?(((((map__40354.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40354.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40354):map__40354);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40354__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40354__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__40356 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40356,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40356,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40356,(2),null);
...
var G__40386__delegate = function (x,y,more){
...
var G__40386 = function (x,y,var_args){
var more = null;
...
while (G__40387__i < G__40387__a.length) {G__40387__a[G__40387__i] = arguments[G__40387__i + 2]; ++G__40387__i;}
  more = new cljs.core.IndexedSeq(G__40387__a,0,null);
} 
return G__40386__delegate.call(this,x,y,more);};
G__40386.cljs$lang$maxFixedArity = 2;
...
var more = cljs.core.rest(arglist__40388);
return G__40386__delegate(x,y,more);
});
...
G__40389 = new cljs.core.IndexedSeq(G__40390__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40389);
}
...
var G__40394__delegate = function (x,y,more){
...
var G__40394 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__40396__i = 0, G__40396__a = new Array(arguments.length -  2);
while (G__40396__i < G__40396__a.length) {G__40396__a[G__40396__i] = arguments[G__40396__i + 2]; ++G__40396__i;}
  more = new cljs.core.IndexedSeq(G__40396__a,0,null);
} 
return G__40394__delegate.call(this,x,y,more);};
G__40394.cljs$lang$maxFixedArity = 2;
G__40394.cljs$lang$applyTo = (function (arglist__40397){
var x = cljs.core.first(arglist__40397);
arglist__40397 = cljs.core.next(arglist__40397);
var y = cljs.core.first(arglist__40397);
var more = cljs.core.rest(arglist__40397);
return G__40394__delegate(x,y,more);
});
...
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40398);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__40370 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40370__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40371 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40371__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var x = cljs.core.first(arglist__40407);
arglist__40407 = cljs.core.next(arglist__40407);
var y = cljs.core.first(arglist__40407);
var more = cljs.core.rest(arglist__40407);
...
var G__40408 = null;
if (arguments.length > 2) {
var G__40409__i = 0, G__40409__a = new Array(arguments.length -  2);
while (G__40409__i < G__40409__a.length) {G__40409__a[G__40409__i] = arguments[G__40409__i + 2]; ++G__40409__i;}
G__40408 = new cljs.core.IndexedSeq(G__40409__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40408);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40417);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
