...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__38716,style_created_handler){
...
var style = map__38717__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38717__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38717__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38720_38796 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38720_38796) : style_created_handler.call(null,G__38720_38796));

var seq__38722 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__38723 = null;
var count__38724 = (0);
var i__38725 = (0);
while(true){
if((i__38725 < count__38724)){
var sub_style = chunk__38723.cljs$core$IIndexed$_nth$arity$2(null,i__38725);
var G__38734_38797 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38735_38798 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38734_38797,G__38735_38798) : stylefy.impl.styles.create_style_BANG_.call(null,G__38734_38797,G__38735_38798));


var G__38799 = seq__38722;
var G__38800 = chunk__38723;
var G__38801 = count__38724;
var G__38802 = (i__38725 + (1));
seq__38722 = G__38799;
chunk__38723 = G__38800;
count__38724 = G__38801;
i__38725 = G__38802;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38722);
if(temp__5735__auto__){
var seq__38722__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38722__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38722__$1);
var G__38803 = cljs.core.chunk_rest(seq__38722__$1);
var G__38804 = c__4609__auto__;
var G__38805 = cljs.core.count(c__4609__auto__);
var G__38806 = (0);
seq__38722 = G__38803;
chunk__38723 = G__38804;
count__38724 = G__38805;
i__38725 = G__38806;
continue;
} else {
var sub_style = cljs.core.first(seq__38722__$1);
var G__38737_38807 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38738_38808 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38737_38807,G__38738_38808) : stylefy.impl.styles.create_style_BANG_.call(null,G__38737_38807,G__38738_38808));


var G__38809 = cljs.core.next(seq__38722__$1);
var G__38810 = null;
var G__38811 = (0);
var G__38812 = (0);
seq__38722 = G__38809;
chunk__38723 = G__38810;
count__38724 = G__38811;
i__38725 = G__38812;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38743_SHARP_){
return ((typeof p1__38743_SHARP_ === 'string') || ((p1__38743_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38743_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38743#] (or (string? p1__38743#) (keyword? p1__38743#) (nil? p1__38743#))) class)))"].join('')));
}
});
/**
...
var G__38827 = (i__4790__auto___38824 + (1));
i__4790__auto___38824 = G__38827;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__38774_SHARP_,p2__38775_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38774_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__38775_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq38776){
var G__38777 = cljs.core.first(seq38776);
var seq38776__$1 = cljs.core.next(seq38776);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38777,seq38776__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__38783){
var map__38784 = p__38783;
var map__38784__$1 = (((((!((map__38784 == null))))?(((((map__38784.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38784.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38784):map__38784);
var options = map__38784__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38784__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_38834__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__38786_38835 = cljs.core.seq(styles_38834__$1);
var chunk__38787_38836 = null;
var count__38788_38837 = (0);
var i__38789_38838 = (0);
while(true){
if((i__38789_38838 < count__38788_38837)){
var style_38839 = chunk__38787_38836.cljs$core$IIndexed$_nth$arity$2(null,i__38789_38838);
stylefy.impl.styles.use_style_BANG_(style_38839,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38840 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38839));
if(cljs.core.truth_(temp__5735__auto___38840)){
var sub_styles_38841 = temp__5735__auto___38840;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38841,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38842 = seq__38786_38835;
var G__38843 = chunk__38787_38836;
var G__38844 = count__38788_38837;
var G__38845 = (i__38789_38838 + (1));
seq__38786_38835 = G__38842;
chunk__38787_38836 = G__38843;
count__38788_38837 = G__38844;
i__38789_38838 = G__38845;
continue;
} else {
var temp__5735__auto___38848 = cljs.core.seq(seq__38786_38835);
if(temp__5735__auto___38848){
var seq__38786_38849__$1 = temp__5735__auto___38848;
if(cljs.core.chunked_seq_QMARK_(seq__38786_38849__$1)){
var c__4609__auto___38850 = cljs.core.chunk_first(seq__38786_38849__$1);
var G__38851 = cljs.core.chunk_rest(seq__38786_38849__$1);
var G__38852 = c__4609__auto___38850;
var G__38853 = cljs.core.count(c__4609__auto___38850);
var G__38854 = (0);
seq__38786_38835 = G__38851;
chunk__38787_38836 = G__38852;
count__38788_38837 = G__38853;
i__38789_38838 = G__38854;
continue;
} else {
var style_38856 = cljs.core.first(seq__38786_38849__$1);
stylefy.impl.styles.use_style_BANG_(style_38856,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38857__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38856));
if(cljs.core.truth_(temp__5735__auto___38857__$1)){
var sub_styles_38859 = temp__5735__auto___38857__$1;
...
var G__38861 = cljs.core.next(seq__38786_38849__$1);
var G__38862 = null;
var G__38863 = (0);
var G__38864 = (0);
seq__38786_38835 = G__38861;
chunk__38787_38836 = G__38862;
count__38788_38837 = G__38863;
i__38789_38838 = G__38864;
continue;
}
} else {
}
