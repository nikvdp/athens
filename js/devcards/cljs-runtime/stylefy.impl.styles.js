...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44298,style_created_handler){
...
var style = map__44300__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44300__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44300__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44303_44391 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44303_44391) : style_created_handler.call(null,G__44303_44391));

var seq__44305 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44306 = null;
var count__44307 = (0);
var i__44308 = (0);
while(true){
if((i__44308 < count__44307)){
var sub_style = chunk__44306.cljs$core$IIndexed$_nth$arity$2(null,i__44308);
var G__44318_44393 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44319_44394 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44318_44393,G__44319_44394) : stylefy.impl.styles.create_style_BANG_.call(null,G__44318_44393,G__44319_44394));


var G__44396 = seq__44305;
var G__44397 = chunk__44306;
var G__44398 = count__44307;
var G__44399 = (i__44308 + (1));
seq__44305 = G__44396;
chunk__44306 = G__44397;
count__44307 = G__44398;
i__44308 = G__44399;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44305);
if(temp__5735__auto__){
var seq__44305__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44305__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44305__$1);
var G__44402 = cljs.core.chunk_rest(seq__44305__$1);
var G__44403 = c__4556__auto__;
var G__44404 = cljs.core.count(c__4556__auto__);
var G__44405 = (0);
seq__44305 = G__44402;
chunk__44306 = G__44403;
count__44307 = G__44404;
i__44308 = G__44405;
continue;
} else {
var sub_style = cljs.core.first(seq__44305__$1);
var G__44324_44408 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44325_44409 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44324_44408,G__44325_44409) : stylefy.impl.styles.create_style_BANG_.call(null,G__44324_44408,G__44325_44409));


var G__44411 = cljs.core.next(seq__44305__$1);
var G__44412 = null;
var G__44413 = (0);
var G__44414 = (0);
seq__44305 = G__44411;
chunk__44306 = G__44412;
count__44307 = G__44413;
i__44308 = G__44414;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44331_SHARP_){
return ((typeof p1__44331_SHARP_ === 'string') || ((p1__44331_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44331_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44331#] (or (string? p1__44331#) (keyword? p1__44331#) (nil? p1__44331#))) class)))"].join('')));
}
});
/**
...
var i__4737__auto___44432 = (0);
while(true){
if((i__4737__auto___44432 < len__4736__auto___44431)){
args__4742__auto__.push((arguments[i__4737__auto___44432]));

var G__44433 = (i__4737__auto___44432 + (1));
i__4737__auto___44432 = G__44433;
continue;
} else {
}
break;
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__44363){
var map__44364 = p__44363;
var map__44364__$1 = (((((!((map__44364 == null))))?(((((map__44364.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44364.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44364):map__44364);
var options = map__44364__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44364__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_44437__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44370_44438 = cljs.core.seq(styles_44437__$1);
var chunk__44371_44439 = null;
var count__44372_44440 = (0);
var i__44373_44441 = (0);
while(true){
if((i__44373_44441 < count__44372_44440)){
var style_44442 = chunk__44371_44439.cljs$core$IIndexed$_nth$arity$2(null,i__44373_44441);
stylefy.impl.styles.use_style_BANG_(style_44442,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44443 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44442));
if(cljs.core.truth_(temp__5735__auto___44443)){
var sub_styles_44444 = temp__5735__auto___44443;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44444,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44445 = seq__44370_44438;
var G__44446 = chunk__44371_44439;
var G__44447 = count__44372_44440;
var G__44448 = (i__44373_44441 + (1));
seq__44370_44438 = G__44445;
chunk__44371_44439 = G__44446;
count__44372_44440 = G__44447;
i__44373_44441 = G__44448;
continue;
} else {
var temp__5735__auto___44451 = cljs.core.seq(seq__44370_44438);
if(temp__5735__auto___44451){
var seq__44370_44452__$1 = temp__5735__auto___44451;
if(cljs.core.chunked_seq_QMARK_(seq__44370_44452__$1)){
var c__4556__auto___44453 = cljs.core.chunk_first(seq__44370_44452__$1);
var G__44454 = cljs.core.chunk_rest(seq__44370_44452__$1);
var G__44455 = c__4556__auto___44453;
var G__44456 = cljs.core.count(c__4556__auto___44453);
var G__44457 = (0);
seq__44370_44438 = G__44454;
chunk__44371_44439 = G__44455;
count__44372_44440 = G__44456;
i__44373_44441 = G__44457;
continue;
} else {
var style_44458 = cljs.core.first(seq__44370_44452__$1);
stylefy.impl.styles.use_style_BANG_(style_44458,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44459__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44458));
if(cljs.core.truth_(temp__5735__auto___44459__$1)){
var sub_styles_44460 = temp__5735__auto___44459__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44460,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44461 = cljs.core.next(seq__44370_44452__$1);
var G__44462 = null;
var G__44463 = (0);
var G__44464 = (0);
seq__44370_44438 = G__44461;
chunk__44371_44439 = G__44462;
count__44372_44440 = G__44463;
i__44373_44441 = G__44464;
continue;
}
} else {
}
