...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__38977,style_created_handler){
...
var style = map__38978__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38978__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38978__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38981_39061 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38981_39061) : style_created_handler.call(null,G__38981_39061));

var seq__38983 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__38984 = null;
var count__38985 = (0);
var i__38986 = (0);
while(true){
if((i__38986 < count__38985)){
var sub_style = chunk__38984.cljs$core$IIndexed$_nth$arity$2(null,i__38986);
var G__38994_39062 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38995_39063 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38994_39062,G__38995_39063) : stylefy.impl.styles.create_style_BANG_.call(null,G__38994_39062,G__38995_39063));


var G__39064 = seq__38983;
var G__39065 = chunk__38984;
var G__39066 = count__38985;
var G__39067 = (i__38986 + (1));
seq__38983 = G__39064;
chunk__38984 = G__39065;
count__38985 = G__39066;
i__38986 = G__39067;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38983);
if(temp__5735__auto__){
var seq__38983__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38983__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38983__$1);
var G__39068 = cljs.core.chunk_rest(seq__38983__$1);
var G__39069 = c__4609__auto__;
var G__39070 = cljs.core.count(c__4609__auto__);
var G__39071 = (0);
seq__38983 = G__39068;
chunk__38984 = G__39069;
count__38985 = G__39070;
i__38986 = G__39071;
continue;
} else {
var sub_style = cljs.core.first(seq__38983__$1);
var G__38998_39074 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38999_39075 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38998_39074,G__38999_39075) : stylefy.impl.styles.create_style_BANG_.call(null,G__38998_39074,G__38999_39075));


var G__39077 = cljs.core.next(seq__38983__$1);
var G__39078 = null;
var G__39079 = (0);
var G__39080 = (0);
seq__38983 = G__39077;
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__39003_SHARP_){
return ((typeof p1__39003_SHARP_ === 'string') || ((p1__39003_SHARP_ instanceof cljs.core.Keyword)) || ((p1__39003_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__39003#] (or (string? p1__39003#) (keyword? p1__39003#) (nil? p1__39003#))) class)))"].join('')));
}
});
/**
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39031_SHARP_,p2__39032_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__39031_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__39032_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq39034){
var G__39035 = cljs.core.first(seq39034);
var seq39034__$1 = cljs.core.next(seq39034);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39035,seq39034__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__39049){
var map__39050 = p__39049;
var map__39050__$1 = (((((!((map__39050 == null))))?(((((map__39050.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39050.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__39050):map__39050);
var options = map__39050__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39050__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_39091__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__39054_39092 = cljs.core.seq(styles_39091__$1);
var chunk__39055_39093 = null;
var count__39056_39094 = (0);
var i__39057_39095 = (0);
while(true){
if((i__39057_39095 < count__39056_39094)){
var style_39097 = chunk__39055_39093.cljs$core$IIndexed$_nth$arity$2(null,i__39057_39095);
stylefy.impl.styles.use_style_BANG_(style_39097,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39098 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39097));
if(cljs.core.truth_(temp__5735__auto___39098)){
var sub_styles_39099 = temp__5735__auto___39098;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_39099,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__39102 = seq__39054_39092;
var G__39103 = chunk__39055_39093;
var G__39104 = count__39056_39094;
var G__39105 = (i__39057_39095 + (1));
seq__39054_39092 = G__39102;
chunk__39055_39093 = G__39103;
count__39056_39094 = G__39104;
i__39057_39095 = G__39105;
continue;
} else {
var temp__5735__auto___39106 = cljs.core.seq(seq__39054_39092);
if(temp__5735__auto___39106){
var seq__39054_39107__$1 = temp__5735__auto___39106;
if(cljs.core.chunked_seq_QMARK_(seq__39054_39107__$1)){
var c__4609__auto___39108 = cljs.core.chunk_first(seq__39054_39107__$1);
var G__39109 = cljs.core.chunk_rest(seq__39054_39107__$1);
var G__39110 = c__4609__auto___39108;
var G__39111 = cljs.core.count(c__4609__auto___39108);
var G__39112 = (0);
seq__39054_39092 = G__39109;
chunk__39055_39093 = G__39110;
count__39056_39094 = G__39111;
i__39057_39095 = G__39112;
continue;
} else {
var style_39114 = cljs.core.first(seq__39054_39107__$1);
stylefy.impl.styles.use_style_BANG_(style_39114,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39116__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39114));
if(cljs.core.truth_(temp__5735__auto___39116__$1)){
var sub_styles_39117 = temp__5735__auto___39116__$1;
...
var G__39120 = cljs.core.next(seq__39054_39107__$1);
var G__39121 = null;
var G__39122 = (0);
var G__39123 = (0);
seq__39054_39092 = G__39120;
chunk__39055_39093 = G__39121;
count__39056_39094 = G__39122;
i__39057_39095 = G__39123;
continue;
}
} else {
}
