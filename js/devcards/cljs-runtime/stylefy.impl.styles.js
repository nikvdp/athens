...
var G__38742_38818 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38742_38818) : style_created_handler.call(null,G__38742_38818));
...
var G__38754_38821 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38755_38822 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38754_38821,G__38755_38822) : stylefy.impl.styles.create_style_BANG_.call(null,G__38754_38821,G__38755_38822));


var G__38826 = seq__38743;
var G__38827 = chunk__38744;
var G__38828 = count__38745;
var G__38829 = (i__38746 + (1));
seq__38743 = G__38826;
chunk__38744 = G__38827;
count__38745 = G__38828;
i__38746 = G__38829;
continue;
} else {
...
var G__38831 = cljs.core.chunk_rest(seq__38743__$1);
var G__38832 = c__4609__auto__;
var G__38833 = cljs.core.count(c__4609__auto__);
var G__38834 = (0);
seq__38743 = G__38831;
chunk__38744 = G__38832;
count__38745 = G__38833;
i__38746 = G__38834;
continue;
} else {
var sub_style = cljs.core.first(seq__38743__$1);
var G__38757_38835 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38758_38836 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38757_38835,G__38758_38836) : stylefy.impl.styles.create_style_BANG_.call(null,G__38757_38835,G__38758_38836));


var G__38838 = cljs.core.next(seq__38743__$1);
var G__38839 = null;
var G__38840 = (0);
var G__38841 = (0);
seq__38743 = G__38838;
chunk__38744 = G__38839;
count__38745 = G__38840;
i__38746 = G__38841;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38764_SHARP_){
return ((typeof p1__38764_SHARP_ === 'string') || ((p1__38764_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38764_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38764#] (or (string? p1__38764#) (keyword? p1__38764#) (nil? p1__38764#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___38866 = arguments.length;
var i__4790__auto___38867 = (0);
while(true){
if((i__4790__auto___38867 < len__4789__auto___38866)){
args__4795__auto__.push((arguments[i__4790__auto___38867]));

var G__38869 = (i__4790__auto___38867 + (1));
i__4790__auto___38867 = G__38869;
continue;
} else {
}
break;
...
var styles_38876__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__38808_38877 = cljs.core.seq(styles_38876__$1);
var chunk__38809_38878 = null;
var count__38810_38879 = (0);
var i__38811_38880 = (0);
while(true){
if((i__38811_38880 < count__38810_38879)){
var style_38881 = chunk__38809_38878.cljs$core$IIndexed$_nth$arity$2(null,i__38811_38880);
stylefy.impl.styles.use_style_BANG_(style_38881,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38882 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38881));
if(cljs.core.truth_(temp__5735__auto___38882)){
var sub_styles_38883 = temp__5735__auto___38882;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38883,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38885 = seq__38808_38877;
var G__38886 = chunk__38809_38878;
var G__38887 = count__38810_38879;
var G__38888 = (i__38811_38880 + (1));
seq__38808_38877 = G__38885;
chunk__38809_38878 = G__38886;
count__38810_38879 = G__38887;
i__38811_38880 = G__38888;
continue;
} else {
var temp__5735__auto___38890 = cljs.core.seq(seq__38808_38877);
if(temp__5735__auto___38890){
var seq__38808_38891__$1 = temp__5735__auto___38890;
if(cljs.core.chunked_seq_QMARK_(seq__38808_38891__$1)){
var c__4609__auto___38893 = cljs.core.chunk_first(seq__38808_38891__$1);
var G__38894 = cljs.core.chunk_rest(seq__38808_38891__$1);
var G__38895 = c__4609__auto___38893;
var G__38896 = cljs.core.count(c__4609__auto___38893);
var G__38897 = (0);
seq__38808_38877 = G__38894;
chunk__38809_38878 = G__38895;
count__38810_38879 = G__38896;
i__38811_38880 = G__38897;
continue;
} else {
var style_38899 = cljs.core.first(seq__38808_38891__$1);
stylefy.impl.styles.use_style_BANG_(style_38899,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38900__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38899));
if(cljs.core.truth_(temp__5735__auto___38900__$1)){
var sub_styles_38901 = temp__5735__auto___38900__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38901,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38902 = cljs.core.next(seq__38808_38891__$1);
var G__38903 = null;
var G__38904 = (0);
var G__38905 = (0);
seq__38808_38877 = G__38902;
chunk__38809_38878 = G__38903;
count__38810_38879 = G__38904;
i__38811_38880 = G__38905;
continue;
}
} else {
}
