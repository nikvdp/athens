...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__38954,style_created_handler){
...
var style = map__38955__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38955__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38955__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38957_39019 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38957_39019) : style_created_handler.call(null,G__38957_39019));

var seq__38959 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__38960 = null;
var count__38961 = (0);
var i__38962 = (0);
while(true){
if((i__38962 < count__38961)){
var sub_style = chunk__38960.cljs$core$IIndexed$_nth$arity$2(null,i__38962);
var G__38969_39022 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38970_39023 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38969_39022,G__38970_39023) : stylefy.impl.styles.create_style_BANG_.call(null,G__38969_39022,G__38970_39023));


var G__39025 = seq__38959;
var G__39026 = chunk__38960;
var G__39027 = count__38961;
var G__39028 = (i__38962 + (1));
seq__38959 = G__39025;
chunk__38960 = G__39026;
count__38961 = G__39027;
i__38962 = G__39028;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38959);
if(temp__5735__auto__){
var seq__38959__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38959__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38959__$1);
var G__39030 = cljs.core.chunk_rest(seq__38959__$1);
var G__39031 = c__4609__auto__;
var G__39032 = cljs.core.count(c__4609__auto__);
var G__39033 = (0);
seq__38959 = G__39030;
chunk__38960 = G__39031;
count__38961 = G__39032;
i__38962 = G__39033;
continue;
} else {
var sub_style = cljs.core.first(seq__38959__$1);
var G__38972_39034 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38973_39035 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38972_39034,G__38973_39035) : stylefy.impl.styles.create_style_BANG_.call(null,G__38972_39034,G__38973_39035));


var G__39037 = cljs.core.next(seq__38959__$1);
var G__39038 = null;
var G__39039 = (0);
var G__39040 = (0);
seq__38959 = G__39037;
chunk__38960 = G__39038;
count__38961 = G__39039;
i__38962 = G__39040;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38978_SHARP_){
return ((typeof p1__38978_SHARP_ === 'string') || ((p1__38978_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38978_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38978#] (or (string? p1__38978#) (keyword? p1__38978#) (nil? p1__38978#))) class)))"].join('')));
}
});
/**
...
var G__39057 = (i__4790__auto___39055 + (1));
i__4790__auto___39055 = G__39057;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__38990_SHARP_,p2__38991_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38990_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__38991_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq38992){
var G__38993 = cljs.core.first(seq38992);
var seq38992__$1 = cljs.core.next(seq38992);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38993,seq38992__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__39000){
var map__39002 = p__39000;
...
var options = map__39002__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39002__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_39064__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__39006_39065 = cljs.core.seq(styles_39064__$1);
var chunk__39007_39066 = null;
var count__39008_39067 = (0);
var i__39009_39068 = (0);
while(true){
if((i__39009_39068 < count__39008_39067)){
var style_39070 = chunk__39007_39066.cljs$core$IIndexed$_nth$arity$2(null,i__39009_39068);
stylefy.impl.styles.use_style_BANG_(style_39070,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39071 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39070));
if(cljs.core.truth_(temp__5735__auto___39071)){
var sub_styles_39073 = temp__5735__auto___39071;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_39073,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__39074 = seq__39006_39065;
var G__39075 = chunk__39007_39066;
var G__39076 = count__39008_39067;
var G__39077 = (i__39009_39068 + (1));
seq__39006_39065 = G__39074;
chunk__39007_39066 = G__39075;
count__39008_39067 = G__39076;
i__39009_39068 = G__39077;
continue;
} else {
var temp__5735__auto___39079 = cljs.core.seq(seq__39006_39065);
if(temp__5735__auto___39079){
var seq__39006_39081__$1 = temp__5735__auto___39079;
if(cljs.core.chunked_seq_QMARK_(seq__39006_39081__$1)){
var c__4609__auto___39082 = cljs.core.chunk_first(seq__39006_39081__$1);
var G__39083 = cljs.core.chunk_rest(seq__39006_39081__$1);
var G__39084 = c__4609__auto___39082;
var G__39085 = cljs.core.count(c__4609__auto___39082);
var G__39086 = (0);
seq__39006_39065 = G__39083;
chunk__39007_39066 = G__39084;
count__39008_39067 = G__39085;
i__39009_39068 = G__39086;
continue;
} else {
var style_39089 = cljs.core.first(seq__39006_39081__$1);
stylefy.impl.styles.use_style_BANG_(style_39089,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39090__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39089));
if(cljs.core.truth_(temp__5735__auto___39090__$1)){
var sub_styles_39092 = temp__5735__auto___39090__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_39092,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__39093 = cljs.core.next(seq__39006_39081__$1);
var G__39094 = null;
var G__39096 = (0);
var G__39097 = (0);
seq__39006_39065 = G__39093;
chunk__39007_39066 = G__39094;
count__39008_39067 = G__39096;
i__39009_39068 = G__39097;
continue;
}
} else {
}
