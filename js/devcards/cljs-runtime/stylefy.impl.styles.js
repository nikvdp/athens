...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44280,style_created_handler){
var map__44283 = p__44280;
var map__44283__$1 = (((((!((map__44283 == null))))?(((((map__44283.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44283.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44283):map__44283);
var style = map__44283__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44283__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44283__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44287_44368 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44287_44368) : style_created_handler.call(null,G__44287_44368));

var seq__44288 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44289 = null;
var count__44290 = (0);
var i__44291 = (0);
while(true){
if((i__44291 < count__44290)){
var sub_style = chunk__44289.cljs$core$IIndexed$_nth$arity$2(null,i__44291);
var G__44298_44371 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44299_44372 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44298_44371,G__44299_44372) : stylefy.impl.styles.create_style_BANG_.call(null,G__44298_44371,G__44299_44372));


var G__44373 = seq__44288;
var G__44374 = chunk__44289;
var G__44375 = count__44290;
var G__44376 = (i__44291 + (1));
seq__44288 = G__44373;
chunk__44289 = G__44374;
count__44290 = G__44375;
i__44291 = G__44376;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44288);
if(temp__5735__auto__){
var seq__44288__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44288__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44288__$1);
var G__44379 = cljs.core.chunk_rest(seq__44288__$1);
var G__44380 = c__4556__auto__;
var G__44381 = cljs.core.count(c__4556__auto__);
var G__44382 = (0);
seq__44288 = G__44379;
chunk__44289 = G__44380;
count__44290 = G__44381;
i__44291 = G__44382;
continue;
} else {
var sub_style = cljs.core.first(seq__44288__$1);
var G__44303_44384 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44304_44385 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44303_44384,G__44304_44385) : stylefy.impl.styles.create_style_BANG_.call(null,G__44303_44384,G__44304_44385));


var G__44387 = cljs.core.next(seq__44288__$1);
var G__44388 = null;
var G__44389 = (0);
var G__44390 = (0);
seq__44288 = G__44387;
chunk__44289 = G__44388;
count__44290 = G__44389;
i__44291 = G__44390;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44306_SHARP_){
return ((typeof p1__44306_SHARP_ === 'string') || ((p1__44306_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44306_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44306#] (or (string? p1__44306#) (keyword? p1__44306#) (nil? p1__44306#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___44408 = arguments.length;
var i__4737__auto___44409 = (0);
while(true){
if((i__4737__auto___44409 < len__4736__auto___44408)){
args__4742__auto__.push((arguments[i__4737__auto___44409]));

var G__44410 = (i__4737__auto___44409 + (1));
i__4737__auto___44409 = G__44410;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44343_SHARP_,p2__44344_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__44343_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__44344_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq44346){
var G__44347 = cljs.core.first(seq44346);
var seq44346__$1 = cljs.core.next(seq44346);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44347,seq44346__$1);
}));
...
var styles_44421__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44360_44422 = cljs.core.seq(styles_44421__$1);
var chunk__44361_44423 = null;
var count__44362_44424 = (0);
var i__44363_44425 = (0);
while(true){
if((i__44363_44425 < count__44362_44424)){
var style_44427 = chunk__44361_44423.cljs$core$IIndexed$_nth$arity$2(null,i__44363_44425);
stylefy.impl.styles.use_style_BANG_(style_44427,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44428 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44427));
if(cljs.core.truth_(temp__5735__auto___44428)){
var sub_styles_44430 = temp__5735__auto___44428;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44430,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44432 = seq__44360_44422;
var G__44433 = chunk__44361_44423;
var G__44434 = count__44362_44424;
var G__44435 = (i__44363_44425 + (1));
seq__44360_44422 = G__44432;
chunk__44361_44423 = G__44433;
count__44362_44424 = G__44434;
i__44363_44425 = G__44435;
continue;
} else {
var temp__5735__auto___44436 = cljs.core.seq(seq__44360_44422);
if(temp__5735__auto___44436){
var seq__44360_44438__$1 = temp__5735__auto___44436;
if(cljs.core.chunked_seq_QMARK_(seq__44360_44438__$1)){
var c__4556__auto___44439 = cljs.core.chunk_first(seq__44360_44438__$1);
var G__44440 = cljs.core.chunk_rest(seq__44360_44438__$1);
var G__44441 = c__4556__auto___44439;
var G__44442 = cljs.core.count(c__4556__auto___44439);
var G__44443 = (0);
seq__44360_44422 = G__44440;
chunk__44361_44423 = G__44441;
count__44362_44424 = G__44442;
i__44363_44425 = G__44443;
continue;
} else {
var style_44445 = cljs.core.first(seq__44360_44438__$1);
stylefy.impl.styles.use_style_BANG_(style_44445,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44446__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44445));
if(cljs.core.truth_(temp__5735__auto___44446__$1)){
var sub_styles_44448 = temp__5735__auto___44446__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44448,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44449 = cljs.core.next(seq__44360_44438__$1);
var G__44450 = null;
var G__44451 = (0);
var G__44452 = (0);
seq__44360_44422 = G__44449;
chunk__44361_44423 = G__44450;
count__44362_44424 = G__44451;
i__44363_44425 = G__44452;
continue;
}
} else {
}
