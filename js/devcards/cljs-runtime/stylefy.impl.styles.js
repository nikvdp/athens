...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__45178,style_created_handler){
...
var style = map__45179__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45179__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45179__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__45182_45259 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__45182_45259) : style_created_handler.call(null,G__45182_45259));

var seq__45183 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__45184 = null;
var count__45185 = (0);
var i__45186 = (0);
while(true){
if((i__45186 < count__45185)){
var sub_style = chunk__45184.cljs$core$IIndexed$_nth$arity$2(null,i__45186);
var G__45195_45260 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__45196_45261 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__45195_45260,G__45196_45261) : stylefy.impl.styles.create_style_BANG_.call(null,G__45195_45260,G__45196_45261));


var G__45262 = seq__45183;
var G__45263 = chunk__45184;
var G__45264 = count__45185;
var G__45265 = (i__45186 + (1));
seq__45183 = G__45262;
chunk__45184 = G__45263;
count__45185 = G__45264;
i__45186 = G__45265;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__45183);
if(temp__5735__auto__){
var seq__45183__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__45183__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__45183__$1);
var G__45266 = cljs.core.chunk_rest(seq__45183__$1);
var G__45267 = c__4609__auto__;
var G__45268 = cljs.core.count(c__4609__auto__);
var G__45269 = (0);
seq__45183 = G__45266;
chunk__45184 = G__45267;
count__45185 = G__45268;
i__45186 = G__45269;
continue;
} else {
var sub_style = cljs.core.first(seq__45183__$1);
var G__45199_45270 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__45200_45271 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__45199_45270,G__45200_45271) : stylefy.impl.styles.create_style_BANG_.call(null,G__45199_45270,G__45200_45271));


var G__45272 = cljs.core.next(seq__45183__$1);
var G__45273 = null;
var G__45274 = (0);
var G__45275 = (0);
seq__45183 = G__45272;
chunk__45184 = G__45273;
count__45185 = G__45274;
i__45186 = G__45275;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__45202_SHARP_){
return ((typeof p1__45202_SHARP_ === 'string') || ((p1__45202_SHARP_ instanceof cljs.core.Keyword)) || ((p1__45202_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__45202#] (or (string? p1__45202#) (keyword? p1__45202#) (nil? p1__45202#))) class)))"].join('')));
}
});
/**
...
var G__45291 = (i__4790__auto___45289 + (1));
i__4790__auto___45289 = G__45291;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__45239_SHARP_,p2__45240_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__45239_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__45240_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
var styles_45299__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__45249_45300 = cljs.core.seq(styles_45299__$1);
var chunk__45250_45301 = null;
var count__45251_45302 = (0);
var i__45252_45303 = (0);
while(true){
if((i__45252_45303 < count__45251_45302)){
var style_45305 = chunk__45250_45301.cljs$core$IIndexed$_nth$arity$2(null,i__45252_45303);
stylefy.impl.styles.use_style_BANG_(style_45305,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___45306 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_45305));
if(cljs.core.truth_(temp__5735__auto___45306)){
var sub_styles_45308 = temp__5735__auto___45306;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_45308,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__45310 = seq__45249_45300;
var G__45311 = chunk__45250_45301;
var G__45312 = count__45251_45302;
var G__45313 = (i__45252_45303 + (1));
seq__45249_45300 = G__45310;
chunk__45250_45301 = G__45311;
count__45251_45302 = G__45312;
i__45252_45303 = G__45313;
continue;
} else {
var temp__5735__auto___45314 = cljs.core.seq(seq__45249_45300);
if(temp__5735__auto___45314){
var seq__45249_45315__$1 = temp__5735__auto___45314;
if(cljs.core.chunked_seq_QMARK_(seq__45249_45315__$1)){
var c__4609__auto___45316 = cljs.core.chunk_first(seq__45249_45315__$1);
var G__45318 = cljs.core.chunk_rest(seq__45249_45315__$1);
var G__45319 = c__4609__auto___45316;
var G__45320 = cljs.core.count(c__4609__auto___45316);
var G__45321 = (0);
seq__45249_45300 = G__45318;
chunk__45250_45301 = G__45319;
count__45251_45302 = G__45320;
i__45252_45303 = G__45321;
continue;
} else {
var style_45322 = cljs.core.first(seq__45249_45315__$1);
stylefy.impl.styles.use_style_BANG_(style_45322,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___45324__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_45322));
if(cljs.core.truth_(temp__5735__auto___45324__$1)){
var sub_styles_45325 = temp__5735__auto___45324__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_45325,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__45327 = cljs.core.next(seq__45249_45315__$1);
var G__45328 = null;
var G__45329 = (0);
var G__45330 = (0);
seq__45249_45300 = G__45327;
chunk__45250_45301 = G__45328;
count__45251_45302 = G__45329;
i__45252_45303 = G__45330;
continue;
}
} else {
}
