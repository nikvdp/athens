...
if(cljs.core.truth_((function (){var fexpr__57945 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57945.cljs$core$IFn$_invoke$arity$1 ? fexpr__57945.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57945.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57956 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57956.cljs$core$IFn$_invoke$arity$1 ? fexpr__57956.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57956.call(null,type));
})())){
} else {
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57972){
var map__57974 = p__57972;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57979 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57979) : instaparse.reduction.node_builders.call(null,G__57979));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57965){
var G__57966 = cljs.core.first(seq57965);
var seq57965__$1 = cljs.core.next(seq57965);
var G__57967 = cljs.core.first(seq57965__$1);
var seq57965__$2 = cljs.core.next(seq57965__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57966,G__57967,seq57965__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57991){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57994 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57994) : instaparse.reduction.node_builders.call(null,G__57994));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57984){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57985,G__57986,seq57984__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57996,else__4442__auto__){
var self__ = this;
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57997,other57998){
var self__ = this;
var this57997__$1 = this;
return (((!((other57998 == null)))) && ((this57997__$1.constructor === other57998.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57997__$1.grammar,other57998.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57997__$1.start_production,other57998.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57997__$1.output_format,other57998.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57997__$1.__extmap,other57998.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57995){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58007 = cljs.core.keyword_identical_QMARK_;
var expr__58008 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58010 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58011 = expr__58008;
return (pred__58007.cljs$core$IFn$_invoke$arity$2 ? pred__58007.cljs$core$IFn$_invoke$arity$2(G__58010,G__58011) : pred__58007.call(null,G__58010,G__58011));
})())){
return (new instaparse.core.Parser(G__57995,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58012 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__58013 = expr__58008;
return (pred__58007.cljs$core$IFn$_invoke$arity$2 ? pred__58007.cljs$core$IFn$_invoke$arity$2(G__58012,G__58013) : pred__58007.call(null,G__58012,G__58013));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57995,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58014 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58015 = expr__58008;
return (pred__58007.cljs$core$IFn$_invoke$arity$2 ? pred__58007.cljs$core$IFn$_invoke$arity$2(G__58014,G__58015) : pred__58007.call(null,G__58014,G__58015));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57995,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57995),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57995){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57995,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58016 = (arguments.length - (1));
switch (G__58016) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args58000){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args58000)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57999){
var extmap__4478__auto__ = (function (){var G__58017 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57999,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57999)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58017);
} else {
return G__58017;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57999),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57999),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57999),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58020){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58023 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58024 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58024);

try{var G__58025 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58025__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58023);
}});
...
var map__58026 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58026__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58026__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58018){
var G__58019 = cljs.core.first(seq58018);
var seq58018__$1 = cljs.core.next(seq58018);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58019,seq58018__$1);
}));
