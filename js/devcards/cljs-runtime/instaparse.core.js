...
if(cljs.core.truth_((function (){var fexpr__57543 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57546 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__57548 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57548)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57548)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57548)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57548)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57548)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57553){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57558 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57558) : instaparse.reduction.node_builders.call(null,G__57558));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57550){
var G__57551 = cljs.core.first(seq57550);
var seq57550__$1 = cljs.core.next(seq57550);
var G__57552 = cljs.core.first(seq57550__$1);
var seq57550__$2 = cljs.core.next(seq57550__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57551,G__57552,seq57550__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57564){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57572 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57572) : instaparse.reduction.node_builders.call(null,G__57572));
})());
} else {
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57583,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57590 = k57583;
var G__57590__$1 = (((G__57590 instanceof cljs.core.Keyword))?G__57590.fqn:null);
switch (G__57590__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57583,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57595){
var vec__57596 = p__57595;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57596,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57596,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57584,other57585){
var self__ = this;
var this57584__$1 = this;
return (((!((other57585 == null)))) && ((this57584__$1.constructor === other57585.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57584__$1.grammar,other57585.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57584__$1.start_production,other57585.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57584__$1.output_format,other57585.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57584__$1.__extmap,other57585.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57582){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57616 = cljs.core.keyword_identical_QMARK_;
var expr__57617 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57619 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__57582,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57621 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__57582,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57623 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57582,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57582),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57582){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57582,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57625 = (arguments.length - (1));
switch (G__57625) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57588){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57588)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57587){
var extmap__4478__auto__ = (function (){var G__57626 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57587,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57587)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57626);
} else {
return G__57626;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57587),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57587),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57587),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var i__4790__auto___57735 = (0);
while(true){
if((i__4790__auto___57735 < len__4789__auto___57733)){
args__4795__auto__.push((arguments[i__4790__auto___57735]));

var G__57736 = (i__4790__auto___57735 + (1));
i__4790__auto___57735 = G__57736;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57629){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57632 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57633 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57633);

try{var G__57634 = input_format;
var G__57634__$1 = (((G__57634 instanceof cljs.core.Keyword))?G__57634.fqn:null);
switch (G__57634__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57634__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57632);
}});
...
var map__57635 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57635__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57635__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57627){
var G__57628 = cljs.core.first(seq57627);
var seq57627__$1 = cljs.core.next(seq57627);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57628,seq57627__$1);
}));
