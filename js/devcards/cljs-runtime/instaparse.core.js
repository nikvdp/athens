...
if(cljs.core.truth_((function (){var fexpr__56611 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56611.cljs$core$IFn$_invoke$arity$1 ? fexpr__56611.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56611.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__56612 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__56612.cljs$core$IFn$_invoke$arity$1 ? fexpr__56612.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56612.call(null,type));
})())){
} else {
...
var G__56616 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56616)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__56616)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__56616)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__56616)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56616)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56633){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56641 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56641) : instaparse.reduction.node_builders.call(null,G__56641));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56629){
var G__56630 = cljs.core.first(seq56629);
var seq56629__$1 = cljs.core.next(seq56629);
var G__56631 = cljs.core.first(seq56629__$1);
var seq56629__$2 = cljs.core.next(seq56629__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56630,G__56631,seq56629__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56657){
var map__56658 = p__56657;
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56650){
...
var G__56756 = (i__4737__auto___56754 + (1));
i__4737__auto___56754 = G__56756;
continue;
} else {
}
break;
