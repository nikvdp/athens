...
if(cljs.core.truth_((function (){var fexpr__57671 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57671.cljs$core$IFn$_invoke$arity$1 ? fexpr__57671.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57671.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57683 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57683.cljs$core$IFn$_invoke$arity$1 ? fexpr__57683.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57683.call(null,type));
})())){
} else {
...
var G__57687 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57687)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57687)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57687)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57687)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57687)].join('')));
...
var len__4789__auto___57756 = arguments.length;
var i__4790__auto___57757 = (0);
while(true){
if((i__4790__auto___57757 < len__4789__auto___57756)){
args__4795__auto__.push((arguments[i__4790__auto___57757]));

var G__57758 = (i__4790__auto___57757 + (1));
i__4790__auto___57757 = G__57758;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57697){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57707 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57707) : instaparse.reduction.node_builders.call(null,G__57707));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57692){
var G__57693 = cljs.core.first(seq57692);
var seq57692__$1 = cljs.core.next(seq57692);
var G__57694 = cljs.core.first(seq57692__$1);
var seq57692__$2 = cljs.core.next(seq57692__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57693,G__57694,seq57692__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57765 = arguments.length;
var i__4790__auto___57766 = (0);
while(true){
if((i__4790__auto___57766 < len__4789__auto___57765)){
args__4795__auto__.push((arguments[i__4790__auto___57766]));

var G__57767 = (i__4790__auto___57766 + (1));
i__4790__auto___57766 = G__57767;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57719){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57722 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57722) : instaparse.reduction.node_builders.call(null,G__57722));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57712){
var G__57713 = cljs.core.first(seq57712);
var seq57712__$1 = cljs.core.next(seq57712);
var G__57714 = cljs.core.first(seq57712__$1);
var seq57712__$2 = cljs.core.next(seq57712__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57713,G__57714,seq57712__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57724,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57729 = k57724;
var G__57729__$1 = (((G__57729 instanceof cljs.core.Keyword))?G__57729.fqn:null);
switch (G__57729__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57724,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57730){
var vec__57731 = p__57730;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57731,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57731,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57734 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57734(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57725,other57726){
var self__ = this;
var this57725__$1 = this;
return (((!((other57726 == null)))) && ((this57725__$1.constructor === other57726.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57725__$1.grammar,other57726.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57725__$1.start_production,other57726.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57725__$1.output_format,other57726.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57725__$1.__extmap,other57726.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57723){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57735 = cljs.core.keyword_identical_QMARK_;
var expr__57736 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57738 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57739 = expr__57736;
return (pred__57735.cljs$core$IFn$_invoke$arity$2 ? pred__57735.cljs$core$IFn$_invoke$arity$2(G__57738,G__57739) : pred__57735.call(null,G__57738,G__57739));
})())){
return (new instaparse.core.Parser(G__57723,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57740 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57741 = expr__57736;
return (pred__57735.cljs$core$IFn$_invoke$arity$2 ? pred__57735.cljs$core$IFn$_invoke$arity$2(G__57740,G__57741) : pred__57735.call(null,G__57740,G__57741));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57723,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57742 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57743 = expr__57736;
return (pred__57735.cljs$core$IFn$_invoke$arity$2 ? pred__57735.cljs$core$IFn$_invoke$arity$2(G__57742,G__57743) : pred__57735.call(null,G__57742,G__57743));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57723,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57723),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57723){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57723,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57744 = (arguments.length - (1));
switch (G__57744) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57728){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57728)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57727){
var extmap__4478__auto__ = (function (){var G__57745 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57727,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57727)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57745);
} else {
return G__57745;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57727),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57727),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57727),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___57835 = arguments.length;
var i__4790__auto___57836 = (0);
while(true){
if((i__4790__auto___57836 < len__4789__auto___57835)){
args__4795__auto__.push((arguments[i__4790__auto___57836]));

var G__57838 = (i__4790__auto___57836 + (1));
i__4790__auto___57836 = G__57838;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57748){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57751 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57752 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57752);

try{var G__57753 = input_format;
var G__57753__$1 = (((G__57753 instanceof cljs.core.Keyword))?G__57753.fqn:null);
switch (G__57753__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57753__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57751);
}});
...
var map__57754 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57754__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57754__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57746){
var G__57747 = cljs.core.first(seq57746);
var seq57746__$1 = cljs.core.next(seq57746);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57747,seq57746__$1);
}));
