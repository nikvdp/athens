...
if(cljs.core.truth_((function (){var fexpr__57645 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57645.cljs$core$IFn$_invoke$arity$1 ? fexpr__57645.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57645.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57650 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57650.cljs$core$IFn$_invoke$arity$1 ? fexpr__57650.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57650.call(null,type));
})())){
} else {
...
var G__57655 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57655)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57655)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57655)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57655)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57655)].join('')));
...
var args__4795__auto__ = [];
var len__4789__auto___57770 = arguments.length;
var i__4790__auto___57771 = (0);
while(true){
if((i__4790__auto___57771 < len__4789__auto___57770)){
args__4795__auto__.push((arguments[i__4790__auto___57771]));

var G__57772 = (i__4790__auto___57771 + (1));
i__4790__auto___57771 = G__57772;
continue;
} else {
}
break;
