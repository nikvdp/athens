...
if(cljs.core.truth_((function (){var fexpr__57514 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57514.cljs$core$IFn$_invoke$arity$1 ? fexpr__57514.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57514.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57515 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57515.cljs$core$IFn$_invoke$arity$1 ? fexpr__57515.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57515.call(null,type));
})())){
} else {
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57527 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57527) : instaparse.reduction.node_builders.call(null,G__57527));
})());
} else {
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57535){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57545 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57545) : instaparse.reduction.node_builders.call(null,G__57545));
})());
} else {
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57552,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57557 = k57552;
var G__57557__$1 = (((G__57557 instanceof cljs.core.Keyword))?G__57557.fqn:null);
switch (G__57557__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57552,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57558){
var vec__57559 = p__57558;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57559,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57559,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57553,other57554){
var self__ = this;
var this57553__$1 = this;
return (((!((other57554 == null)))) && ((this57553__$1.constructor === other57554.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57553__$1.grammar,other57554.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57553__$1.start_production,other57554.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57553__$1.output_format,other57554.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57553__$1.__extmap,other57554.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57551){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57580 = cljs.core.keyword_identical_QMARK_;
var expr__57581 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57583 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57584 = expr__57581;
return (pred__57580.cljs$core$IFn$_invoke$arity$2 ? pred__57580.cljs$core$IFn$_invoke$arity$2(G__57583,G__57584) : pred__57580.call(null,G__57583,G__57584));
})())){
return (new instaparse.core.Parser(G__57551,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57585 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57586 = expr__57581;
return (pred__57580.cljs$core$IFn$_invoke$arity$2 ? pred__57580.cljs$core$IFn$_invoke$arity$2(G__57585,G__57586) : pred__57580.call(null,G__57585,G__57586));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57551,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57587 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57551,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57551),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57551){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57551,self__.__extmap,self__.__hash));
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57686 = arguments.length;
var i__4790__auto___57687 = (0);
while(true){
if((i__4790__auto___57687 < len__4789__auto___57686)){
args__4795__auto__.push((arguments[i__4790__auto___57687]));

var G__57688 = (i__4790__auto___57687 + (1));
i__4790__auto___57687 = G__57688;
continue;
} else {
}
break;
