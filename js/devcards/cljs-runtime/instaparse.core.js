...
if(cljs.core.truth_((function (){var fexpr__57970 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__57972 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57972)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57972)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57972)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57972)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57972)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57984){
var map__57985 = p__57984;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57987 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57987) : instaparse.reduction.node_builders.call(null,G__57987));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57977){
var G__57978 = cljs.core.first(seq57977);
var seq57977__$1 = cljs.core.next(seq57977);
var G__57979 = cljs.core.first(seq57977__$1);
var seq57977__$2 = cljs.core.next(seq57977__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57978,G__57979,seq57977__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___58031 = arguments.length;
var i__4790__auto___58032 = (0);
while(true){
if((i__4790__auto___58032 < len__4789__auto___58031)){
args__4795__auto__.push((arguments[i__4790__auto___58032]));

var G__58033 = (i__4790__auto___58032 + (1));
i__4790__auto___58032 = G__58033;
continue;
} else {
}
break;
