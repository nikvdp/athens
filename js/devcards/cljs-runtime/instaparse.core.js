...
if(cljs.core.truth_((function (){var fexpr__57939 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57939.cljs$core$IFn$_invoke$arity$1 ? fexpr__57939.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57939.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57940 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57940.cljs$core$IFn$_invoke$arity$1 ? fexpr__57940.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57940.call(null,type));
})())){
} else {
...
var G__57941 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57941)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57941)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57941)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57941)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57941)].join('')));
...
var G__58035 = (i__4790__auto___58034 + (1));
i__4790__auto___58034 = G__58035;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57945){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57948 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57948) : instaparse.reduction.node_builders.call(null,G__57948));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57942){
var G__57943 = cljs.core.first(seq57942);
var seq57942__$1 = cljs.core.next(seq57942);
var G__57944 = cljs.core.first(seq57942__$1);
var seq57942__$2 = cljs.core.next(seq57942__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57943,G__57944,seq57942__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___58041 = arguments.length;
var i__4790__auto___58042 = (0);
while(true){
if((i__4790__auto___58042 < len__4789__auto___58041)){
args__4795__auto__.push((arguments[i__4790__auto___58042]));

var G__58044 = (i__4790__auto___58042 + (1));
i__4790__auto___58042 = G__58044;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57952){
var map__57953 = p__57952;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57956 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57956) : instaparse.reduction.node_builders.call(null,G__57956));
})());
} else {
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57960,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57960,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57961,other57962){
var self__ = this;
var this57961__$1 = this;
return (((!((other57962 == null)))) && ((this57961__$1.constructor === other57962.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57961__$1.grammar,other57962.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57961__$1.start_production,other57962.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57961__$1.output_format,other57962.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57961__$1.__extmap,other57962.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57959){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57981 = cljs.core.keyword_identical_QMARK_;
var expr__57983 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57985 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57986 = expr__57983;
return (pred__57981.cljs$core$IFn$_invoke$arity$2 ? pred__57981.cljs$core$IFn$_invoke$arity$2(G__57985,G__57986) : pred__57981.call(null,G__57985,G__57986));
})())){
return (new instaparse.core.Parser(G__57959,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57988 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57989 = expr__57983;
return (pred__57981.cljs$core$IFn$_invoke$arity$2 ? pred__57981.cljs$core$IFn$_invoke$arity$2(G__57988,G__57989) : pred__57981.call(null,G__57988,G__57989));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57959,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57991 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57992 = expr__57983;
return (pred__57981.cljs$core$IFn$_invoke$arity$2 ? pred__57981.cljs$core$IFn$_invoke$arity$2(G__57991,G__57992) : pred__57981.call(null,G__57991,G__57992));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57959,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57959),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57959){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57959,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58000 = (arguments.length - (1));
switch (G__58000) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57965){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57965)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57963){
var extmap__4478__auto__ = (function (){var G__58022 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57963,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57963)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58022);
} else {
return G__58022;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57963),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57963),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57963),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___58129 = arguments.length;
var i__4790__auto___58131 = (0);
while(true){
if((i__4790__auto___58131 < len__4789__auto___58129)){
args__4795__auto__.push((arguments[i__4790__auto___58131]));

var G__58132 = (i__4790__auto___58131 + (1));
i__4790__auto___58131 = G__58132;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58025){
var map__58026 = p__58025;
...
var _STAR_case_insensitive_literals_STAR__orig_val__58028 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58029 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58029);

try{var G__58030 = input_format;
var G__58030__$1 = (((G__58030 instanceof cljs.core.Keyword))?G__58030.fqn:null);
switch (G__58030__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58030__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58028);
}});
...
var map__58031 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58031__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58031__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58023){
var G__58024 = cljs.core.first(seq58023);
var seq58023__$1 = cljs.core.next(seq58023);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58024,seq58023__$1);
}));
