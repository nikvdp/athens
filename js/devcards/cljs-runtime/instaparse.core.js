...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56610){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56613 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56613) : instaparse.reduction.node_builders.call(null,G__56613));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56607){
var G__56608 = cljs.core.first(seq56607);
var seq56607__$1 = cljs.core.next(seq56607);
var G__56609 = cljs.core.first(seq56607__$1);
var seq56607__$2 = cljs.core.next(seq56607__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56608,G__56609,seq56607__$2);
}));
...
var G__56702 = (i__4737__auto___56701 + (1));
i__4737__auto___56701 = G__56702;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56621){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56624 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56624) : instaparse.reduction.node_builders.call(null,G__56624));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56617){
var G__56618 = cljs.core.first(seq56617);
var seq56617__$1 = cljs.core.next(seq56617);
var G__56619 = cljs.core.first(seq56617__$1);
var seq56617__$2 = cljs.core.next(seq56617__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56618,G__56619,seq56617__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56629,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__56634 = k56629;
var G__56634__$1 = (((G__56634 instanceof cljs.core.Keyword))?G__56634.fqn:null);
switch (G__56634__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56629,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56636){
var vec__56638 = p__56636;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56638,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56638,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56630,other56631){
var self__ = this;
var this56630__$1 = this;
return (((!((other56631 == null)))) && ((this56630__$1.constructor === other56631.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56630__$1.grammar,other56631.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56630__$1.start_production,other56631.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56630__$1.output_format,other56631.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56630__$1.__extmap,other56631.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56628){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56661 = cljs.core.keyword_identical_QMARK_;
var expr__56662 = k__4388__auto__;
if(cljs.core.truth_((pred__56661.cljs$core$IFn$_invoke$arity$2 ? pred__56661.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56662) : pred__56661.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56662)))){
return (new instaparse.core.Parser(G__56628,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56661.cljs$core$IFn$_invoke$arity$2 ? pred__56661.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56662) : pred__56661.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56662)))){
return (new instaparse.core.Parser(self__.grammar,G__56628,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56661.cljs$core$IFn$_invoke$arity$2 ? pred__56661.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56662) : pred__56661.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56662)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56628,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56628),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56628){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56628,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56671 = (arguments.length - (1));
switch (G__56671) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56633){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56633)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56632){
var extmap__4419__auto__ = (function (){var G__56680 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56632,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56632)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56680);
} else {
return G__56680;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56632),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56632),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56632),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
