...
if(cljs.core.truth_((function (){var fexpr__57549 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57549.cljs$core$IFn$_invoke$arity$1 ? fexpr__57549.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57549.call(null,type));
})())){
} else {
...
var G__57558 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57558)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57558)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57558)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57558)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57558)].join('')));
...
var G__57632 = (i__4790__auto___57631 + (1));
i__4790__auto___57631 = G__57632;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57569){
var map__57571 = p__57569;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57576 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57576) : instaparse.reduction.node_builders.call(null,G__57576));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57562){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57563,G__57564,seq57562__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57589){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57592 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57592) : instaparse.reduction.node_builders.call(null,G__57592));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57582){
var G__57583 = cljs.core.first(seq57582);
var seq57582__$1 = cljs.core.next(seq57582);
var G__57584 = cljs.core.first(seq57582__$1);
var seq57582__$2 = cljs.core.next(seq57582__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57583,G__57584,seq57582__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57598,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57603 = k57598;
var G__57603__$1 = (((G__57603 instanceof cljs.core.Keyword))?G__57603.fqn:null);
switch (G__57603__$1) {
case "grammar":
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57604){
var vec__57605 = p__57604;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57605,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57605,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57608 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57608(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57599,other57600){
var self__ = this;
var this57599__$1 = this;
return (((!((other57600 == null)))) && ((this57599__$1.constructor === other57600.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57599__$1.grammar,other57600.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57599__$1.start_production,other57600.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57599__$1.output_format,other57600.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57599__$1.__extmap,other57600.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57597){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57609 = cljs.core.keyword_identical_QMARK_;
var expr__57610 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57612 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57613 = expr__57610;
return (pred__57609.cljs$core$IFn$_invoke$arity$2 ? pred__57609.cljs$core$IFn$_invoke$arity$2(G__57612,G__57613) : pred__57609.call(null,G__57612,G__57613));
})())){
return (new instaparse.core.Parser(G__57597,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57614 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57615 = expr__57610;
return (pred__57609.cljs$core$IFn$_invoke$arity$2 ? pred__57609.cljs$core$IFn$_invoke$arity$2(G__57614,G__57615) : pred__57609.call(null,G__57614,G__57615));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57597,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57616 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57617 = expr__57610;
return (pred__57609.cljs$core$IFn$_invoke$arity$2 ? pred__57609.cljs$core$IFn$_invoke$arity$2(G__57616,G__57617) : pred__57609.call(null,G__57616,G__57617));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57597,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57597),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57597){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57597,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57618 = (arguments.length - (1));
switch (G__57618) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57602){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57602)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57601){
var extmap__4478__auto__ = (function (){var G__57619 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57601,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57601),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57601),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57601),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57622){
...
var _STAR_case_insensitive_literals_STAR__temp_val__57626 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57626);

try{var G__57627 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57627__$1)].join('')));
...
var map__57628 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57628__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57628__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57620){
var G__57621 = cljs.core.first(seq57620);
var seq57620__$1 = cljs.core.next(seq57620);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57621,seq57620__$1);
}));
