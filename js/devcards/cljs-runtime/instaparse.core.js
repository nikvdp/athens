...
if(cljs.core.truth_((function (){var fexpr__57935 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57935.cljs$core$IFn$_invoke$arity$1 ? fexpr__57935.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57935.call(null,type));
})())){
} else {
...
var G__57936 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57936)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57936)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57936)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57936)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57936)].join('')));
...
var len__4789__auto___58027 = arguments.length;
var i__4790__auto___58028 = (0);
while(true){
if((i__4790__auto___58028 < len__4789__auto___58027)){
args__4795__auto__.push((arguments[i__4790__auto___58028]));

var G__58031 = (i__4790__auto___58028 + (1));
i__4790__auto___58028 = G__58031;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57941){
var map__57943 = p__57941;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57947 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57947) : instaparse.reduction.node_builders.call(null,G__57947));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57938){
var G__57939 = cljs.core.first(seq57938);
var seq57938__$1 = cljs.core.next(seq57938);
var G__57940 = cljs.core.first(seq57938__$1);
var seq57938__$2 = cljs.core.next(seq57938__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57939,G__57940,seq57938__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57955){
var map__57956 = p__57955;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57964 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57964) : instaparse.reduction.node_builders.call(null,G__57964));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57948){
var G__57949 = cljs.core.first(seq57948);
var seq57948__$1 = cljs.core.next(seq57948);
var G__57950 = cljs.core.first(seq57948__$1);
var seq57948__$2 = cljs.core.next(seq57948__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57949,G__57950,seq57948__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57972,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57977 = k57972;
var G__57977__$1 = (((G__57977 instanceof cljs.core.Keyword))?G__57977.fqn:null);
switch (G__57977__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57972,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57980){
var vec__57982 = p__57980;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57982,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57982,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57995 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57995(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57973,other57974){
var self__ = this;
var this57973__$1 = this;
return (((!((other57974 == null)))) && ((this57973__$1.constructor === other57974.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57973__$1.grammar,other57974.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57973__$1.start_production,other57974.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57973__$1.output_format,other57974.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57973__$1.__extmap,other57974.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57971){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58000 = cljs.core.keyword_identical_QMARK_;
var expr__58001 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58003 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58004 = expr__58001;
return (pred__58000.cljs$core$IFn$_invoke$arity$2 ? pred__58000.cljs$core$IFn$_invoke$arity$2(G__58003,G__58004) : pred__58000.call(null,G__58003,G__58004));
})())){
return (new instaparse.core.Parser(G__57971,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58005 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__58006 = expr__58001;
return (pred__58000.cljs$core$IFn$_invoke$arity$2 ? pred__58000.cljs$core$IFn$_invoke$arity$2(G__58005,G__58006) : pred__58000.call(null,G__58005,G__58006));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57971,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58007 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58008 = expr__58001;
return (pred__58000.cljs$core$IFn$_invoke$arity$2 ? pred__58000.cljs$core$IFn$_invoke$arity$2(G__58007,G__58008) : pred__58000.call(null,G__58007,G__58008));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57971,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57971),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57971){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57971,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58013 = (arguments.length - (1));
switch (G__58013) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57976){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57976)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57975){
var extmap__4478__auto__ = (function (){var G__58014 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57975,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57975),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57975),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57975),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___58133 = arguments.length;
var i__4790__auto___58134 = (0);
while(true){
if((i__4790__auto___58134 < len__4789__auto___58133)){
args__4795__auto__.push((arguments[i__4790__auto___58134]));

var G__58135 = (i__4790__auto___58134 + (1));
i__4790__auto___58134 = G__58135;
continue;
} else {
}
break;
