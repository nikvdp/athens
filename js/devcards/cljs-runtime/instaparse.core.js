...
if(cljs.core.truth_((function (){var fexpr__57946 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57946.cljs$core$IFn$_invoke$arity$1 ? fexpr__57946.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57946.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57951 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57951.cljs$core$IFn$_invoke$arity$1 ? fexpr__57951.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57951.call(null,type));
})())){
} else {
...
var G__57956 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57956)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57956)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57956)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57956)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57956)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57960){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57963 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57957){
var G__57958 = cljs.core.first(seq57957);
var seq57957__$1 = cljs.core.next(seq57957);
var G__57959 = cljs.core.first(seq57957__$1);
var seq57957__$2 = cljs.core.next(seq57957__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57958,G__57959,seq57957__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57967){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57970 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57970) : instaparse.reduction.node_builders.call(null,G__57970));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57964){
...
var h__4297__auto____$1 = (function (){var fexpr__57982 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57982(this__4435__auto____$1);
})();
...
var extmap__4478__auto__ = (function (){var G__57993 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57975,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
var args__4795__auto__ = [];
var len__4789__auto___58084 = arguments.length;
var i__4790__auto___58085 = (0);
while(true){
if((i__4790__auto___58085 < len__4789__auto___58084)){
args__4795__auto__.push((arguments[i__4790__auto___58085]));

var G__58086 = (i__4790__auto___58085 + (1));
i__4790__auto___58085 = G__58086;
continue;
} else {
}
break;
