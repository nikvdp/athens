...
if(cljs.core.truth_((function (){var fexpr__57932 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57933 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57933.cljs$core$IFn$_invoke$arity$1 ? fexpr__57933.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57933.call(null,type));
})())){
} else {
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57934)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57934)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57934)){
...
var len__4789__auto___58028 = arguments.length;
var i__4790__auto___58029 = (0);
while(true){
if((i__4790__auto___58029 < len__4789__auto___58028)){
args__4795__auto__.push((arguments[i__4790__auto___58029]));

var G__58030 = (i__4790__auto___58029 + (1));
i__4790__auto___58029 = G__58030;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57935){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57936,G__57937,seq57935__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___58037 = arguments.length;
var i__4790__auto___58038 = (0);
while(true){
if((i__4790__auto___58038 < len__4789__auto___58037)){
args__4795__auto__.push((arguments[i__4790__auto___58038]));

var G__58039 = (i__4790__auto___58038 + (1));
i__4790__auto___58038 = G__58039;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57955 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57955) : instaparse.reduction.node_builders.call(null,G__57955));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57946){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57947,G__57948,seq57946__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57958,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57958,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57974){
var vec__57976 = p__57974;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57976,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57976,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57988 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57988(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57959,other57960){
var self__ = this;
var this57959__$1 = this;
return (((!((other57960 == null)))) && ((this57959__$1.constructor === other57960.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57959__$1.grammar,other57960.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57959__$1.start_production,other57960.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57959__$1.output_format,other57960.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57959__$1.__extmap,other57960.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57957){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57997 = cljs.core.keyword_identical_QMARK_;
var expr__57998 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58000 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58001 = expr__57998;
return (pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(G__58000,G__58001) : pred__57997.call(null,G__58000,G__58001));
})())){
return (new instaparse.core.Parser(G__57957,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58002 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__58003 = expr__57998;
return (pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(G__58002,G__58003) : pred__57997.call(null,G__58002,G__58003));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57957,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58004 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58005 = expr__57998;
return (pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(G__58004,G__58005) : pred__57997.call(null,G__58004,G__58005));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57957,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57957),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57957){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57957,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58010 = (arguments.length - (1));
switch (G__58010) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57962){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57962)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57961){
var extmap__4478__auto__ = (function (){var G__58015 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57961,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57961),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57961),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57961),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58018){
var map__58019 = p__58018;
...
var _STAR_case_insensitive_literals_STAR__orig_val__58021 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58022 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58022);

try{var G__58023 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58021);
}});
...
var map__58024 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58024__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58024__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58016){
var G__58017 = cljs.core.first(seq58016);
var seq58016__$1 = cljs.core.next(seq58016);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58017,seq58016__$1);
}));
