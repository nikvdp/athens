...
if(cljs.core.truth_((function (){var fexpr__57931 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57931.cljs$core$IFn$_invoke$arity$1 ? fexpr__57931.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57931.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57932 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57932.cljs$core$IFn$_invoke$arity$1 ? fexpr__57932.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57932.call(null,type));
})())){
} else {
...
var G__57933 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57933)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57933)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57933)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57933)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57933)].join('')));
...
var len__4789__auto___58025 = arguments.length;
var i__4790__auto___58026 = (0);
while(true){
if((i__4790__auto___58026 < len__4789__auto___58025)){
args__4795__auto__.push((arguments[i__4790__auto___58026]));

var G__58027 = (i__4790__auto___58026 + (1));
i__4790__auto___58026 = G__58027;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57939){
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57934){
var G__57935 = cljs.core.first(seq57934);
var seq57934__$1 = cljs.core.next(seq57934);
var G__57936 = cljs.core.first(seq57934__$1);
var seq57934__$2 = cljs.core.next(seq57934__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57935,G__57936,seq57934__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___58034 = arguments.length;
var i__4790__auto___58035 = (0);
while(true){
if((i__4790__auto___58035 < len__4789__auto___58034)){
args__4795__auto__.push((arguments[i__4790__auto___58035]));

var G__58038 = (i__4790__auto___58035 + (1));
i__4790__auto___58035 = G__58038;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57950){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57954 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57954) : instaparse.reduction.node_builders.call(null,G__57954));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57945){
var G__57946 = cljs.core.first(seq57945);
var seq57945__$1 = cljs.core.next(seq57945);
var G__57947 = cljs.core.first(seq57945__$1);
var seq57945__$2 = cljs.core.next(seq57945__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57946,G__57947,seq57945__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57956,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57956,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57957,other57958){
var self__ = this;
var this57957__$1 = this;
return (((!((other57958 == null)))) && ((this57957__$1.constructor === other57958.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57957__$1.grammar,other57958.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57957__$1.start_production,other57958.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57957__$1.output_format,other57958.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57957__$1.__extmap,other57958.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57955){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57988 = cljs.core.keyword_identical_QMARK_;
var expr__57989 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57991 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57992 = expr__57989;
return (pred__57988.cljs$core$IFn$_invoke$arity$2 ? pred__57988.cljs$core$IFn$_invoke$arity$2(G__57991,G__57992) : pred__57988.call(null,G__57991,G__57992));
})())){
return (new instaparse.core.Parser(G__57955,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57993 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57994 = expr__57989;
return (pred__57988.cljs$core$IFn$_invoke$arity$2 ? pred__57988.cljs$core$IFn$_invoke$arity$2(G__57993,G__57994) : pred__57988.call(null,G__57993,G__57994));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57955,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57995 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57996 = expr__57989;
return (pred__57988.cljs$core$IFn$_invoke$arity$2 ? pred__57988.cljs$core$IFn$_invoke$arity$2(G__57995,G__57996) : pred__57988.call(null,G__57995,G__57996));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57955,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57955),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57955){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57955,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57997 = (arguments.length - (1));
switch (G__57997) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57961){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57961)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57959){
var extmap__4478__auto__ = (function (){var G__58014 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57959,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57959)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58014);
} else {
return G__58014;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57959),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57959),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57959),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58017){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58020 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58021 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58021);

try{var G__58022 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58022__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58020);
}});
...
var map__58023 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58023__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58023__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58015){
var G__58016 = cljs.core.first(seq58015);
var seq58015__$1 = cljs.core.next(seq58015);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58016,seq58015__$1);
}));
