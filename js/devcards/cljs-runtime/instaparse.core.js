...
if(cljs.core.truth_((function (){var fexpr__57549 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57557 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57557.cljs$core$IFn$_invoke$arity$1 ? fexpr__57557.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57557.call(null,type));
})())){
} else {
...
var G__57564 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57564)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57564)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57564)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57564)){
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57573){
var map__57574 = p__57573;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57581 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57581) : instaparse.reduction.node_builders.call(null,G__57581));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57566){
var G__57567 = cljs.core.first(seq57566);
var seq57566__$1 = cljs.core.next(seq57566);
var G__57568 = cljs.core.first(seq57566__$1);
var seq57566__$2 = cljs.core.next(seq57566__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57567,G__57568,seq57566__$2);
}));
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57589){
...
var args__4795__auto__ = [];
var len__4789__auto___57700 = arguments.length;
var i__4790__auto___57701 = (0);
while(true){
if((i__4790__auto___57701 < len__4789__auto___57700)){
args__4795__auto__.push((arguments[i__4790__auto___57701]));

var G__57702 = (i__4790__auto___57701 + (1));
i__4790__auto___57701 = G__57702;
continue;
} else {
}
break;
