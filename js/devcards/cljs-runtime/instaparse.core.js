...
if(cljs.core.truth_((function (){var fexpr__56616 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56616.cljs$core$IFn$_invoke$arity$1 ? fexpr__56616.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56616.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__56617 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__56617.cljs$core$IFn$_invoke$arity$1 ? fexpr__56617.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56617.call(null,type));
})())){
} else {
...
var G__56618 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56618)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__56618)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__56618)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__56618)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56618)].join('')));
...
var len__4736__auto___56703 = arguments.length;
var i__4737__auto___56704 = (0);
while(true){
if((i__4737__auto___56704 < len__4736__auto___56703)){
args__4742__auto__.push((arguments[i__4737__auto___56704]));

var G__56705 = (i__4737__auto___56704 + (1));
i__4737__auto___56704 = G__56705;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56622){
var map__56623 = p__56622;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56628 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56628) : instaparse.reduction.node_builders.call(null,G__56628));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56619){
var G__56620 = cljs.core.first(seq56619);
var seq56619__$1 = cljs.core.next(seq56619);
var G__56621 = cljs.core.first(seq56619__$1);
var seq56619__$2 = cljs.core.next(seq56619__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56620,G__56621,seq56619__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56712 = arguments.length;
var i__4737__auto___56713 = (0);
while(true){
if((i__4737__auto___56713 < len__4736__auto___56712)){
args__4742__auto__.push((arguments[i__4737__auto___56713]));

var G__56714 = (i__4737__auto___56713 + (1));
i__4737__auto___56713 = G__56714;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56636){
var map__56637 = p__56636;
var map__56637__$1 = (((((!((map__56637 == null))))?(((((map__56637.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56637.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56637):map__56637);
var options = map__56637__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56639 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56639) : instaparse.reduction.node_builders.call(null,G__56639));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56630){
var G__56631 = cljs.core.first(seq56630);
var seq56630__$1 = cljs.core.next(seq56630);
var G__56632 = cljs.core.first(seq56630__$1);
var seq56630__$2 = cljs.core.next(seq56630__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56631,G__56632,seq56630__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56646,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56646,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56663){
var vec__56664 = p__56663;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56664,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56664,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56647,other56648){
var self__ = this;
var this56647__$1 = this;
return (((!((other56648 == null)))) && ((this56647__$1.constructor === other56648.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.grammar,other56648.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.start_production,other56648.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.output_format,other56648.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56647__$1.__extmap,other56648.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56645){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56684 = cljs.core.keyword_identical_QMARK_;
var expr__56685 = k__4388__auto__;
if(cljs.core.truth_((pred__56684.cljs$core$IFn$_invoke$arity$2 ? pred__56684.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56685) : pred__56684.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56685)))){
return (new instaparse.core.Parser(G__56645,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56684.cljs$core$IFn$_invoke$arity$2 ? pred__56684.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56685) : pred__56684.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56685)))){
return (new instaparse.core.Parser(self__.grammar,G__56645,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56684.cljs$core$IFn$_invoke$arity$2 ? pred__56684.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56685) : pred__56684.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56685)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56645,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56645),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56645){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56645,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56691 = (arguments.length - (1));
switch (G__56691) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56657){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56657)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56651){
var extmap__4419__auto__ = (function (){var G__56692 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56651,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56651)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56692);
} else {
return G__56692;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56651),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56651),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56651),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___56777 = arguments.length;
var i__4737__auto___56780 = (0);
while(true){
if((i__4737__auto___56780 < len__4736__auto___56777)){
args__4742__auto__.push((arguments[i__4737__auto___56780]));

var G__56781 = (i__4737__auto___56780 + (1));
i__4737__auto___56780 = G__56781;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__56695){
...
var _STAR_case_insensitive_literals_STAR__orig_val__56698 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56699 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56699);

try{var G__56700 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56700__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56698);
}});
...
var map__56701 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56701__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56701__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq56693){
var G__56694 = cljs.core.first(seq56693);
var seq56693__$1 = cljs.core.next(seq56693);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56694,seq56693__$1);
}));
