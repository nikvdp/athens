...
var seq__44081 = cljs.core.seq(cljs.core.keys(cljs.core.deref(stylefy.impl.dom.styles_in_dom)));
var chunk__44082 = null;
var count__44083 = (0);
var i__44084 = (0);
while(true){
if((i__44084 < count__44083)){
var style_hash = chunk__44082.cljs$core$IIndexed$_nth$arity$2(null,i__44084);
...
var G__44146 = seq__44081;
var G__44147 = chunk__44082;
var G__44148 = count__44083;
var G__44149 = (i__44084 + (1));
seq__44081 = G__44146;
chunk__44082 = G__44147;
count__44083 = G__44148;
i__44084 = G__44149;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44081);
if(temp__5735__auto__){
var seq__44081__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44081__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44081__$1);
var G__44153 = cljs.core.chunk_rest(seq__44081__$1);
var G__44154 = c__4556__auto__;
var G__44155 = cljs.core.count(c__4556__auto__);
var G__44156 = (0);
seq__44081 = G__44153;
chunk__44082 = G__44154;
count__44083 = G__44155;
i__44084 = G__44156;
continue;
} else {
var style_hash = cljs.core.first(seq__44081__$1);
cljs.core.reset_BANG_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(stylefy.impl.dom.styles_in_dom),style_hash),true);


var G__44158 = cljs.core.next(seq__44081__$1);
var G__44159 = null;
var G__44160 = (0);
var G__44161 = (0);
seq__44081 = G__44158;
chunk__44082 = G__44159;
count__44083 = G__44160;
i__44084 = G__44161;
continue;
}
} else {
...
}catch (e44090){var e_44163 = e44090;
stylefy.impl.log.warn(["Unable to cache styles, error: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e_44163)].join(''));
...
var c__42519__auto___44164 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__42520__auto__ = (function (){var switch__42483__auto__ = (function (state_44099){
var state_val_44100 = (state_44099[(1)]);
if((state_val_44100 === (1))){
var inst_44097 = stylefy.impl.dom.update_dom();
var state_44099__$1 = state_44099;
return cljs.core.async.impl.ioc_helpers.return_chan(state_44099__$1,inst_44097);
} else {
return null;
}
});
return (function() {
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__ = null;
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____0 = (function (){
var statearr_44104 = [null,null,null,null,null,null,null];
(statearr_44104[(0)] = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__);

(statearr_44104[(1)] = (1));

return statearr_44104;
});
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____1 = (function (state_44099){
while(true){
var ret_value__42485__auto__ = (function (){try{while(true){
var result__42486__auto__ = switch__42483__auto__(state_44099);
...
}catch (e44106){var ex__42487__auto__ = e44106;
var statearr_44107_44165 = state_44099;
(statearr_44107_44165[(2)] = ex__42487__auto__);


if(cljs.core.seq((state_44099[(4)]))){
var statearr_44109_44166 = state_44099;
(statearr_44109_44166[(1)] = cljs.core.first((state_44099[(4)])));
...
var G__44174 = state_44099;
state_44099 = G__44174;
continue;
} else {
...
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__ = function(state_44099){
switch(arguments.length){
case 0:
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____0.call(this);
case 1:
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____1.call(this,state_44099);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__.cljs$core$IFn$_invoke$arity$0 = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____0;
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__.cljs$core$IFn$_invoke$arity$1 = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto____1;
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__42484__auto__;
})()
})();
var state__42521__auto__ = (function (){var statearr_44112 = f__42520__auto__();
(statearr_44112[(6)] = c__42519__auto___44164);
...
stylefy.impl.dom.init_multi_instance = (function stylefy$impl$dom$init_multi_instance(p__44115){
var map__44116 = p__44115;
var map__44116__$1 = (((((!((map__44116 == null))))?(((((map__44116.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44116.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44116):map__44116);
var options = map__44116__$1;
var multi_instance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44116__$1,new cljs.core.Keyword(null,"multi-instance","multi-instance",-1525956512));
...
return cljs.core.reset_BANG_(stylefy.impl.dom.styles_in_dom,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44121_SHARP_){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__44121_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)]);
 ...
 */
stylefy.impl.dom.save_style_BANG_ = (function stylefy$impl$dom$save_style_BANG_(p__44123){
var map__44124 = p__44123;
var map__44124__$1 = (((((!((map__44124 == null))))?(((((map__44124.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44124.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44124):map__44124);
var style = map__44124__$1;
var css = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44124__$1,new cljs.core.Keyword(null,"css","css",1135045163));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44124__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
