...
var fexpr__31420 = new cljs.core.Keyword(null,"pull*","pull*",413297819).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31420.cljs$core$IFn$_invoke$arity$3 ? fexpr__31420.cljs$core$IFn$_invoke$arity$3(db,query,id) : fexpr__31420.call(null,db,query,id));
} else {
if(cljs.core.vector_QMARK_(id)){
var temp__5733__auto__ = (function (){var fexpr__31421 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31421.cljs$core$IFn$_invoke$arity$2 ? fexpr__31421.cljs$core$IFn$_invoke$arity$2(db,id) : fexpr__31421.call(null,db,id));
})();
if(cljs.core.truth_(temp__5733__auto__)){
var eid = temp__5733__auto__;
var fexpr__31422 = new cljs.core.Keyword(null,"pull*","pull*",413297819).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31422.cljs$core$IFn$_invoke$arity$3 ? fexpr__31422.cljs$core$IFn$_invoke$arity$3(db,query,eid) : fexpr__31422.call(null,db,query,eid));
} else {
...
var G__31424_31589 = conn;
var G__31425_31590 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766);
var G__31426_31591 = (function (var$){
...
var fexpr__31423_31592 = new cljs.core.Keyword(null,"listen!","listen!",-1756109477).cljs$core$IFn$_invoke$arity$1(dcfg);
(fexpr__31423_31592.cljs$core$IFn$_invoke$arity$3 ? fexpr__31423_31592.cljs$core$IFn$_invoke$arity$3(G__31424_31589,G__31425_31590,G__31426_31591) : fexpr__31423_31592.call(null,G__31424_31589,G__31425_31590,G__31426_31591));
...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31477_SHARP_){
return posh.core.add_pull_many(p1__31477_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__31492,query_item){
var vec__31493 = p__31492;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31493,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31493,(1),null);
...
var args__4795__auto__ = [];
var len__4789__auto___31625 = arguments.length;
var i__4790__auto___31626 = (0);
while(true){
if((i__4790__auto___31626 < len__4789__auto___31625)){
args__4795__auto__.push((arguments[i__4790__auto___31626]));

var G__31628 = (i__4790__auto___31626 + (1));
i__4790__auto___31626 = G__31628;
continue;
} else {
}
break;
...
var vec__31519 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n_query_args,cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,cljs.core.PersistentArrayMap.EMPTY], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((n_query_args + (1)),cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.butlast(args),cljs.core.last(args)], null):(function(){throw "Incorrect number of args passed to posh query"})()
));
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31519,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31519,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31502_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31524 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31524.cljs$core$IFn$_invoke$arity$1 ? fexpr__31524.cljs$core$IFn$_invoke$arity$1(p1__31502_SHARP_) : fexpr__31524.call(null,p1__31502_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31502_SHARP_);
} else {
return p1__31502_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31503_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31503_SHARP_);
}),args__$1)));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31504_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__31504_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq31513){
var G__31515 = cljs.core.first(seq31513);
var seq31513__$1 = cljs.core.next(seq31513);
var G__31516 = cljs.core.first(seq31513__$1);
var seq31513__$2 = cljs.core.next(seq31513__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31515,G__31516,seq31513__$2);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31532_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31540 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31540.cljs$core$IFn$_invoke$arity$1 ? fexpr__31540.cljs$core$IFn$_invoke$arity$1(p1__31532_SHARP_) : fexpr__31540.call(null,p1__31532_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31532_SHARP_);
} else {
return p1__31532_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31535_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31535_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq31536){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31537,G__31538,seq31536__$2);
}));
...
/** @this {Function} */
(posh.plugin_base.q_tx.cljs$lang$applyTo = (function (seq31545){
...
var G__31548 = cljs.core.first(seq31545__$2);
var seq31545__$3 = cljs.core.next(seq31545__$2);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31546,G__31547,G__31548,seq31545__$3);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31559_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31569 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31569.cljs$core$IFn$_invoke$arity$1 ? fexpr__31569.cljs$core$IFn$_invoke$arity$1(p1__31559_SHARP_) : fexpr__31569.call(null,p1__31559_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31559_SHARP_);
} else {
return p1__31559_SHARP_;
}
}),args);
...
/** @this {Function} */
(posh.plugin_base.filter_q.cljs$lang$applyTo = (function (seq31561){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31562,G__31563,seq31561__$2);
}));

posh.plugin_base.transact_BANG_ = (function posh$plugin_base$transact_BANG_(dcfg,poshdb_or_conn,txs){
var G__31576 = (cljs.core.truth_((function (){var fexpr__31580 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31580.cljs$core$IFn$_invoke$arity$1 ? fexpr__31580.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31580.call(null,poshdb_or_conn));
})())?poshdb_or_conn:posh.stateful.poshdb__GT_conn(poshdb_or_conn));
var G__31577 = txs;
var fexpr__31575 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31575.cljs$core$IFn$_invoke$arity$2 ? fexpr__31575.cljs$core$IFn$_invoke$arity$2(G__31576,G__31577) : fexpr__31575.call(null,G__31576,G__31577));
});
