...
return posh.core.add_pull_many(p1__31254_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31314_SHARP_){
...
return (fexpr__31321.cljs$core$IFn$_invoke$arity$1 ? fexpr__31321.cljs$core$IFn$_invoke$arity$1(p1__31314_SHARP_) : fexpr__31321.call(null,p1__31314_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31314_SHARP_);
} else {
return p1__31314_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31315_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31315_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
