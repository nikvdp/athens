...
var len__4789__auto___31369 = arguments.length;
var i__4790__auto___31370 = (0);
while(true){
if((i__4790__auto___31370 < len__4789__auto___31369)){
args__4795__auto__.push((arguments[i__4790__auto___31370]));

var G__31372 = (i__4790__auto___31370 + (1));
i__4790__auto___31370 = G__31372;
continue;
} else {
}
break;
...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31270_SHARP_){
return posh.core.add_pull_many(p1__31270_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__31290,query_item){
var vec__31293 = p__31290;
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq31305){
