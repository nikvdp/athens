...
var fexpr__31207 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(new cljs.core.Keyword(null,"listeners","listeners",394544445).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(conn))));
return (fexpr__31207.cljs$core$IFn$_invoke$arity$1 ? fexpr__31207.cljs$core$IFn$_invoke$arity$1(var$) : fexpr__31207.call(null,var$));
});
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31240_SHARP_){
return posh.core.add_pull(p1__31240_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.core.add_pull_many(p1__31257_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
var vec__31276 = p__31273;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(1),null);
...
if(cljs.core.truth_((function (){var fexpr__31305 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31305.cljs$core$IFn$_invoke$arity$1 ? fexpr__31305.cljs$core$IFn$_invoke$arity$1(p1__31286_SHARP_) : fexpr__31305.call(null,p1__31286_SHARP_));
})())){
