...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31248_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31265 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31265.cljs$core$IFn$_invoke$arity$1 ? fexpr__31265.cljs$core$IFn$_invoke$arity$1(p1__31248_SHARP_) : fexpr__31265.call(null,p1__31248_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31248_SHARP_);
} else {
return p1__31248_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31249_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31249_SHARP_);
}),args__$1)));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31272_SHARP_){
...
return (fexpr__31282.cljs$core$IFn$_invoke$arity$1 ? fexpr__31282.cljs$core$IFn$_invoke$arity$1(p1__31272_SHARP_) : fexpr__31282.call(null,p1__31272_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31272_SHARP_);
} else {
return p1__31272_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31274_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31274_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_tx.cljs$lang$applyTo = (function (seq31291){
var G__31293 = cljs.core.first(seq31291);
var seq31291__$1 = cljs.core.next(seq31291);
var G__31294 = cljs.core.first(seq31291__$1);
var seq31291__$2 = cljs.core.next(seq31291__$1);
var G__31295 = cljs.core.first(seq31291__$2);
var seq31291__$3 = cljs.core.next(seq31291__$2);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31293,G__31294,G__31295,seq31291__$3);
}));
...
if(cljs.core.truth_((function (){var fexpr__31318 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31318.cljs$core$IFn$_invoke$arity$1 ? fexpr__31318.cljs$core$IFn$_invoke$arity$1(p1__31307_SHARP_) : fexpr__31318.call(null,p1__31307_SHARP_));
})())){
...
/** @this {Function} */
(posh.plugin_base.filter_q.cljs$lang$applyTo = (function (seq31310){
var G__31312 = cljs.core.first(seq31310);
var seq31310__$1 = cljs.core.next(seq31310);
var G__31313 = cljs.core.first(seq31310__$1);
var seq31310__$2 = cljs.core.next(seq31310__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31312,G__31313,seq31310__$2);
}));

posh.plugin_base.transact_BANG_ = (function posh$plugin_base$transact_BANG_(dcfg,poshdb_or_conn,txs){
var G__31325 = (cljs.core.truth_((function (){var fexpr__31327 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31327.cljs$core$IFn$_invoke$arity$1 ? fexpr__31327.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31327.call(null,poshdb_or_conn));
})())?poshdb_or_conn:posh.stateful.poshdb__GT_conn(poshdb_or_conn));
var G__31326 = txs;
var fexpr__31324 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31324.cljs$core$IFn$_invoke$arity$2 ? fexpr__31324.cljs$core$IFn$_invoke$arity$2(G__31325,G__31326) : fexpr__31324.call(null,G__31325,G__31326));
});
