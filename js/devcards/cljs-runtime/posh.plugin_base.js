...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__26327_SHARP_){
return posh.core.add_pull_many(p1__26327_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
