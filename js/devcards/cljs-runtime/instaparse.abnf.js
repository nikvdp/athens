...
var vec__57454 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57454,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57454,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57454,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4582__auto__ = (function instaparse$abnf$iter__57457(s__57458){
...
var n = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57459);
cljs.core.chunk_append(b__57460,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__57521 = (i__57459 + (1));
i__57459 = G__57521;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57460),instaparse$abnf$iter__57457(cljs.core.chunk_rest(s__57458__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57460),null);
}
} else {
var n = cljs.core.first(s__57458__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__57457(cljs.core.rest(s__57458__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq57453){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57453));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$abnf$project_$_iter__57461(s__57462){
return (new cljs.core.LazySeq(null,(function (){
...
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57463);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__57464,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__57522 = (i__57463 + (1));
i__57463 = G__57522;
continue;
} else {
var G__57523 = (i__57463 + (1));
i__57463 = G__57523;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57464),instaparse$abnf$project_$_iter__57461(cljs.core.chunk_rest(s__57462__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57464),null);
}
} else {
var k = cljs.core.first(s__57462__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__57461(cljs.core.rest(s__57462__$2)));
} else {
var G__57524 = cljs.core.rest(s__57462__$2);
s__57462__$1 = G__57524;
continue;
}
}
} else {
...
var G__57525__delegate = function (cs){
var G__57468 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs);
var G__57469 = (2);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2(G__57468,G__57469) : instaparse.abnf.parse_int.call(null,G__57468,G__57469));
};
var G__57525 = function (var_args){
var cs = null;
...
return G__57525__delegate.call(this,cs);};
G__57525.cljs$lang$maxFixedArity = 0;
G__57525.cljs$lang$applyTo = (function (arglist__57527){
var cs = cljs.core.seq(arglist__57527);
return G__57525__delegate(cs);
});
G__57525.cljs$core$IFn$_invoke$arity$variadic = G__57525__delegate;
return G__57525;
})()
,cljs.core.hash_map,(function() { 
var G__57530__delegate = function (rest__57466_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57466_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57466_SHARP_)));
}
};
...
while (G__57531__i < G__57531__a.length) {G__57531__a[G__57531__i] = arguments[G__57531__i + 0]; ++G__57531__i;}
  rest__57466_SHARP_ = new cljs.core.IndexedSeq(G__57531__a,0,null);
} 
return G__57530__delegate.call(this,rest__57466_SHARP_);};
G__57530.cljs$lang$maxFixedArity = 0;
G__57530.cljs$lang$applyTo = (function (arglist__57532){
var rest__57466_SHARP_ = cljs.core.seq(arglist__57532);
return G__57530__delegate(rest__57466_SHARP_);
});
...
var G__57470 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57467_SHARP_);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1(G__57470) : instaparse.abnf.parse_int.call(null,G__57470));
};
...
while (G__57536__i < G__57536__a.length) {G__57536__a[G__57536__i] = arguments[G__57536__i + 0]; ++G__57536__i;}
  rest__57467_SHARP_ = new cljs.core.IndexedSeq(G__57536__a,0,null);
} 
return G__57534__delegate.call(this,rest__57467_SHARP_);};
G__57534.cljs$lang$maxFixedArity = 0;
G__57534.cljs$lang$applyTo = (function (arglist__57538){
var rest__57467_SHARP_ = cljs.core.seq(arglist__57538);
...
G__57539.cljs$lang$applyTo = (function (arglist__57542){
...
var G__57471 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs);
var G__57472 = (16);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2(G__57471,G__57472) : instaparse.abnf.parse_int.call(null,G__57471,G__57472));
};
...
var G__57546 = null;
var G__57546__1 = (function (element){
return element;
});
var G__57546__2 = (function (repeat,element){
...
G__57546 = function(repeat,element){
switch(arguments.length){
case 1:
return G__57546__1.call(this,repeat);
case 2:
return G__57546__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__57546.cljs$core$IFn$_invoke$arity$1 = G__57546__1;
G__57546.cljs$core$IFn$_invoke$arity$2 = G__57546__2;
return G__57546;
})()
,(function() { 
var G__57551__delegate = function (rest__57465_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57465_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57465_SHARP_));
}
};
var G__57551 = function (var_args){
var rest__57465_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57552__i < G__57552__a.length) {G__57552__a[G__57552__i] = arguments[G__57552__i + 0]; ++G__57552__i;}
  rest__57465_SHARP_ = new cljs.core.IndexedSeq(G__57552__a,0,null);
} 
return G__57551__delegate.call(this,rest__57465_SHARP_);};
G__57551.cljs$lang$maxFixedArity = 0;
G__57551.cljs$lang$applyTo = (function (arglist__57553){
var rest__57465_SHARP_ = cljs.core.seq(arglist__57553);
return G__57551__delegate(rest__57465_SHARP_);
});
G__57551.cljs$core$IFn$_invoke$arity$variadic = G__57551__delegate;
return G__57551;
})()
,(function() { 
var G__57554__delegate = function (items){
var G__57478 = cljs.core.count(items);
switch (G__57478) {
case (1):
...
while (G__57557__i < G__57557__a.length) {G__57557__a[G__57557__i] = arguments[G__57557__i + 0]; ++G__57557__i;}
  items = new cljs.core.IndexedSeq(G__57557__a,0,null);
} 
return G__57554__delegate.call(this,items);};
G__57554.cljs$lang$maxFixedArity = 0;
G__57554.cljs$lang$applyTo = (function (arglist__57558){
var items = cljs.core.seq(arglist__57558);
return G__57554__delegate(items);
});
...
G__57559.cljs$lang$applyTo = (function (arglist__57563){
...
(instaparse.abnf.abnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57487){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57490 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57491 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57491);
...
var _STAR_print_newline_STAR__orig_val__57493_57572 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57494_57573 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57495_57574 = true;
var _STAR_print_fn_STAR__temp_val__57496_57575 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57495_57574);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57496_57575);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57494_57573);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57493_57572);
}
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57490);
}}));

(instaparse.abnf.abnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.abnf.abnf.cljs$lang$applyTo = (function (seq57485){
var G__57486 = cljs.core.first(seq57485);
var seq57485__$1 = cljs.core.next(seq57485);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57486,seq57485__$1);
}));
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57506_57578 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57507_57579 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57508_57580 = true;
var _STAR_print_fn_STAR__temp_val__57509_57581 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57508_57580);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57509_57581);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57507_57579);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57506_57578);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
