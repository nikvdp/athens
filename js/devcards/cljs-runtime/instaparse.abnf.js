...
var vec__57458 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57458,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57458,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57458,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4582__auto__ = (function instaparse$abnf$iter__57461(s__57462){
return (new cljs.core.LazySeq(null,(function (){
var s__57462__$1 = s__57462;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57462__$1);
if(temp__5735__auto__){
var s__57462__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57462__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57462__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57464 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57463 = (0);
while(true){
if((i__57463 < size__4581__auto__)){
var n = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57463);
cljs.core.chunk_append(b__57464,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__57525 = (i__57463 + (1));
i__57463 = G__57525;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57464),instaparse$abnf$iter__57461(cljs.core.chunk_rest(s__57462__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57464),null);
}
} else {
var n = cljs.core.first(s__57462__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__57461(cljs.core.rest(s__57462__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$abnf$project_$_iter__57465(s__57466){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__57466__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57468 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57467 = (0);
while(true){
if((i__57467 < size__4581__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57467);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__57468,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__57526 = (i__57467 + (1));
i__57467 = G__57526;
continue;
} else {
var G__57527 = (i__57467 + (1));
i__57467 = G__57527;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57468),instaparse$abnf$project_$_iter__57465(cljs.core.chunk_rest(s__57466__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57468),null);
}
} else {
var k = cljs.core.first(s__57466__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__57465(cljs.core.rest(s__57466__$2)));
} else {
var G__57528 = cljs.core.rest(s__57466__$2);
s__57466__$1 = G__57528;
continue;
}
}
} else {
...
var G__57536__delegate = function (cs){
...
return G__57536__delegate.call(this,cs);};
G__57536.cljs$lang$maxFixedArity = 0;
G__57536.cljs$lang$applyTo = (function (arglist__57541){
var cs = cljs.core.seq(arglist__57541);
return G__57536__delegate(cs);
});
G__57536.cljs$core$IFn$_invoke$arity$variadic = G__57536__delegate;
return G__57536;
})()
,cljs.core.hash_map,(function() { 
var G__57542__delegate = function (rest__57470_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57470_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57470_SHARP_)));
}
};
var G__57542 = function (var_args){
var rest__57470_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57543__i < G__57543__a.length) {G__57543__a[G__57543__i] = arguments[G__57543__i + 0]; ++G__57543__i;}
  rest__57470_SHARP_ = new cljs.core.IndexedSeq(G__57543__a,0,null);
} 
return G__57542__delegate.call(this,rest__57470_SHARP_);};
G__57542.cljs$lang$maxFixedArity = 0;
G__57542.cljs$lang$applyTo = (function (arglist__57544){
var rest__57470_SHARP_ = cljs.core.seq(arglist__57544);
return G__57542__delegate(rest__57470_SHARP_);
});
G__57542.cljs$core$IFn$_invoke$arity$variadic = G__57542__delegate;
return G__57542;
})()
,(function() { 
var G__57545__delegate = function (rest__57476_SHARP_){
var G__57480 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57476_SHARP_);
...
while (G__57546__i < G__57546__a.length) {G__57546__a[G__57546__i] = arguments[G__57546__i + 0]; ++G__57546__i;}
  rest__57476_SHARP_ = new cljs.core.IndexedSeq(G__57546__a,0,null);
} 
return G__57545__delegate.call(this,rest__57476_SHARP_);};
G__57545.cljs$lang$maxFixedArity = 0;
G__57545.cljs$lang$applyTo = (function (arglist__57547){
var rest__57476_SHARP_ = cljs.core.seq(arglist__57547);
return G__57545__delegate(rest__57476_SHARP_);
});
G__57545.cljs$core$IFn$_invoke$arity$variadic = G__57545__delegate;
return G__57545;
})()
,(function() { 
var G__57548__delegate = function (cs){
return instaparse.cfg.string_PLUS_(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs),true);
};
var G__57548 = function (var_args){
var cs = null;
if (arguments.length > 0) {
...
return G__57548__delegate.call(this,cs);};
G__57548.cljs$lang$maxFixedArity = 0;
G__57548.cljs$lang$applyTo = (function (arglist__57550){
var cs = cljs.core.seq(arglist__57550);
return G__57548__delegate(cs);
});
G__57548.cljs$core$IFn$_invoke$arity$variadic = G__57548__delegate;
return G__57548;
})()
...
var G__57555 = null;
var G__57555__1 = (function (element){
return element;
});
var G__57555__2 = (function (repeat,element){
...
G__57555 = function(repeat,element){
switch(arguments.length){
case 1:
return G__57555__1.call(this,repeat);
case 2:
return G__57555__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__57555.cljs$core$IFn$_invoke$arity$1 = G__57555__1;
G__57555.cljs$core$IFn$_invoke$arity$2 = G__57555__2;
return G__57555;
})()
,(function() { 
var G__57561__delegate = function (rest__57469_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57469_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57469_SHARP_));
}
};
var G__57561 = function (var_args){
var rest__57469_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57562__i < G__57562__a.length) {G__57562__a[G__57562__i] = arguments[G__57562__i + 0]; ++G__57562__i;}
  rest__57469_SHARP_ = new cljs.core.IndexedSeq(G__57562__a,0,null);
} 
return G__57561__delegate.call(this,rest__57469_SHARP_);};
G__57561.cljs$lang$maxFixedArity = 0;
G__57561.cljs$lang$applyTo = (function (arglist__57565){
var rest__57469_SHARP_ = cljs.core.seq(arglist__57565);
return G__57561__delegate(rest__57469_SHARP_);
});
...
var G__57487 = cljs.core.count(items);
switch (G__57487) {
case (1):
...
G__57566.cljs$lang$applyTo = (function (arglist__57572){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57500 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57501 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57501);
...
var _STAR_print_newline_STAR__orig_val__57506_57581 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57507_57582 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57508_57583 = true;
var _STAR_print_fn_STAR__temp_val__57509_57584 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57508_57583);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57509_57584);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57507_57582);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57506_57581);
}
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57500);
}}));

(instaparse.abnf.abnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.abnf.abnf.cljs$lang$applyTo = (function (seq57490){
var G__57491 = cljs.core.first(seq57490);
var seq57490__$1 = cljs.core.next(seq57490);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57491,seq57490__$1);
}));
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57511_57588 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57512_57589 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57513_57590 = true;
var _STAR_print_fn_STAR__temp_val__57514_57591 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57513_57590);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57514_57591);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57512_57589);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57511_57588);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
