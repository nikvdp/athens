...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60341){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60342__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60344 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60344 = (function (meta60345){
this.meta60345 = meta60345;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60344.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60346,meta60345__$1){
var self__ = this;
var _60346__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60344(meta60345__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60344.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60346){
var self__ = this;
var _60346__$1 = this;
return self__.meta60345;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60344.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60344.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60344.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60345","meta60345",-256257492,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60344.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60344.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60344");

(athens.devcards.textinput.t_athens$devcards$textinput60344.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60344");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60344.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60344 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60344(meta60345){
return (new athens.devcards.textinput.t_athens$devcards$textinput60344(meta60345));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60344(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60347 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60347 = (function (meta60348){
this.meta60348 = meta60348;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60347.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60349,meta60348__$1){
var self__ = this;
var _60349__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60347(meta60348__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60347.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60349){
var self__ = this;
var _60349__$1 = this;
return self__.meta60348;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60347.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60347.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60347.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60347.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60347.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60347");

(athens.devcards.textinput.t_athens$devcards$textinput60347.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60347");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60347.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60347 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60347(meta60348){
return (new athens.devcards.textinput.t_athens$devcards$textinput60347(meta60348));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60347(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
