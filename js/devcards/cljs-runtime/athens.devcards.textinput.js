...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60391){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60392__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60394 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60394 = (function (meta60395){
this.meta60395 = meta60395;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60394.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60396,meta60395__$1){
var self__ = this;
var _60396__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60394(meta60395__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60394.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60396){
var self__ = this;
var _60396__$1 = this;
return self__.meta60395;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60394.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60394.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41691__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41709__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.textinput.textinput,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"pink"], null)], null);
...
(athens.devcards.textinput.t_athens$devcards$textinput60394.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60395","meta60395",-785130680,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60394.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60394.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60394");

(athens.devcards.textinput.t_athens$devcards$textinput60394.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60394");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60394.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60394 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60394(meta60395){
return (new athens.devcards.textinput.t_athens$devcards$textinput60394(meta60395));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60394(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60397 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60397 = (function (meta60398){
this.meta60398 = meta60398;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60397.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60399,meta60398__$1){
var self__ = this;
var _60399__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60397(meta60398__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60397.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60399){
var self__ = this;
var _60399__$1 = this;
return self__.meta60398;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60397.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60397.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41691__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41709__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.textinput.textinput,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"pink",new cljs.core.Keyword(null,"icon","icon",1679606541),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Face], null)], null)], null);
if(cljs.core.fn_QMARK_(v__41709__auto__)){
return (function (data_atom__41710__auto__,owner__41711__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__41709__auto__,data_atom__41710__auto__,owner__41711__auto__], null));
});
...
(athens.devcards.textinput.t_athens$devcards$textinput60397.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60398","meta60398",-2006270670,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60397.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60397.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60397");

(athens.devcards.textinput.t_athens$devcards$textinput60397.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60397");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60397.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60397 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60397(meta60398){
return (new athens.devcards.textinput.t_athens$devcards$textinput60397(meta60398));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60397(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
