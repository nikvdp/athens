...
var G__58886 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,var_STAR_,tbox_val);
var G__58887 = cljs.core.next(kvs);
ret = G__58886;
kvs = G__58887;
continue;
} else {
...
var G__58893__i = 0, G__58893__a = new Array(arguments.length -  3);
while (G__58893__i < G__58893__a.length) {G__58893__a[G__58893__i] = arguments[G__58893__i + 3]; ++G__58893__i;}
  args = new cljs.core.IndexedSeq(G__58893__a,0,null);
} 
return G__58891__delegate.call(this,x,y,z,args);};
G__58891.cljs$lang$maxFixedArity = 3;
G__58891.cljs$lang$applyTo = (function (arglist__58895){
var x = cljs.core.first(arglist__58895);
arglist__58895 = cljs.core.next(arglist__58895);
var y = cljs.core.first(arglist__58895);
arglist__58895 = cljs.core.next(arglist__58895);
var z = cljs.core.first(arglist__58895);
var args = cljs.core.rest(arglist__58895);
...
var G__58896 = null;
if (arguments.length > 3) {
var G__58897__i = 0, G__58897__a = new Array(arguments.length -  3);
while (G__58897__i < G__58897__a.length) {G__58897__a[G__58897__i] = arguments[G__58897__i + 3]; ++G__58897__i;}
G__58896 = new cljs.core.IndexedSeq(G__58897__a,0,null);
}
return G__58889__4.cljs$core$IFn$_invoke$arity$variadic(x,y,z, G__58896);
}
...
while(true){
if(vvs){
var G__58929 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,cljs.core.first(vvs),null,(1),null)))))),cljs.core.second(vvs));
var G__58930 = cljs.core.next(cljs.core.next(vvs));
ret = G__58929;
vvs = G__58930;
continue;
} else {
