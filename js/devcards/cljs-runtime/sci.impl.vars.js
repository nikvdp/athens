...
var G__58889__i = 0, G__58889__a = new Array(arguments.length -  3);
while (G__58889__i < G__58889__a.length) {G__58889__a[G__58889__i] = arguments[G__58889__i + 3]; ++G__58889__i;}
  args = new cljs.core.IndexedSeq(G__58889__a,0,null);
} 
...
var x = cljs.core.first(arglist__58890);
arglist__58890 = cljs.core.next(arglist__58890);
var y = cljs.core.first(arglist__58890);
arglist__58890 = cljs.core.next(arglist__58890);
var z = cljs.core.first(arglist__58890);
var args = cljs.core.rest(arglist__58890);
...
while(true){
if(vvs){
var G__58938 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,cljs.core.first(vvs),null,(1),null)))))),cljs.core.second(vvs));
var G__58939 = cljs.core.next(cljs.core.next(vvs));
ret = G__58938;
vvs = G__58939;
continue;
} else {
