...
var G__38387 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ch,(n - (1)));
block = G__38387;
continue;
}
break;
...
var G__38392 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__38392;
continue;
}
break;
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__38353_SHARP_){
return (p1__38353_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
