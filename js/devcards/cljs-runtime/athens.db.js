...
var G__32910 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
var G__32911 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__32910;
res = G__32911;
continue;
}
...
return athens.db.get_block(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__32863 = cljs.core.deref(athens.db.dsdb);
var G__32864 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__32863,G__32864) : datascript.core.entity.call(null,G__32863,G__32864));
})()))));
});
athens.db.deepest_child_block = (function athens$db$deepest_child_block(id){
var document = cljs.core.deref((function (){var G__32865 = athens.db.dsdb;
var G__32866 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__32867 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__32865,G__32866,G__32867) : posh.reagent.pull.call(null,G__32865,G__32866,G__32867));
})());
var block = document;
while(true){
...
var G__32918 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ch,(n - (1)));
block = G__32918;
continue;
}
break;
...
var G__32924 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__32924;
continue;
}
break;
...
var G__32926 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__32927 = cljs.core.next(xs__$1);
acc = G__32926;
xs__$1 = G__32927;
continue;
...
return cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__32893_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__32893_SHARP_) : pred.call(null,p1__32893_SHARP_)));
}),xs));
});
athens.db.find_next = (function athens$db$find_next(xs,pred){
return cljs.core.fnext(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__32898_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__32898_SHARP_) : pred.call(null,p1__32898_SHARP_)));
}),xs));
});
...
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32900__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32900__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__32899_SHARP_){
return (p1__32899_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
