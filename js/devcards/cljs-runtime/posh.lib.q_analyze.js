...
var G__26129 = rest_at_QMARK_;
var G__26130 = cljs.core.rest(ls);
rest_at_QMARK_ = G__26129;
ls = G__26130;
continue;
}
break;
...
var G__25761 = cljs.core.rest(eav);
var G__25762 = (n - (1));
var G__25763 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(neweav,cljs.core.first(eav));
var G__25764 = vars;
return (posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4 ? posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4(G__25761,G__25762,G__25763,G__25764) : posh.lib.q_analyze.normalize_eav_helper.call(null,G__25761,G__25762,G__25763,G__25764));
} else {
...
var G__25765 = cljs.core.rest(eav);
var G__25766 = (n - (1));
var G__25767 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(neweav,var$);
var G__25768 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vars,var$);
return (posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4 ? posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4(G__25765,G__25766,G__25767,G__25768) : posh.lib.q_analyze.normalize_eav_helper.call(null,G__25765,G__25766,G__25767,G__25768));
}
}
});
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(where),cljs.core.second(where)], null),(function (){var G__25778 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__25778) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__25778));
})());
} else {
return cljs.core.cons(cljs.core.first(where),(function (){var G__25779 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__25779) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__25779));
})());
}
} else {
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__25788 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25788) : posh.lib.q_analyze.get_eavs.call(null,G__25788));
})(),(function (){var G__25789 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25789) : posh.lib.q_analyze.get_eavs.call(null,G__25789));
})());
} else {
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__25791 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25791) : posh.lib.q_analyze.get_eavs.call(null,G__25791));
})(),(function (){var G__25792 = cljs.core.vec(cljs.core.rest(item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25792) : posh.lib.q_analyze.get_eavs.call(null,G__25792));
})());
}
} else {
if(posh.lib.q_analyze.eav_QMARK_(item)){
return cljs.core.cons(item,(function (){var G__25793 = cljs.core.rest(where);
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25793) : posh.lib.q_analyze.get_eavs.call(null,G__25793));
})());
} else {
if(((cljs.core.vector_QMARK_(item)) && (cljs.core.seq_QMARK_(cljs.core.first(item))))){
var ocr_25797 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.vec(cljs.core.first(item))], null),cljs.core.rest(item)));
try{if(((cljs.core.vector_QMARK_(ocr_25797)) && ((cljs.core.count(ocr_25797) === 2)))){
try{var ocr_25797_0__25801 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797,(0));
if(((cljs.core.vector_QMARK_(ocr_25797_0__25801)) && ((cljs.core.count(ocr_25797_0__25801) === 5)))){
try{var ocr_25797_0__25801_0__25803 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797_0__25801,(0));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(ocr_25797_0__25801_0__25803,new cljs.core.Symbol(null,"get-else","get-else",1312024065,null))){
var db = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797_0__25801,(1));
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797_0__25801,(2));
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797_0__25801,(3));
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_25797,(1));
...
var G__26167 = cljs.core.rest(s__25845__$2);
s__25845__$1 = G__26167;
continue;
}
}
} else {
...
var G__26168 = cljs.core.rest(s__25843__$1);
s__25843__$1 = G__26168;
continue;
}
} else {
return null;
...
var G__26169 = cljs.core.rest(s__25841__$1);
s__25841__$1 = G__26169;
continue;
}
} else {
return null;
...
var G__26256 = var$;
var G__26257 = dbvarmap;
var G__26258 = cljs.core.rest(dbeavs);
var$ = G__26256;
dbvarmap = G__26257;
dbeavs = G__26258;
continue;
...
var G__26259 = (n + (1));
var G__26260 = cljs.core.rest(xs__$1);
n = G__26259;
xs__$1 = G__26260;
continue;
...
var G__26261 = cljs.core.first(remaining);
var G__26262 = cljs.core.rest(remaining);
clause = G__26261;
remaining = G__26262;
continue;
} else {
...
if(cljs.core.seq(remaining)){
var G__26263 = cljs.core.first(remaining);
var G__26264 = cljs.core.rest(remaining);
clause = G__26263;
remaining = G__26264;
continue;
} else {
