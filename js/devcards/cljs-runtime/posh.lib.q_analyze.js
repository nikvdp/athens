...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(where),cljs.core.second(where)], null),(function (){var G__25771 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__25771) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__25771));
})());
} else {
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__25783 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25783) : posh.lib.q_analyze.get_eavs.call(null,G__25783));
})(),(function (){var G__25784 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__25784) : posh.lib.q_analyze.get_eavs.call(null,G__25784));
})());
} else {
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__25785 = cljs.core.vec(cljs.core.rest(where));
...
})(),(function (){var G__25789 = cljs.core.vec(cljs.core.rest(item));
...
return cljs.core.cons(item,(function (){var G__25792 = cljs.core.rest(where);
...
var G__26258 = (n + (1));
var G__26259 = cljs.core.rest(xs__$1);
n = G__26258;
xs__$1 = G__26259;
continue;
...
var G__26260 = cljs.core.first(remaining);
var G__26261 = cljs.core.rest(remaining);
clause = G__26260;
remaining = G__26261;
continue;
} else {
...
if(cljs.core.seq(remaining)){
var G__26262 = cljs.core.first(remaining);
var G__26263 = cljs.core.rest(remaining);
clause = G__26262;
remaining = G__26263;
continue;
} else {
