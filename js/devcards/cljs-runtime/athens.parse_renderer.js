...
var G__58345 = athens.db.dsdb;
var G__58346 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58347 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),["",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(typeof el === 'string'){
return el;
} else {
...
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58345,G__58346,G__58347) : posh.reagent.pull.call(null,G__58345,G__58346,G__58347));
});
/**
...
var G__58364__delegate = function (contents){
...
while (G__58365__i < G__58365__a.length) {G__58365__a[G__58365__i] = arguments[G__58365__i + 0]; ++G__58365__i;}
  contents = new cljs.core.IndexedSeq(G__58365__a,0,null);
} 
return G__58364__delegate.call(this,contents);};
G__58364.cljs$lang$maxFixedArity = 0;
G__58364.cljs$lang$applyTo = (function (arglist__58366){
var contents = cljs.core.seq(arglist__58366);
return G__58364__delegate(contents);
});
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58351__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58351__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
var G__58367__delegate = function (contents){
...
while (G__58368__i < G__58368__a.length) {G__58368__a[G__58368__i] = arguments[G__58368__i + 0]; ++G__58368__i;}
  contents = new cljs.core.IndexedSeq(G__58368__a,0,null);
} 
return G__58367__delegate.call(this,contents);};
G__58367.cljs$lang$maxFixedArity = 0;
G__58367.cljs$lang$applyTo = (function (arglist__58369){
var contents = cljs.core.seq(arglist__58369);
return G__58367__delegate(contents);
});
G__58367.cljs$core$IFn$_invoke$arity$variadic = G__58367__delegate;
return G__58367;
})()
,(function() { 
var G__58370__delegate = function (title){
return athens.parse_renderer.render_page_link(title);
};
var G__58370 = function (var_args){
var title = null;
if (arguments.length > 0) {
var G__58371__i = 0, G__58371__a = new Array(arguments.length -  0);
while (G__58371__i < G__58371__a.length) {G__58371__a[G__58371__i] = arguments[G__58371__i + 0]; ++G__58371__i;}
  title = new cljs.core.IndexedSeq(G__58371__a,0,null);
} 
return G__58370__delegate.call(this,title);};
G__58370.cljs$lang$maxFixedArity = 0;
G__58370.cljs$lang$applyTo = (function (arglist__58372){
var title = cljs.core.seq(arglist__58372);
return G__58370__delegate(title);
});
...
var block = (function (){var G__58353 = athens.db.dsdb;
...
var G__58355 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid__$1], null);
...
})], null),(function (){var G__58356 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
var G__58357 = uid__$1;
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2(G__58356,G__58357) : athens.parse_renderer.parse_and_render.call(null,G__58356,G__58357));
})()], null)], null);
}),(function() { 
var G__58376__delegate = function (tag_name){
var parsed_name = cljs.core.concat.cljs$core$IFn$_invoke$arity$1(tag_name);
var node = (function (){var G__58358 = athens.db.dsdb;
var G__58359 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58360 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),parsed_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58358,G__58359,G__58360) : posh.reagent.pull.call(null,G__58358,G__58359,G__58360));
})();
...
var G__58376 = function (var_args){
var tag_name = null;
if (arguments.length > 0) {
var G__58383__i = 0, G__58383__a = new Array(arguments.length -  0);
while (G__58383__i < G__58383__a.length) {G__58383__a[G__58383__i] = arguments[G__58383__i + 0]; ++G__58383__i;}
  tag_name = new cljs.core.IndexedSeq(G__58383__a,0,null);
} 
return G__58376__delegate.call(this,tag_name);};
G__58376.cljs$lang$maxFixedArity = 0;
G__58376.cljs$lang$applyTo = (function (arglist__58385){
var tag_name = cljs.core.seq(arglist__58385);
return G__58376__delegate(tag_name);
});
G__58376.cljs$core$IFn$_invoke$arity$variadic = G__58376__delegate;
return G__58376;
})()
,(function (p__58361,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58362__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__58349 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58348,G__58349) : instaparse.core.transform.call(null,G__58348,G__58349));
});
/**
