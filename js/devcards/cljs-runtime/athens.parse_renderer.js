...
var G__56992__delegate = function (contents){
...
while (G__56993__i < G__56993__a.length) {G__56993__a[G__56993__i] = arguments[G__56993__i + 0]; ++G__56993__i;}
  contents = new cljs.core.IndexedSeq(G__56993__a,0,null);
} 
return G__56992__delegate.call(this,contents);};
G__56992.cljs$lang$maxFixedArity = 0;
G__56992.cljs$lang$applyTo = (function (arglist__56994){
var contents = cljs.core.seq(arglist__56994);
return G__56992__delegate(contents);
});
...
var map__56985__$1 = (((((!((map__56985 == null))))?(((((map__56985.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56985.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56985):map__56985);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56985__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56985__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
var G__56995__delegate = function (contents){
return athens.components.render_component(cljs.core.first(contents),uid);
};
var G__56995 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__56996__i = 0, G__56996__a = new Array(arguments.length -  0);
while (G__56996__i < G__56996__a.length) {G__56996__a[G__56996__i] = arguments[G__56996__i + 0]; ++G__56996__i;}
  contents = new cljs.core.IndexedSeq(G__56996__a,0,null);
} 
return G__56995__delegate.call(this,contents);};
G__56995.cljs$lang$maxFixedArity = 0;
G__56995.cljs$lang$applyTo = (function (arglist__56997){
var contents = cljs.core.seq(arglist__56997);
return G__56995__delegate(contents);
});
G__56995.cljs$core$IFn$_invoke$arity$variadic = G__56995__delegate;
return G__56995;
})()
,(function() { 
var G__56998__delegate = function (title){
return athens.parse_renderer.render_page_link(title);
};
var G__56998 = function (var_args){
var title = null;
if (arguments.length > 0) {
var G__56999__i = 0, G__56999__a = new Array(arguments.length -  0);
while (G__56999__i < G__56999__a.length) {G__56999__a[G__56999__i] = arguments[G__56999__i + 0]; ++G__56999__i;}
  title = new cljs.core.IndexedSeq(G__56999__a,0,null);
} 
return G__56998__delegate.call(this,title);};
G__56998.cljs$lang$maxFixedArity = 0;
G__56998.cljs$lang$applyTo = (function (arglist__57000){
var title = cljs.core.seq(arglist__57000);
return G__56998__delegate(title);
});
G__56998.cljs$core$IFn$_invoke$arity$variadic = G__56998__delegate;
return G__56998;
})()
,(function (text){
...
})], null),(function (){var G__56987 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
var G__56988 = uid__$1;
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2(G__56987,G__56988) : athens.parse_renderer.parse_and_render.call(null,G__56987,G__56988));
})()], null)], null);
}),(function() { 
var G__57001__delegate = function (tag_name){
...
while (G__57002__i < G__57002__a.length) {G__57002__a[G__57002__i] = arguments[G__57002__i + 0]; ++G__57002__i;}
  tag_name = new cljs.core.IndexedSeq(G__57002__a,0,null);
} 
return G__57001__delegate.call(this,tag_name);};
G__57001.cljs$lang$maxFixedArity = 0;
G__57001.cljs$lang$applyTo = (function (arglist__57004){
var tag_name = cljs.core.seq(arglist__57004);
return G__57001__delegate(tag_name);
});
G__57001.cljs$core$IFn$_invoke$arity$variadic = G__57001__delegate;
return G__57001;
})()
,(function (p__56989,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56990__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__56983 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__56982,G__56983) : instaparse.core.transform.call(null,G__56982,G__56983));
});
/**
