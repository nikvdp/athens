...
var G__58341 = athens.db.dsdb;
var G__58342 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58343 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),["",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(typeof el === 'string'){
return el;
} else {
...
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58341,G__58342,G__58343) : posh.reagent.pull.call(null,G__58341,G__58342,G__58343));
});
/**
...
var G__58360__delegate = function (contents){
...
while (G__58361__i < G__58361__a.length) {G__58361__a[G__58361__i] = arguments[G__58361__i + 0]; ++G__58361__i;}
  contents = new cljs.core.IndexedSeq(G__58361__a,0,null);
} 
return G__58360__delegate.call(this,contents);};
G__58360.cljs$lang$maxFixedArity = 0;
G__58360.cljs$lang$applyTo = (function (arglist__58362){
var contents = cljs.core.seq(arglist__58362);
return G__58360__delegate(contents);
});
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58347__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58347__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
var G__58363__delegate = function (contents){
return athens.components.render_component(cljs.core.first(contents),uid);
};
var G__58363 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__58364__i = 0, G__58364__a = new Array(arguments.length -  0);
while (G__58364__i < G__58364__a.length) {G__58364__a[G__58364__i] = arguments[G__58364__i + 0]; ++G__58364__i;}
  contents = new cljs.core.IndexedSeq(G__58364__a,0,null);
} 
return G__58363__delegate.call(this,contents);};
G__58363.cljs$lang$maxFixedArity = 0;
G__58363.cljs$lang$applyTo = (function (arglist__58365){
var contents = cljs.core.seq(arglist__58365);
return G__58363__delegate(contents);
});
G__58363.cljs$core$IFn$_invoke$arity$variadic = G__58363__delegate;
return G__58363;
})()
,(function() { 
var G__58366__delegate = function (title){
return athens.parse_renderer.render_page_link(title);
};
var G__58366 = function (var_args){
var title = null;
if (arguments.length > 0) {
var G__58367__i = 0, G__58367__a = new Array(arguments.length -  0);
while (G__58367__i < G__58367__a.length) {G__58367__a[G__58367__i] = arguments[G__58367__i + 0]; ++G__58367__i;}
  title = new cljs.core.IndexedSeq(G__58367__a,0,null);
} 
return G__58366__delegate.call(this,title);};
G__58366.cljs$lang$maxFixedArity = 0;
G__58366.cljs$lang$applyTo = (function (arglist__58368){
var title = cljs.core.seq(arglist__58368);
return G__58366__delegate(title);
});
...
var block = (function (){var G__58349 = athens.db.dsdb;
var G__58350 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58351 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid__$1], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58349,G__58350,G__58351) : posh.reagent.pull.call(null,G__58349,G__58350,G__58351));
})();
...
})], null),(function (){var G__58352 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
var G__58353 = uid__$1;
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$2(G__58352,G__58353) : athens.parse_renderer.parse_and_render.call(null,G__58352,G__58353));
})()], null)], null);
}),(function (tag_name){
var node = (function (){var G__58354 = athens.db.dsdb;
var G__58355 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58356 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58354,G__58355,G__58356) : posh.reagent.pull.call(null,G__58354,G__58355,G__58356));
})();
...
}),(function (p__58357,text){
var map__58358 = p__58357;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58358__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__58345 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58344,G__58345) : instaparse.core.transform.call(null,G__58344,G__58345));
});
/**
