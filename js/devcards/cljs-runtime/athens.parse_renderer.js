...
var node = (function (){var G__57994 = athens.db.dsdb;
var G__57995 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57996 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),["",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(typeof el === 'string'){
return el;
} else {
...
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57994,G__57995,G__57996) : posh.reagent.pull.call(null,G__57994,G__57995,G__57996));
})();
...
var G__57997 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__58024__delegate = function (contents){
...
var G__58025__i = 0, G__58025__a = new Array(arguments.length -  0);
while (G__58025__i < G__58025__a.length) {G__58025__a[G__58025__i] = arguments[G__58025__i + 0]; ++G__58025__i;}
  contents = new cljs.core.IndexedSeq(G__58025__a,0,null);
} 
return G__58024__delegate.call(this,contents);};
G__58024.cljs$lang$maxFixedArity = 0;
G__58024.cljs$lang$applyTo = (function (arglist__58026){
var contents = cljs.core.seq(arglist__58026);
return G__58024__delegate(contents);
});
...
var G__58027__delegate = function (title){
return athens.parse_renderer.render_page_link(title);
};
var G__58027 = function (var_args){
var title = null;
if (arguments.length > 0) {
var G__58028__i = 0, G__58028__a = new Array(arguments.length -  0);
while (G__58028__i < G__58028__a.length) {G__58028__a[G__58028__i] = arguments[G__58028__i + 0]; ++G__58028__i;}
  title = new cljs.core.IndexedSeq(G__58028__a,0,null);
} 
return G__58027__delegate.call(this,title);};
G__58027.cljs$lang$maxFixedArity = 0;
G__58027.cljs$lang$applyTo = (function (arglist__58029){
var title = cljs.core.seq(arglist__58029);
return G__58027__delegate(title);
});
...
var block = (function (){var G__57999 = athens.db.dsdb;
var G__58000 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58001 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57999,G__58000,G__58001) : posh.reagent.pull.call(null,G__57999,G__58000,G__58001));
})();
...
})], null),(function (){var G__58002 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__58002) : athens.parse_renderer.parse_and_render.call(null,G__58002));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__58003 = athens.db.dsdb;
var G__58004 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58005 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58003,G__58004,G__58005) : posh.reagent.pull.call(null,G__58003,G__58004,G__58005));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__58006){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58007__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58007__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__58009,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58010__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57998 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57997,G__57998) : instaparse.core.transform.call(null,G__57997,G__57998));
});
/**
