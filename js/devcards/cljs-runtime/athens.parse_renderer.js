...
var G__57928 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57946__delegate = function (contents){
...
while (G__57947__i < G__57947__a.length) {G__57947__a[G__57947__i] = arguments[G__57947__i + 0]; ++G__57947__i;}
  contents = new cljs.core.IndexedSeq(G__57947__a,0,null);
} 
return G__57946__delegate.call(this,contents);};
G__57946.cljs$lang$maxFixedArity = 0;
G__57946.cljs$lang$applyTo = (function (arglist__57948){
var contents = cljs.core.seq(arglist__57948);
return G__57946__delegate(contents);
});
...
var node = (function (){var G__57930 = athens.db.dsdb;
var G__57931 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57932 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57930,G__57931,G__57932) : posh.reagent.pull.call(null,G__57930,G__57931,G__57932));
})();
...
var block = (function (){var G__57933 = athens.db.dsdb;
...
var G__57935 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
...
})], null),(function (){var G__57936 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57936) : athens.parse_renderer.parse_and_render.call(null,G__57936));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57937 = athens.db.dsdb;
var G__57938 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57939 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57937,G__57938,G__57939) : posh.reagent.pull.call(null,G__57937,G__57938,G__57939));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57940){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57941__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57941__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57943,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57944__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57929 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57928,G__57929) : instaparse.core.transform.call(null,G__57928,G__57929));
});
/**
