 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__39846){
var vec__39847 = p__39846;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39847,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39847,(1),null);
return (function (s){
...
var G__39866 = (i__4790__auto___39864 + (1));
i__4790__auto___39864 = G__39866;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__39851_SHARP_){
return (p1__39851_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__39851_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__39851_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq39854){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39854));
}));
...
var map__39859 = temp__5733__auto__;
var map__39859__$1 = (((((!((map__39859 == null))))?(((((map__39859.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39859.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__39859):map__39859);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39859__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39859__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39859__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__39867 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__39868 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__39862 = tag;
var G__39862__$1 = (((G__39862 instanceof cljs.core.Keyword))?G__39862.fqn:null);
switch (G__39862__$1) {
case "string":
return chunk;
