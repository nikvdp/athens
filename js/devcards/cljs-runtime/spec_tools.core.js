...
var G__48478 = (i__4790__auto___48476 + (1));
i__4790__auto___48476 = G__48478;
continue;
} else {
}
break;
...
var G__48553 = cljs.spec.alpha.get_spec(x);
x = G__48553;
continue;
} else {
...
var G__48558 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48558;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48598 = cljs.spec.alpha.get_spec(x);
x = G__48598;
continue;
} else {
