...
var G__48543 = cljs.spec.alpha.get_spec(x);
x = G__48543;
continue;
} else {
...
var G__48544 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48544;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48566 = cljs.spec.alpha.get_spec(x);
x = G__48566;
continue;
} else {
