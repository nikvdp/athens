...
var G__48318 = cljs.spec.alpha.get_spec(x);
x = G__48318;
continue;
} else {
...
var G__48320 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48320;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48360 = cljs.spec.alpha.get_spec(x);
x = G__48360;
continue;
} else {
