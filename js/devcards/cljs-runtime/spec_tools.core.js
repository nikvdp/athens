...
var G__53650 = (i__4790__auto___53646 + (1));
i__4790__auto___53646 = G__53650;
continue;
} else {
}
break;
...
var G__53716 = cljs.spec.alpha.get_spec(x);
x = G__53716;
continue;
} else {
...
var G__53720 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__53720;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__53754 = cljs.spec.alpha.get_spec(x);
x = G__53754;
continue;
} else {
