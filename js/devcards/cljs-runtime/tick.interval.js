...
var G__51305_51678 = tick.interval.temporal_value;
var G__51306_51679 = "string";
var G__51307_51680 = (function (s){
return tick.interval.temporal_value(tick.core.parse(s));
});
goog.object.set(G__51305_51678,G__51306_51679,G__51307_51680);

goog.object.set(tick.interval.ITimeSpanable,"function",true);

var G__51308_51681 = tick.interval.temporal_value;
var G__51309_51682 = "function";
var G__51310_51683 = (function (f){
return tick.interval.temporal_value((f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null)));
});
goog.object.set(G__51308_51681,G__51309_51682,G__51310_51683);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__51331){
var vec__51332 = p__51331;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51332,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51332,(1),null);
...
cljs.spec.alpha.assert_STAR_(r,(function (p1__51378_SHARP_){
return (p1__51378_SHARP_ instanceof tick.interval.GeneralRelation);
}));
} else {
}
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(this$__$1,new cljs.core.Keyword("tick","intervals","tick/intervals",2091945314),cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__51460_SHARP_){
return tick.interval.slice(p1__51460_SHARP_,beginning,end);
}),intervals)));
} else {
...
var fexpr__51498 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.meets_QMARK_,tick.interval.precedes_QMARK_]);
...
var x__$1 = this;
var G__51502 = (tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2 ? tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2(x__$1,y) : tick.interval.basic_relation.call(null,x__$1,y));
var fexpr__51501 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.starts_QMARK_,tick.interval.overlaps_QMARK_,tick.interval.equals_QMARK_,tick.interval.meets_QMARK_,tick.interval.finished_by_QMARK_,tick.interval.precedes_QMARK_]);
return (fexpr__51501.cljs$core$IFn$_invoke$arity$1 ? fexpr__51501.cljs$core$IFn$_invoke$arity$1(G__51502) : fexpr__51501.call(null,G__51502));
}));
...
var fexpr__51503 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_]);
...
var x__$1 = this;
var G__51507 = (tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2 ? tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2(x__$1,y) : tick.interval.basic_relation.call(null,x__$1,y));
var fexpr__51506 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.started_by_QMARK_,tick.interval.equals_QMARK_,tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_,tick.interval.overlapped_by_QMARK_,tick.interval.finishes_QMARK_]);
return (fexpr__51506.cljs$core$IFn$_invoke$arity$1 ? fexpr__51506.cljs$core$IFn$_invoke$arity$1(G__51507) : fexpr__51506.call(null,G__51507));
}));
/**
...
return (!(((function (){var G__51513 = s;
var vec__51514 = G__51513;
...
var x = first__51516;
var xs = seq__51515__$1;
var G__51513__$1 = G__51513;
while(true){
var vec__51517 = G__51513__$1;
...
var x__$1 = first__51519;
var xs__$1 = seq__51518__$1;
if((((x__$1 == null)) || ((cljs.core.first(xs__$1) == null)))){
return true;
} else {
if(cljs.core.truth_((function (){var G__51521 = x__$1;
var G__51522 = cljs.core.first(xs__$1);
return (rel.cljs$core$IFn$_invoke$arity$2 ? rel.cljs$core$IFn$_invoke$arity$2(G__51521,G__51522) : rel.call(null,G__51521,G__51522));
})())){
var G__51738 = xs__$1;
G__51513__$1 = G__51738;
continue;
} else {
return null;
}
...
var vec__51524 = s;
var initial = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51524,(0),null);
var subsequent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51524,(1),null);
...
var G__51536 = tick.interval.relation(ival1,ival2);
...
var G__51570 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51570__$1)].join('')));
...
/** @this {Function} */
(tick.interval.intersection.cljs$lang$applyTo = (function (seq51565){
var G__51566 = cljs.core.first(seq51565);
var seq51565__$1 = cljs.core.next(seq51565);
var G__51567 = cljs.core.first(seq51565__$1);
var seq51565__$2 = cljs.core.next(seq51565__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51566,G__51567,seq51565__$2);
}));
...
/** @this {Function} */
(tick.interval.difference.cljs$lang$applyTo = (function (seq51573){
var G__51574 = cljs.core.first(seq51573);
var seq51573__$1 = cljs.core.next(seq51573);
var G__51575 = cljs.core.first(seq51573__$1);
var seq51573__$2 = cljs.core.next(seq51573__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51574,G__51575,seq51573__$2);
}));
...
var G__51605 = r;
var G__51605__$1 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(tick.core.beginning(cljs.core.first(coll)),tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll)))))?(function (){var fexpr__51606 = (function (p1__51599_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll))),tick.core.beginning(cljs.core.first(coll)))], null),p1__51599_SHARP_);
});
...
var fexpr__51607 = (function (p1__51600_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__51600_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.end(cljs.core.last(coll)),tick.core.max_of_type(tick.core.end(cljs.core.last(coll))))], null));
});
...
var x = cljs.core.first(xs);
var y = cljs.core.first(ys);
var G__51615 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51615__$1)].join('')));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,(function (p1__51627_SHARP_){
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__51627_SHARP_,dur),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
...
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__51628_SHARP_,period),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
...
var G__51636_51765 = tick.interval.divide_interval;
var G__51637_51766 = "function";
var G__51638_51767 = (function (f,ival){
return tick.interval.divide_by_apply(ival,f);
});
goog.object.set(G__51636_51765,G__51637_51766,G__51638_51767);
...
var G__51639_51768 = tick.interval.divide_interval;
var G__51640_51769 = "number";
var G__51641_51770 = (function (divisor,ival){
return tick.interval.divide_by_divisor(ival,divisor);
});
goog.object.set(G__51639_51768,G__51640_51769,G__51641_51770);
...
var G__51670_51812 = tick.interval.group_by;
var G__51671_51813 = "function";
var G__51672_51814 = (function (f,ivals){
if(cljs.core.empty_QMARK_(ivals)){
return cljs.core.PersistentArrayMap.EMPTY;
} else {
var r = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(tick.interval.bounds,ivals);
var b = (function (){var G__51673 = tick.core.beginning(r);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__51673) : f.call(null,G__51673));
})();
var e = (function (){var G__51675 = tick.core.end(r);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__51675) : f.call(null,G__51675));
})();
var groups = tick.core.range.cljs$core$IFn$_invoke$arity$2(b,tick.core.inc(e));
return tick.interval.group_by(groups,ivals);
}
});
goog.object.set(G__51670_51812,G__51671_51813,G__51672_51814);
