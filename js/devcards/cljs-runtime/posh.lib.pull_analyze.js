...
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29371_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__29371_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__29371_SHARP_)));
}),entity_keys);
...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__29376_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__29376_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__29376_SHARP_,refs_only_QMARK_));
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__29421,pull_pattern,ent_id){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29422__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29422__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29422__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__29431 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29431.cljs$core$IFn$_invoke$arity$2 ? fexpr__29431.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__29431.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__29443,pull_pattern,ent_ids){
var map__29444 = p__29443;
var map__29444__$1 = (((((!((map__29444 == null))))?(((((map__29444.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29444.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29444):map__29444);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29444__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29444__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29444__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__29457 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29457.cljs$core$IFn$_invoke$arity$2 ? fexpr__29457.cljs$core$IFn$_invoke$arity$2(db,p1__29433_SHARP_) : fexpr__29457.call(null,db,p1__29433_SHARP_));
}),ent_ids);
