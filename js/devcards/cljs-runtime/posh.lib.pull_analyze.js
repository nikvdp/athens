...
var G__24307 = cljs.core.first(x);
var fexpr__24306 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"limit","limit",284709164,null),null,"limit",null], null), null);
return (fexpr__24306.cljs$core$IFn$_invoke$arity$1 ? fexpr__24306.cljs$core$IFn$_invoke$arity$1(G__24307) : fexpr__24306.call(null,G__24307));
} else {
return false;
}
});
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__24332,pull_pattern,ent_id){
var map__24334 = p__24332;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24334__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24334__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24334__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__24338 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24338.cljs$core$IFn$_invoke$arity$2 ? fexpr__24338.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__24338.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__24361,pull_pattern,ent_ids){
var map__24364 = p__24361;
...
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24364__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24364__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_(retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24351_SHARP_){
var fexpr__24373 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24373.cljs$core$IFn$_invoke$arity$2 ? fexpr__24373.cljs$core$IFn$_invoke$arity$2(db,p1__24351_SHARP_) : fexpr__24373.call(null,db,p1__24351_SHARP_));
}),ent_ids);
