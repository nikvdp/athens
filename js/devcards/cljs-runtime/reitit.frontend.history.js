...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k54634,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k54634,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__54639){
var vec__54640 = p__54639;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54640,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54640,(1),null);
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__54633){
var self__ = this;
var G__54633__$1 = this;
return (new cljs.core.RecordIter((0),G__54633__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this54635,other54636){
var self__ = this;
var this54635__$1 = this;
return (((!((other54636 == null)))) && ((this54635__$1.constructor === other54636.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.on_navigate,other54636.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.router,other54636.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.popstate_listener,other54636.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.hashchange_listener,other54636.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.last_fragment,other54636.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54635__$1.__extmap,other54636.__extmap)));
}));
...
var G__54645 = reitit.frontend.match_by_path(self__.router,path);
var G__54646 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__54645,G__54646) : self__.on_navigate.call(null,G__54645,G__54646));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__54633){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__54647 = cljs.core.keyword_identical_QMARK_;
var expr__54648 = k__4388__auto__;
if(cljs.core.truth_((pred__54647.cljs$core$IFn$_invoke$arity$2 ? pred__54647.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54648) : pred__54647.call(null,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54648)))){
return (new reitit.frontend.history.FragmentHistory(G__54633,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54647.cljs$core$IFn$_invoke$arity$2 ? pred__54647.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"router","router",1091916230),expr__54648) : pred__54647.call(null,new cljs.core.Keyword(null,"router","router",1091916230),expr__54648)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__54633,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54647.cljs$core$IFn$_invoke$arity$2 ? pred__54647.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__54648) : pred__54647.call(null,new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__54648)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__54633,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54647.cljs$core$IFn$_invoke$arity$2 ? pred__54647.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__54648) : pred__54647.call(null,new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__54648)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__54633,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54647.cljs$core$IFn$_invoke$arity$2 ? pred__54647.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__54648) : pred__54647.call(null,new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__54648)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__54633,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__54633),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__54633){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__54633,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__54637){
var extmap__4419__auto__ = (function (){var G__54650 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__54637,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__54637)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__54650);
} else {
return G__54650;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__54637),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__54637),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__54637),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__54637),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__54637),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__54700 = el__$1.parentNode;
el__$1 = G__54700;
continue;
}
} else {
...
(reitit.frontend.history.Html5History.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k54659,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__54663 = k54659;
var G__54663__$1 = (((G__54663 instanceof cljs.core.Keyword))?G__54663.fqn:null);
switch (G__54663__$1) {
case "on-navigate":
return self__.on_navigate;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k54659,else__4383__auto__);
...
var self__ = this;
var this__4399__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__54664){
var vec__54665 = p__54664;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54665,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54665,(1),null);
return (f__4400__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4400__auto__.cljs$core$IFn$_invoke$arity$3(ret__4402__auto__,k__4403__auto__,v__4404__auto__) : f__4400__auto__.call(null,ret__4402__auto__,k__4403__auto__,v__4404__auto__));
}),init__4401__auto__,this__4399__auto____$1);
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__54658){
var self__ = this;
var G__54658__$1 = this;
return (new cljs.core.RecordIter((0),G__54658__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"listen-key","listen-key",51973686),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this54660,other54661){
var self__ = this;
var this54660__$1 = this;
return (((!((other54661 == null)))) && ((this54660__$1.constructor === other54661.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54660__$1.on_navigate,other54661.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54660__$1.router,other54661.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54660__$1.listen_key,other54661.listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54660__$1.click_listen_key,other54661.click_listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54660__$1.__extmap,other54661.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__54668 = reitit.frontend.match_by_path(self__.router,path);
var G__54669 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__54668,G__54669) : self__.on_navigate.call(null,G__54668,G__54669));
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__54658){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__54670 = cljs.core.keyword_identical_QMARK_;
var expr__54671 = k__4388__auto__;
if(cljs.core.truth_((pred__54670.cljs$core$IFn$_invoke$arity$2 ? pred__54670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54671) : pred__54670.call(null,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54671)))){
return (new reitit.frontend.history.Html5History(G__54658,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54670.cljs$core$IFn$_invoke$arity$2 ? pred__54670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"router","router",1091916230),expr__54671) : pred__54670.call(null,new cljs.core.Keyword(null,"router","router",1091916230),expr__54671)))){
return (new reitit.frontend.history.Html5History(self__.on_navigate,G__54658,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54670.cljs$core$IFn$_invoke$arity$2 ? pred__54670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"listen-key","listen-key",51973686),expr__54671) : pred__54670.call(null,new cljs.core.Keyword(null,"listen-key","listen-key",51973686),expr__54671)))){
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,G__54658,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54670.cljs$core$IFn$_invoke$arity$2 ? pred__54670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955),expr__54671) : pred__54670.call(null,new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955),expr__54671)))){
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,G__54658,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__54658),null));
}
}
}
}
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__54658){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,G__54658,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_Html5History = (function reitit$frontend$history$map__GT_Html5History(G__54662){
var extmap__4419__auto__ = (function (){var G__54673 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__54662,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"listen-key","listen-key",51973686),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955)], 0));
if(cljs.core.record_QMARK_(G__54662)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__54673);
} else {
return G__54673;
}
})();
return (new reitit.frontend.history.Html5History(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__54662),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__54662),new cljs.core.Keyword(null,"listen-key","listen-key",51973686).cljs$core$IFn$_invoke$arity$1(G__54662),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955).cljs$core$IFn$_invoke$arity$1(G__54662),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(reitit.frontend.history.start_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (router,on_navigate,p__54676){
var map__54677 = p__54676;
var map__54677__$1 = (((((!((map__54677 == null))))?(((((map__54677.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54677.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54677):map__54677);
var opts = map__54677__$1;
var use_fragment = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__54677__$1,new cljs.core.Keyword(null,"use-fragment","use-fragment",-1617737154),true);
