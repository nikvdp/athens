...
var reitit$frontend$history$History$_get_path$dyn_54688 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return reitit$frontend$history$History$_get_path$dyn_54688(this$);
}
});

var reitit$frontend$history$History$_href$dyn_54690 = (function (this$,path){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return reitit$frontend$history$History$_href$dyn_54690(this$,path);
}
});
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k54633,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k54633,else__4383__auto__);
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__54632){
var self__ = this;
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this54634,other54635){
var self__ = this;
var this54634__$1 = this;
return (((!((other54635 == null)))) && ((this54634__$1.constructor === other54635.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.on_navigate,other54635.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.router,other54635.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.popstate_listener,other54635.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.hashchange_listener,other54635.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.last_fragment,other54635.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54634__$1.__extmap,other54635.__extmap)));
}));
...
var G__54644 = reitit.frontend.match_by_path(self__.router,path);
var G__54645 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__54644,G__54645) : self__.on_navigate.call(null,G__54644,G__54645));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__54632){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__54646 = cljs.core.keyword_identical_QMARK_;
var expr__54647 = k__4388__auto__;
if(cljs.core.truth_((pred__54646.cljs$core$IFn$_invoke$arity$2 ? pred__54646.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54647) : pred__54646.call(null,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__54647)))){
return (new reitit.frontend.history.FragmentHistory(G__54632,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54646.cljs$core$IFn$_invoke$arity$2 ? pred__54646.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"router","router",1091916230),expr__54647) : pred__54646.call(null,new cljs.core.Keyword(null,"router","router",1091916230),expr__54647)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__54632,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54646.cljs$core$IFn$_invoke$arity$2 ? pred__54646.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__54647) : pred__54646.call(null,new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),expr__54647)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__54632,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54646.cljs$core$IFn$_invoke$arity$2 ? pred__54646.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__54647) : pred__54646.call(null,new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),expr__54647)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__54632,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__54646.cljs$core$IFn$_invoke$arity$2 ? pred__54646.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__54647) : pred__54646.call(null,new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173),expr__54647)))){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__54632,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__54632),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__54632){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__54632,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__54636){
var extmap__4419__auto__ = (function (){var G__54649 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__54636,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__54636)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__54649);
} else {
return G__54649;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__54636),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__54636),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__54636),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__54636),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__54636),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(reitit.frontend.history.Html5History.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k54653,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__54663 = k54653;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k54653,else__4383__auto__);
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__54652){
var self__ = this;
var G__54652__$1 = this;
return (new cljs.core.RecordIter((0),G__54652__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"listen-key","listen-key",51973686),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this54654,other54655){
var self__ = this;
var this54654__$1 = this;
return (((!((other54655 == null)))) && ((this54654__$1.constructor === other54655.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54654__$1.on_navigate,other54655.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54654__$1.router,other54655.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54654__$1.listen_key,other54655.listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54654__$1.click_listen_key,other54655.click_listen_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this54654__$1.__extmap,other54655.__extmap)));
}));
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__54652){
var self__ = this;
var this__4387__auto____$1 = this;
...
return (new reitit.frontend.history.Html5History(G__54652,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,G__54652,self__.listen_key,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,G__54652,self__.click_listen_key,self__.__meta,self__.__extmap,null));
} else {
...
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,G__54652,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__54652),null));
}
}
}
}
...
(reitit.frontend.history.Html5History.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__54652){
var self__ = this;
var this__4379__auto____$1 = this;
return (new reitit.frontend.history.Html5History(self__.on_navigate,self__.router,self__.listen_key,self__.click_listen_key,G__54652,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_Html5History = (function reitit$frontend$history$map__GT_Html5History(G__54656){
var extmap__4419__auto__ = (function (){var G__54673 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__54656,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"listen-key","listen-key",51973686),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955)], 0));
if(cljs.core.record_QMARK_(G__54656)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__54673);
} else {
return G__54673;
}
})();
return (new reitit.frontend.history.Html5History(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__54656),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__54656),new cljs.core.Keyword(null,"listen-key","listen-key",51973686).cljs$core$IFn$_invoke$arity$1(G__54656),new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955).cljs$core$IFn$_invoke$arity$1(G__54656),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
