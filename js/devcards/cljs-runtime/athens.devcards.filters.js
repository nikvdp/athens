...
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60757 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60757)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60757)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60757)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60757)].join('')));
...
var vec__60761 = cljs.core.first(s__60746__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60761,(0),null);
var map__60764 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60761,(1),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60764__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60764__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__60761,k,map__60764,map__60764__$1,count,state,s__60746__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60767 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60767)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60767)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60767)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60767)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__60761,k,map__60764,map__60764__$1,count,state,s__60746__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60771 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60771 = (function (meta60772){
this.meta60772 = meta60772;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60771.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60773,meta60772__$1){
var self__ = this;
var _60773__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60771(meta60772__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60771.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60773){
var self__ = this;
var _60773__$1 = this;
return self__.meta60772;
}));

(athens.devcards.filters.t_athens$devcards$filters60771.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60771.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60771.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters60771.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60771.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60771");

(athens.devcards.filters.t_athens$devcards$filters60771.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters60771");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60771.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60771 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60771(meta60772){
return (new athens.devcards.filters.t_athens$devcards$filters60771(meta60772));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60771(null));
})()
