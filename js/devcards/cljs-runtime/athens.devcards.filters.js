...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61529 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61529 = (function (meta61530){
this.meta61530 = meta61530;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61529.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61531,meta61530__$1){
var self__ = this;
var _61531__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61529(meta61530__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61529.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61531){
var self__ = this;
var _61531__$1 = this;
return self__.meta61530;
}));

(athens.devcards.filters.t_athens$devcards$filters61529.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61529.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61529.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61529.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61529.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61529");

(athens.devcards.filters.t_athens$devcards$filters61529.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61529");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61529.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61529 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61529(meta61530){
return (new athens.devcards.filters.t_athens$devcards$filters61529(meta61530));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61529(null));
})()
