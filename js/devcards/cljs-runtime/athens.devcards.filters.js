...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60109 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60109 = (function (meta60110){
this.meta60110 = meta60110;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60109.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60111,meta60110__$1){
var self__ = this;
var _60111__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60109(meta60110__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60109.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60111){
var self__ = this;
var _60111__$1 = this;
return self__.meta60110;
}));

(athens.devcards.filters.t_athens$devcards$filters60109.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60109.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47717__auto__,devcard_opts__47718__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60109.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters60109.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60109.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60109");

(athens.devcards.filters.t_athens$devcards$filters60109.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.filters/t_athens$devcards$filters60109");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60109.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60109 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60109(meta60110){
return (new athens.devcards.filters.t_athens$devcards$filters60109(meta60110));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60109(null));
})()
