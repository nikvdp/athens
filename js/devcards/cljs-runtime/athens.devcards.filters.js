...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61386 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61386 = (function (meta61387){
this.meta61387 = meta61387;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61386.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61388,meta61387__$1){
var self__ = this;
var _61388__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61386(meta61387__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61386.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61388){
var self__ = this;
var _61388__$1 = this;
return self__.meta61387;
}));

(athens.devcards.filters.t_athens$devcards$filters61386.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61386.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48675__auto__,devcard_opts__48676__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61386.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61387","meta61387",939857331,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters61386.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61386.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61386");

(athens.devcards.filters.t_athens$devcards$filters61386.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61386");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61386.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61386 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61386(meta61387){
return (new athens.devcards.filters.t_athens$devcards$filters61386(meta61387));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61386(null));
})()
