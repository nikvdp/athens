...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61536 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61536 = (function (meta61537){
this.meta61537 = meta61537;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61536.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61538,meta61537__$1){
var self__ = this;
var _61538__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61536(meta61537__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61536.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61538){
var self__ = this;
var _61538__$1 = this;
return self__.meta61537;
}));

(athens.devcards.filters.t_athens$devcards$filters61536.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61536.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61536.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61536.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61536.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61536");

(athens.devcards.filters.t_athens$devcards$filters61536.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61536");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61536.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61536 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61536(meta61537){
return (new athens.devcards.filters.t_athens$devcards$filters61536(meta61537));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61536(null));
})()
