...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61487 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61487 = (function (meta61488){
this.meta61488 = meta61488;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61487.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61489,meta61488__$1){
var self__ = this;
var _61489__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61487(meta61488__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61487.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61489){
var self__ = this;
var _61489__$1 = this;
return self__.meta61488;
}));

(athens.devcards.filters.t_athens$devcards$filters61487.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61487.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61487.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61487.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61487.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61487");

(athens.devcards.filters.t_athens$devcards$filters61487.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61487");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61487.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61487 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61487(meta61488){
return (new athens.devcards.filters.t_athens$devcards$filters61487(meta61488));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61487(null));
})()
