...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61507 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61507 = (function (meta61508){
this.meta61508 = meta61508;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61507.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61509,meta61508__$1){
var self__ = this;
var _61509__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61507(meta61508__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61507.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61509){
var self__ = this;
var _61509__$1 = this;
return self__.meta61508;
}));

(athens.devcards.filters.t_athens$devcards$filters61507.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61507.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61507.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61507.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61507.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61507");

(athens.devcards.filters.t_athens$devcards$filters61507.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61507");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61507.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61507 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61507(meta61508){
return (new athens.devcards.filters.t_athens$devcards$filters61507(meta61508));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61507(null));
})()
