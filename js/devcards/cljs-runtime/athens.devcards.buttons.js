...
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-inline-start","margin-inline-start",320232954),"0.251em"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__42164 = (function (){var fexpr__42167 = (function (){var G__42168 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$1(G__42168) : garden.selectors.first_child.call(null,G__42168));
})();
return (fexpr__42167.cljs$core$IFn$_invoke$arity$0 ? fexpr__42167.cljs$core$IFn$_invoke$arity$0() : fexpr__42167.call(null));
})();
...
athens.devcards.buttons.button = (function athens$devcards$buttons$button(p__42169){
var map__42170 = p__42169;
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var active = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42170__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
athens.devcards.buttons.button_primary = (function athens$devcards$buttons$button_primary(p__42172){
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.buttons !== 'undefined') && (typeof athens.devcards.buttons.t_athens$devcards$buttons42178 !== 'undefined')){
} else {
...
*/
athens.devcards.buttons.t_athens$devcards$buttons42178 = (function (meta42179){
this.meta42179 = meta42179;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.buttons.t_athens$devcards$buttons42178.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42180,meta42179__$1){
var self__ = this;
var _42180__$1 = this;
return (new athens.devcards.buttons.t_athens$devcards$buttons42178(meta42179__$1));
}));

(athens.devcards.buttons.t_athens$devcards$buttons42178.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42180){
var self__ = this;
var _42180__$1 = this;
return self__.meta42179;
}));

(athens.devcards.buttons.t_athens$devcards$buttons42178.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.buttons.t_athens$devcards$buttons42178.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.buttons.t_athens$devcards$buttons42178.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta42179","meta42179",129119710,null)], null);
}));

(athens.devcards.buttons.t_athens$devcards$buttons42178.cljs$lang$type = true);

(athens.devcards.buttons.t_athens$devcards$buttons42178.cljs$lang$ctorStr = "athens.devcards.buttons/t_athens$devcards$buttons42178");

(athens.devcards.buttons.t_athens$devcards$buttons42178.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.buttons/t_athens$devcards$buttons42178");
}));

/**
 * Positional factory function for athens.devcards.buttons/t_athens$devcards$buttons42178.
 */
athens.devcards.buttons.__GT_t_athens$devcards$buttons42178 = (function athens$devcards$buttons$__GT_t_athens$devcards$buttons42178(meta42179){
return (new athens.devcards.buttons.t_athens$devcards$buttons42178(meta42179));
});

}

return (new athens.devcards.buttons.t_athens$devcards$buttons42178(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.buttons !== 'undefined') && (typeof athens.devcards.buttons.t_athens$devcards$buttons42182 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.buttons.t_athens$devcards$buttons42182 = (function (meta42183){
this.meta42183 = meta42183;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.buttons.t_athens$devcards$buttons42182.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42184,meta42183__$1){
var self__ = this;
var _42184__$1 = this;
return (new athens.devcards.buttons.t_athens$devcards$buttons42182(meta42183__$1));
}));

(athens.devcards.buttons.t_athens$devcards$buttons42182.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42184){
var self__ = this;
var _42184__$1 = this;
return self__.meta42183;
}));

(athens.devcards.buttons.t_athens$devcards$buttons42182.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.buttons.t_athens$devcards$buttons42182.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.buttons.t_athens$devcards$buttons42182.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta42183","meta42183",217092080,null)], null);
}));

(athens.devcards.buttons.t_athens$devcards$buttons42182.cljs$lang$type = true);

(athens.devcards.buttons.t_athens$devcards$buttons42182.cljs$lang$ctorStr = "athens.devcards.buttons/t_athens$devcards$buttons42182");

(athens.devcards.buttons.t_athens$devcards$buttons42182.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.buttons/t_athens$devcards$buttons42182");
}));

/**
 * Positional factory function for athens.devcards.buttons/t_athens$devcards$buttons42182.
 */
athens.devcards.buttons.__GT_t_athens$devcards$buttons42182 = (function athens$devcards$buttons$__GT_t_athens$devcards$buttons42182(meta42183){
return (new athens.devcards.buttons.t_athens$devcards$buttons42182(meta42183));
});

}

return (new athens.devcards.buttons.t_athens$devcards$buttons42182(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
