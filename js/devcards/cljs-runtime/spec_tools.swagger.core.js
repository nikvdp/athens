...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__53988 = cljs.core.get_global_hierarchy;
return (fexpr__53988.cljs$core$IFn$_invoke$arity$0 ? fexpr__53988.cljs$core$IFn$_invoke$arity$0() : fexpr__53988.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__53989){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53990__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53990__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__53992 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53992,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53992,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__53997 = cljs.core.get_global_hierarchy;
return (fexpr__53997.cljs$core$IFn$_invoke$arity$0 ? fexpr__53997.cljs$core$IFn$_invoke$arity$0() : fexpr__53997.call(null));
})());
...
var map__53998 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53998__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53998__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__54000){
var vec__54001 = p__54000;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54001,(0),null);
var map__54004 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54001,(1),null);
var map__54004__$1 = (((((!((map__54004 == null))))?(((((map__54004.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54004.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54004):map__54004);
var schema = map__54004__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54004__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54006 = cljs.core.get_global_hierarchy;
return (fexpr__54006.cljs$core$IFn$_invoke$arity$0 ? fexpr__54006.cljs$core$IFn$_invoke$arity$0() : fexpr__54006.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__54008(s__54009){
return (new cljs.core.LazySeq(null,(function (){
var s__54009__$1 = s__54009;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54009__$1);
if(temp__5735__auto__){
var s__54009__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54009__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__54009__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__54011 = cljs.core.chunk_buffer(size__4581__auto__);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54011),spec_tools$swagger$core$iter__54008(cljs.core.chunk_rest(s__54009__$2)));
} else {
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__54008(cljs.core.rest(s__54009__$2)));
}
} else {
return null;
}
