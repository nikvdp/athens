...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__48548){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48549__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48549__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__48551 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48551,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48551,(1),null);
...
var map__48557 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48557__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48557__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__48560){
var vec__48561 = p__48560;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48561,(0),null);
var map__48564 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48561,(1),null);
...
var schema = map__48564__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48564__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__48566 = cljs.core.get_global_hierarchy;
return (fexpr__48566.cljs$core$IFn$_invoke$arity$0 ? fexpr__48566.cljs$core$IFn$_invoke$arity$0() : fexpr__48566.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__48567(s__48568){
return (new cljs.core.LazySeq(null,(function (){
var s__48568__$1 = s__48568;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__48568__$1);
if(temp__5735__auto__){
var s__48568__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48568__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__48568__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__48570 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__48569 = (0);
while(true){
if((i__48569 < size__4581__auto__)){
var vec__48571 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__48569);
...
cljs.core.chunk_append(b__48570,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48570),spec_tools$swagger$core$iter__48567(cljs.core.chunk_rest(s__48568__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48570),null);
}
} else {
var vec__48574 = cljs.core.first(s__48568__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48574,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48574,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__48567(cljs.core.rest(s__48568__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__48577){
var vec__48578 = p__48577;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48578,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48578,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__48581,p){
var vec__48582 = p__48581;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48582,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48582,(1),null);
var acc__$1 = vec__48582;
