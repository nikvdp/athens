...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61040 = (function (){var G__61041 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61041) : garden.selectors.not.call(null,G__61041));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61040) : garden.selectors._AMPERSAND_.call(null,G__61040));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61042 = (function (){var G__61043 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61043) : garden.selectors.not.call(null,G__61043));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61042) : garden.selectors._AMPERSAND_.call(null,G__61042));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__61044){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61045__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__61047){
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61050){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"label","label",1718410804));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61053 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61053 = (function (meta61054){
this.meta61054 = meta61054;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61053.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61055,meta61054__$1){
var self__ = this;
var _61055__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61053(meta61054__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61053.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61055){
var self__ = this;
var _61055__$1 = this;
return self__.meta61054;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61053.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61053.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61053.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61053.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61053.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61053");

(athens.devcards.dropdown.t_athens$devcards$dropdown61053.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61053");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61053.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61053 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61053(meta61054){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61053(meta61054));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61053(null));
})()
