...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60802 = (function (){var G__60803 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60803) : garden.selectors.not.call(null,G__60803));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60802) : garden.selectors._AMPERSAND_.call(null,G__60802));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60804 = (function (){var G__60805 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60805) : garden.selectors.not.call(null,G__60805));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60804) : garden.selectors._AMPERSAND_.call(null,G__60804));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__60806){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60807__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60807__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__60809){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60810__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60810__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__60812){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60813__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60813__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60813__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60815 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60815 = (function (meta60816){
this.meta60816 = meta60816;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60815.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60817,meta60816__$1){
var self__ = this;
var _60817__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60815(meta60816__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60817){
var self__ = this;
var _60817__$1 = this;
return self__.meta60816;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60815.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60816","meta60816",-1977609636,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60815");

(athens.devcards.dropdown.t_athens$devcards$dropdown60815.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60815");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60815.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60815 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60815(meta60816){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60815(meta60816));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60815(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60818 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60818 = (function (meta60819){
this.meta60819 = meta60819;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60818.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60820,meta60819__$1){
var self__ = this;
var _60820__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60818(meta60819__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60818.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60820){
var self__ = this;
var _60820__$1 = this;
return self__.meta60819;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60818.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60818.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60818.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60818.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60818.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60818");

(athens.devcards.dropdown.t_athens$devcards$dropdown60818.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60818");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60818.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60818 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60818(meta60819){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60818(meta60819));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60818(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60821 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60821 = (function (meta60822){
this.meta60822 = meta60822;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60821.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60823,meta60822__$1){
var self__ = this;
var _60823__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60821(meta60822__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60821.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60823){
var self__ = this;
var _60823__$1 = this;
return self__.meta60822;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60821.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60821.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60821.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60821.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60821.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60821");

(athens.devcards.dropdown.t_athens$devcards$dropdown60821.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60821");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60821.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60821 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60821(meta60822){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60821(meta60822));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60821(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
