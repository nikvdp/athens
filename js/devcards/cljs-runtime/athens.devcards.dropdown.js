...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61031 = (function (){var G__61032 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61032) : garden.selectors.not.call(null,G__61032));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61031) : garden.selectors._AMPERSAND_.call(null,G__61031));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61033 = (function (){var G__61034 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61034) : garden.selectors.not.call(null,G__61034));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61033) : garden.selectors._AMPERSAND_.call(null,G__61033));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__61035){
var map__61036 = p__61035;
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61036__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61036__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__61038){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61041){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61042__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61042__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61042__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61044 !== 'undefined')){
} else {
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61044.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61045","meta61045",1688677493,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61044.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61044.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61044");

(athens.devcards.dropdown.t_athens$devcards$dropdown61044.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61044");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61044.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61044 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61044(meta61045){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61044(meta61045));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61044(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61047 !== 'undefined')){
} else {
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61047.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61048","meta61048",-452269812,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61047.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61047.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61047");

(athens.devcards.dropdown.t_athens$devcards$dropdown61047.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61047");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61047.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61047 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61047(meta61048){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61047(meta61048));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61047(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61050 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61050 = (function (meta61051){
this.meta61051 = meta61051;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61050.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61052,meta61051__$1){
var self__ = this;
var _61052__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61050(meta61051__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61052){
var self__ = this;
var _61052__$1 = this;
return self__.meta61051;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.dropdown,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"20em",new cljs.core.Keyword(null,"height","height",1025178622),"20em"], null),new cljs.core.Keyword(null,"content","content",15833224),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.menu_heading,"Filters"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.filters.filters_el,"((some-uid))",athens.devcards.dropdown.items], null)], null)], null)], null);
if(cljs.core.fn_QMARK_(v__41695__auto__)){
return (function (data_atom__41696__auto__,owner__41697__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__41695__auto__,data_atom__41696__auto__,owner__41697__auto__], null));
});
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61050.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61051","meta61051",-1650363384,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61050");

(athens.devcards.dropdown.t_athens$devcards$dropdown61050.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61050");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61050.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61050 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61050(meta61051){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61050(meta61051));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61050(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
