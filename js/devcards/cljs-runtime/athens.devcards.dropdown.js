...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61006 = (function (){var G__61007 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61007) : garden.selectors.not.call(null,G__61007));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61006) : garden.selectors._AMPERSAND_.call(null,G__61006));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61008 = (function (){var G__61009 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61009) : garden.selectors.not.call(null,G__61009));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61008) : garden.selectors._AMPERSAND_.call(null,G__61008));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__61010){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61011__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61011__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__61013){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61014__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61014__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61016){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61017__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61017__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61017__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61019 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61019 = (function (meta61020){
this.meta61020 = meta61020;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61019.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61021,meta61020__$1){
var self__ = this;
var _61021__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61019(meta61020__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61019.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61021){
var self__ = this;
var _61021__$1 = this;
return self__.meta61020;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61019.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61019.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61019.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61019.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61019.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61019");

(athens.devcards.dropdown.t_athens$devcards$dropdown61019.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61019");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61019.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61019 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61019(meta61020){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61019(meta61020));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61019(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61022 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61022 = (function (meta61023){
this.meta61023 = meta61023;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61022.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61024,meta61023__$1){
var self__ = this;
var _61024__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61022(meta61023__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61024){
var self__ = this;
var _61024__$1 = this;
return self__.meta61023;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61022.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61023","meta61023",679602229,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61022");

(athens.devcards.dropdown.t_athens$devcards$dropdown61022.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61022");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61022.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61022 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61022(meta61023){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61022(meta61023));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61022(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61025 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61025 = (function (meta61026){
this.meta61026 = meta61026;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61025.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61027,meta61026__$1){
var self__ = this;
var _61027__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61025(meta61026__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61027){
var self__ = this;
var _61027__$1 = this;
return self__.meta61026;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61025.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61026","meta61026",851361167,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61025");

(athens.devcards.dropdown.t_athens$devcards$dropdown61025.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61025");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61025.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61025 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61025(meta61026){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61025(meta61026));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61025(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
