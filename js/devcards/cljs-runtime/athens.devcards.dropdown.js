...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60993 = (function (){var G__60994 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60994) : garden.selectors.not.call(null,G__60994));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60993) : garden.selectors._AMPERSAND_.call(null,G__60993));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60995 = (function (){var G__60996 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60996) : garden.selectors.not.call(null,G__60996));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60995) : garden.selectors._AMPERSAND_.call(null,G__60995));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__60997){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60998__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60998__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__61000){
var map__61001 = p__61000;
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61001__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61001__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61003){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61004__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61004__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61004__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61006 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61006 = (function (meta61007){
this.meta61007 = meta61007;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61006.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61008,meta61007__$1){
var self__ = this;
var _61008__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61006(meta61007__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61006.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61008){
var self__ = this;
var _61008__$1 = this;
return self__.meta61007;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61006.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61006.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61006.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61006.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61006.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61006");

(athens.devcards.dropdown.t_athens$devcards$dropdown61006.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61006");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61006.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61006 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61006(meta61007){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61006(meta61007));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61006(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61009 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61009 = (function (meta61010){
this.meta61010 = meta61010;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61009.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61011,meta61010__$1){
var self__ = this;
var _61011__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61009(meta61010__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61009.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61011){
var self__ = this;
var _61011__$1 = this;
return self__.meta61010;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61009.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61009.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61009.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61009.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61009.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61009");

(athens.devcards.dropdown.t_athens$devcards$dropdown61009.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61009");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61009.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61009 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61009(meta61010){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61009(meta61010));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61009(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61012 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61012 = (function (meta61013){
this.meta61013 = meta61013;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61012.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61014,meta61013__$1){
var self__ = this;
var _61014__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61012(meta61013__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61012.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61014){
var self__ = this;
var _61014__$1 = this;
return self__.meta61013;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61012.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61012.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61012.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61012.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61012.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61012");

(athens.devcards.dropdown.t_athens$devcards$dropdown61012.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61012");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61012.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61012 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61012(meta61013){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61012(meta61013));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61012(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
