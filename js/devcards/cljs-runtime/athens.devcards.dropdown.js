...
(athens.devcards.dropdown.t_athens$devcards$dropdown61061.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61067.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
var this__42228__auto____$1 = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61073 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61073 = (function (meta61074){
this.meta61074 = meta61074;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61073.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61075,meta61074__$1){
var self__ = this;
var _61075__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61073(meta61074__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61073.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61075){
var self__ = this;
var _61075__$1 = this;
return self__.meta61074;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61073.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61073.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
var this__42228__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61073.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61073.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61073.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61073");

(athens.devcards.dropdown.t_athens$devcards$dropdown61073.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61073");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61073.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61073 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61073(meta61074){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61073(meta61074));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61073(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
