...
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61164,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61164,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61164,(2),null);
cljs.core.chunk_append(b__61163,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61162,vec__61164,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61163,s__61161__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__61162,vec__61164,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61163,s__61161__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__61171 = (i__61162 + (1));
i__61162 = G__61171;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61163),athens$views$left_sidebar$left_sidebar_$_iter__61160(cljs.core.chunk_rest(s__61161__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61163),null);
}
} else {
var vec__61167 = cljs.core.first(s__61161__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61167,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61167,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61167,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61167,_order,title,uid,s__61161__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61167,_order,title,uid,s__61161__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$views$left_sidebar$left_sidebar_$_iter__61160(cljs.core.rest(s__61161__$2)));
}
} else {
return null;
}
...
var G__61170 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61170) : re_frame.core.dispatch.call(null,G__61170));
})], null)], null)], null)], null);
} else {
return null;
}
