...
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61191,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61191,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61191,(2),null);
cljs.core.chunk_append(b__61190,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61189,vec__61191,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61190,s__61188__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__61189,vec__61191,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61190,s__61188__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__61198 = (i__61189 + (1));
i__61189 = G__61198;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61190),athens$views$left_sidebar$left_sidebar_$_iter__61187(cljs.core.chunk_rest(s__61188__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61190),null);
}
} else {
var vec__61194 = cljs.core.first(s__61188__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61194,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61194,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61194,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61194,_order,title,uid,s__61188__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61194,_order,title,uid,s__61188__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$views$left_sidebar$left_sidebar_$_iter__61187(cljs.core.rest(s__61188__$2)));
}
} else {
return null;
}
...
var G__61197 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61197) : re_frame.core.dispatch.call(null,G__61197));
})], null)], null)], null)], null);
} else {
return null;
}
