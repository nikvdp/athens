...
athens.views.left_sidebar.shortcut_component = (function athens$views$left_sidebar$shortcut_component(p__61251){
var vec__61252 = p__61251;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61252,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61252,(1),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61252,(2),null);
var drag = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function (p__61255){
var vec__61256 = p__61255;
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61256,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61256,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61256,(2),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.left_sidebar.shortcut_style,(function (){var G__61259 = cljs.core.deref(drag);
...
var source_order_61271 = parseInt(e.dataTransfer.getData("text/plain"));
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([source_order_61271,order], 0));

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_61271,order)){
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_61271,(order - (1)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"above","above",-1286866470))))){
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"below","below",-926774883))){
var G__61260_61272 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-below","left-sidebar/drop-below",1291292866),source_order_61271,order], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61260_61272) : re_frame.core.dispatch.call(null,G__61260_61272));
} else {
var G__61261_61273 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-above","left-sidebar/drop-above",75584917),source_order_61271,order], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61261_61273) : re_frame.core.dispatch.call(null,G__61261_61273));
...
var open_QMARK_ = (function (){var G__61262 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","open","left-sidebar/open",-686633270)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61262) : re_frame.core.subscribe.call(null,G__61262));
})();
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61263 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61264 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61263,G__61264) : posh.reagent.q.call(null,G__61263,G__61264));
})())));
if(cljs.core.truth_(cljs.core.deref(open_QMARK_))){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.left_sidebar.left_sidebar_style),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol","ol",932524051),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.left_sidebar.shortcuts_list_style),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.views.left_sidebar.shortcuts_list_style,new cljs.core.Keyword(null,"heading","heading",-1312171873)),"Shortcuts"], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$views$left_sidebar$left_sidebar_$_iter__61265(s__61266){
return (new cljs.core.LazySeq(null,(function (){
var s__61266__$1 = s__61266;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61266__$1);
if(temp__5735__auto__){
var s__61266__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61266__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61266__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61268 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61267 = (0);
while(true){
if((i__61267 < size__4581__auto__)){
var sh = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61267);
cljs.core.chunk_append(b__61268,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.left_sidebar.shortcut_component,sh], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["left-sidebar-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(sh))].join('')], null)));

var G__61274 = (i__61267 + (1));
i__61267 = G__61274;
continue;
} else {
return true;
...
var G__61269 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
