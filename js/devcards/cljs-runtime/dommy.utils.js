 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__34612){
var vec__34614 = p__34612;
var seq__34615 = cljs.core.seq(vec__34614);
var first__34616 = cljs.core.first(seq__34615);
var seq__34615__$1 = cljs.core.next(seq__34615);
var k = first__34616;
var ks = seq__34615__$1;
...
return [(function (){var G__34625 = cljs.core.namespace(s);
if((G__34625 == null)){
return null;
} else {
return [G__34625,"/"].join('');
}
