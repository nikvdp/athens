 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61713){
var vec__61714 = p__61713;
var seq__61715 = cljs.core.seq(vec__61714);
var first__61716 = cljs.core.first(seq__61715);
var seq__61715__$1 = cljs.core.next(seq__61715);
var k = first__61716;
var ks = seq__61715__$1;
var keys = vec__61714;
if(ks){
...
var G__61718 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61719 = now_seen_events;
var fexpr__61717 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61717.cljs$core$IFn$_invoke$arity$2 ? fexpr__61717.cljs$core$IFn$_invoke$arity$2(G__61718,G__61719) : fexpr__61717.call(null,G__61718,G__61719));
...
var G__61720 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61721 = "async-flow: got bad value for :when - ";
var G__61722 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61720,G__61721,G__61722) : re_frame.core.console.call(null,G__61720,G__61721,G__61722));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61723){
...
var rule = map__61724__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61724__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61726 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61727 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61728 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61726,G__61727,G__61728) : re_frame.core.console.call(null,G__61726,G__61727,G__61728));
} else {
var G__61729 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61729__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61729,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61729);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61729__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61729__$1;
}
...
var map__61730 = rule;
var map__61730__$1 = (((((!((map__61730 == null))))?(((((map__61730.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61730.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61730):map__61730);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61730__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61730__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61732 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61733 = "async-flow: dispatch-fn must return a seq of events ";
var G__61734 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61732,G__61733,G__61734) : re_frame.core.console.call(null,G__61732,G__61733,G__61734));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61735){
var map__61736 = p__61735;
var map__61736__$1 = (((((!((map__61736 == null))))?(((((map__61736.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61736.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61736):map__61736);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61736__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61736__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61736__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61736__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61738,p__61739){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61740__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61741 = p__61739;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61741,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61741,(1),null);
var event_v = vec__61741;
var pred__61745 = cljs.core._EQ_;
var expr__61746 = event_type;
if(cljs.core.truth_((function (){var G__61748 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61749 = expr__61746;
return (pred__61745.cljs$core$IFn$_invoke$arity$2 ? pred__61745.cljs$core$IFn$_invoke$arity$2(G__61748,G__61749) : pred__61745.call(null,G__61748,G__61749));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61750 = db;
var G__61751 = cljs.core.PersistentHashSet.EMPTY;
var G__61752 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61750,G__61751,G__61752) : set_state.call(null,G__61750,G__61751,G__61752));
...
var vec__61753 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61753,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61753,(1),null);
var map__61756 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
var map__61756__$1 = (((((!((map__61756 == null))))?(((((map__61756.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61756.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61756):map__61756);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61756__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61756__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61758 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61758,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61758,(1),null);
...
var G__61761 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61761) : re_frame.core.dispatch.call(null,G__61761));
});
var G__61762_61764 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61763_61765 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61762_61764,G__61763_61765) : re_frame.core.reg_fx.call(null,G__61762_61764,G__61763_61765));
