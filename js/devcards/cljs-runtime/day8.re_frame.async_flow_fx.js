 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61720){
var vec__61721 = p__61720;
var seq__61722 = cljs.core.seq(vec__61721);
var first__61723 = cljs.core.first(seq__61722);
var seq__61722__$1 = cljs.core.next(seq__61722);
var k = first__61723;
var ks = seq__61722__$1;
var keys = vec__61721;
if(ks){
...
var G__61725 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61726 = now_seen_events;
var fexpr__61724 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61724.cljs$core$IFn$_invoke$arity$2 ? fexpr__61724.cljs$core$IFn$_invoke$arity$2(G__61725,G__61726) : fexpr__61724.call(null,G__61725,G__61726));
...
var G__61727 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61728 = "async-flow: got bad value for :when - ";
var G__61729 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61727,G__61728,G__61729) : re_frame.core.console.call(null,G__61727,G__61728,G__61729));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61730){
var map__61731 = p__61730;
var map__61731__$1 = (((((!((map__61731 == null))))?(((((map__61731.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61731.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61731):map__61731);
var rule = map__61731__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61731__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61733 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61734 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61735 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61733,G__61734,G__61735) : re_frame.core.console.call(null,G__61733,G__61734,G__61735));
} else {
var G__61736 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61736__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61736,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61736);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61736__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61736__$1;
}
...
var map__61737 = rule;
var map__61737__$1 = (((((!((map__61737 == null))))?(((((map__61737.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61737.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61737):map__61737);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61737__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61737__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61739 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61740 = "async-flow: dispatch-fn must return a seq of events ";
var G__61741 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61739,G__61740,G__61741) : re_frame.core.console.call(null,G__61739,G__61740,G__61741));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61742){
var map__61743 = p__61742;
var map__61743__$1 = (((((!((map__61743 == null))))?(((((map__61743.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61743.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61743):map__61743);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61745,p__61746){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61747__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61748 = p__61746;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61748,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61748,(1),null);
var event_v = vec__61748;
var pred__61752 = cljs.core._EQ_;
var expr__61753 = event_type;
if(cljs.core.truth_((function (){var G__61755 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61756 = expr__61753;
return (pred__61752.cljs$core$IFn$_invoke$arity$2 ? pred__61752.cljs$core$IFn$_invoke$arity$2(G__61755,G__61756) : pred__61752.call(null,G__61755,G__61756));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61757 = db;
var G__61758 = cljs.core.PersistentHashSet.EMPTY;
var G__61759 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61757,G__61758,G__61759) : set_state.call(null,G__61757,G__61758,G__61759));
...
var vec__61760 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61760,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61760,(1),null);
var map__61763 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61763__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61763__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61765 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61765,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61765,(1),null);
...
var G__61768 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61768) : re_frame.core.dispatch.call(null,G__61768));
});
var G__61769_61771 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61770_61772 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61769_61771,G__61770_61772) : re_frame.core.reg_fx.call(null,G__61769_61771,G__61770_61772));
