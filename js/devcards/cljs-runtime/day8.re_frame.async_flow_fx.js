 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61700){
var vec__61701 = p__61700;
var seq__61702 = cljs.core.seq(vec__61701);
var first__61703 = cljs.core.first(seq__61702);
var seq__61702__$1 = cljs.core.next(seq__61702);
var k = first__61703;
var ks = seq__61702__$1;
var keys = vec__61701;
if(ks){
...
var G__61705 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61706 = now_seen_events;
var fexpr__61704 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61704.cljs$core$IFn$_invoke$arity$2 ? fexpr__61704.cljs$core$IFn$_invoke$arity$2(G__61705,G__61706) : fexpr__61704.call(null,G__61705,G__61706));
...
var G__61707 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61708 = "async-flow: got bad value for :when - ";
var G__61709 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61707,G__61708,G__61709) : re_frame.core.console.call(null,G__61707,G__61708,G__61709));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61710){
...
var rule = map__61711__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61713 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61714 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61715 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61713,G__61714,G__61715) : re_frame.core.console.call(null,G__61713,G__61714,G__61715));
} else {
var G__61716 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61716__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61716,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61716);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61716__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61716__$1;
}
...
var map__61717 = rule;
var map__61717__$1 = (((((!((map__61717 == null))))?(((((map__61717.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61717.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61717):map__61717);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61717__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61717__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61719 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61720 = "async-flow: dispatch-fn must return a seq of events ";
var G__61721 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61719,G__61720,G__61721) : re_frame.core.console.call(null,G__61719,G__61720,G__61721));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61722){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61723__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61723__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61723__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61723__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61725,p__61726){
var map__61727 = p__61725;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61727__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61728 = p__61726;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61728,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61728,(1),null);
var event_v = vec__61728;
var pred__61732 = cljs.core._EQ_;
var expr__61733 = event_type;
if(cljs.core.truth_((function (){var G__61735 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61736 = expr__61733;
return (pred__61732.cljs$core$IFn$_invoke$arity$2 ? pred__61732.cljs$core$IFn$_invoke$arity$2(G__61735,G__61736) : pred__61732.call(null,G__61735,G__61736));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61737 = db;
var G__61738 = cljs.core.PersistentHashSet.EMPTY;
var G__61739 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61737,G__61738,G__61739) : set_state.call(null,G__61737,G__61738,G__61739));
...
var vec__61740 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61740,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61740,(1),null);
var map__61743 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61743__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61745 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61745,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61745,(1),null);
...
var G__61748 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
...
var G__61749_61751 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61750_61752 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61749_61751,G__61750_61752) : re_frame.core.reg_fx.call(null,G__61749_61751,G__61750_61752));
