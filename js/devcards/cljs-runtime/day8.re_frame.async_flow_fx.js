 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61718){
var vec__61719 = p__61718;
var seq__61720 = cljs.core.seq(vec__61719);
var first__61721 = cljs.core.first(seq__61720);
var seq__61720__$1 = cljs.core.next(seq__61720);
var k = first__61721;
var ks = seq__61720__$1;
var keys = vec__61719;
if(ks){
...
var G__61723 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61724 = now_seen_events;
var fexpr__61722 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61722.cljs$core$IFn$_invoke$arity$2 ? fexpr__61722.cljs$core$IFn$_invoke$arity$2(G__61723,G__61724) : fexpr__61722.call(null,G__61723,G__61724));
...
var G__61725 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61726 = "async-flow: got bad value for :when - ";
var G__61727 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61725,G__61726,G__61727) : re_frame.core.console.call(null,G__61725,G__61726,G__61727));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61728){
...
var rule = map__61729__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61729__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61731 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61732 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61733 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61731,G__61732,G__61733) : re_frame.core.console.call(null,G__61731,G__61732,G__61733));
} else {
var G__61734 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61734__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61734,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61734);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61734__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61734__$1;
}
...
var map__61735 = rule;
var map__61735__$1 = (((((!((map__61735 == null))))?(((((map__61735.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61735.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61735):map__61735);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61737 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61738 = "async-flow: dispatch-fn must return a seq of events ";
var G__61739 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61737,G__61738,G__61739) : re_frame.core.console.call(null,G__61737,G__61738,G__61739));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61740){
var map__61741 = p__61740;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61743,p__61744){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61745__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61746 = p__61744;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61746,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61746,(1),null);
var event_v = vec__61746;
var pred__61750 = cljs.core._EQ_;
var expr__61751 = event_type;
if(cljs.core.truth_((function (){var G__61753 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61754 = expr__61751;
return (pred__61750.cljs$core$IFn$_invoke$arity$2 ? pred__61750.cljs$core$IFn$_invoke$arity$2(G__61753,G__61754) : pred__61750.call(null,G__61753,G__61754));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61755 = db;
var G__61756 = cljs.core.PersistentHashSet.EMPTY;
var G__61757 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61755,G__61756,G__61757) : set_state.call(null,G__61755,G__61756,G__61757));
...
var vec__61758 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61758,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61758,(1),null);
var map__61761 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61761__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61761__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61763 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61763,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61763,(1),null);
...
var G__61766 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61766) : re_frame.core.dispatch.call(null,G__61766));
});
var G__61767_61769 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61768_61770 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61767_61769,G__61768_61770) : re_frame.core.reg_fx.call(null,G__61767_61769,G__61768_61770));
