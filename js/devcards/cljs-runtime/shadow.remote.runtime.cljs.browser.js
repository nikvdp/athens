...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61005,action,ex){
...
var state = map__61006__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61006__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61008 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61008) : callback.call(null,G__61008));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61009,p__61010){
var map__61011 = p__61009;
...
var state = map__61011__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61011__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__61012__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61012__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61015 = type;
var G__61015__$1 = (((G__61015 instanceof cljs.core.Keyword))?G__61015.fqn:null);
switch (G__61015__$1) {
case "repl/invoke":
var map__61016 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61016__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61019 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61019) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61019));
}catch (e61018){var ex = e61018;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61015__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61020){
...
var state = map__61021__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61021__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61023 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61023.cljs$core$IFn$_invoke$arity$1 ? fexpr__61023.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61023.call(null,state));
} else {
var map__61024 = cljs.core.first(actions);
...
var action = map__61024__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61024__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61031 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61032 = (function (res){
var req = this;
var map__61036 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__61038 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61038) : callback.call(null,G__61038));
} else {
...
var G__61033 = "POST";
var G__61034 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61035 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61031,G__61032,G__61033,G__61034,G__61035);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61027,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61027,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61040){
var vec__61041 = p__61040;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61041,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61041,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61026){
var self__ = this;
var G__61026__$1 = this;
return (new cljs.core.RecordIter((0),G__61026__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61044 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61044(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61028,other61029){
var self__ = this;
var this61028__$1 = this;
return (((!((other61029 == null)))) && ((this61028__$1.constructor === other61029.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61028__$1.ws,other61029.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61028__$1.state_ref,other61029.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61028__$1.__extmap,other61029.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61026){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61045 = cljs.core.keyword_identical_QMARK_;
var expr__61046 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61048 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61049 = expr__61046;
return (pred__61045.cljs$core$IFn$_invoke$arity$2 ? pred__61045.cljs$core$IFn$_invoke$arity$2(G__61048,G__61049) : pred__61045.call(null,G__61048,G__61049));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61026,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61050 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61051 = expr__61046;
return (pred__61045.cljs$core$IFn$_invoke$arity$2 ? pred__61045.cljs$core$IFn$_invoke$arity$2(G__61050,G__61051) : pred__61045.call(null,G__61050,G__61051));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61026,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61026),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61026){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61026,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61030){
var extmap__4478__auto__ = (function (){var G__61052 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61030,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61030)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61052);
} else {
return G__61052;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61030),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61030),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61053 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61053);
...
var map__61054 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61054__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
