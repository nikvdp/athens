...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__60863,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60864__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__60866 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60866) : callback.call(null,G__60866));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__60867,p__60868){
...
var state = map__60869__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60869__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__60870 = p__60868;
...
var G__60873 = type;
var G__60873__$1 = (((G__60873 instanceof cljs.core.Keyword))?G__60873.fqn:null);
switch (G__60873__$1) {
case "repl/invoke":
var map__60874 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60874__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__60877 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__60877) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__60877));
}catch (e60876){var ex = e60876;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60873__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__60878){
...
var state = map__60879__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60879__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__60881 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__60881.cljs$core$IFn$_invoke$arity$1 ? fexpr__60881.cljs$core$IFn$_invoke$arity$1(state) : fexpr__60881.call(null,state));
} else {
var map__60882 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__60889 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__60890 = (function (res){
var req = this;
var map__60894 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__60894__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60894__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__60896 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60896) : callback.call(null,G__60896));
} else {
...
var G__60891 = "POST";
var G__60892 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__60893 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__60889,G__60890,G__60891,G__60892,G__60893);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k60885,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k60885,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__60898){
var vec__60899 = p__60898;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60899,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60899,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__60884){
var self__ = this;
var G__60884__$1 = this;
return (new cljs.core.RecordIter((0),G__60884__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__60902 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__60902(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this60886,other60887){
var self__ = this;
var this60886__$1 = this;
return (((!((other60887 == null)))) && ((this60886__$1.constructor === other60887.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60886__$1.ws,other60887.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60886__$1.state_ref,other60887.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60886__$1.__extmap,other60887.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__60884){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__60903 = cljs.core.keyword_identical_QMARK_;
var expr__60904 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__60906 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__60907 = expr__60904;
return (pred__60903.cljs$core$IFn$_invoke$arity$2 ? pred__60903.cljs$core$IFn$_invoke$arity$2(G__60906,G__60907) : pred__60903.call(null,G__60906,G__60907));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__60884,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__60908 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__60909 = expr__60904;
return (pred__60903.cljs$core$IFn$_invoke$arity$2 ? pred__60903.cljs$core$IFn$_invoke$arity$2(G__60908,G__60909) : pred__60903.call(null,G__60908,G__60909));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__60884,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__60884),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__60884){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__60884,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__60888){
var extmap__4478__auto__ = (function (){var G__60910 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__60888,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
...
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__60888),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__60888),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__60911 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__60911);
...
var map__60912 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60912__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
