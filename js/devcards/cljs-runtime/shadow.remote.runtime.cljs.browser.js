...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__60622,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60623__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__60625 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60625) : callback.call(null,G__60625));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__60626,p__60627){
var map__60628 = p__60626;
...
var state = map__60628__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60628__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__60629 = p__60627;
...
var action = map__60629__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60629__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__60632 = type;
var G__60632__$1 = (((G__60632 instanceof cljs.core.Keyword))?G__60632.fqn:null);
switch (G__60632__$1) {
case "repl/invoke":
var map__60633 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60633__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__60636 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__60636) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__60636));
}catch (e60635){var ex = e60635;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60632__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__60637){
...
var state = map__60638__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60638__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__60640 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__60640.cljs$core$IFn$_invoke$arity$1 ? fexpr__60640.cljs$core$IFn$_invoke$arity$1(state) : fexpr__60640.call(null,state));
} else {
var map__60641 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__60648 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__60649 = (function (res){
var req = this;
var map__60653 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__60655 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60655) : callback.call(null,G__60655));
} else {
...
var G__60650 = "POST";
var G__60651 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__60652 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__60648,G__60649,G__60650,G__60651,G__60652);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k60644,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k60644,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__60657){
var vec__60658 = p__60657;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60658,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60658,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__60661 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__60661(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this60645,other60646){
var self__ = this;
var this60645__$1 = this;
return (((!((other60646 == null)))) && ((this60645__$1.constructor === other60646.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60645__$1.ws,other60646.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60645__$1.state_ref,other60646.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60645__$1.__extmap,other60646.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__60643){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__60662 = cljs.core.keyword_identical_QMARK_;
var expr__60663 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__60665 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__60666 = expr__60663;
return (pred__60662.cljs$core$IFn$_invoke$arity$2 ? pred__60662.cljs$core$IFn$_invoke$arity$2(G__60665,G__60666) : pred__60662.call(null,G__60665,G__60666));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__60643,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__60667 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__60668 = expr__60663;
return (pred__60662.cljs$core$IFn$_invoke$arity$2 ? pred__60662.cljs$core$IFn$_invoke$arity$2(G__60667,G__60668) : pred__60662.call(null,G__60667,G__60668));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__60643,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__60643),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__60643){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__60643,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__60647){
var extmap__4478__auto__ = (function (){var G__60669 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__60647,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__60647)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__60669);
} else {
return G__60669;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__60647),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__60647),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__60670 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__60670);
...
var map__60671 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60671__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
