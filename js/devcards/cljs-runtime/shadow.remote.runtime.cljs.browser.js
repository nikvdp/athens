...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61414,action,ex){
...
var state = map__61415__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61415__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61417) : callback.call(null,G__61417));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61418,p__61419){
...
var action = map__61421__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61421__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61424 = type;
var G__61424__$1 = (((G__61424 instanceof cljs.core.Keyword))?G__61424.fqn:null);
switch (G__61424__$1) {
case "repl/invoke":
var map__61425 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61425__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61428 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61428) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61428));
}catch (e61427){var ex = e61427;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61424__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61429){
...
var state = map__61430__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61430__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61432 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61432.cljs$core$IFn$_invoke$arity$1 ? fexpr__61432.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61432.call(null,state));
} else {
var map__61433 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__61440 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61441 = (function (res){
var req = this;
var map__61445 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__61447 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
...
var G__61442 = "POST";
var G__61443 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61444 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61440,G__61441,G__61442,G__61443,G__61444);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61436,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61436,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61449){
var vec__61450 = p__61449;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61450,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61450,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__61453 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61453(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61437,other61438){
var self__ = this;
var this61437__$1 = this;
return (((!((other61438 == null)))) && ((this61437__$1.constructor === other61438.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61437__$1.ws,other61438.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61437__$1.state_ref,other61438.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61437__$1.__extmap,other61438.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61435){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61454 = cljs.core.keyword_identical_QMARK_;
var expr__61455 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61457 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61458 = expr__61455;
return (pred__61454.cljs$core$IFn$_invoke$arity$2 ? pred__61454.cljs$core$IFn$_invoke$arity$2(G__61457,G__61458) : pred__61454.call(null,G__61457,G__61458));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61435,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61459 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61460 = expr__61455;
return (pred__61454.cljs$core$IFn$_invoke$arity$2 ? pred__61454.cljs$core$IFn$_invoke$arity$2(G__61459,G__61460) : pred__61454.call(null,G__61459,G__61460));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61435,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61435),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61435){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61435,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61439){
var extmap__4478__auto__ = (function (){var G__61461 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61439,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61439)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61461);
} else {
return G__61461;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61439),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61439),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61462 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61462);
...
var map__61463 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61463__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
