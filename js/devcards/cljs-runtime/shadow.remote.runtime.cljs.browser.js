...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61426,action,ex){
...
var state = map__61427__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61427__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61429 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61429) : callback.call(null,G__61429));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61430,p__61431){
...
var action = map__61433__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61433__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61436 = type;
var G__61436__$1 = (((G__61436 instanceof cljs.core.Keyword))?G__61436.fqn:null);
switch (G__61436__$1) {
case "repl/invoke":
var map__61437 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61437__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61440 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61440) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61440));
}catch (e61439){var ex = e61439;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61436__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61441){
...
var state = map__61442__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61442__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61444 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61444.cljs$core$IFn$_invoke$arity$1 ? fexpr__61444.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61444.call(null,state));
} else {
var map__61445 = cljs.core.first(actions);
...
var action = map__61445__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61445__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61452 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61453 = (function (res){
var req = this;
var map__61457 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__61459 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
...
var G__61454 = "POST";
var G__61455 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61456 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61452,G__61453,G__61454,G__61455,G__61456);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61448,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61448,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61461){
var vec__61462 = p__61461;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61462,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61462,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__61465 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61465(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61449,other61450){
var self__ = this;
var this61449__$1 = this;
return (((!((other61450 == null)))) && ((this61449__$1.constructor === other61450.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61449__$1.ws,other61450.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61449__$1.state_ref,other61450.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61449__$1.__extmap,other61450.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61447){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61466 = cljs.core.keyword_identical_QMARK_;
var expr__61467 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61469 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61470 = expr__61467;
return (pred__61466.cljs$core$IFn$_invoke$arity$2 ? pred__61466.cljs$core$IFn$_invoke$arity$2(G__61469,G__61470) : pred__61466.call(null,G__61469,G__61470));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61447,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61471 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61472 = expr__61467;
return (pred__61466.cljs$core$IFn$_invoke$arity$2 ? pred__61466.cljs$core$IFn$_invoke$arity$2(G__61471,G__61472) : pred__61466.call(null,G__61471,G__61472));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61447,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61447),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61447){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61447,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61451){
var extmap__4478__auto__ = (function (){var G__61473 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61451,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61451)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61473);
} else {
return G__61473;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61451),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61451),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61474 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61474);
...
var map__61475 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61475__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
